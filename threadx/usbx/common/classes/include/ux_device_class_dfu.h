...
#define UX_DEVICE_CLASS_DFU_REQTYPE_INTERFACE_GET                                                                      \
    (UX_REQUEST_IN | UX_REQUEST_TYPE_CLASS | UX_REQUEST_TARGET_INTERFACE) /* 10100001b, 0xA1  */
...
typedef struct UX_SLAVE_CLASS_DFU_PARAMETER_STRUCT {
    ...
    UINT (*ux_slave_class_dfu_parameter_read)(VOID *dfu, ULONG block_number, UCHAR *data_pointer, ULONG length,
                                              ULONG *actual_length);
    UINT (*ux_slave_class_dfu_parameter_write)(VOID *dfu, ULONG block_number, UCHAR *data_pointer, ULONG length,
                                               ULONG *media_status);
...
typedef struct UX_SLAVE_CLASS_DFU_STRUCT {
    ...
    UINT (*ux_slave_class_dfu_read)(VOID *dfu, ULONG block_number, UCHAR *data_pointer, ULONG length,
                                    ULONG *actual_length);
    UINT (*ux_slave_class_dfu_write)(VOID *dfu, ULONG block_number, UCHAR *data_pointer, ULONG length,
                                     ULONG *media_status);
