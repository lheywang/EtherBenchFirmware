...
/* Notification/interrupt endpoint buffer size, must be larger than max packet size in framework, and aligned in
 * 4-bytes.  */
#define UX_DEVICE_CLASS_CCID_INTERRUPT_BUFFER_SIZE 16

/* Bulk endpoints buffer size, must be larger than dwMaxCCIDMessageLength and wMaxPacketSize in framework, and aligned
 * in 4-bytes.  */
...
#define UX_DEVICE_CLASS_CCID_COMMAND_ABORTABLE(bMessageType)                                                           \
    (((bMessageType) == 0x62) || ((bMessageType) == 0x6F) || ((bMessageType) == 0x6B) || ((bMessageType) == 0x69) ||   \
     ((bMessageType) == 0x71) || ((bMessageType) == 0x72))

#define UX_DEVICE_CLASS_CCID_COMMAND_HW_ERROR_CHECK(bMessageType)                                                      \
    (((bMessageType) != 0x63) && ((bMessageType) != 0x6B) && ((bMessageType) != 0x6A) && ((bMessageType) != 0x72) &&   \
     ((bMessageType) != 0x73))

#define UX_DEVICE_CLASS_CCID_COMMAND_AUTO_SEQUENCE_CHECK(bMessageType)                                                 \
    (((bMessageType) != 0x62) && ((bMessageType) != 0x65) && ((bMessageType) != 0x6B) && ((bMessageType) != 0x6A) &&   \
     ((bMessageType) != 0x72) && ((bMessageType) != 0x73))

#define UX_DEVICE_CLASS_CCID_COMMAND_RESP_DATA_BLOCK(m) ((m) == 0x62 || (m) == 0x6F || (m) == 0x69)
#define UX_DEVICE_CLASS_CCID_COMMAND_RESP_SLOT_STATUS(m)                                                               \
    ((m) == 0x63 || (m) == 0x64 || (m) == 0x6E || (m) == 0x6A || (m) == 0x71 || (m) == 0x72 || (m) == 0x65)
#define UX_DEVICE_CLASS_CCID_COMMAND_RESP_PARAMETERS(m) ((m) == 0x6C || (m) == 0x6D || (m) == 0x61)
#define UX_DEVICE_CLASS_CCID_COMMAND_RESP_ESCAPE(m) ((m) == 0x6B)
#define UX_DEVICE_CLASS_CCID_COMMAND_RESP_DATA_RATE_AND_CLOCK_FREQ(m) ((m) == 0x73)
...
#define UX_DEVICE_CLASS_CCID_COMMAND_FLAG_ABORTABLE(bMessageType)                                                      \
    (UX_DEVICE_CLASS_CCID_COMMAND_ABORTABLE(bMessageType) ? UX_DEVICE_CLASS_CCID_FLAG_ABORTABLE : 0)

#define UX_DEVICE_CLASS_CCID_COMMAND_FLAG_AUTO_SEQUENCE_CHECK(bMessageType)                                            \
    (UX_DEVICE_CLASS_CCID_COMMAND_AUTO_SEQUENCE_CHECK(bMessageType) ? UX_DEVICE_CLASS_CCID_FLAG_AUTO_SEQUENCING : 0)

#define UX_DEVICE_CLASS_CCID_COMMAND_FLAG_HW_ERROR_CHECK(bMessageType)                                                 \
    (UX_DEVICE_CLASS_CCID_COMMAND_HW_ERROR_CHECK(bMessageType) ? UX_DEVICE_CLASS_CCID_FLAG_HW_ERROR : 0)
...
#define UX_DEVICE_CLASS_CCID_MESSAGE_LENGTH_SET(msg, len)                                                              \
    _ux_utility_long_put(((UX_DEVICE_CLASS_CCID_MESSAGE_HEADER *)(msg))->dwLength, (len))
...
#define UX_DEVICE_CLASS_CCID_PC_TO_RDR_PROTOCOL_NUM(msg)                                                               \
    (((UX_DEVICE_CLASS_CCID_PC_TO_RDR_SET_PARAMETERS_HEADER *)(msg))->bProtocolNum)
...
#define UX_DEVICE_CLASS_CCID_PC_TO_RDR_PIN_LENGTH_FORMAT(msg)                                                          \
    (((UX_DEVICE_CLASS_CCID_PC_TO_RDR_PIN_VERIFICATION *)(msg))->bmPINLengthFormat)

#define UX_DEVICE_CLASS_CCID_PC_TO_RDR_PIN_VERIFICATION_PIN_MAX_EXTRA_DIGIT(msg)                                       \
    _ux_utility_short_get(((UX_DEVICE_CLASS_CCID_PC_TO_RDR_SECURE_PIN_VERIFICATION *)(msg))->wPINMaxExtraDigit)
#define UX_DEVICE_CLASS_CCID_PC_TO_RDR_PIN_VERIFICATION_PIN_MIN_PIN_SIZE(msg)                                          \
    (((UX_DEVICE_CLASS_CCID_PC_TO_RDR_SECURE_PIN_VERIFICATION *)(msg))->wPINMaxExtraDigit[1])
#define UX_DEVICE_CLASS_CCID_PC_TO_RDR_PIN_VERIFICATION_PIN_MAX_PIN_SIZE(msg)                                          \
    (((UX_DEVICE_CLASS_CCID_PC_TO_RDR_SECURE_PIN_VERIFICATION *)(msg))->wPINMaxExtraDigit[0])
#define UX_DEVICE_CLASS_CCID_PC_TO_RDR_PIN_VERIFICATION_ENTRY_VALIDATION_CONDITION(msg)                                \
    (((UX_DEVICE_CLASS_CCID_PC_TO_RDR_SECURE_PIN_VERIFICATION *)(msg))->bEntryValidationCondition)
#define UX_DEVICE_CLASS_CCID_PC_TO_RDR_PIN_VERIFICATION_NUMBER_MESSAGE(msg)                                            \
    (((UX_DEVICE_CLASS_CCID_PC_TO_RDR_SECURE_PIN_VERIFICATION *)(msg))->bNumberMessage)
#define UX_DEVICE_CLASS_CCID_PC_TO_RDR_PIN_VERIFICATION_LANG_ID(msg)                                                   \
    _ux_utility_short_get(((UX_DEVICE_CLASS_CCID_PC_TO_RDR_SECURE_PIN_VERIFICATION *)(msg))->wLangId)
...
#define UX_DEVICE_CLASS_CCID_PC_TO_RDR_PIN_VERIFICATION_TEO_PROLOGUE(msg)                                              \
    (((UX_DEVICE_CLASS_CCID_PC_TO_RDR_SECURE_PIN_VERIFICATION *)(msg))->bTeoPrologue)
...
#define UX_DEVICE_CLASS_CCID_PC_TO_RDR_CLOCK_FREQUENCY_GET(msg)                                                        \
    _ux_utility_long_get(((UX_DEVICE_CLASS_CCID_PC_TO_RDR_SET_DATA_RATE_AND_CLOCK_FREQUENCY *)(msg))->dwClockFrequency)
#define UX_DEVICE_CLASS_CCID_PC_TO_RDR_DATA_RATE_GET(msg)                                                              \
    _ux_utility_long_get(((UX_DEVICE_CLASS_CCID_PC_TO_RDR_SET_DATA_RATE_AND_CLOCK_FREQUENCY *)(msg))->dwDataRate)
...
#define UX_DEVICE_CLASS_CCID_RDR_TO_PC_CLOCK_FREQUENCY_SET(msg, v)                                                     \
    _ux_utility_long_put(((UX_DEVICE_CLASS_CCID_RDR_TO_PC_DATA_RATE_AND_CLOCK_FREQUENCY *)(msg))->dwClockFrequency, (v))
#define UX_DEVICE_CLASS_CCID_RDR_TO_PC_DATA_RATE_SET(msg, v)                                                           \
    _ux_utility_long_put(((UX_DEVICE_CLASS_CCID_RDR_TO_PC_DATA_RATE_AND_CLOCK_FREQUENCY *)(msg))->dwDataRate, (v))
...
#define UX_DEVICE_CLASS_CCID_ENDPOINT_BUFFER_SIZE                                                                      \
    (UX_DEVICE_CLASS_CCID_BULK_BUFFER_SIZE * 2 + UX_DEVICE_CLASS_CCID_INTERRUPT_BUFFER_SIZE)
...
#define UX_DEVICE_CLASS_CCID_BULKIN_BUFFER(ccid)                                                                       \
    (UX_DEVICE_CLASS_CCID_BULKOUT_BUFFER(ccid) + UX_DEVICE_CLASS_CCID_BULK_BUFFER_SIZE)
#define UX_DEVICE_CLASS_CCID_INTERRUPTIN_BUFFER(ccid)                                                                  \
    (UX_DEVICE_CLASS_CCID_BULKIN_BUFFER(ccid) + UX_DEVICE_CLASS_CCID_BULK_BUFFER_SIZE)
