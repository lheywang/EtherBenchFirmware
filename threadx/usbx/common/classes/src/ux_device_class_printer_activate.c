...
UINT _ux_device_class_printer_activate(UX_SLAVE_CLASS_COMMAND *command) {
    ...
    printer->ux_device_class_printer_port_status = UX_DEVICE_CLASS_PRINTER_SELECT | UX_DEVICE_CLASS_PRINTER_NOT_ERROR;
    ...
    UX_TRACE_IN_LINE_INSERT(UX_TRACE_DEVICE_CLASS_PRINTER_ACTIVATE, printer, 0, 0, 0, UX_TRACE_DEVICE_CLASS_EVENTS, 0,
                            0)
