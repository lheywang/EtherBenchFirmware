...
/*                                                                        */
/**************************************************************************/
UINT _ux_device_class_pima_object_prop_desc_get(UX_SLAVE_CLASS_PIMA *pima, ULONG object_property,
    ...
    UX_TRACE_IN_LINE_INSERT(UX_TRACE_DEVICE_CLASS_PIMA_GET_OBJECT_PROP_DESC, pima, object_property, object_format_code,
    ...
    status = pima->ux_device_class_pima_object_prop_desc_get(pima, object_property, object_format_code,
    ...
    if (status == UX_SUCCESS) {
        ...
        if (object_props_desc + UX_DEVICE_CLASS_PIMA_DATA_HEADER_SIZE + object_prop_dataset_length <=
            object_props_desc_end) {

            /* Copy the object property array.  */
            _ux_utility_memory_copy(object_props_desc + UX_DEVICE_CLASS_PIMA_DATA_HEADER_SIZE, object_prop_dataset,
                                    object_prop_dataset_length); /* Use case of memcpy is verified. */
