...
UINT _ux_device_class_hid_read_run(UX_SLAVE_CLASS_HID *hid, UCHAR *buffer, ULONG requested_length,
    ...
    if (status <= UX_STATE_NEXT) {
        ...
        *actual_length = transfer_request->ux_slave_transfer_request_actual_length;
        ...
        hid->ux_device_class_hid_read_status = transfer_request->ux_slave_transfer_request_completion_code;
    ...
    case UX_DEVICE_CLASS_HID_READ_START:
        ...
        requested_length = hid->ux_device_class_hid_read_requested_length - hid->ux_device_class_hid_read_actual_length;
    ...
    case UX_DEVICE_CLASS_HID_READ_WAIT:
        ...
        /* Send the request to the device controller.  */
        status = _ux_device_stack_transfer_run(transfer_request, hid->ux_device_class_hid_read_transfer_length,
        ...
        if (status == UX_STATE_NEXT) {
            ...
            _ux_utility_memory_copy(
                hid->ux_device_class_hid_read_buffer, transfer_request->ux_slave_transfer_request_data_pointer,
                transfer_request->ux_slave_transfer_request_actual_length); /* Use case of memcpy is verified. */

            /* Next buffer address.  */
            hid->ux_device_class_hid_read_buffer += transfer_request->ux_slave_transfer_request_actual_length;

            /* Set the length actually received. */
            hid->ux_device_class_hid_read_actual_length += transfer_request->ux_slave_transfer_request_actual_length;
