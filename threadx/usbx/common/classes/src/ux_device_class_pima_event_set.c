...
/*                                                                        */
/**************************************************************************/
UINT _ux_device_class_pima_event_set(UX_SLAVE_CLASS_PIMA *pima, UX_SLAVE_CLASS_PIMA_EVENT *pima_event) {
    ...
    UX_TRACE_IN_LINE_INSERT(UX_TRACE_DEVICE_CLASS_PIMA_EVENT_SET, pima, pima_event, 0, 0, UX_TRACE_DEVICE_CLASS_EVENTS,
                            0, 0)
    ...
    current_pima_event->ux_device_class_pima_event_transaction_id =
