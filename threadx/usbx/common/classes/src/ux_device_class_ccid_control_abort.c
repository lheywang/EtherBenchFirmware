...
UINT _ux_device_class_ccid_control_abort(UX_DEVICE_CLASS_CCID *ccid, ULONG slot, ULONG seq) {
    ...
    transfer_out = &ccid->ux_device_class_ccid_endpoint_out->ux_slave_endpoint_transfer_request;
    if (transfer_out->ux_slave_transfer_request_actual_length < UX_DEVICE_CLASS_CCID_MESSAGE_HEADER_LENGTH) {
        ...
        msg = (UX_DEVICE_CLASS_CCID_MESSAGE_HEADER *)transfer_out->ux_slave_transfer_request_data_pointer;
        ...
        if (msg->bSlot == (UCHAR)slot) {
            ...
            if ((signed char)ccid_slot->ux_device_class_ccid_slot_runner >= 0) {
                ...
                transfer_in = &ccid->ux_device_class_ccid_endpoint_in->ux_slave_endpoint_transfer_request;
