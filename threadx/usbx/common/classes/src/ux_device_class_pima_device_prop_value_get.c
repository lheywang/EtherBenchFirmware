...
UINT _ux_device_class_pima_device_prop_value_get(UX_SLAVE_CLASS_PIMA *pima, ULONG device_property_code) {
    ...
    UX_TRACE_IN_LINE_INSERT(UX_TRACE_DEVICE_CLASS_PIMA_GET_DEVICE_PROP_VALUE, pima, device_property_code, 0, 0,
    ...
    status = pima->ux_device_class_pima_device_prop_value_get(pima, device_property_code, &device_property_value,
    ...
    if (status != UX_SUCCESS) {
        ...
        _ux_utility_memory_copy(pima_data_buffer + UX_DEVICE_CLASS_PIMA_DATA_HEADER_SIZE, device_property_value,
                                device_property_value_length); /* Use case of memcpy is verified. */
        ...
        _ux_utility_long_put(pima_data_buffer + UX_DEVICE_CLASS_PIMA_DATA_HEADER_LENGTH, device_property_value_length);
