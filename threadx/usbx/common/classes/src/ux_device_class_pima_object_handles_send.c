...
/*                                                                        */
/**************************************************************************/
UINT _ux_device_class_pima_object_handles_send(UX_SLAVE_CLASS_PIMA *pima, ULONG storage_id, ULONG object_format_code,
    ...
    UX_TRACE_IN_LINE_INSERT(UX_TRACE_DEVICE_CLASS_PIMA_OBJECT_HANDLES_SEND, pima, storage_id, object_format_code,
                            object_association, UX_TRACE_DEVICE_CLASS_EVENTS, 0, 0)
    ...
    status = pima->ux_device_class_pima_object_handles_get(
        pima, object_format_code, object_association,
        (ULONG *)(object_handles_array + UX_DEVICE_CLASS_PIMA_DATA_HEADER_SIZE),
    ...
    if (status != UX_SUCCESS)
        ...
        object_handles_array_length =
            (_ux_utility_long_get(object_handles_array + UX_DEVICE_CLASS_PIMA_DATA_HEADER_SIZE) + 1) *
            (ULONG)sizeof(ULONG);
