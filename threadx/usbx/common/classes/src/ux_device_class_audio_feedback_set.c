...
/*                                                                        */
/**************************************************************************/
UINT _ux_device_class_audio_feedback_set(UX_DEVICE_CLASS_AUDIO_STREAM *stream, UCHAR *encoded_feedback) {
...
/*                                                                        */
/**************************************************************************/
UINT _uxe_device_class_audio_feedback_set(UX_DEVICE_CLASS_AUDIO_STREAM *stream, UCHAR *encoded_feedback) {
