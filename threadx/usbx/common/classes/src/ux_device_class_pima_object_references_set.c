...
/*                                                                        */
/**************************************************************************/
UINT _ux_device_class_pima_object_references_set(UX_SLAVE_CLASS_PIMA *pima, ULONG object_handle) {
    ...
    UX_TRACE_IN_LINE_INSERT(UX_TRACE_DEVICE_CLASS_PIMA_SET_OBJECT_REFERENCES, pima, object_handle, 0, 0,
    ...
    if (object_references_length > UX_DEVICE_CLASS_PIMA_DATA_HEADER_SIZE) {
        ...
        status = pima->ux_device_class_pima_object_references_set(pima, object_handle, object_references,
