...
/*                                                                        */
/**************************************************************************/
UINT _ux_device_class_pima_object_props_supported_get(UX_SLAVE_CLASS_PIMA *pima, ULONG object_format_code) {
    ...
    UX_TRACE_IN_LINE_INSERT(UX_TRACE_DEVICE_CLASS_PIMA_OBJECTS_PROPS_SUPPORTED_GET, pima, object_format_code, 0, 0,
    ...
    while (*object_props_list_pointer != 0) {
        ...
        if (*object_props_list_pointer == (USHORT)object_format_code) {
            ...
            /* Compute the overall length of the object properties array = number of properties + size of array in
             * USHORT.  */
            ...
            _ux_utility_long_put(object_props_list + UX_DEVICE_CLASS_PIMA_DATA_HEADER_LENGTH, object_props_list_length);
