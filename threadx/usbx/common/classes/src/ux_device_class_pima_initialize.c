...
UINT _ux_device_class_pima_initialize(UX_SLAVE_CLASS_COMMAND *command) {
    ...
    pima->ux_device_class_pima_endpoint_buffer =
        _ux_utility_memory_allocate(UX_NO_ALIGN, UX_CACHE_SAFE_MEMORY, UX_DEVICE_CLASS_PIMA_ENDPOINT_BUFFER_SIZE);
    ...
    if (status == UX_SUCCESS) {
        status = _ux_device_thread_create(
            &class_ptr->ux_slave_class_thread, "ux_slave_class_thread", _ux_device_class_pima_thread,
            (ULONG)(ALIGN_TYPE)class_ptr, (VOID *)class_ptr->ux_slave_class_thread_stack, UX_THREAD_STACK_SIZE,
            UX_THREAD_PRIORITY_CLASS, UX_THREAD_PRIORITY_CLASS, UX_NO_TIME_SLICE, UX_DONT_START);
    ...
    pima->ux_device_class_pima_storage_file_system_type =
        pima_parameter->ux_device_class_pima_parameter_storage_file_system_type;
    pima->ux_device_class_pima_storage_access_capability =
        pima_parameter->ux_device_class_pima_parameter_storage_access_capability;
    pima->ux_device_class_pima_storage_max_capacity_low =
        pima_parameter->ux_device_class_pima_parameter_storage_max_capacity_low;
    ...
    pima->ux_device_class_pima_storage_free_space_low =
        pima_parameter->ux_device_class_pima_parameter_storage_free_space_low;
    pima->ux_device_class_pima_storage_free_space_high =
        pima_parameter->ux_device_class_pima_parameter_storage_free_space_high;
    pima->ux_device_class_pima_storage_free_space_image =
        pima_parameter->ux_device_class_pima_parameter_storage_free_space_image;
    ...
    pima->ux_device_class_pima_device_properties_list =
        pima_parameter->ux_device_class_pima_parameter_device_properties_list;

    /* Update the capture formats supported list. */
    pima->ux_device_class_pima_supported_capture_formats_list =
        pima_parameter->ux_device_class_pima_parameter_supported_capture_formats_list;

    /* Update the image formats supported list. */
    pima->ux_device_class_pima_supported_image_formats_list =
    ...
    pima->ux_device_class_pima_object_properties_list =
        pima_parameter->ux_device_class_pima_parameter_object_properties_list;
    ...
    pima->ux_device_class_pima_device_prop_desc_get =
        pima_parameter->ux_device_class_pima_parameter_device_prop_desc_get;
    pima->ux_device_class_pima_device_prop_value_get =
        pima_parameter->ux_device_class_pima_parameter_device_prop_value_get;
    pima->ux_device_class_pima_device_prop_value_set =
        pima_parameter->ux_device_class_pima_parameter_device_prop_value_set;
    ...
    pima->ux_device_class_pima_object_prop_desc_get =
        pima_parameter->ux_device_class_pima_parameter_object_prop_desc_get;
    pima->ux_device_class_pima_object_prop_value_get =
        pima_parameter->ux_device_class_pima_parameter_object_prop_value_get;
    pima->ux_device_class_pima_object_prop_value_set =
        pima_parameter->ux_device_class_pima_parameter_object_prop_value_set;
    pima->ux_device_class_pima_object_references_get =
        pima_parameter->ux_device_class_pima_parameter_object_references_get;
    pima->ux_device_class_pima_object_references_set =
        pima_parameter->ux_device_class_pima_parameter_object_references_set;
#endif
