...
UINT _ux_device_class_printer_initialize(UX_SLAVE_CLASS_COMMAND *command) {
    ...
    printer->ux_device_class_printer_parameter.ux_device_class_printer_device_id =
        printer_parameter->ux_device_class_printer_device_id;
    printer->ux_device_class_printer_parameter.ux_device_class_printer_instance_activate =
        printer_parameter->ux_device_class_printer_instance_activate;
    printer->ux_device_class_printer_parameter.ux_device_class_printer_instance_deactivate =
        printer_parameter->ux_device_class_printer_instance_deactivate;
    printer->ux_device_class_printer_parameter.ux_device_class_printer_soft_reset =
        printer_parameter->ux_device_class_printer_soft_reset;
    ...
    printer->ux_device_class_printer_endpoint_buffer =
        _ux_utility_memory_allocate(UX_NO_ALIGN, UX_CACHE_SAFE_MEMORY, UX_DEVICE_CLASS_PRINTER_ENDPOINT_BUFFER_SIZE);
    ...
    status = _ux_utility_mutex_create(&printer->ux_device_class_printer_endpoint_in_mutex,
                                      "ux_device_class_printer_in_mutex");
    ...
    /* Out Mutex. */
    status = _ux_utility_mutex_create(&printer->ux_device_class_printer_endpoint_out_mutex,
                                      "ux_device_class_printer_out_mutex");
