...
UINT _ux_device_class_pima_device_info_send(UX_SLAVE_CLASS_PIMA *pima) {
    ...
    UX_TRACE_IN_LINE_INSERT(UX_TRACE_DEVICE_CLASS_PIMA_DEVICE_INFO_SEND, pima, 0, 0, 0, UX_TRACE_DEVICE_CLASS_EVENTS, 0,
                            0)
    ...
    _ux_utility_short_put(device_info + UX_DEVICE_CLASS_PIMA_DATA_HEADER_TYPE, UX_DEVICE_CLASS_PIMA_CT_DATA_BLOCK);

    /* Fill in the data code.  */
    _ux_utility_short_put(device_info + UX_DEVICE_CLASS_PIMA_DATA_HEADER_CODE, UX_DEVICE_CLASS_PIMA_OC_GET_DEVICE_INFO);
    ...
    /* Fill in the supported properties.  This table can be configured by the user. If it is declared NULL, use the
     * local default one. */
    ...
    /* Fill in the supported capture formats.  This table can be configured by the user. If it is declared NULL, use the
     * local default one. */
    ...
    /* Fill in the supported image formats.  This table can be configured by the user. If it is declared NULL, use the
     * local default one. */
    ...
    _ux_utility_long_put(device_info + UX_DEVICE_CLASS_PIMA_DATA_HEADER_LENGTH, device_info_length);
