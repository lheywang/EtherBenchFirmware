...
UINT _ux_device_class_ccid_activate(UX_SLAVE_CLASS_COMMAND *command) {
    ...
    ccid->ux_device_class_ccid_slots->ux_device_class_ccid_slot_icc_status = UX_DEVICE_CLASS_CCID_ICC_NOT_PRESENT;
    ...
    /* Initialize slots.  */
    for (i = 0; i < ccid->ux_device_class_ccid_parameter.ux_device_class_ccid_max_n_slots; i++) {
        ccid->ux_device_class_ccid_slots[i].ux_device_class_ccid_slot_runner = -1;
        ccid->ux_device_class_ccid_slots[i].ux_device_class_ccid_slot_icc_status = UX_DEVICE_CLASS_CCID_ICC_NOT_PRESENT;
    }
    ...
    for (i = 0; i < ccid->ux_device_class_ccid_parameter.ux_device_class_ccid_max_n_busy_slots; i++) {
        _ux_device_thread_resume(&ccid->ux_device_class_ccid_runners[i].ux_device_class_ccid_runner_thread);
    }
#endif
