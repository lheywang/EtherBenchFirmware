...
/*                                                                        */
/**************************************************************************/
UINT _ux_device_class_pima_partial_object_data_get(UX_SLAVE_CLASS_PIMA *pima, ULONG object_handle,
                                                   ULONG offset_requested, ULONG length_requested) {
    ...
    UX_TRACE_IN_LINE_INSERT(UX_TRACE_DEVICE_CLASS_PIMA_PARTIAL_OBJECT_DATA_GET, pima, object_handle, offset_requested,
                            length_requested, UX_TRACE_DEVICE_CLASS_EVENTS, 0, 0)
        ...
        while (total_length != 0) {
            ...
            if (object_offset == 0) {
                ...
                object_length_demanded =
                    UX_DEVICE_CLASS_PIMA_OBJECT_INFO_BUFFER_SIZE - UX_DEVICE_CLASS_PIMA_DATA_HEADER_SIZE;
                ...
                status = pima->ux_device_class_pima_object_data_get(
                    pima, object_handle, object_data + UX_DEVICE_CLASS_PIMA_DATA_HEADER_SIZE,
                    object_offset + offset_requested, object_length_demanded, &object_length_received);
                ...
                /* Obtain some data from the application.  */
                status = pima->ux_device_class_pima_object_data_get(pima, object_handle, object_data,
            ...
            status = _ux_device_stack_transfer_request(transfer_request, object_length_transfer,
