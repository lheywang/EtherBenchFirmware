...
UINT _ux_device_class_pima_device_prop_desc_get(UX_SLAVE_CLASS_PIMA *pima, ULONG device_property_code) {
    ...
    UX_TRACE_IN_LINE_INSERT(UX_TRACE_DEVICE_CLASS_PIMA_GET_DEVICE_PROP_DESC_GET, pima, device_property_code, 0, 0,
    ...
    if (status != UX_SUCCESS) {
        ...
        _ux_utility_memory_copy(pima_data_buffer + UX_DEVICE_CLASS_PIMA_DATA_HEADER_SIZE, device_property_desc_dataset,
                                device_property_desc_dataset_length); /* Use case of memcpy is verified. */
