...
/*                                                                        */
/**************************************************************************/
UINT _ux_host_class_dpump_write(UX_HOST_CLASS_DPUMP *dpump, UCHAR *data_pointer, ULONG requested_length,
                                ULONG *actual_length) {
    ...
    UX_TRACE_IN_LINE_INSERT(UX_TRACE_HOST_CLASS_DPUMP_WRITE, dpump, data_pointer, requested_length, 0,
        ...
        if (status == UX_SUCCESS) {
            ...
            if (status != UX_SUCCESS) {
                ...
                *actual_length += transfer_request->ux_transfer_request_actual_length;
                ...
                /* If trace is enabled, insert this event into the trace buffer.  */
                UX_TRACE_IN_LINE_INSERT(UX_TRACE_ERROR, UX_TRANSFER_TIMEOUT, transfer_request, 0, 0, UX_TRACE_ERRORS, 0,
                                        0)
