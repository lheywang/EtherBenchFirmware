...
/*                                                                        */
/**************************************************************************/
UINT _ux_device_class_dpump_write_run(UX_SLAVE_CLASS_DPUMP *dpump, UCHAR *buffer, ULONG requested_length,
                                      ULONG *actual_length) {
    ...
    UX_TRACE_IN_LINE_INSERT(UX_TRACE_DEVICE_CLASS_DPUMP_WRITE, dpump, buffer, requested_length, 0,
    ...
    case UX_DEVICE_CLASS_DPUMP_WRITE_START:
        ...
        requested_length =
            dpump->ux_device_class_dpump_write_requested_length - dpump->ux_device_class_dpump_write_actual_length;
        ...
        _ux_utility_memory_copy(
            transfer_request->ux_slave_transfer_request_data_pointer, dpump->ux_device_class_dpump_write_buffer,
    ...
    case UX_DEVICE_CLASS_DPUMP_WRITE_WAIT:
        ...
        status = _ux_device_stack_transfer_run(transfer_request, dpump->ux_device_class_dpump_write_transfer_length,
        ...
        if (status < UX_STATE_NEXT) {
            ...
            dpump->ux_device_class_dpump_write_state = UX_STATE_RESET;
            dpump->ux_device_class_dpump_write_status = transfer_request->ux_slave_transfer_request_completion_code;
            return (UX_STATE_EXIT);
        }
        ...
        if (status == UX_STATE_NEXT) {
            ...
            /* Next buffer address.  */
            dpump->ux_device_class_dpump_write_buffer += transfer_request->ux_slave_transfer_request_actual_length;
