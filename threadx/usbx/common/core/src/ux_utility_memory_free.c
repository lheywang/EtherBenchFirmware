...
VOID _ux_utility_memory_free(VOID *memory) {
    ...
    regular_end =
        regular_start + _ux_system->ux_system_memory_byte_pool[UX_MEMORY_BYTE_POOL_REGULAR]->ux_byte_pool_size;
    regular_start += UX_MEMORY_BLOCK_HEADER_SIZE;
    cache_safe_start =
        (UCHAR *)_ux_system->ux_system_memory_byte_pool[UX_MEMORY_BYTE_POOL_CACHE_SAFE]->ux_byte_pool_start;
    cache_safe_end =
        cache_safe_start + _ux_system->ux_system_memory_byte_pool[UX_MEMORY_BYTE_POOL_CACHE_SAFE]->ux_byte_pool_size;
    ...
    *free_ptr = UX_BYTE_BLOCK_FREE;
    ...
    if (((UCHAR *)memory >= _ux_system->ux_system_memory_byte_pool[UX_MEMORY_BYTE_POOL_REGULAR]->ux_byte_pool_start) &&
        ((UCHAR *)memory < (_ux_system->ux_system_memory_byte_pool[UX_MEMORY_BYTE_POOL_REGULAR]->ux_byte_pool_start +
                            _ux_system->ux_system_memory_byte_pool[UX_MEMORY_BYTE_POOL_REGULAR]->ux_byte_pool_size)))
