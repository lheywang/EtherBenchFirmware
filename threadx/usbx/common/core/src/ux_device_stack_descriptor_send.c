...
UINT _ux_device_stack_descriptor_send(ULONG descriptor_type, ULONG request_index, ULONG host_length) {
    ...
    UX_TRACE_IN_LINE_INSERT(UX_TRACE_DEVICE_STACK_DESCRIPTOR_SEND, descriptor_type, request_index, 0, 0,
    ...
    case UX_OTG_DESCRIPTOR_ITEM:
        ...
        if (descriptor_type == UX_OTG_DESCRIPTOR_ITEM && host_length > UX_OTG_DESCRIPTOR_LENGTH)
        ...
        while (device_framework < device_framework_end) {
            ...
            if (*(device_framework + 1) == descriptor_type) {
                ...
                _ux_utility_memory_copy(transfer_request->ux_slave_transfer_request_data_pointer, device_framework,
        ...
        while (device_framework < device_framework_end) {
            ...
            if (descriptor_type == UX_BOS_DESCRIPTOR_ITEM) {
                if (*(device_framework + 1) == UX_BOS_DESCRIPTOR_ITEM) {
                    ...
                    _ux_utility_descriptor_parse(device_framework, _ux_system_bos_descriptor_structure,
        ...
        if (descriptor_index == 0) {
            ...
            *(string_memory + 1) = UX_STRING_DESCRIPTOR_ITEM;
            ...
            _ux_utility_memory_copy(
                string_memory + 2, _ux_system_slave->ux_system_slave_language_id_framework,
