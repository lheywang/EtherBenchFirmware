...
UINT _ux_host_stack_configuration_set(UX_CONFIGURATION *configuration) {
        ...
        if (UX_DEVICE_PARENT_IS_ROOTHUB(device)) {
            ...
            if (hcd->ux_hcd_otg_capabilities & UX_HCD_OTG_CAPABLE) {
                ...
                transfer_request->ux_transfer_request_type =
                    UX_REQUEST_OUT | UX_REQUEST_TYPE_STANDARD | UX_REQUEST_TARGET_DEVICE;
    ...
    UX_TRACE_IN_LINE_INSERT(UX_TRACE_HOST_STACK_CONFIGURATION_SET, configuration, 0, 0, 0, UX_TRACE_HOST_STACK_EVENTS,
                            0, 0)
