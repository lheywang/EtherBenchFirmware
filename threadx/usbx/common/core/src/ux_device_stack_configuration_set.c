...
UINT _ux_device_stack_configuration_set(ULONG configuration_value) {
    ...
    _ux_system_slave->ux_system_slave_power_state =
        (configuration_descriptor.bmAttributes & 0x40) ? UX_DEVICE_SELF_POWERED : UX_DEVICE_BUS_POWERED;
                        ...
                        for (class_index = 0; class_index < _ux_system_slave->ux_system_slave_max_class;
                            ...
                            if (class_inst->ux_slave_class_status == UX_USED) {
                                ...
                                if ((interface_descriptor.bInterfaceNumber ==
                                    ...
                                    _ux_system_slave
                                        ->ux_system_slave_interface_class_array[interface_descriptor.bInterfaceNumber] =
                                        class_inst;
