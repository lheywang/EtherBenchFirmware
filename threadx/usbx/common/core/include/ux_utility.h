...
ULONG _ux_utility_pci_class_scan(ULONG pci_class, ULONG bus_number, ULONG device_number, ULONG function_number,
                                 ULONG *current_bus_number, ULONG *current_device_number,
                                 ULONG *current_function_number);
ULONG _ux_utility_pci_read(ULONG bus_number, ULONG device_number, ULONG function_number, ULONG offset, UINT read_size);
VOID _ux_utility_pci_write(ULONG bus_number, ULONG device_number, ULONG function_number, ULONG offset, ULONG value,
                           UINT write_size);
...
UINT _ux_utility_thread_create(UX_THREAD *thread_ptr, CHAR *name, VOID (*entry_function)(ULONG), ULONG entry_input,
...
UINT _ux_utility_event_flags_get(UX_EVENT_FLAGS_GROUP *group_ptr, ULONG requested_flags, UINT get_option,
...
#define _ux_system_thread_create(t, name, entry, entry_param, stack, stack_size, priority, preempt_threshold,          \
                                 time_slice, auto_start)                                                               \
    (UX_SUCCESS)
#define _ux_system_thread_create_norc(t, name, entry, entry_param, stack, stack_size, priority, preempt_threshold,     \
                                      time_slice, auto_start)                                                          \
    do {                                                                                                               \
    } while (0)
...
#else
#define _ux_device_thread_create(t, name, entry, entry_param, stack, stack_size, priority, preempt_threshold,          \
                                 time_slice, auto_start)                                                               \
    (UX_SUCCESS)
...
#else
#define _ux_host_thread_create(t, name, entry, entry_param, stack, stack_size, priority, preempt_threshold,            \
                               time_slice, auto_start)                                                                 \
    (UX_SUCCESS)
...
VOID _ux_utility_error_callback_register(VOID (*error_callback)(UINT system_level, UINT system_context,
                                                                UINT error_code));
#endif
...
#define _ux_utility_memory_allocate_mulc_safe(align, cache, size_mul_v, size_mul_c)                                    \
    _ux_utility_memory_allocate((align), (cache), (size_mul_v) * (size_mul_c))
#define _ux_utility_memory_allocate_mulv_safe(align, cache, size_mul_v0, size_mul_v1)                                  \
    _ux_utility_memory_allocate((align), (cache), (size_mul_v0) * (size_mul_v1))
#define _ux_utility_memory_allocate_add_safe(align, cache, size_add_a, size_add_b)                                     \
    _ux_utility_memory_allocate((align), (cache), (size_add_a) + (size_add_b))
