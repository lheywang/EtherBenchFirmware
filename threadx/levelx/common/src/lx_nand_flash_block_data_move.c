...
UINT _lx_nand_flash_block_data_move(LX_NAND_FLASH *nand_flash, ULONG new_block) {
    ...
    status = _lx_nand_flash_block_find(nand_flash, block_mapping_index * nand_flash->lx_nand_flash_pages_per_block,
                                       &block, &block_status);
    ...
    status = _lx_nand_flash_data_page_copy(nand_flash, block_mapping_index * nand_flash->lx_nand_flash_pages_per_block,
    ...
    _lx_nand_flash_block_mapping_set(nand_flash, block_mapping_index * nand_flash->lx_nand_flash_pages_per_block,
                                     new_block);
