...
UINT _nxe_ip_max_payload_size_find(NX_IP *ip_ptr, NXD_ADDRESS *dest_address, UINT if_index, UINT src_port,
    ...
    if ((dest_address->nxd_ip_version != NX_IP_VERSION_V4) && (dest_address->nxd_ip_version != NX_IP_VERSION_V6)) {
    ...
    return (_nx_ip_max_payload_size_find(ip_ptr, dest_address, if_index, src_port, dest_port, protocol,
                                         start_offset_ptr, payload_length_ptr));
}
