...
VOID _nx_icmpv6_process_echo_request(NX_IP *ip_ptr, NX_PACKET *packet_ptr) {
    ...
    if (packet_ptr->nx_packet_address.nx_packet_ipv6_address_ptr->nxd_ipv6_address_attached
        ...
        */
    {
        ...
        if ((IPv6_Address_Type(ipv6_header->nx_ip_header_destination_ip) & IPV6_ADDRESS_MULTICAST) ==
            ...
            tmp = _nx_ip_checksum_compute(packet_ptr, NX_PROTOCOL_ICMPV6, (UINT)packet_ptr->nx_packet_length,
    ...
    _nx_ipv6_packet_send(ip_ptr, packet_ptr, NX_PROTOCOL_ICMPV6, packet_ptr->nx_packet_length, hop_limit,
                         packet_ptr->nx_packet_address.nx_packet_ipv6_address_ptr->nxd_ipv6_address,
