...
UINT _nxd_ipv6_enable(NX_IP *ip_ptr) {
    ...
    ip_ptr->nx_ipv6_address[NX_LOOPBACK_IPV6_SOURCE_INDEX].nxd_ipv6_address_attached =
        &ip_ptr->nx_ip_interface[NX_LOOPBACK_INTERFACE];
    ip_ptr->nx_ipv6_address[NX_LOOPBACK_IPV6_SOURCE_INDEX].nxd_ipv6_address_ConfigurationMethod =
    ...
    ip_ptr->nx_ip_interface[NX_LOOPBACK_INTERFACE].nxd_interface_ipv6_address_list_head =
