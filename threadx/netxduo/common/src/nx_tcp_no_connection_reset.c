...
VOID _nx_tcp_no_connection_reset(NX_IP *ip_ptr, NX_PACKET *packet_ptr, NX_TCP_HEADER *tcp_header_ptr) {
    ...
    if (packet_ptr->nx_packet_ip_version == NX_IP_VERSION_V4) {
        ...
        _nx_ip_route_find(ip_ptr, fake_socket.nx_tcp_socket_connect_ip.nxd_ip_address.v4,
                          &fake_socket.nx_tcp_socket_connect_interface, &fake_socket.nx_tcp_socket_next_hop_address);
