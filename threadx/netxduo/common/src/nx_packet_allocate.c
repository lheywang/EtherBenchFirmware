...
UINT _nx_packet_allocate(NX_PACKET_POOL *pool_ptr, NX_PACKET **packet_ptr, ULONG packet_type, ULONG wait_option) {
    ...
    *packet_ptr = NX_NULL;
    ...
    NX_TRACE_IN_LINE_INSERT(NX_TRACE_PACKET_ALLOCATE, pool_ptr, 0, packet_type, pool_ptr->nx_packet_pool_available,
                            NX_TRACE_PACKET_EVENTS, &trace_event, &trace_timestamp);
        ...
        *packet_ptr = work_ptr;
        ...
        if (wait_option) {
            ...
            if (pool_ptr->nx_packet_pool_suspension_list) {
                ...
                thread_ptr->tx_thread_suspended_next = pool_ptr->nx_packet_pool_suspension_list;
