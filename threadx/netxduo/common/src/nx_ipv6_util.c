...
INT CHECK_IPV6_ADDRESSES_SAME(ULONG *ip_addr1, ULONG *ip_addr2) {
    ...
    return (ip_addr1[0] == ip_addr2[0] && ip_addr1[1] == ip_addr2[1] && ip_addr1[2] == ip_addr2[2] &&
...
INT CHECK_ALL_ROUTER_MCAST_ADDRESS(ULONG *address) {
    ...
    return (address[0] == (ULONG)0xFF020000 && address[1] == (ULONG)0 && address[2] == (ULONG)0 &&
...
INT CHECK_IPV6_SOLICITED_NODE_MCAST_ADDRESS(ULONG *dest_ip, ULONG *myip) {
    ...
    if ((dest_ip[0] == (ULONG)0xFF020000) && (dest_ip[1] == (ULONG)0x0) && (dest_ip[2] == (ULONG)0x00000001) &&
        (dest_ip[3] == ((myip[3] & (ULONG)0x00FFFFFF) | (ULONG)0xFF000000))) {
        isMulticast = 1;
    } else if ((dest_ip[0] == (ULONG)0xFF020000) && (dest_ip[1] == (ULONG)0x0) && (dest_ip[2] == (ULONG)0x0) &&
               ((dest_ip[3] == (ULONG)0x00000001) || (dest_ip[3] == (ULONG)0x00010002))) {
        isMulticast = 1;
    }
#ifdef NX_ENABLE_THREAD
    else if ((dest_ip[0] == (ULONG)0xFF030000) && (dest_ip[1] == (ULONG)0x0) && (dest_ip[2] == (ULONG)0x0) &&
             ((dest_ip[3] == (ULONG)0x00000001))) /* Realm-Local All nodes multicast address. */
    {
        isMulticast = 1;
    }
#endif /* NX_ENABLE_THREAD  */
    else if ((dest_ip[0] == (ULONG)0xFF050000) && (dest_ip[1] == (ULONG)0x0) && (dest_ip[2] == (ULONG)0x0) &&
...
ULONG IPv6_Address_Type(ULONG *ip_address) {
    ...
    if ((ip_address[0] & (ULONG)0xFF000000) == (ULONG)0xFF000000) {
        ...
        if (((ip_address[0] == (ULONG)0xFF010000) || (ip_address[0] == (ULONG)0xFF020000)) &&
            (ip_address[1] == (ULONG)0) && (ip_address[2] == (ULONG)0) && (ip_address[3] == (ULONG)1)) {
            return (ret | IPV6_ALL_NODE_MCAST);
        }

        if ((ip_address[0] == (ULONG)0xFF050000) && /* All DHCPv6 relay and server hosts */
            (ip_address[1] == (ULONG)0) && (ip_address[2] == (ULONG)0) && (ip_address[3] == (ULONG)0x00010003)) {
            return (ret | IPV6_ALL_NODE_MCAST);
        }

        if (((ip_address[0] == (ULONG)0xFF010000) || (ip_address[0] == (ULONG)0xFF020000) ||
             (ip_address[0] == (ULONG)0xFF050000)) &&
            (ip_address[1] == (ULONG)0) && (ip_address[2] == (ULONG)0) && (ip_address[3] == (ULONG)2)) {
            return (ret | IPV6_ALL_ROUTER_MCAST);
        }

        if ((ip_address[0] == (ULONG)0xFF020000) && (ip_address[1] == (ULONG)0) && (ip_address[2] == (ULONG)1) &&
