    ...
    while (packet_length > 0) {
        ...
        if (option_ptr->nx_icmpv6_option_type == ICMPV6_OPTION_TYPE_PREFIX_INFO) {
            ...
            if ((prefix_ptr->nx_icmpv6_option_prefix[0] & (ULONG)0xFFC00000) == (ULONG)0xFE800000) {
                 ...
                 * necessary  */
                option_ptr =
                    (NX_ICMPV6_OPTION *)NX_UCHAR_POINTER_ADD(option_ptr, ((option_ptr->nx_icmpv6_option_length) << 3));
                    ...
                    if ((prefix_ptr->nx_icmpv6_option_prefix_flag & 0x40) &&
                        ...
                        if ((first_unused != NX_MAX_IPV6_ADDRESSES)
                            ...
                            if (ip_ptr->nx_ipv6_address_change_notify) {
                                ...
                                (ip_ptr->nx_ipv6_address_change_notify)(ip_ptr, NX_IPV6_ADDRESS_STATELESS_AUTO_CONFIG,
                            ...
                            if ((ip_ptr->nx_ipv6_address_change_notify_internal) &&
                                ...
                                (ip_ptr->nx_ipv6_address_change_notify_internal)(
                                    ip_ptr, NX_IPV6_ADDRESS_STATELESS_AUTO_CONFIG, interface_index, first_unused,
                                    &ipv6_address->nxd_ipv6_address[0]);
                            }
#endif /* NX_ENABLE_IPV6_ADDRESS_CHANGE_NOTIFY */
                        }
