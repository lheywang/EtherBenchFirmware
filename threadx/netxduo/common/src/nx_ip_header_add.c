...
UINT _nx_ip_header_add(NX_IP *ip_ptr, NX_PACKET *packet_ptr, ULONG source_ip, ULONG destination_ip,
    ...
    packet_ptr->nx_packet_ip_header_length =
        (UCHAR)(packet_ptr->nx_packet_ip_header_length + sizeof(NX_IPV4_HEADER) + router_alert);
    ...
    if (router_alert) {
        ...
        ip_header_ptr->nx_ip_header_word_0 = (ULONG)((NX_IP_VERSION_V4 << 28) | (NX_IP_HEADER_LENGTH_ENCODE_6 << 24) |
                                                     type_of_service | (0xFFFF & packet_ptr->nx_packet_length));
    } else
#endif
    {
        ...
        ip_header_ptr->nx_ip_header_word_0 =
            (NX_IP_VERSION | type_of_service | (0xFFFF & packet_ptr->nx_packet_length));
    }
    ...
    if (router_alert) {
        ...
        *((ULONG *)(packet_ptr->nx_packet_prepend_ptr + sizeof(NX_IPV4_HEADER))) =
            (NX_IP_OPTION_COPY_FLAG | NX_IP_OPTION_CLASS | NX_IP_OPTION_ROUTER_ALERT_NUMBER |
             NX_IP_OPTION_ROUTER_ALERT_LENGTH | NX_IP_OPTION_ROUTER_ALERT_VALUE);
    }
#endif
