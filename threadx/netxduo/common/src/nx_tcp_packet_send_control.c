...
VOID _nx_tcp_packet_send_control(NX_TCP_SOCKET *socket_ptr, ULONG control_bits, ULONG tx_sequence, ULONG ack_number,
    ...
    if (_nx_packet_allocate(ip_ptr->nx_ip_auxiliary_packet_pool, &packet_ptr, NX_IP_PACKET + data_offset, NX_NO_WAIT)) {
...
#endif /* NX_ENABLE_DUAL_PACKET_POOL */
        {
            ...
            if (_nx_packet_allocate(ip_ptr->nx_ip_default_packet_pool, &packet_ptr, NX_IP_PACKET + data_offset,
    ...
    tcp_header_ptr->nx_tcp_header_word_0 =
        (((ULONG)(socket_ptr->nx_tcp_socket_port)) << NX_SHIFT_BY_16) | (ULONG)socket_ptr->nx_tcp_socket_connect_port;
    ...
    if (socket_ptr->nx_tcp_socket_connect_ip.nxd_ip_version == NX_IP_VERSION_V4) {
        ...
        _nx_ip_packet_send(ip_ptr, packet_ptr, socket_ptr->nx_tcp_socket_connect_ip.nxd_ip_address.v4,
                           ...
                           socket_ptr->nx_tcp_socket_fragment_enable, socket_ptr->nx_tcp_socket_next_hop_address);
    }
#endif /* !NX_DISABLE_IPV4  */
    ...
    if (socket_ptr->nx_tcp_socket_connect_ip.nxd_ip_version == NX_IP_VERSION_V6) {
        ...
        _nx_ipv6_packet_send(ip_ptr, packet_ptr, NX_PROTOCOL_TCP, packet_ptr->nx_packet_length,
