...
/*                                                                        */
/**************************************************************************/
VOID _nx_icmpv4_send_error_message(NX_IP *ip_ptr, NX_PACKET *offending_packet, ULONG word1, ULONG error_pointer) {
    ...
    _nx_ip_route_find(ip_ptr, src_ip, &pkt_ptr->nx_packet_address.nx_packet_interface_ptr, &next_hop_address);
    ...
    if (pkt_ptr->nx_packet_address.nx_packet_interface_ptr->nx_interface_capability_flag &
        ...
        */
    {
        ...
        checksum = _nx_ip_checksum_compute(pkt_ptr, NX_IP_ICMP, (UINT)pkt_ptr->nx_packet_length,
    ...
    _nx_ip_packet_send(ip_ptr, pkt_ptr, src_ip, NX_IP_NORMAL, 255, NX_IP_ICMP, NX_FRAGMENT_OKAY, next_hop_address);
