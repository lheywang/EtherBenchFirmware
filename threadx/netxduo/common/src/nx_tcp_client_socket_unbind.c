...
UINT _nx_tcp_client_socket_unbind(NX_TCP_SOCKET *socket_ptr) {
    ...
    if (socket_ptr->nx_tcp_socket_bind_suspension_list) {
        ...
        new_socket_ptr =
            (NX_TCP_SOCKET *)(socket_ptr->nx_tcp_socket_bind_suspension_list)->tx_thread_suspend_control_block;
        ...
        /* Inherit the suspension list from the previously bound socket.  Decrement
           ...
           from the list later.  */
        new_socket_ptr->nx_tcp_socket_bind_suspension_list = socket_ptr->nx_tcp_socket_bind_suspension_list;
        ...
        if (ip_ptr->nx_ip_tcp_port_table[index]) {
            ...
            /* There are already sockets on this list... just add this one
               to the end.  */
            new_socket_ptr->nx_tcp_socket_bound_next = ip_ptr->nx_ip_tcp_port_table[index];
