...
VOID _nx_ipv6_packet_receive(NX_IP *ip_ptr, NX_PACKET *packet_ptr) {
    ...
    interface_ipv6_address_next =
        packet_ptr->nx_packet_address.nx_packet_interface_ptr->nxd_interface_ipv6_address_list_head;
    ...
    if ((incoming_address == NX_NULL) && ((ip_header_ptr->nx_ip_header_destination_ip[0] & 0xFF000000) == 0xFF000000)) {
        ...
        for (i = 0; i < NX_MAX_MULTICAST_GROUPS; i++) {
            ...
            if ((ip_ptr->nx_ipv6_multicast_entry[i].nx_ip_mld_join_interface_list ==
                ...
                (CHECK_IPV6_ADDRESSES_SAME(ip_header_ptr->nx_ip_header_destination_ip,
