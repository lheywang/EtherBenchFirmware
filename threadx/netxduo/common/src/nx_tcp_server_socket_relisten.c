...
UINT _nx_tcp_server_socket_relisten(NX_IP *ip_ptr, UINT port, NX_TCP_SOCKET *socket_ptr) {
    ...
    NX_TRACE_IN_LINE_INSERT(NX_TRACE_TCP_SERVER_SOCKET_RELISTEN, ip_ptr, port, socket_ptr,
    ...
    if ((socket_ptr->nx_tcp_socket_bound_next) || (socket_ptr->nx_tcp_socket_bind_in_progress)) {
    ...
    if (listen_ptr) {
        ...
        do {
            ...
            if ((listen_ptr->nx_tcp_listen_port == port) && (!listen_ptr->nx_tcp_listen_socket_ptr)) {
                ...
                if (!listen_ptr->nx_tcp_listen_queue_current) {
                    ...
                    if (tcp_header_ptr->nx_tcp_header_word_3 & NX_TCP_SYN_BIT) {
                        ...
                        if (option_words > 0) {
                            ...
                            _nx_tcp_mss_option_get((packet_ptr->nx_packet_prepend_ptr + sizeof(NX_TCP_HEADER)),
