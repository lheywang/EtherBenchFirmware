...
UINT _nx_udp_socket_port_get(NX_UDP_SOCKET *socket_ptr, UINT *port_ptr) {
    ...
    NX_TRACE_IN_LINE_INSERT(NX_TRACE_UDP_SOCKET_PORT_GET, socket_ptr->nx_udp_socket_ip_ptr, socket_ptr,
                            socket_ptr->nx_udp_socket_port, 0, NX_TRACE_UDP_EVENTS, 0, 0);
