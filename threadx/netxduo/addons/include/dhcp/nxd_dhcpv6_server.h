...
#define NX_DHCPV6_RFC_DNS_SERVER_OPTION                                                  \
    0x00000017UL /* RFC Option code for requesting DNS server IP address  */
#define NX_DHCPV6_RFC_TIME_SERVER_OPTION                                                 \
    0x0000001FUL /* RFC Option code for requesting tme server IP address. */
#define NX_DHCPV6_RFC_TIME_ZONE_OPTION                                                   \
    0x00000029UL /* RFC Option code for requesting Time zone. */
#define NX_DHCPV6_RFC_DOMAIN_NAME                                                        \
    0x00000018UL /* RFC Option code for requesting domain name. */
...
/* NX_DHCPV6_HW_TYPE_IEEE_802 is defined as 1 to indicate Ethernet hardware type in old
   ...
   NX_DHCPV6_SERVER_HARDWARE_TYPE_ETHERNET in future releases, should use above symbols to
...
#define NX_DHCPV6_OP_RAPID_COMMIT                                                        \
    14 /* Option requesting exchange of two DHCPv6 packets to assign address  */

/* Define the DHCPv6 Client states */

#define NX_DHCPV6_STATE_BOUND 1 /* Client not known to be bound to an IP address.   */
#define NX_DHCPV6_STATE_UNBOUND                                                          \
    2 /* Client is bound to an IP address (not necessarily by this server).  */
...
#define NX_DHCPV6_SERVER_RECEIVE_EVENT                                                   \
    0x00000001UL /* Packet received on the DHCPv6 server queue. */
#define NX_DHCPV6_IP_LEASE_CHECK_PERIODIC_EVENT                                          \
    0x00000008UL /* Time keeper to check for expiration on leased IP addresses. */
#define NX_DHCPV6_CHECK_SESSION_PERIODIC_EVENT                                           \
    0x00000004UL /* Time keeper to check if each session with active client has timed    \
                    out. */
...
#define NX_DHCPV6_INVALID_DEVICE_MAC_ADDRESS                                             \
    0xE94 /* DHCPv6 server device mac address unknown or undefined */
#define NX_DHCPV6_INVALID_INTERFACE_IP_ADDRESS                                           \
    0xE95 /* DHCPv6 server interface global IP address unknown or undefined */
#define NX_DHCPV6_INVALID_INTERFACE_LL_ADDRESS                                           \
    0xE96 /* DHCPv6 server interface link local address unknown or undefined */
#define NX_DHCPV6_INVALID_GLOBAL_INDEX 0xE97 /* DHCPv6 global address index not set */
#define NX_DHCPV6_BAD_SERVER_DUID                                                        \
    0xE98 /* Invalid or inappropriate server DUID (Should not be in some DHCPv6 message  \
             types).  */
#define NX_DHCPV6_MESSAGE_DUID_MISSING                                                   \
    0xE99 /* Received a message type missing server or client DUID. */
#define NX_DHCPV6_INVALID_INTERFACE_INDEX                                                \
    0xEBC /* Specified interface does not exist for the DHCPv6 server instance  */
#define NX_DHCPV6_INVALID_IANA_TIME                                                      \
    0xEA0 /* Client IA-NA option T1 vs T2 address lease time is invalid. */
#define NX_DHCPV6_IANA_OPTION_MISSING                                                    \
    0xEA1 /* Received IA address option not belonging to an IA block */
#define NX_DHCPV6_NO_SERVER_DUID                                                         \
    0xEA2 /* No server DUID detected; DHCPv6 server cannot start without one */
#define NX_DHCPV6_INVALID_IANA_DATA                                                      \
    0xEA3 /* Client IA-NA option block has bad syntax or missing data */
...
#define NX_DHCPV6_NO_ASSIGNABLE_ADDRESSES                                                \
    0xEA7 /* Server created with no assignable addresses. */
#define NX_DHCPV6_ADDRESS_NOT_FOUND                                                      \
    0xEA8 /* Client address not found in server lease table. */
#define NX_DHCPV6_OPTION_BLOCK_INCOMPLETE                                                \
    0xEA9 /* Empty option block data; either zero length or zero option parsed. */
#define NX_DHCPV6_INVALID_OPTION_DATA                                                    \
    0xEAA /* Server received option data with missing data or bad syntax */
#define NX_DHCPV6_ILLEGAL_MESSAGE_TYPE                                                   \
    0xEB1 /* Received invalid message request e.g. RENEW (server should discard),  */
#define NX_DHCPV6_PROCESSING_ERROR                                                       \
    0xEB5 /* Invalid Client packet with DHCPv6 format or packet size  */
#define NX_DHCPV6_INSUFFICIENT_PACKET_PAYLOAD                                            \
    0xEB6 /* Server DHCPv6 reply will not fit in packet pool packet buffer. */
#define NX_DHCPV6_INVALID_DATA_SIZE                                                      \
    0xEB7 /* Attempting to parse too large a data object from DHCPv6 request. */
#define NX_DHCPV6_TABLE_FULL                                                             \
    0xEC4 /* Server table (e.g. Client records or IP address leases) is full. */
#define NX_DHCPV6_INVALID_IP_ADDRESS                                                     \
    0xECB /* Invalid IP address e.g. null address received or obtained from client       \
             record. */
#define NX_DHCPV6_INVALID_DUID                                                           \
    0xECC /* Invalid DUID received from client or retrieved from memory. */
#define NX_DHCPV6_CLIENT_RECORD_NOT_FOUND                                                \
    0xECF /* Unable to find client in Client records table. */
#define NX_DHCPV6_TIMER_INTERNAL_ERROR                                                   \
    0xED4 /* Problem setting or accessing real time clock server for DUID time field. */
#define NX_DHCPV6_INVALID_VENDOR_DATA                                                    \
    0xED5 /* Vendor data invalid (ID is too long, null data etc). */
...
#define NX_DHCPV6_STATUS_NO_ADDRS_AVAILABLE                                              \
    2 /* Server has no addresses available to assign to  the IA(s) */
#define NX_DHCPV6_STATUS_NO_BINDING                                                      \
    3 /* Client record (binding) unavailable or not possible */
#define NX_DHCPV6_STATUS_NOT_ON_LINK                                                     \
    4 /* Address prefix not appropriate for client domain */
#define NX_DHCPV6_STATUS_USE_MULTICAST                                                   \
    5 /* Server informs client to use the All_DHCP_Relay_Agents_and_Servers address. */
...
#define NX_DHCPV6_STATUS_MESSAGE_NO_ADDRS_AVAILABLE                                      \
...
#define NX_DHCPV6_STATUS_MESSAGE_USE_MULTICAST                                           \
...
/* Define the session time out in seconds. This is the timer for how long the server has
   not received a client response. */
...
/* Define the vendor ID. The server must have this data to create its DUID required for
   sending responses to the DHCPv6 client. */
...
/* Define the preference option pref-value. When multiple DHCPv6 servers exist, this
   enables a server to tell the client which preference to place on this server. The
   higher the value the greater the preference. A value of 255 received by a DHCPv6 client
   will instruct the client to choose this DHPCv6 server immediately, rather than wait for
   the full round trip time out option specified in RFC 3315. RFC 3315 sect 17.2.2
   requires the server set this value to zero by default*/
...
/* Set the default valid lifetime in seconds for leased IP addresses in secs, which is
   when the Client IP address becomes obsolete. A value of zero in this field indicates
...
typedef struct NX_DHCPV6_SVR_DUID_STRUCT {
    ...
    USHORT nx_link_layer_address_msw; /* Only if LL/LLT type. Pointer to Unique link layer
                                         address - most significant word (2 bytes)*/
...
/* Define the Client DHCPv6 structure containing the DHCPv6 Client record (DHCPv6 status,
 * server DUID etc).  */
...
typedef struct NX_DHCPV6_CLIENT_STRUCT {
    ...
    UINT nx_dhcpv6_message_type; /* DHCPv6 message type most recently received from
                                    client. */
    UINT nx_dhcpv6_response_back_from_server; /* Response server will send back to client
                                                 based on previous client message */
    NX_DHCPV6_SVR_DUID
    nx_dhcpv6_client_duid; /* Client DUID parsed from client DHCPv6 requests */
    NX_DHCPV6_SVR_DUID
    nx_dhcpv6_server_duid; /* Server DUID parsed from client DHCPv6 requests */
    ULONG nx_dhcpv6_client_session_time; /* Duration of client server session. Used to
                                            determine if client quit on the session. */
    UINT nx_dhcpv6_rapid_commit_status;  /* Client status on rapid commit (set to true if
                                            requests and server approves). */
    NX_DHCPV6_SERVER_ELAPSED_TIME
    nx_dhcpv6_elapsed_time; /* Time duration of the current DHCP msg exchange between
                               Client and Server. */
    NX_DHCPV6_SERVER_IA_NA nx_dhcpv6_iana; /* Identity Association for non temp address -
    ...
    ULONG nx_dhcpv6_IP_lease_time_accrued; /* Time remaining on the Client IP address
                                              lease. */
    NXD_ADDRESS nx_dhcp_source_ip_address; /* Source IP of the client DHCP message. */
    NXD_ADDRESS
    nx_dhcp_destination_ip_address; /* Destination IP of the client DHCP message. */
...
typedef struct NX_DHCPV6_ADDRESS_LEASE_STRUCT {
    ...
    ULONG nx_dhcpv6_lease_preferred_lifetime; /* preferred lifetime set if assigned to
                                                 client */
    NX_DHCPV6_CLIENT *nx_dhcpv6_lease_assigned_to; /* Client DUID assigned the address */

} NX_DHCPV6_ADDRESS_LEASE;

/* Define the Server DHCPv6 structure containing the Client tables and assignable IP
 * address tables.  */
...
typedef struct NX_DHCPV6_SERVER_STRUCT {
    ...
    UINT nx_dhcpv6_server_interface_index;  /* Index indicating interface DHCPv6 requests
                                               accepted */
    UINT nx_dhcpv6_server_ga_address_index; /* Global address index of the DHCPv6 server*/
    NX_DHCPV6_SVR_DUID
    nx_dhcpv6_server_duid; /* DUID by which server identifies itself to clients */
    NX_DHCPV6_CLIENT nx_dhcpv6_clients[NX_DHCPV6_MAX_CLIENTS]; /* list of clients leased
                                                                  an IPv6 address */
    NX_DHCPV6_ADDRESS_LEASE
    nx_dhcpv6_lease_list[NX_DHCPV6_MAX_LEASES]; /* List of IP addresses available for
                                                   DHCPv6 Clients */
    UINT nx_dhcpv6_assignable_addresses;  /* Number of assignable addresses the server
                                             starts with. */
    UINT nx_dhcpv6_server_multicast_only; /* Indicate if the client should send requests
                                             using all servers multicast address */
    NX_UDP_SOCKET
    nx_dhcpv6_server_socket; /* UDP socket for communicating with DHCPv6 clients */
    ...
    NX_PACKET_POOL *nx_dhcpv6_packet_pool_ptr; /* Pointer to packet pool for sending
                                                  DHCPV6 messages */
    TX_EVENT_FLAGS_GROUP nx_dhcpv6_server_timer_events; /* Message queue for IP lease and
                                                           session timer events. */
    UINT nx_dhcpv6_server_running; /* Status of dhcpv6 server; idle (NX_FALSE) or running
                                      (NX_TRUE) */
    NXD_ADDRESS nx_dhcpv6_dns_ip_address; /* DHCP server DNS Server Address in message to
                                             DHCP Client  */

    /* Define a handler for receiving a DECLINE or RELEASE message. */
    VOID (*nx_dhcpv6_IP_address_declined_handler)(
    ...
    VOID (*nx_dhcpv6_server_option_request_handler)(
        struct NX_DHCPV6_SERVER_STRUCT *dhcpv6_server_ptr,
        UINT option_request,
        UCHAR *buffer_ptr,
        UINT *index);
    ...
    VOID (*nx_dhcpv6_server_option_request_handler_extended)(
        struct NX_DHCPV6_SERVER_STRUCT *dhcpv6_server_ptr,
        UINT option_request,
        UCHAR *buffer_ptr,
        UINT *index,
...
#define nx_dhcpv6_server_option_request_handler_set                                      \
...
#define nx_dhcpv6_server_option_request_handler_set                                      \
    _nxe_dhcpv6_server_option_request_handler_set
#endif /* NX_DISABLE_ERROR_CHECKING */

/* Define the prototypes accessible to the application software.  */
UINT nx_dhcpv6_set_server_duid(
...
UINT nx_dhcpv6_add_ip_address_lease(
    ...
    ULONG preferred_lifetimeo);
UINT nx_dhcpv6_add_client_record(
    NX_DHCPV6_SERVER *dhcpv6_server_ptr,
    UINT table_index,
    ULONG message_xid,
...
UINT nx_dhcpv6_retrieve_client_record(
    NX_DHCPV6_SERVER *dhcpv6_server_ptr,
    UINT table_index,
    ULONG *message_xid,
    NXD_ADDRESS *client_address,
    ...
    UCHAR *duid_vendor_private,
    UINT *duid_private_length);
UINT nx_dhcpv6_retrieve_ip_address_lease(
    NX_DHCPV6_SERVER *dhcpv6_server_ptr,
    UINT table_index,
    NXD_ADDRESS *lease_IP_address,
    ULONG *T1,
...
UINT _nx_dhcpv6_create_server_duid(
    NX_DHCPV6_SERVER *dhcpv6_server_ptr,
    UINT duid_type,
    UINT hardware_type,
    ULONG mac_address_msw,
...
UINT _nx_dhcpv6_update_client_record(
    NX_DHCPV6_SERVER *dhcpv6_server_ptr,
    NX_DHCPV6_CLIENT *from_client_ptr,
    NX_DHCPV6_CLIENT *to_client_ptr);
