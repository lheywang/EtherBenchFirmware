...
/* Define the max number of retries retransmitting a data packet or ACK if no response or
   a previous (duplicate) ACK or data packet, respectively, is received. */
...
#define NX_TFTP_PACKET_SIZE                                                              \
    (NX_UDP_PACKET + NX_TFTP_FILE_TRANSFER_MAX + NX_PHYSICAL_TRAILER)
...
#define NX_INVALID_TFTP_SERVER_ADDRESS                                                   \
    0x08 /* Invalid TFTP server IP extraced from received packet */
...
#define NX_TFTP_INVALID_ADDRESS_TYPE                                                     \
    0x0B /* Invalid IP version associated with client data       */
#define NX_TFTP_SESSION_TIMED_OUT                                                        \
    0x0C /* No response from client or retransmissions limit hit */
...
#define NX_TFTP_SERVER_RECEIVE_EVENT                                                     \
    0x01 /* TFTP received Client packet                           */
#define NX_TFTP_SERVER_TIMER_EVENT                                                       \
    0x02 /* TFTP timer event                                      */
#define NX_SERVER_TFTP_ANY_EVENT                                                         \
    0x0F /* Any event                                             */
...
typedef struct NX_TFTP_SERVER_STRUCT {
    ...
    NX_PACKET_POOL
    *nx_tftp_server_packet_pool_ptr;    /* Pointer to TFTP server packet pool   */
