...
UINT _fx_directory_attributes_read(FX_MEDIA *media_ptr, CHAR *directory_name, UINT *attributes_ptr) {
    ...
    FX_TRACE_IN_LINE_INSERT(FX_TRACE_DIRECTORY_ATTRIBUTES_READ, media_ptr, directory_name, 0, 0,
                            FX_TRACE_DIRECTORY_EVENTS, &trace_event, &trace_timestamp)
    ...
    *attributes_ptr = (UINT)dir_entry.fx_dir_entry_attributes;
    ...
    FX_TRACE_EVENT_UPDATE(trace_event, trace_timestamp, FX_TRACE_DIRECTORY_ATTRIBUTES_READ, 0, 0,
