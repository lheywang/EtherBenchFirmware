...
/*                                                                        */
/**************************************************************************/
UINT _fx_fault_tolerant_add_dir_log(FX_MEDIA *media_ptr, ULONG64 logical_sector, ULONG offset, UCHAR *data,
                                    ULONG data_size) {
    ULONG file_size;
    ...
    /* Set log type. */
    _fx_utility_16_unsigned_write((UCHAR *)&dir_log->fx_fault_tolerant_dir_log_type, FX_FAULT_TOLERANT_DIR_LOG_TYPE);
    ...
    memcpy(media_ptr->fx_media_fault_tolerant_memory_buffer + /* Use case of memcpy
                                                                 is verified. */
