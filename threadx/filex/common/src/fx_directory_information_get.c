...
UINT _fx_directory_information_get(FX_MEDIA *media_ptr, CHAR *directory_name, UINT *attributes, ULONG *size, UINT *year,
    ...
    FX_TRACE_IN_LINE_INSERT(FX_TRACE_DIRECTORY_INFORMATION_GET, media_ptr, directory_name, 0, 0,
    ...
    while (open_count) {
        ...
        if ((search_ptr->fx_file_dir_entry.fx_dir_entry_log_sector == dir_entry.fx_dir_entry_log_sector) &&
            ...
            /* The file has been opened for writing by a previous call. Use the
               ...
               media.  */
            _fx_utility_memory_copy((UCHAR *)&search_ptr->fx_file_dir_entry, (UCHAR *)&dir_entry,
    ...
    if (year) {
        ...
        /* Pickup the year.  */
        *year = ((dir_entry.fx_dir_entry_date >> FX_YEAR_SHIFT) & FX_YEAR_MASK) + FX_BASE_YEAR;
    }
