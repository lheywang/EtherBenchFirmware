...
UINT _fx_media_write(FX_MEDIA *media_ptr, ULONG logical_sector, VOID *buffer_ptr) {
    ...
    FX_TRACE_IN_LINE_INSERT(FX_TRACE_MEDIA_WRITE, media_ptr, logical_sector, buffer_ptr, 0, FX_TRACE_MEDIA_EVENTS,
    ...
    status =
        _fx_utility_logical_sector_write(media_ptr, (ULONG64)logical_sector, buffer_ptr, ((ULONG)1), FX_DATA_SECTOR);
    ...
    if (status == FX_SUCCESS) {
        ...
        FX_TRACE_EVENT_UPDATE(trace_event, trace_timestamp, FX_TRACE_MEDIA_WRITE, 0, 0, 0,
