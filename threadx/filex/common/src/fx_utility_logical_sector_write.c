    ...
    if ((((UCHAR *)buffer_ptr) >= media_ptr->fx_media_memory_buffer) &&
        ...
        if (cache_found) {
            ...
            if (sector_type != FX_DATA_SECTOR) {
                ...
                FX_TRACE_IN_LINE_INSERT(FX_TRACE_INTERNAL_IO_DRIVER_WRITE, media_ptr, logical_sector, 1,
        ...
        /* If trace is enabled, insert this event into the trace buffer.  */
        FX_TRACE_IN_LINE_INSERT(FX_TRACE_INTERNAL_IO_DRIVER_WRITE, media_ptr, logical_sector, sectors, buffer_ptr,
