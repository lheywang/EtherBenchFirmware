...
UINT _fx_media_check(FX_MEDIA *media_ptr, UCHAR *scratch_memory_ptr, ULONG scratch_memory_size,
    ...
    FX_TRACE_IN_LINE_INSERT(FX_TRACE_MEDIA_CHECK, media_ptr, scratch_memory_ptr, scratch_memory_size, 0,
                            FX_TRACE_MEDIA_EVENTS, &trace_event, &trace_timestamp)
    ...
    *errors_detected = 0;
...
#ifdef FX_ENABLE_EXFAT
    if ((media_ptr->fx_media_FAT_type == FX_FAT32) || (media_ptr->fx_media_FAT_type == FX_exFAT))
#else
...
#endif /* FX_ENABLE_EXFAT */
    {
        ...
        current_errors = _fx_media_check_FAT_chain_check(media_ptr, media_ptr->fx_media_root_cluster_32, &last_cluster,
    ...
    do {
        ...
        while (i < current_directory[current_directory_index].current_total_entries) {
            ...
            *errors_detected = *errors_detected | current_errors;
            ...
            if ((dir_entry_ptr->fx_dir_entry_attributes & FX_DIRECTORY) && (valid_clusters == 0)) {
            ...
            if (dir_entry_ptr->fx_dir_entry_attributes & FX_DIRECTORY) {
                ...
                if (((valid_clusters * bytes_per_cluster) - dir_entry_ptr->fx_dir_entry_file_size) >
                    bytes_per_cluster) {
    ...
    if (media_ptr->fx_media_FAT_type == FX_exFAT) {
        ...
        current_errors = _fx_media_check_exFAT_lost_cluster_check(
            media_ptr, logical_fat, media_ptr->fx_media_total_clusters, error_correction_option);
    } else {
#endif /* FX_ENABLE_EXFAT */
        ...
        current_errors = _fx_media_check_lost_cluster_check(media_ptr, logical_fat, media_ptr->fx_media_total_clusters,
