...
UINT _fx_directory_local_path_set(FX_MEDIA *media_ptr, FX_LOCAL_PATH *local_path_ptr, CHAR *new_path_name) {
    ...
    FX_TRACE_IN_LINE_INSERT(FX_TRACE_DIRECTORY_LOCAL_PATH_SET, media_ptr, local_path_ptr, new_path_name, 0,
    ...
    if ((!new_path_name) ||
        (((new_path_name[0] == '\\') || (new_path_name[0] == '/')) && (new_path_name[1] == (CHAR)0))) {
            ...
            if (local_path_ptr != (FX_LOCAL_PATH *)_tx_thread_current_ptr->tx_thread_filex_ptr) {
                ...
                if (_tx_thread_current_ptr->tx_thread_filex_ptr) {
                    ...
                    do {
                        ...
                        local_path_ptr->fx_path_string[i] = media_ptr->fx_media_default_path.fx_path_string[i];
