...
VOID _fx_utility_exFAT_size_calculate(UINT bytes_per_sector, ULONG boundary_unit, ULONG64 size_in_sectors,
    ...
    *sectors_per_fat_ptr = (ULONG)DIVIDE_TO_CEILING(
        ((total_cluster_heap_sectors / sectors_per_cluster) * EXFAT_FAT_BITS), (bytes_per_sector * BITS_PER_BYTE));
    ...
    *sectors_per_fat_ptr = ALIGN_UP(*sectors_per_fat_ptr, boundary_unit >> 1);
              ...
              size.  */
    {
        do {
            ...
            *sectors_per_fat_ptr =
                (ULONG)DIVIDE_TO_CEILING(((total_cluster_heap_sectors / sectors_per_cluster) * EXFAT_FAT_BITS),
        ...
        } while (*sectors_per_fat_ptr * bytes_per_sector * BITS_PER_BYTE / EXFAT_FAT_BITS <
