...
typedef struct {
    ...
    uint32_t WaitForInterrupt; /*!< Specifies whether SDMMC wait for interrupt request
...
#define SDMMC_SDIO_R5_ERRORBITS                                                                                        \
    (SDMMC_SDIO_R5_COM_CRC_FAILED | SDMMC_SDIO_R5_ILLEGAL_CMD | SDMMC_SDIO_R5_GENERAL_UNKNOWN_ERROR |                  \
...
#define IS_SDMMC_SPEED_MODE(MODE)                                                                                      \
    (((MODE) == SDMMC_SPEED_MODE_AUTO) || ((MODE) == SDMMC_SPEED_MODE_DEFAULT) || ((MODE) == SDMMC_SPEED_MODE_HIGH) || \
     ((MODE) == SDMMC_SPEED_MODE_ULTRA) || ((MODE) == SDMMC_SPEED_MODE_ULTRA_SDR50) ||                                 \
