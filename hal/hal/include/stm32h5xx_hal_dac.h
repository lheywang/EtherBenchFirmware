...
typedef struct {
    ...
    FunctionalState DAC_SignedFormat; /*!< Specifies if signed format should be used or not
    ...
    uint32_t DAC_ConnectOnChipPeripheral; /*!< Specifies whether the DAC output is
...
#define DAC_TRIGGER_T6_TRGO                                                                                            \
    (DAC_CR_TSEL1_2 | DAC_CR_TSEL1_0 | DAC_CR_TEN1) /*!< TIM6 TRGO selected as external conversion trigger for DAC     \
                                                       channel */
#define DAC_TRIGGER_T7_TRGO                                                                                            \
    (DAC_CR_TSEL1_2 | DAC_CR_TSEL1_1 | DAC_CR_TEN1) /*!< TIM7 TRGO selected as external conversion trigger for DAC     \
                                                       channel */
#define DAC_TRIGGER_LPTIM1_CH1                                                                                         \
    (DAC_CR_TSEL1_3 | DAC_CR_TSEL1_1 | DAC_CR_TSEL1_0 | DAC_CR_TEN1) /*!< LPTIM1 CH1 selected as external conversion   \
                                                                        trigger for DAC channel */
#define DAC_TRIGGER_LPTIM2_CH1                                                                                         \
    (DAC_CR_TSEL1_3 | DAC_CR_TSEL1_2 | DAC_CR_TEN1) /*!< LPTIM2 CH1 selected as external conversion trigger for        \
                                                       DAC channel */
#define DAC_TRIGGER_EXT_IT9                                                                                            \
    (DAC_CR_TSEL1_3 | DAC_CR_TSEL1_2 | DAC_CR_TSEL1_0 | DAC_CR_TEN1) /*!< EXTI Line9 event selected as external        \
                                                                        conversion trigger for DAC channel */
...
#define DAC_TRIGGER_T4_TRGO                                                                                            \
    (DAC_CR_TSEL1_1 | DAC_CR_TSEL1_0 | DAC_CR_TEN1) /*!< TIM4 TRGO selected as external conversion trigger for DAC     \
                                                       channel */
#define DAC_TRIGGER_T5_TRGO                                                                                            \
    (DAC_CR_TSEL1_2 | DAC_CR_TEN1) /*!< TIM5 TRGO selected as external                                                 \
                                      conversion trigger for DAC channel */
#define DAC_TRIGGER_T8_TRGO                                                                                            \
    (DAC_CR_TSEL1_2 | DAC_CR_TSEL1_1 | DAC_CR_TSEL1_0 | DAC_CR_TEN1) /*!< TIM8 TRGO selected as external conversion    \
                                                                        trigger for DAC channel */
...
#define DAC_TRIGGER_T3_TRGO                                                                                            \
    (DAC_CR_TSEL1_1 | DAC_CR_TSEL1_0 | DAC_CR_TEN1) /*!< TIM3 TRGO selected as external conversion trigger for DAC     \
                                                       channel */
