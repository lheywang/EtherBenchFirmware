...
#define IS_SBS_ETHERNET_CONFIG(CONFIG) (((CONFIG) == SBS_ETH_MII) || ((CONFIG) == SBS_ETH_RMII))
...
#define IS_SBS_MEMORIES_ERASE_FLAG(FLAG)                                                                               \
    (((FLAG) == SBS_MEMORIES_ERASE_FLAG_IPMEE) || ((FLAG) == SBS_MEMORIES_ERASE_FLAG_MCLR))
...
#define IS_SBS_VDD_CODE_SELECT(SELECT) (((SELECT) == SBS_VDD_CELL_CODE) || ((SELECT) == SBS_VDD_REGISTER_CODE))
...
#define IS_SBS_VDDIO_CODE_SELECT(SELECT) (((SELECT) == SBS_VDDIO_CELL_CODE) || ((SELECT) == SBS_VDDIO_REGISTER_CODE))
...
#define IS_SBS_FPU_INTERRUPT(__INTERRUPT__)                                                                            \
    ((((__INTERRUPT__) & SBS_IT_FPU_IOC) == SBS_IT_FPU_IOC) ||                                                         \
     ...
     (((__INTERRUPT__) & SBS_IT_FPU_IDC) == SBS_IT_FPU_IDC) || (((__INTERRUPT__) & SBS_IT_FPU_IXC) == SBS_IT_FPU_IXC))
...
#define IS_VREFBUF_VOLTAGE_SCALE(__SCALE__)                                                                            \
    (((__SCALE__) == VREFBUF_VOLTAGE_SCALE0) || ((__SCALE__) == VREFBUF_VOLTAGE_SCALE1) ||                             \
     ((__SCALE__) == VREFBUF_VOLTAGE_SCALE2) || ((__SCALE__) == VREFBUF_VOLTAGE_SCALE3))

#define IS_VREFBUF_HIGH_IMPEDANCE(__VALUE__)                                                                           \
    (((__VALUE__) == VREFBUF_HIGH_IMPEDANCE_DISABLE) || ((__VALUE__) == VREFBUF_HIGH_IMPEDANCE_ENABLE))
...
#define IS_SBS_HDPL(__LEVEL__)                                                                                         \
    (((__LEVEL__) == SBS_HDPL_VALUE_0) || ((__LEVEL__) == SBS_HDPL_VALUE_1) || ((__LEVEL__) == SBS_HDPL_VALUE_2) ||    \
...
#define IS_SBS_ITEMS_ATTRIBUTES(__ITEM__)                                                                              \
    ((((__ITEM__) & SBS_CLK) == SBS_CLK) || (((__ITEM__) & SBS_CLASSB) == SBS_CLASSB) ||                               \
     (((__ITEM__) & SBS_FPU) == SBS_FPU) || (((__ITEM__) & ~(SBS_ALL)) == 0U))

#define IS_SBS_ATTRIBUTES(__ATTRIBUTES__) (((__ATTRIBUTES__) == SBS_SEC) || ((__ATTRIBUTES__) == SBS_NSEC))

#if defined(__ARM_FEATURE_CMSE) && (__ARM_FEATURE_CMSE == 3U)

#define IS_SBS_LOCK_ITEMS(__ITEM__)                                                                                    \
    ((((__ITEM__) & SBS_MPU_NSEC) == SBS_MPU_NSEC) || (((__ITEM__) & SBS_VTOR_NSEC) == SBS_VTOR_NSEC) ||               \
     (((__ITEM__) & SBS_SAU) == SBS_SAU) || (((__ITEM__) & SBS_MPU_SEC) == SBS_MPU_SEC) ||                             \
     (((__ITEM__) & SBS_VTOR_AIRCR_SEC) == SBS_VTOR_AIRCR_SEC) || (((__ITEM__) & ~(SBS_LOCK_ALL)) == 0U))
