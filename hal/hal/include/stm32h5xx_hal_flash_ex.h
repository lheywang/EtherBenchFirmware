...
typedef struct {
    ...
    uint32_t USERConfig2; /*!< Value of the User Option Byte (used for
    ...
    uint32_t WMSecStartSector; /*!< Start sector of secure area (used for
                                  ...
                                  the bank - 1)*/
    uint32_t WMSecEndSector;   /*!< End sector of secure area (used for
...
#define OPTIONBYTE_ALL                                                                                                 \
    (OPTIONBYTE_WRP | OPTIONBYTE_PROD_STATE | OPTIONBYTE_USER | OPTIONBYTE_BOOTADDR | OPTIONBYTE_BOOT_LOCK |           \
     OPTIONBYTE_OTP_LOCK | OPTIONBYTE_HDP | OPTIONBYTE_EDATA | OPTIONBYTE_WMSEC) /*!< All option                       \
                        byte configuration */
#else
#if defined(FLASH_EDATAR_EDATA_EN)
#define OPTIONBYTE_ALL                                                                                                 \
    (OPTIONBYTE_WRP | OPTIONBYTE_PROD_STATE | OPTIONBYTE_USER | OPTIONBYTE_BOOTADDR | OPTIONBYTE_BOOT_LOCK |           \
     OPTIONBYTE_OTP_LOCK | OPTIONBYTE_HDP | OPTIONBYTE_EDATA) /*!< All option byte configuration */
#else
#define OPTIONBYTE_ALL                                                                                                 \
    (OPTIONBYTE_WRP | OPTIONBYTE_PROD_STATE | OPTIONBYTE_USER | OPTIONBYTE_BOOTADDR | OPTIONBYTE_BOOT_LOCK |           \
     OPTIONBYTE_OTP_LOCK | OPTIONBYTE_HDP) /*!< All option byte configuration */
#endif                                     /* FLASH_EDATAR_EDATA_EN */
#endif                                     /* __ARM_FEATURE_CMSE */
/**
 * @}
...
#define OB_USER_ALL                                                                                                    \
    (OB_USER_BOR_LEV | OB_USER_BORH_EN | OB_USER_IWDG_SW | OB_USER_WWDG_SW | OB_USER_NRST_STOP | OB_USER_NRST_STDBY |  \
     OB_USER_IO_VDD_HSLV | OB_USER_IO_VDDIO2_HSLV | OB_USER_IWDG_STOP | OB_USER_IWDG_STDBY | OB_USER_BOOT_UBE |        \
     OB_USER_SWAP_BANK | OB_USER_SRAM1_3_RST | OB_USER_SRAM2_RST | OB_USER_BKPRAM_ECC | OB_USER_SRAM3_ECC |            \
     OB_USER_SRAM2_ECC | OB_USER_USBPD_DIS | OB_USER_TZEN)
#else
#define OB_USER_ALL                                                                                                    \
    (OB_USER_BOR_LEV | OB_USER_BORH_EN | OB_USER_IWDG_SW | OB_USER_WWDG_SW | OB_USER_NRST_STOP | OB_USER_NRST_STDBY |  \
     OB_USER_IO_VDD_HSLV | OB_USER_IO_VDDIO2_HSLV | OB_USER_IWDG_STOP | OB_USER_IWDG_STDBY | OB_USER_SWAP_BANK |       \
     OB_USER_SRAM1_RST | OB_USER_SRAM2_RST | OB_USER_BKPRAM_ECC | OB_USER_SRAM3_ECC | OB_USER_SRAM2_ECC |              \
     OB_USER_SRAM1_ECC)
...
#define IS_FLASH_TYPEERASE(VALUE)                                                                                      \
    (((VALUE) == FLASH_TYPEERASE_SECTORS) || ((VALUE) == FLASH_TYPEERASE_SECTORS_NS) ||                                \
...
#define IS_OPTIONBYTE(VALUE) ((((VALUE) & OPTIONBYTE_ALL) != 0U) && (((VALUE) & ~OPTIONBYTE_ALL) == 0U))

#define IS_OB_PRODUCT_STATE(STATE)                                                                                     \
    (((STATE) == OB_PROD_STATE_OPEN) || ((STATE) == OB_PROD_STATE_PROVISIONING) ||                                     \
     ((STATE) == OB_PROD_STATE_IROT_PROVISIONED) || ((STATE) == OB_PROD_STATE_TZ_CLOSED) ||                            \
     ((STATE) == OB_PROD_STATE_CLOSED) || ((STATE) == OB_PROD_STATE_LOCKED) ||                                         \
     ((STATE) == OB_PROD_STATE_REGRESSION) || ((STATE) == OB_PROD_STATE_NS_REGRESSION))

#define IS_OB_USER_BOR_LEVEL(LEVEL)                                                                                    \
    (((LEVEL) == OB_BOR_LEVEL_1) || ((LEVEL) == OB_BOR_LEVEL_2) || ((LEVEL) == OB_BOR_LEVEL_3))
...
#define IS_OB_USER_TYPE(TYPE) ((((TYPE) & OB_USER_ALL) != 0U) && (((TYPE) & ~OB_USER_ALL) == 0U))
