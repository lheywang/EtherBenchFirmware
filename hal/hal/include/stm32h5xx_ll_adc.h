...
typedef struct {
    ...
    uint32_t MultiTwoSamplingDelay; /*!< Set ADC multimode delay between 2 sampling
...
typedef struct {
    ...
    uint32_t SequencerDiscont; /*!< Set ADC group regular sequencer discontinuous mode:
    ...
    uint32_t ContinuousMode; /*!< Set ADC continuous conversion mode on ADC group
 ...
 */
typedef struct {
    uint32_t TriggerSource; /*!< Set ADC group injected conversion trigger source:
                               internal (SW start) or from external peripheral (timer
                               event, external interrupt line). This parameter can be a
    ...
    uint32_t TrigAuto; /*!< Set ADC group injected conversion trigger: independent or
...
#define LL_ADC_CHANNEL_19                                                                                              \
    (ADC_CHANNEL_19_NUMBER | ADC_CHANNEL_19_SMP | ADC_CHANNEL_19_BITFIELD) /*!< ADC channel ADCx_IN19 */
#if defined(ADC2)
...
#define LL_ADC_REG_TRIG_EXT_LPTIM1_CH1                                                                                 \
    (ADC_CFGR_EXTSEL_4 | ADC_CFGR_EXTSEL_1 | ADC_REG_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group regular                     \
...
#define LL_ADC_REG_TRIG_EXT_TIM8_TRGO                                                                                  \
    (ADC_CFGR_EXTSEL_2 | ADC_CFGR_EXTSEL_1 | ADC_CFGR_EXTSEL_0 | ADC_REG_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group regular \
                                                              conversion trigger from external peripheral: TIM12 TRGO  \
                                                              event. Trigger edge set to rising edge (default          \
                                                              setting). Specific to devices: STM32H563/H573xx. */
...
#define LL_ADC_REG_TRIG_EXT_TIM7_TRGO                                                                                  \
    (ADC_CFGR_EXTSEL_4 | ADC_CFGR_EXTSEL_0 | ADC_REG_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group regular                     \
...
#define LL_ADC_INJ_TRIG_EXT_LPTIM1_CH1                                                                                 \
    (ADC_JSQR_JEXTSEL_4 | ADC_JSQR_JEXTSEL_1 | ADC_INJ_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group injected                  \
...
#define LL_ADC_INJ_TRIG_EXT_TIM7_TRGO                                                                                  \
    (ADC_JSQR_JEXTSEL_4 | ADC_JSQR_JEXTSEL_0 | ADC_INJ_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group injected                  \
...
#define __LL_ADC_IS_CHANNEL_INTERNAL_AVAILABLE(__ADC_INSTANCE__, __CHANNEL__)                                          \
    ((((__ADC_INSTANCE__) == ADC1) &&                                                                                  \
      (((__CHANNEL__) == LL_ADC_CHANNEL_TEMPSENSOR) || ((__CHANNEL__) == LL_ADC_CHANNEL_VREFINT))) ||                  \
     (((__ADC_INSTANCE__) == ADC2) &&                                                                                  \
      (((__CHANNEL__) == LL_ADC_CHANNEL_VBAT) || ((__CHANNEL__) == LL_ADC_CHANNEL_VDDCORE))))
#else
#define __LL_ADC_IS_CHANNEL_INTERNAL_AVAILABLE(__ADC_INSTANCE__, __CHANNEL__)                                          \
    (((__CHANNEL__) == LL_ADC_CHANNEL_VREFINT) || ((__CHANNEL__) == LL_ADC_CHANNEL_TEMPSENSOR) ||                      \
     ((__CHANNEL__) == LL_ADC_CHANNEL_VDDCORE) || ((__CHANNEL__) == LL_ADC_CHANNEL_VBAT))
#endif /* ADC2 */
 ...
 * @retval None
 */
__STATIC_INLINE void LL_ADC_EnableChannelVDDcore(ADC_TypeDef *ADCx) { SET_BIT(ADCx->OR, ADC_OR_OP0); }
#else
/**
 * @brief  Enable VddCore (internal digital core voltage) channel.
 * @note   On this STM32 series, VddCore channel is controlled via a specific
 ...
 * @retval None
 */
__STATIC_INLINE void LL_ADC_EnableChannelVDDcore(ADC_TypeDef *ADCx) { SET_BIT(ADCx->OR, ADC_OR_OP1); }
#endif /* ADC2 */
 ...
 * @retval None
 */
__STATIC_INLINE void LL_ADC_DisableChannelVDDcore(ADC_TypeDef *ADCx) { CLEAR_BIT(ADCx->OR, ADC_OR_OP0); }
#else
/**
 * @brief  Disable VddCore (internal digital core voltage) channel.
 * @note   On this STM32 series, VddCore channel is controlled via a specific
 ...
 * @retval None
 */
__STATIC_INLINE void LL_ADC_DisableChannelVDDcore(ADC_TypeDef *ADCx) { CLEAR_BIT(ADCx->OR, ADC_OR_OP1); }
#endif /* ADC2 */
 ...
 * @retval None
 */
__STATIC_INLINE void LL_ADC_ClearFlag_JQOVF(ADC_TypeDef *ADCx) { WRITE_REG(ADCx->ISR, LL_ADC_FLAG_JQOVF); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_ADC_EnableIT_JQOVF(ADC_TypeDef *ADCx) { SET_BIT(ADCx->IER, LL_ADC_IT_JQOVF); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_ADC_DisableIT_JQOVF(ADC_TypeDef *ADCx) { CLEAR_BIT(ADCx->IER, LL_ADC_IT_JQOVF); }
