 ...
 * @retval None
 */
__STATIC_INLINE void LL_PWR_SetPowerMode(uint32_t Mode) { MODIFY_REG(PWR->PMCR, PWR_PMCR_LPMS, Mode); }
 ...
 *         @arg @ref LL_PWR_STANDBY_MODE
 */
__STATIC_INLINE uint32_t LL_PWR_GetPowerMode(void) { return (READ_BIT(PWR->PMCR, PWR_PMCR_LPMS)); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_PWR_EnableFlashPowerDown(void) { SET_BIT(PWR->PMCR, PWR_PMCR_FLPS); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_PWR_DisableFlashPowerDown(void) { CLEAR_BIT(PWR->PMCR, PWR_PMCR_FLPS); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_PWR_EnableAnalogBooster(void) { SET_BIT(PWR->PMCR, PWR_PMCR_BOOSTE); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_PWR_DisableAnalogBooster(void) { CLEAR_BIT(PWR->PMCR, PWR_PMCR_BOOSTE); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_PWR_EnableAnalogVoltageReady(void) { SET_BIT(PWR->PMCR, PWR_PMCR_AVD_READY); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_PWR_DisableAnalogVoltageReady(void) { CLEAR_BIT(PWR->PMCR, PWR_PMCR_AVD_READY); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_PWR_EnableAHBRAM1ShutOff(void) { SET_BIT(PWR->PMCR, PWR_PMCR_SRAM1SO); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_PWR_DisableAHBRAM1ShutOff(void) { CLEAR_BIT(PWR->PMCR, PWR_PMCR_SRAM1SO); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_PWR_EnableAHBRAM2_48K_ShutOff(void) { SET_BIT(PWR->PMCR, PWR_PMCR_SRAM2_48SO); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_PWR_DisableAHBRAM2_48K_ShutOff(void) { CLEAR_BIT(PWR->PMCR, PWR_PMCR_SRAM2_48SO); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_PWR_EnableAHBRAM2_16K_ShutOff(void) { SET_BIT(PWR->PMCR, PWR_PMCR_SRAM2_16SO); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_PWR_DisableAHBRAM2_16K_ShutOff(void) { CLEAR_BIT(PWR->PMCR, PWR_PMCR_SRAM2_16SO); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_PWR_EnableAHBRAM2_High_16K_ShutOff(void) { SET_BIT(PWR->PMCR, PWR_PMCR_SRAM2_16HSO); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_PWR_DisableAHBRAM2_High_16K_ShutOff(void) { CLEAR_BIT(PWR->PMCR, PWR_PMCR_SRAM2_16HSO); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_PWR_EnableAHBRAM2_Low_16K_ShutOff(void) { SET_BIT(PWR->PMCR, PWR_PMCR_SRAM2_16LSO); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_PWR_DisableAHBRAM2_Low_16K_ShutOff(void) { CLEAR_BIT(PWR->PMCR, PWR_PMCR_SRAM2_16LSO); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_PWR_EnableAHBRAM2ShutOff(void) { SET_BIT(PWR->PMCR, PWR_PMCR_SRAM2SO); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_PWR_DisableAHBRAM2ShutOff(void) { CLEAR_BIT(PWR->PMCR, PWR_PMCR_SRAM2SO); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_PWR_EnableAHBRAM3ShutOff(void) { SET_BIT(PWR->PMCR, PWR_PMCR_SRAM3SO); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_PWR_DisableAHBRAM3ShutOff(void) { CLEAR_BIT(PWR->PMCR, PWR_PMCR_SRAM3SO); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_PWR_EnableETHERNETRAMShutOff(void) { SET_BIT(PWR->PMCR, PWR_PMCR_ETHERNETSO); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_PWR_DisableETHERNETRAMShutOff(void) { CLEAR_BIT(PWR->PMCR, PWR_PMCR_ETHERNETSO); }
 ...
 *         @arg @ref LL_PWR_REGU_VOLTAGE_SCALE3
 */
__STATIC_INLINE uint32_t LL_PWR_GetRegulVoltageScaling(void) { return (uint32_t)(READ_BIT(PWR->VOSCR, PWR_VOSCR_VOS)); }
 ...
 *         @arg @ref LL_PWR_REGU_VOLTAGE_SCALE3
 */
__STATIC_INLINE uint32_t LL_PWR_GetCurrentVOS(void) { return (READ_BIT(PWR->VOSSR, PWR_VOSSR_ACTVOS)); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_PWR_EnableBkUpRegulator(void) { SET_BIT(PWR->BDCR, PWR_BDCR_BREN); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_PWR_DisableBkUpRegulator(void) { CLEAR_BIT(PWR->BDCR, PWR_BDCR_BREN); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_PWR_EnableMonitoring(void) { SET_BIT(PWR->BDCR, PWR_BDCR_MONEN); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_PWR_DisableMonitoring(void) { CLEAR_BIT(PWR->BDCR, PWR_BDCR_MONEN); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_PWR_EnableBatteryCharging(void) { SET_BIT(PWR->BDCR, PWR_BDCR_VBE); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_PWR_DisableBatteryCharging(void) { CLEAR_BIT(PWR->BDCR, PWR_BDCR_VBE); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_PWR_SetBattChargResistor(uint32_t Resistor) { MODIFY_REG(PWR->BDCR, PWR_BDCR_VBRS, Resistor); }
 ...
 *         @arg @ref LL_PWR_BATT_CHARG_RESISTOR_1_5K
 */
__STATIC_INLINE uint32_t LL_PWR_GetBattChargResistor(void) { return (uint32_t)(READ_BIT(PWR->BDCR, PWR_BDCR_VBRS)); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_PWR_EnableBkUpAccess(void) { SET_BIT(PWR->DBPCR, PWR_DBPCR_DBP); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_PWR_DisableBkUpAccess(void) { CLEAR_BIT(PWR->DBPCR, PWR_DBPCR_DBP); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_PWR_EnableUCPDStandbyMode(void) { SET_BIT(PWR->UCPDR, PWR_UCPDR_UCPD_STBY); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_PWR_DisableUCPDStandbyMode(void) { CLEAR_BIT(PWR->UCPDR, PWR_UCPDR_UCPD_STBY); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_PWR_EnablePVD(void) { SET_BIT(PWR->VMCR, PWR_VMCR_PVDEN); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_PWR_DisablePVD(void) { CLEAR_BIT(PWR->VMCR, PWR_VMCR_PVDEN); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_PWR_SetPVDLevel(uint32_t PVDLevel) { MODIFY_REG(PWR->VMCR, PWR_VMCR_PLS, PVDLevel); }
 ...
 *         @arg @ref LL_PWR_PVDLEVEL_7
 */
__STATIC_INLINE uint32_t LL_PWR_GetPVDLevel(void) { return (uint32_t)(READ_BIT(PWR->VMCR, PWR_VMCR_PLS)); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_PWR_EnableAVD(void) { SET_BIT(PWR->VMCR, PWR_VMCR_AVDEN); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_PWR_DisableAVD(void) { CLEAR_BIT(PWR->VMCR, PWR_VMCR_AVDEN); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_PWR_SetAVDLevel(uint32_t AVDLevel) { MODIFY_REG(PWR->VMCR, PWR_VMCR_ALS, AVDLevel); }
 ...
 *         @arg @ref LL_PWR_AVDLEVEL_3
 */
__STATIC_INLINE uint32_t LL_PWR_GetAVDLevel(void) { return (uint32_t)(READ_BIT(PWR->VMCR, PWR_VMCR_ALS)); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_PWR_EnableUSBVoltageDetector(void) { SET_BIT(PWR->USBSCR, PWR_USBSCR_USB33DEN); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_PWR_DisableUSBVoltageDetector(void) { CLEAR_BIT(PWR->USBSCR, PWR_USBSCR_USB33DEN); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_PWR_EnableVddUSB(void) { SET_BIT(PWR->USBSCR, PWR_USBSCR_USB33SV); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_PWR_DisableVddUSB(void) { CLEAR_BIT(PWR->USBSCR, PWR_USBSCR_USB33SV); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_PWR_EnableWakeUpPin(uint32_t WakeUpPin) { SET_BIT(PWR->WUCR, WakeUpPin); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_PWR_DisableWakeUpPin(uint32_t WakeUpPin) { CLEAR_BIT(PWR->WUCR, WakeUpPin); }
...
__STATIC_INLINE void LL_PWR_SetWakeUpPinPullNone(uint32_t WakeUpPin) {
    MODIFY_REG(
        ...
        (LL_PWR_WAKEUP_PIN_NOPULL << ((PWR_WUCR_WUPPUPD1_Pos +
...
__STATIC_INLINE void LL_PWR_SetWakeUpPinPullUp(uint32_t WakeUpPin) {
    MODIFY_REG(
        ...
        (PWR_WUCR_WUPPUPD1 << ((LL_PWR_WAKEUP_PINS_PULL_SHIFT_OFFSET * (POSITION_VAL(WakeUpPin) & 0xFU)) &
                               LL_PWR_WAKEUP_PINS_MAX_SHIFT_MASK)),
        (LL_PWR_WAKEUP_PIN_PULLUP << ((PWR_WUCR_WUPPUPD1_Pos +
                                       ((LL_PWR_WAKEUP_PINS_PULL_SHIFT_OFFSET * POSITION_VAL(WakeUpPin)) & 0xFU)) &
                                      LL_PWR_WAKEUP_PINS_MAX_SHIFT_MASK)));
}
...
__STATIC_INLINE uint32_t LL_PWR_GetWakeUpPinPull(uint32_t WakeUpPin) {
    uint32_t regValue = READ_BIT(
        PWR->WUCR, (PWR_WUCR_WUPPUPD1 << ((LL_PWR_WAKEUP_PINS_PULL_SHIFT_OFFSET * (POSITION_VAL(WakeUpPin) & 0xFU)) &
                                          LL_PWR_WAKEUP_PINS_MAX_SHIFT_MASK)));
 ...
 * @retval None
 */
__STATIC_INLINE void LL_PWR_EnableIORetention(void) { SET_BIT(PWR->IORETR, PWR_IORETR_IORETEN); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_PWR_DisableIORetention(void) { CLEAR_BIT(PWR->IORETR, PWR_IORETR_IORETEN); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_PWR_EnableJTAGIORetention(void) { SET_BIT(PWR->IORETR, PWR_IORETR_JTAGIORETEN); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_PWR_DisableJTAGIORetention(void) { CLEAR_BIT(PWR->IORETR, PWR_IORETR_JTAGIORETEN); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_PWR_ClearFlag_STOP(void) { WRITE_REG(PWR->PMCR, PWR_PMCR_CSSF); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_PWR_ClearFlag_SB(void) { WRITE_REG(PWR->PMCR, PWR_PMCR_CSSF); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_PWR_EnableNSecurePrivilege(void) { SET_BIT(PWR->PRIVCFGR, PWR_PRIVCFGR_PRIV); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_PWR_DisableNSecurePrivilege(void) { CLEAR_BIT(PWR->PRIVCFGR, PWR_PRIVCFGR_PRIV); }
