...
#define __HAL_HASH_GET_FLAG(__HANDLE__, __FLAG__)                                                                      \
    (((__FLAG__) > 8U) ? ((((__HANDLE__)->Instance->CR & (__FLAG__)) == (__FLAG__)) ? SET : RESET)                     \
...
#define HASH_DIGEST_LENGTH(__HANDLE__)                                                                                 \
    (((READ_BIT((__HANDLE__)->Instance->CR, HASH_CR_ALGO) == HASH_ALGOSELECTION_SHA1)                                  \
          ? 20U                                                                                                        \
          : ((READ_BIT((__HANDLE__)->Instance->CR, HASH_CR_ALGO) == HASH_ALGOSELECTION_SHA224)                         \
                 ? 28U                                                                                                 \
                 : ((READ_BIT((__HANDLE__)->Instance->CR, HASH_CR_ALGO) == HASH_ALGOSELECTION_SHA256)                  \
                        ? 32U                                                                                          \
                        : ((READ_BIT((__HANDLE__)->Instance->CR, HASH_CR_ALGO) == HASH_ALGOSELECTION_SHA384)           \
                               ? 48U                                                                                   \
...
#define IS_HASH_ALGORITHM(__ALGORITHM__)                                                                               \
    (((__ALGORITHM__) == HASH_ALGOSELECTION_SHA1) || ((__ALGORITHM__) == HASH_ALGOSELECTION_SHA224) ||                 \
     ((__ALGORITHM__) == HASH_ALGOSELECTION_SHA256) || ((__ALGORITHM__) == HASH_ALGOSELECTION_SHA384) ||               \
     ((__ALGORITHM__) == HASH_ALGOSELECTION_SHA512_224) || ((__ALGORITHM__) == HASH_ALGOSELECTION_SHA512_256) ||       \
