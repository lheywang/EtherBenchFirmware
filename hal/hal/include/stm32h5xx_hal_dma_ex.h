...
typedef struct {
    ...
    DMA_DataHandlingConfTypeDef DataHandlingConfig; /*!< Specifies the DMA channel data handling channel
                                                       configuration  */
...
#define DMA_GPDMA_LINEAR_NODE                                                                                          \
    (DMA_CHANNEL_TYPE_GPDMA | DMA_CHANNEL_TYPE_LINEAR_ADDR) /*!< Defines the GPDMA linear addressing node              \
                                                               type      */
#define DMA_GPDMA_2D_NODE                                                                                              \
    (DMA_CHANNEL_TYPE_GPDMA | DMA_CHANNEL_TYPE_2D_ADDR) /*!< Defines the GPDMA 2 dimension addressing                  \
                                                           node type */
/**
 * @}
 */
...
#define IS_DMA_NODE_TYPE(TYPE) (((TYPE) == DMA_GPDMA_LINEAR_NODE) || ((TYPE) == DMA_GPDMA_2D_NODE))
/**
 * @}
 */
