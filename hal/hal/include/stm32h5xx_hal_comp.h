...
typedef enum {
    ...
    HAL_COMP_STATE_RESET_LOCKED = (HAL_COMP_STATE_RESET | COMP_STATE_BITFIELD_LOCK), /*!< COMP not yet initialized and
    ...
    HAL_COMP_STATE_BUSY_LOCKED = (HAL_COMP_STATE_BUSY | COMP_STATE_BITFIELD_LOCK) /*!< COMP is running and configuration
                                                                                     is locked          */
...
#define COMP_BLANKINGSRC_TIM3_OC3                                                                                      \
    (COMP_CFGR1_BLANKING_0 | COMP_CFGR1_BLANKING_1)       /*!< TIM3 OC3 selected as blanking source */
...
#define COMP_BLANKINGSRC_LPTIM1_OC2                                                                                    \
    (COMP_CFGR1_BLANKING_2 | COMP_CFGR1_BLANKING_0) /*!< LPTIM1 OC2 selected as blanking source */
#define COMP_BLANKINGSRC_LPTIM2_OC2                                                                                    \
    (COMP_CFGR1_BLANKING_2 | COMP_CFGR1_BLANKING_1) /*!< LPTIM2 OC2 selected as blanking source */
/**
 * @}
 */
...
#define COMP_TRIGGERMODE_IT_RISING_FALLING                                                                             \
    (COMP_EXTI_IT | COMP_EXTI_RISING | COMP_EXTI_FALLING) /*!< Comparator output triggering interrupt                  \
...
#define IS_COMP_INPUT_PLUS(__COMP_INSTANCE__, __INPUT_PLUS__)                                                          \
    (((__INPUT_PLUS__) == COMP_INPUT_PLUS_IO1) || ((__INPUT_PLUS__) == COMP_INPUT_PLUS_IO2) ||                         \
     ((__INPUT_PLUS__) == COMP_INPUT_PLUS_IO3) || ((__INPUT_PLUS__) == COMP_INPUT_PLUS_DAC1_CH1))
...
#define IS_COMP_INPUT_MINUS(__COMP_INSTANCE__, __INPUT_MINUS__)                                                        \
    (((__INPUT_MINUS__) == COMP_INPUT_MINUS_1_4VREFINT) || ((__INPUT_MINUS__) == COMP_INPUT_MINUS_1_2VREFINT) ||       \
     ...
     ((__INPUT_MINUS__) == COMP_INPUT_MINUS_TEMPSENSOR) || ((__INPUT_MINUS__) == COMP_INPUT_MINUS_VBAT))
...
#define IS_COMP_BLANKINGSRCE(__SOURCE__)                                                                               \
    (((__SOURCE__) == COMP_BLANKINGSRC_NONE) || ((__SOURCE__) == COMP_BLANKINGSRC_TIM1_OC5) ||                         \
     ((__SOURCE__) == COMP_BLANKINGSRC_TIM2_OC3) || ((__SOURCE__) == COMP_BLANKINGSRC_TIM3_OC3) ||                     \
     ((__SOURCE__) == COMP_BLANKINGSRC_TIM3_OC4) || ((__SOURCE__) == COMP_BLANKINGSRC_LPTIM1_OC2) ||                   \
     ((__SOURCE__) == COMP_BLANKINGSRC_LPTIM2_OC2))

#define IS_COMP_TRIGGERMODE(__MODE__)                                                                                  \
    (((__MODE__) == COMP_TRIGGERMODE_NONE) || ((__MODE__) == COMP_TRIGGERMODE_IT_RISING_FALLING))
