...
#define USART_CR2_FIELDS                                                                                               \
    ((uint32_t)(USART_CR2_RTOEN | USART_CR2_CLK_FIELDS | USART_CR2_STOP)) /*!< USART CR2 fields of parameters set by   \
                                                                             SMARTCARD_SetConfig API */
...
HAL_StatusTypeDef HAL_SMARTCARD_Receive(SMARTCARD_HandleTypeDef *hsmartcard, uint8_t *pData, uint16_t Size,
    ...
    if (hsmartcard->RxState == HAL_SMARTCARD_STATE_READY) {
        ...
        while (hsmartcard->RxXferCount > 0U) {
            ...
            if (SMARTCARD_WaitOnFlagUntilTimeout(hsmartcard, SMARTCARD_FLAG_RXNE, RESET, tickstart, Timeout) !=
                HAL_OK) {
                return HAL_TIMEOUT;
            }
...
HAL_StatusTypeDef HAL_SMARTCARD_Abort(SMARTCARD_HandleTypeDef *hsmartcard) {
    ...
    __HAL_SMARTCARD_CLEAR_FLAG(hsmartcard, SMARTCARD_CLEAR_OREF | SMARTCARD_CLEAR_NEF | SMARTCARD_CLEAR_PEF |
...
HAL_StatusTypeDef HAL_SMARTCARD_AbortReceive_IT(SMARTCARD_HandleTypeDef *hsmartcard) {
    ...
    if (HAL_IS_BIT_SET(hsmartcard->Instance->CR3, USART_CR3_DMAR)) {
        ...
        if (hsmartcard->hdmarx != NULL) {
            ...
            /* Clear the Error flags in the ICR register */
            __HAL_SMARTCARD_CLEAR_FLAG(hsmartcard, SMARTCARD_CLEAR_OREF | SMARTCARD_CLEAR_NEF | SMARTCARD_CLEAR_PEF |
                                                       SMARTCARD_CLEAR_FEF | SMARTCARD_CLEAR_RTOF |
