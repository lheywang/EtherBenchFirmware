...
#define IS_LL_DMA_ALL_CHANNEL_INSTANCE(INSTANCE, Channel)                                                              \
    ((((INSTANCE) == GPDMA1) &&                                                                                        \
      (((Channel) == LL_DMA_CHANNEL_0) || ((Channel) == LL_DMA_CHANNEL_1) || ((Channel) == LL_DMA_CHANNEL_2) ||        \
       ...
       ((Channel) == LL_DMA_CHANNEL_6) || ((Channel) == LL_DMA_CHANNEL_7) || ((Channel) == LL_DMA_CHANNEL_ALL))) ||    \
     (((INSTANCE) == GPDMA2) &&                                                                                        \
      (((Channel) == LL_DMA_CHANNEL_0) || ((Channel) == LL_DMA_CHANNEL_1) || ((Channel) == LL_DMA_CHANNEL_2) ||        \
       ((Channel) == LL_DMA_CHANNEL_3) || ((Channel) == LL_DMA_CHANNEL_4) || ((Channel) == LL_DMA_CHANNEL_5) ||        \
       ((Channel) == LL_DMA_CHANNEL_6) || ((Channel) == LL_DMA_CHANNEL_7) || ((Channel) == LL_DMA_CHANNEL_ALL))))
...
#define IS_LL_DMA_2D_CHANNEL_INSTANCE(INSTANCE, Channel)                                                               \
    ((((INSTANCE) == GPDMA1) && (((Channel) == LL_DMA_CHANNEL_6) || ((Channel) == LL_DMA_CHANNEL_7))) ||               \
     (((INSTANCE) == GPDMA2) && (((Channel) == LL_DMA_CHANNEL_6) || ((Channel) == LL_DMA_CHANNEL_7))))

#define IS_LL_DMA_MODE(__VALUE__) (((__VALUE__) == LL_DMA_NORMAL) || ((__VALUE__) == LL_DMA_PFCTRL))

#define IS_LL_DMA_PFREQ_INSTANCE(INSTANCE, Channel)                                                                    \
    ((((INSTANCE) == GPDMA1) && (((Channel) == LL_DMA_CHANNEL_0) || ((Channel) == LL_DMA_CHANNEL_7))) ||               \
     (((INSTANCE) == GPDMA2) && (((Channel) == LL_DMA_CHANNEL_0) || ((Channel) == LL_DMA_CHANNEL_7))))
...
uint32_t LL_DMA_Init(DMA_TypeDef *DMAx, uint32_t Channel, LL_DMA_InitTypeDef *DMA_InitStruct) {
    ...
    LL_DMA_ConfigControl(DMAx, Channel,
                         DMA_InitStruct->Priority | DMA_InitStruct->LinkAllocatedPort | DMA_InitStruct->LinkStepMode);
    ...
    if (IS_LL_DMA_2D_CHANNEL_INSTANCE(DMAx, Channel) != 0U) {
        ...
        LL_DMA_ConfigBlkRptAddrUpdate(DMAx, Channel,
                                      DMA_InitStruct->BlkRptSrcAddrUpdateMode |
                                          DMA_InitStruct->BlkRptDestAddrUpdateMode | DMA_InitStruct->SrcAddrUpdateMode |
...
uint32_t LL_DMA_CreateLinkNode(const LL_DMA_InitNodeTypeDef *DMA_InitNodeStruct, LL_DMA_LinkNodeTypeDef *pNode) {
    ...
    if ((DMA_InitNodeStruct->UpdateRegisters & LL_DMA_UPDATE_CTR1) == LL_DMA_UPDATE_CTR1) {
        ...
        pNode->LinkRegisters[reg_counter] =
            (DMA_InitNodeStruct->DestIncMode | DMA_InitNodeStruct->DestDataWidth | DMA_InitNodeStruct->DataAlignment |
             DMA_InitNodeStruct->SrcIncMode | DMA_InitNodeStruct->SrcDataWidth);
        ...
        pNode->LinkRegisters[reg_counter] |=
            (DMA_InitNodeStruct->DestAllocatedPort | DMA_InitNodeStruct->DestHWordExchange |
             DMA_InitNodeStruct->DestByteExchange | ((DMA_InitNodeStruct->DestBurstLength - 1U) << DMA_CTR1_DBL_1_Pos) |
    ...
    if ((DMA_InitNodeStruct->UpdateRegisters & LL_DMA_UPDATE_CTR2) == LL_DMA_UPDATE_CTR2) {
        ...
        pNode->LinkRegisters[reg_counter] =
            (DMA_InitNodeStruct->TransferEventMode | DMA_InitNodeStruct->TriggerPolarity |
             DMA_InitNodeStruct->BlkHWRequest | DMA_InitNodeStruct->Mode | DMA_InitNodeStruct->Direction);
    ...
    if ((DMA_InitNodeStruct->UpdateRegisters & LL_DMA_UPDATE_CBR1) == LL_DMA_UPDATE_CBR1) {
        ...
        if (DMA_InitNodeStruct->NodeType == LL_DMA_GPDMA_2D_NODE) {
            pNode->LinkRegisters[reg_counter] |=
                (DMA_InitNodeStruct->BlkRptDestAddrUpdateMode | DMA_InitNodeStruct->BlkRptSrcAddrUpdateMode |
                 DMA_InitNodeStruct->DestAddrUpdateMode | DMA_InitNodeStruct->SrcAddrUpdateMode |
...
void LL_DMA_ConnectLinkNode(LL_DMA_LinkNodeTypeDef *pPrevLinkNode, uint32_t PrevNodeCLLRIdx,
    ...
    pPrevLinkNode->LinkRegisters[PrevNodeCLLRIdx] =
        (((uint32_t)pNewLinkNode & DMA_CLLR_LA) |
         (pNewLinkNode->LinkRegisters[NewNodeCLLRIdx] & (DMA_CLLR_UT1 | DMA_CLLR_UT2 | DMA_CLLR_UB1 | DMA_CLLR_USA |
