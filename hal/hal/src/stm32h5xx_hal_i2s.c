...
HAL_StatusTypeDef HAL_I2S_Init(I2S_HandleTypeDef *hi2s) {
    ...
    MODIFY_REG(hi2s->Instance->I2SCFGR,
               (SPI_I2SCFGR_I2SMOD | SPI_I2SCFGR_I2SCFG | SPI_I2SCFGR_I2SSTD | SPI_I2SCFGR_PCMSYNC |
                SPI_I2SCFGR_DATLEN | SPI_I2SCFGR_CHLEN | SPI_I2SCFGR_CKPOL | SPI_I2SCFGR_WSINV | SPI_I2SCFGR_DATFMT |
                SPI_I2SCFGR_MCKOE),
               (SPI_I2SCFGR_I2SMOD | hi2s->Init.Mode | hi2s->Init.Standard | hi2s->Init.DataFormat | hi2s->Init.CPOL |
                hi2s->Init.WSInversion | hi2s->Init.Data24BitAlignment | hi2s->Init.MCLKOutput));
...
HAL_StatusTypeDef HAL_I2S_Transmit_DMA(I2S_HandleTypeDef *hi2s, const uint16_t *pData, uint16_t Size) {
    ...
    if ((hi2s->hdmatx->Mode & DMA_LINKEDLIST) == DMA_LINKEDLIST) {
        if (hi2s->hdmatx->LinkedListQueue != NULL) {
            ...
            hi2s->hdmatx->LinkedListQueue->Head->LinkRegisters[NODE_CDAR_DEFAULT_OFFSET] =
...
HAL_StatusTypeDef HAL_I2S_Receive_DMA(I2S_HandleTypeDef *hi2s, uint16_t *pData, uint16_t Size) {
    ...
    if ((hi2s->hdmarx->Mode & DMA_LINKEDLIST) == DMA_LINKEDLIST) {
        if (hi2s->hdmarx->LinkedListQueue != NULL) {
            ...
            /* Set DMA source address */
            hi2s->hdmarx->LinkedListQueue->Head->LinkRegisters[NODE_CSAR_DEFAULT_OFFSET] =
...
HAL_StatusTypeDef HAL_I2S_DMAPause(I2S_HandleTypeDef *hi2s) {
    ...
    if (IS_I2S_MASTER(hi2s->Init.Mode)) {
        ...
        while (HAL_IS_BIT_SET(hi2s->Instance->CR1, SPI_CR1_CSTART) != 0UL) {
            if ((((HAL_GetTick() - tickstart) >= I2S_TIMEOUT) && (I2S_TIMEOUT != HAL_MAX_DELAY)) ||
                (I2S_TIMEOUT == 0U)) {
