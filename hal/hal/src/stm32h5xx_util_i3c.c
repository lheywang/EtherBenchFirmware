    ...
    if ((status == SUCCESS) && (ti3cclk != 0U)) {
        ...
        if (pInputTiming->busType == I3C_PURE_I3C_BUS) {
            ...
            if (((sclhi3c + 1U) * ti3cclk) < ti3ch_min) {
                ...
                sclhi3c =
                    DIV_ROUND_CLOSEST(DIV_ROUND_CLOSEST(ti3c_pp_min * pInputTiming->dutyCycle, ti3cclk), 100U) - 1U;
        ...
        /* I2C SCL high level (mixed bus with I2C) */
            ...
            scllod =
                DIV_ROUND_CLOSEST(DIV_ROUND_CLOSEST(ti2c_od_min * (100U - pInputTiming->dutyCycle), ti3cclk), 100U) -
                1U;
        ...
        if ((scllpp > 0xFFU) || (sclhi3c > 0xFFU) || (scllod > 0xFFU) || (sclhi2c > 0xFFU) || (free > 0xFFU) ||
            (oneus > 0xFFU)) {
