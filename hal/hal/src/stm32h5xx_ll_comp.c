...
#define IS_LL_COMP_INPUT_PLUS(__COMP_INSTANCE__, __INPUT_PLUS__)                                                       \
    (((__INPUT_PLUS__) == LL_COMP_INPUT_PLUS_IO1) || ((__INPUT_PLUS__) == LL_COMP_INPUT_PLUS_IO2) ||                   \
     ((__INPUT_PLUS__) == LL_COMP_INPUT_PLUS_IO3) || ((__INPUT_PLUS__) == LL_COMP_INPUT_PLUS_DAC1_CH1))
...
#define IS_LL_COMP_INPUT_MINUS(__COMP_INSTANCE__, __INPUT_MINUS__)                                                     \
    (((__INPUT_MINUS__) == LL_COMP_INPUT_MINUS_1_4VREFINT) || ((__INPUT_MINUS__) == LL_COMP_INPUT_MINUS_1_2VREFINT) || \
     ((__INPUT_MINUS__) == LL_COMP_INPUT_MINUS_3_4VREFINT) || ((__INPUT_MINUS__) == LL_COMP_INPUT_MINUS_VREFINT) ||    \
     ((__INPUT_MINUS__) == LL_COMP_INPUT_MINUS_DAC1_CH1) || ((__INPUT_MINUS__) == LL_COMP_INPUT_MINUS_IO1) ||          \
     ((__INPUT_MINUS__) == LL_COMP_INPUT_MINUS_IO2) || ((__INPUT_MINUS__) == LL_COMP_INPUT_MINUS_IO3) ||               \
     ((__INPUT_MINUS__) == LL_COMP_INPUT_MINUS_TEMPSENSOR) || ((__INPUT_MINUS__) == LL_COMP_INPUT_MINUS_VBAT))

#define IS_LL_COMP_INPUT_HYSTERESIS(__INPUT_HYSTERESIS__)                                                              \
    (((__INPUT_HYSTERESIS__) == LL_COMP_HYSTERESIS_NONE) || ((__INPUT_HYSTERESIS__) == LL_COMP_HYSTERESIS_LOW) ||      \
     ((__INPUT_HYSTERESIS__) == LL_COMP_HYSTERESIS_MEDIUM) || ((__INPUT_HYSTERESIS__) == LL_COMP_HYSTERESIS_HIGH))
...
ErrorStatus LL_COMP_Init(COMP_TypeDef *COMPx, const LL_COMP_InitTypeDef *COMP_InitStruct) {
    ...
    if (LL_COMP_IsLocked(COMPx) == 0UL) {
        ...
        MODIFY_REG(COMPx->CFGR1,
                   COMP_CFGR1_PWRMODE | COMP_CFGR1_INPSEL1 | COMP_CFGR1_INPSEL2 | COMP_CFGR1_SCALEN | COMP_CFGR1_BRGEN |
                       COMP_CFGR1_INMSEL | COMP_CFGR1_HYST | COMP_CFGR1_POLARITY | COMP_CFGR1_BLANKING,
                   COMP_InitStruct->PowerMode | COMP_InitStruct->InputPlus | COMP_InitStruct->InputMinus |
                       COMP_InitStruct->InputHysteresis | COMP_InitStruct->OutputPolarity |
