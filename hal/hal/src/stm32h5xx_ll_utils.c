...
#define IS_LL_UTILS_APB3_DIV(__VALUE__)                                                                                \
    (((__VALUE__) == LL_RCC_APB3_DIV_1) || ((__VALUE__) == LL_RCC_APB3_DIV_2) || ((__VALUE__) == LL_RCC_APB3_DIV_4) || \
     ((__VALUE__) == LL_RCC_APB3_DIV_8) || ((__VALUE__) == LL_RCC_APB3_DIV_16))
...
#define IS_LL_UTILS_PLLVCO_INPUT(__VALUE__, __RANGE__)                                                                 \
    ((((__RANGE__) == LL_RCC_PLLINPUTRANGE_1_2) && (UTILS_PLLVCO_INPUT_MIN1 <= (__VALUE__)) &&                         \
      ((__VALUE__) <= UTILS_PLLVCO_INPUT_MAX1)) ||                                                                     \
     (((__RANGE__) == LL_RCC_PLLINPUTRANGE_2_4) && (UTILS_PLLVCO_INPUT_MIN2 <= (__VALUE__)) &&                         \
      ((__VALUE__) <= UTILS_PLLVCO_INPUT_MAX2)) ||                                                                     \
     (((__RANGE__) == LL_RCC_PLLINPUTRANGE_4_8) && (UTILS_PLLVCO_INPUT_MIN3 <= (__VALUE__)) &&                         \
      ((__VALUE__) <= UTILS_PLLVCO_INPUT_MAX3)) ||                                                                     \
     (((__RANGE__) == LL_RCC_PLLINPUTRANGE_8_16) && (UTILS_PLLVCO_INPUT_MIN4 <= (__VALUE__)) &&                        \
      ((__VALUE__) <= UTILS_PLLVCO_INPUT_MAX4)))

#define IS_LL_UTILS_PLLVCO_OUTPUT(__VALUE__, __RANGE__)                                                                \
    ((((__RANGE__) == LL_RCC_PLLVCORANGE_MEDIUM) && (UTILS_PLLVCO_MEDIUM_OUTPUT_MIN <= (__VALUE__)) &&                 \
      ((__VALUE__) <= UTILS_PLLVCO_MEDIUM_OUTPUT_MAX)) ||                                                              \
     (((__RANGE__) == LL_RCC_PLLVCORANGE_WIDE) && (UTILS_PLLVCO_WIDE_OUTPUT_MIN <= (__VALUE__)) &&                     \
...
#define IS_LL_UTILS_HSE_BYPASS(__STATE__)                                                                              \
    (((__STATE__) == LL_UTILS_HSEBYPASS_ON) || ((__STATE__) == LL_UTILS_HSEBYPASS_DIGITAL_ON) ||                       \
