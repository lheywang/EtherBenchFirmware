...
typedef struct {
    ...
    uint32_t OffStateIDLEMode; /*!< TIM off state in IDLE mode, This parameter can be a
                                  value of @ref
...
#define TIM_ENCODERMODE_TI12                                                                                           \
    (TIM_SMCR_SMS_1 | TIM_SMCR_SMS_0) /*!< Quadrature encoder mode 3, x4 mode, counts up/down on                       \
...
#define TIM_TRGO2_OC4REF_RISING_OC6REF_FALLING                                                                         \
    (TIM_CR2_MMS2_3 | TIM_CR2_MMS2_2 | TIM_CR2_MMS2_0) /*!< OC4REF rising or OC6REF falling edges generate pulses      \
                                                          on TRGO2 */
