...
typedef struct {
    ...
    FunctionalState InjectedOffsetSaturation; /*!< Define if the offset should be saturated
    ...
    FunctionalState InjectedDiscontinuousConvMode; /*!< Specifies whether the conversions
...
#define IS_ADC_CHANNEL(__HANDLE__, __CHANNEL__)                                                                        \
    (((__CHANNEL__) == ADC_CHANNEL_0) || ((__CHANNEL__) == ADC_CHANNEL_1) || ((__CHANNEL__) == ADC_CHANNEL_2) ||       \
     ...
     ((__CHANNEL__) == ADC_CHANNEL_15) || ((__CHANNEL__) == ADC_CHANNEL_16) || ((__CHANNEL__) == ADC_CHANNEL_17) ||    \
...
#define IS_ADC_DIFF_CHANNEL(__HANDLE__, __CHANNEL__)                                                                   \
    ((((__HANDLE__)->Instance == ADC1)) ? (((__CHANNEL__) == ADC_CHANNEL_1) || ((__CHANNEL__) == ADC_CHANNEL_2) ||     \
...
#define IS_ADC_EXTTRIGINJEC(__INJTRIG__)                                                                               \
    (((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_T1_TRGO) || ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_T1_CC4) ||            \
     ...
     ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_LPTIM1_CH1) || ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_LPTIM2_CH1) ||     \
...
#define IS_ADC_EXTTRIGINJEC(__INJTRIG__)                                                                               \
    (((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_T1_TRGO) || ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_T1_CC4) ||            \
     ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_T2_TRGO) || ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_T2_CC1) ||            \
     ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_T3_CC4) || ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_EXT_IT15) ||           \
     ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_T1_TRGO2) || ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_T3_CC3) ||           \
     ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_T3_TRGO) || ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_T3_CC1) ||            \
     ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_T6_TRGO) || ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_T7_TRGO) ||           \
     ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_LPTIM1_CH1) || ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_LPTIM2_CH1) ||     \
     ((__INJTRIG__) == ADC_INJECTED_SOFTWARE_START))
#endif /* Devices STM32H563/H573xx or STM32H503xx */
...
#define IS_ADC_ANALOG_WATCHDOG_FILTERING_MODE(__FILTERING_MODE__)                                                      \
    (((__FILTERING_MODE__) == ADC_AWD_FILTERING_NONE) || ((__FILTERING_MODE__) == ADC_AWD_FILTERING_2SAMPLES) ||       \
     ((__FILTERING_MODE__) == ADC_AWD_FILTERING_3SAMPLES) || ((__FILTERING_MODE__) == ADC_AWD_FILTERING_4SAMPLES) ||   \
     ((__FILTERING_MODE__) == ADC_AWD_FILTERING_5SAMPLES) || ((__FILTERING_MODE__) == ADC_AWD_FILTERING_6SAMPLES) ||   \
