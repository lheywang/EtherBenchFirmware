 ...
 */
typedef struct {
    uint32_t ClockPrescaler; /*!< Select ADC clock source (synchronous clock derived
    ...
    uint32_t NbrOfConversion; /*!< Specify the number of ranks that will be converted
    ...
    FunctionalState DiscontinuousConvMode; /*!< Specify whether the conversions sequence of
    ...
    uint32_t Overrun; /*!< Select the behavior in case of overrun: data overwritten or
...
typedef struct {
    ...
    uint32_t OffsetSign;              /*!< Define if the offset should be subtracted (negative sign)
...
/**
  ...
  */
typedef struct {
    uint32_t WatchdogNumber; /*!< Select which ADC analog watchdog is monitoring the
...
#endif /* USE_HAL_ADC_REGISTER_CALLBACKS */
{
    ...
    void (*InjectedConvCpltCallback)(struct __ADC_HandleTypeDef *hadc);      /*!< ADC group injected conversion
                                                                                complete callback */
...
#define IS_ADC_EXTTRIG(__REGTRIG__)                                                                                    \
    (((__REGTRIG__) == ADC_EXTERNALTRIG_T1_CC1) || ((__REGTRIG__) == ADC_EXTERNALTRIG_T1_CC2) ||                       \
     ...
     ((__REGTRIG__) == ADC_EXTERNALTRIG_LPTIM2_CH1) || ((__REGTRIG__) == ADC_SOFTWARE_START))
#else
/* Devices STM32H503xx */
#define IS_ADC_EXTTRIG(__REGTRIG__)                                                                                    \
    (((__REGTRIG__) == ADC_EXTERNALTRIG_T1_CC1) || ((__REGTRIG__) == ADC_EXTERNALTRIG_T1_CC2) ||                       \
     ((__REGTRIG__) == ADC_EXTERNALTRIG_T1_CC3) || ((__REGTRIG__) == ADC_EXTERNALTRIG_T2_CC2) ||                       \
     ((__REGTRIG__) == ADC_EXTERNALTRIG_T3_TRGO) || ((__REGTRIG__) == ADC_EXTERNALTRIG_EXT_IT11) ||                    \
     ((__REGTRIG__) == ADC_EXTERNALTRIG_T1_TRGO) || ((__REGTRIG__) == ADC_EXTERNALTRIG_T1_TRGO2) ||                    \
     ((__REGTRIG__) == ADC_EXTERNALTRIG_T2_TRGO) || ((__REGTRIG__) == ADC_EXTERNALTRIG_T6_TRGO) ||                     \
     ((__REGTRIG__) == ADC_EXTERNALTRIG_T3_CC4) || ((__REGTRIG__) == ADC_EXTERNALTRIG_T7_TRGO) ||                      \
     ((__REGTRIG__) == ADC_EXTERNALTRIG_LPTIM1_CH1) || ((__REGTRIG__) == ADC_EXTERNALTRIG_LPTIM2_CH1) ||               \
...
#define IS_ADC_SAMPLINGMODE(__SAMPLINGMODE__)                                                                          \
    (((__SAMPLINGMODE__) == ADC_SAMPLING_MODE_NORMAL) || ((__SAMPLINGMODE__) == ADC_SAMPLING_MODE_BULB) ||             \
...
#define __HAL_ADC_CALC_DIFF_DATA_TO_VOLTAGE(__VREFANALOG_VOLTAGE__, __ADC_DATA__, __ADC_RESOLUTION__)                  \
    __LL_ADC_CALC_DIFF_DATA_TO_VOLTAGE((__VREFANALOG_VOLTAGE__), (__ADC_DATA__), (__ADC_RESOLUTION__))
