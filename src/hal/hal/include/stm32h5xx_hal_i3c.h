...
typedef struct {
    ...
    uint16_t MaxReadDataSize; /*!< Specifies the numbers of data bytes that the target
                                 can read at maximum. This parameter must be a number
                                 between Min_Data=0x00 and Max_Data=0xFFFF */

    uint16_t MaxWriteDataSize; /*!< Specifies the numbers of data bytes that the target
    ...
    uint32_t HandOffActivityState; /*!< Specifies the I3C target activity state when
    ...
    FunctionalState PendingReadMDB; /*!< Specifies the Enable/Disable state of the
...
typedef struct {
    ...
    uint8_t TargetDynamicAddr; /*!< Specifies the dynamic address of the target x (1
                                  to 4) connected on the bus. This parameter must be a
                                  number between Min_Data=0x00 and Max_Data=0x7F */

    FunctionalState IBIAck; /*!< Specifies the Enable/Disable state of the controller's ACK
    ...
    FunctionalState CtrlRoleReqAck; /*!< Specifies the Enable/Disable state of the
...
#define HAL_I3C_ERROR_CE1                                                                                              \
    (I3C_SER_PERR | LL_I3C_CONTROLLER_ERROR_CE1) /*!< Controller detected that transmitted data                        \
...
#define HAL_I3C_ERROR_CE3                                                                                              \
    (I3C_SER_PERR | LL_I3C_CONTROLLER_ERROR_CE3) /*!< Controller detected that new Controller                          \
...
#define HAL_I3C_ALL_COMMON_ITS (uint32_t)(LL_I3C_IER_TXFNFIE | LL_I3C_IER_RXFNEIE | LL_I3C_IER_FCIE | LL_I3C_IER_ERRIE)
/**
 * @}
 */
...
#define HAL_I3C_ALL_TGT_ITS                                                                                            \
    (uint32_t)(LL_I3C_IER_IBIENDIE | LL_I3C_IER_CRUPDIE | LL_I3C_IER_WKPIE | LL_I3C_IER_GETIE | LL_I3C_IER_STAIE |     \
               LL_I3C_IER_DAUPDIE | LL_I3C_IER_MWLUPDIE | LL_I3C_IER_MRLUPDIE | LL_I3C_IER_RSTIE |                     \
               LL_I3C_IER_ASUPDIE | LL_I3C_IER_INTUPDIE | LL_I3C_IER_DEFIE | LL_I3C_IER_GRPIE)
/**
 * @}
 */
...
#define HAL_I3C_ALL_CTRL_ITS                                                                                           \
    (uint32_t)(LL_I3C_IER_CFNFIE | LL_I3C_IER_SFNEIE | LL_I3C_IER_HJIE | LL_I3C_IER_CRIE | LL_I3C_IER_IBIIE |          \
               LL_I3C_IER_RXTGTENDIE)
/**
 * @}
 */
 ...
 */
#if (USE_HAL_I3C_REGISTER_CALLBACKS == 1U)
HAL_StatusTypeDef HAL_I3C_RegisterCallback(I3C_HandleTypeDef *hi3c, HAL_I3C_CallbackIDTypeDef callbackID,
...
HAL_StatusTypeDef HAL_I3C_Tgt_BusCharacteristicConfig(I3C_HandleTypeDef *hi3c, const LL_I3C_TgtBusConfTypeDef *pConfig);
...
HAL_StatusTypeDef HAL_I3C_Ctrl_ConfigBusDevices(I3C_HandleTypeDef *hi3c, const I3C_DeviceConfTypeDef *pDesc,
                                                uint8_t nbDevice);
HAL_StatusTypeDef HAL_I3C_AddDescToFrame(I3C_HandleTypeDef *hi3c, const I3C_CCCTypeDef *pCCCDesc,
                                         const I3C_PrivateTypeDef *pPrivateDesc, I3C_XferTypeDef *pXferData,
...
HAL_StatusTypeDef HAL_I3C_Ctrl_TransmitCCC(I3C_HandleTypeDef *hi3c, I3C_XferTypeDef *pXferData, uint32_t timeout);
HAL_StatusTypeDef HAL_I3C_Ctrl_TransmitCCC_IT(I3C_HandleTypeDef *hi3c, I3C_XferTypeDef *pXferData);
HAL_StatusTypeDef HAL_I3C_Ctrl_TransmitCCC_DMA(I3C_HandleTypeDef *hi3c, I3C_XferTypeDef *pXferData);

/* Controller transmit direct read CCC command APIs */
HAL_StatusTypeDef HAL_I3C_Ctrl_ReceiveCCC(I3C_HandleTypeDef *hi3c, I3C_XferTypeDef *pXferData, uint32_t timeout);
...
HAL_StatusTypeDef HAL_I3C_Ctrl_Transmit(I3C_HandleTypeDef *hi3c, I3C_XferTypeDef *pXferData, uint32_t timeout);
...
HAL_StatusTypeDef HAL_I3C_Ctrl_Receive(I3C_HandleTypeDef *hi3c, I3C_XferTypeDef *pXferData, uint32_t timeout);
...
HAL_StatusTypeDef HAL_I3C_Ctrl_MultipleTransfer_IT(I3C_HandleTypeDef *hi3c, I3C_XferTypeDef *pXferData);
...
HAL_StatusTypeDef HAL_I3C_Ctrl_DynAddrAssign(I3C_HandleTypeDef *hi3c, uint64_t *target_payload, uint32_t dynOption,
                                             uint32_t timeout);
/* Controller check device ready APIs */
HAL_StatusTypeDef HAL_I3C_Ctrl_IsDeviceI3C_Ready(I3C_HandleTypeDef *hi3c, uint8_t devAddress, uint32_t trials,
                                                 uint32_t timeout);
HAL_StatusTypeDef HAL_I3C_Ctrl_IsDeviceI2C_Ready(I3C_HandleTypeDef *hi3c, uint8_t devAddress, uint32_t trials,
                                                 uint32_t timeout);
...
HAL_StatusTypeDef HAL_I3C_Tgt_IBIReq(I3C_HandleTypeDef *hi3c, const uint8_t *pPayload, uint8_t payloadSize,
                                     uint32_t timeout);
...
HAL_StatusTypeDef HAL_I3C_GetCCCInfo(I3C_HandleTypeDef *hi3c, uint32_t notifyId, I3C_CCCInfoTypeDef *pCCCInfo);
HAL_StatusTypeDef HAL_I3C_Get_ENTDAA_Payload_Info(I3C_HandleTypeDef *hi3c, uint64_t ENTDAA_payload,
...
#define IS_I3C_INTERRUPTMASK(__MODE__, __ITMASK__)                                                                     \
    (((__MODE__) == HAL_I3C_MODE_CONTROLLER)                                                                           \
         ? ((((__ITMASK__) & HAL_I3C_ALL_CTRL_ITS) != 0x0U) || (((__ITMASK__) & HAL_I3C_ALL_COMMON_ITS) != 0x0U))      \
         : ((((__ITMASK__) & HAL_I3C_ALL_TGT_ITS) != 0x0U) || (((__ITMASK__) & HAL_I3C_ALL_COMMON_ITS) != 0x0U)))

#define IS_I3C_ENTDAA_OPTION(__OPTION__) (((__OPTION__) == I3C_RSTDAA_THEN_ENTDAA) || ((__OPTION__) == I3C_ONLY_ENTDAA))

#define IS_I3C_SDAHOLDTIME_VALUE(__VALUE__)                                                                            \
    (((__VALUE__) == HAL_I3C_SDA_HOLD_TIME_0_5) || ((__VALUE__) == HAL_I3C_SDA_HOLD_TIME_1_5))

#define IS_I3C_WAITTIME_VALUE(__VALUE__)                                                                               \
    (((__VALUE__) == HAL_I3C_OWN_ACTIVITY_STATE_0) || ((__VALUE__) == HAL_I3C_OWN_ACTIVITY_STATE_1) ||                 \
     ((__VALUE__) == HAL_I3C_OWN_ACTIVITY_STATE_2) || ((__VALUE__) == HAL_I3C_OWN_ACTIVITY_STATE_3))

#define IS_I3C_TXFIFOTHRESHOLD_VALUE(__VALUE__)                                                                        \
    (((__VALUE__) == HAL_I3C_TXFIFO_THRESHOLD_1_4) || ((__VALUE__) == HAL_I3C_TXFIFO_THRESHOLD_4_4))

#define IS_I3C_RXFIFOTHRESHOLD_VALUE(__VALUE__)                                                                        \
    (((__VALUE__) == HAL_I3C_RXFIFO_THRESHOLD_1_4) || ((__VALUE__) == HAL_I3C_RXFIFO_THRESHOLD_4_4))

#define IS_I3C_CONTROLFIFOSTATE_VALUE(__VALUE__)                                                                       \
    (((__VALUE__) == HAL_I3C_CONTROLFIFO_DISABLE) || ((__VALUE__) == HAL_I3C_CONTROLFIFO_ENABLE))

#define IS_I3C_STATUSFIFOSTATE_VALUE(__VALUE__)                                                                        \
    (((__VALUE__) == HAL_I3C_STATUSFIFO_DISABLE) || ((__VALUE__) == HAL_I3C_STATUSFIFO_ENABLE))
...
#define IS_I3C_FUNCTIONALSTATE_VALUE(__VALUE__) (((__VALUE__) == DISABLE) || ((__VALUE__) == ENABLE))

#define IS_I3C_HANDOFFACTIVITYSTATE_VALUE(__VALUE__)                                                                   \
    (((__VALUE__) == HAL_I3C_HANDOFF_ACTIVITY_STATE_0) || ((__VALUE__) == HAL_I3C_HANDOFF_ACTIVITY_STATE_1) ||         \
     ((__VALUE__) == HAL_I3C_HANDOFF_ACTIVITY_STATE_2) || ((__VALUE__) == HAL_I3C_HANDOFF_ACTIVITY_STATE_3))
...
#define IS_I3C_MAXSPEEDDATA_VALUE(__VALUE__)                                                                           \
    (((__VALUE__) == HAL_I3C_GETMXDS_FORMAT_1) || ((__VALUE__) == HAL_I3C_GETMXDS_FORMAT_2_LSB) ||                     \
     ((__VALUE__) == HAL_I3C_GETMXDS_FORMAT_2_MID) || ((__VALUE__) == HAL_I3C_GETMXDS_FORMAT_2_MSB))

#define IS_I3C_IBIPAYLOADSIZE_VALUE(__VALUE__)                                                                         \
    (((__VALUE__) == HAL_I3C_PAYLOAD_EMPTY) || ((__VALUE__) == HAL_I3C_PAYLOAD_1_BYTE) ||                              \
     ((__VALUE__) == HAL_I3C_PAYLOAD_2_BYTES) || ((__VALUE__) == HAL_I3C_PAYLOAD_3_BYTES) ||                           \
...
#define IS_I3C_RESET_PATTERN(__RSTPTRN__)                                                                              \
    (((__RSTPTRN__) == HAL_I3C_RESET_PATTERN_ENABLE) || ((__RSTPTRN__) == HAL_I3C_RESET_PATTERN_DISABLE))
/**
 * @}
 */
