...
typedef struct {
    ...
    uint32_t ContinuousClock; /*!< Enables or disables the FMC clock output to external
    ...
    uint32_t MaxChipSelectPulseTime; /*!< Specifies the maximum chip select pulse time
...
typedef struct {
    ...
    uint32_t CLKDivision; /*!< Defines the period of CLK clock output signal, expressed
 ...
 */
typedef struct {
    uint32_t LoadToActiveDelay; /*!< Defines the delay between a Load Mode Register
    ...
    uint32_t SelfRefreshTime; /*!< Defines the minimum Self Refresh period in number of
    ...
    uint32_t RPDelay; /*!< Defines the delay between a Precharge Command and an other
