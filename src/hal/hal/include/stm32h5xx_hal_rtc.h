...
#define RTC_ALARMSUBSECONDMASK_SS14_3                                                                                  \
    (RTC_ALRMASSR_MASKSS_0 | RTC_ALRMASSR_MASKSS_1) /*!< SS[14:3] not used in Alarm comparison. Only                   \
                                                       SS[2:0] are compared                */
...
#define RTC_ALARMSUBSECONDMASK_SS14_5                                                                                  \
    (RTC_ALRMASSR_MASKSS_0 | RTC_ALRMASSR_MASKSS_2) /*!< SS[14:5] not used in Alarm comparison. Only                   \
                                                       SS[4:0] are compared                */
#define RTC_ALARMSUBSECONDMASK_SS14_6                                                                                  \
    (RTC_ALRMASSR_MASKSS_1 | RTC_ALRMASSR_MASKSS_2) /*!< SS[14:6] not used in Alarm comparison. Only                   \
                                                       SS[5:0] are compared                */
...
#define RTC_ALARMSUBSECONDMASK_SS14_9                                                                                  \
    (RTC_ALRMASSR_MASKSS_0 | RTC_ALRMASSR_MASKSS_3) /*!< SS[14:9] not used in Alarm comparison. Only                   \
                                                       SS[8:0] are compared                */
#define RTC_ALARMSUBSECONDMASK_SS14_10                                                                                 \
    (RTC_ALRMASSR_MASKSS_1 | RTC_ALRMASSR_MASKSS_3) /*!< SS[14:10] not used in Alarm comparison. Only                  \
                                                       SS[9:0] are compared               */
...
#define RTC_ALARMSUBSECONDMASK_SS14_12                                                                                 \
    (RTC_ALRMASSR_MASKSS_2 | RTC_ALRMASSR_MASKSS_3) /*!< SS[14:12] not used in Alarm comparison.Only                   \
...
#define RTC_ALARMSUBSECONDMASK_SS14                                                                                    \
    (RTC_ALRMASSR_MASKSS_1 | RTC_ALRMASSR_MASKSS_2 | RTC_ALRMASSR_MASKSS_3) /*!< SS[14] not used in Alarm comparison.  \
...
#define IS_RTC_ALARM_SUB_SECOND_MASK(MASK)                                                                             \
    (((MASK) == 0UL) || (((MASK) >= RTC_ALARMSUBSECONDMASK_SS14_1) && ((MASK) <= RTC_ALARMSUBSECONDMASK_NONE)))
