...
/**
 * @brief Update SystemCoreClock variable from secure application and return its
 * value when security is implemented in the system (Non-secure callable
 * function).
 *
 * Returns the SystemCoreClock value with current core Clock retrieved from cpu
 * registers.
 */
