...
typedef struct {
    ...
    uint32_t APB3CLKDivider; /*!< The APB3 clock (PCLK3) divider. This clock is derived
                                from the AHB clock (HCLK). This parameter can be a
                                value of @ref RCC_APB1_APB2_APB3_Clock_Source      */
} RCC_ClkInitTypeDef;
...
#define RCC_HSE_BYPASS_DIGITAL                                                                                         \
    ((uint32_t)(RCC_CR_HSEEXT | RCC_CR_HSEBYP | RCC_CR_HSEON)) /*!< External Digital clock source for HSE clock        \
                                                                */
/**
 * @}
 */
...
#define RCC_LSE_BYPASS                                                                                                 \
    ((uint32_t)(RCC_BDCR_LSEBYP | RCC_BDCR_LSEON)) /*!< External Analog clock source for LSE clock                     \
                                                      Bypassed*/
#define RCC_LSE_BYPASS_DIGITAL                                                                                         \
    ((uint32_t)(RCC_BDCR_LSEEXT | RCC_BDCR_LSEBYP | RCC_BDCR_LSEON)) /*!< External Digital clock source for LSE        \
                                                                        clock Bypassed */
/**
 * @}
 */
...
#define RCC_PLL1_VCIRANGE_3                                                                                            \
    (RCC_PLL1CFGR_PLL1RGE_0 | RCC_PLL1CFGR_PLL1RGE_1) /*!< Clock range frequency between 8 and 16 MHz */
/**
 * @}
 */
...
#define RCC_FLAG_LSECSSD                                                                                               \
    ((uint32_t)((RCC_BDCR_REG_INDEX << 5U) | RCC_BDCR_LSECSSD_Pos)) /*!< LSE Clock Security System Interrupt           \
                                                                       flag */
...
#define RCC_FLAG_IWDGRST                                                                                               \
    ((uint32_t)((RCC_RSR_REG_INDEX << 5U) | RCC_RSR_IWDGRSTF_Pos)) /*!< Independent Watchdog reset flag */
#define RCC_FLAG_WWDGRST                                                                                               \
    ((uint32_t)((RCC_RSR_REG_INDEX << 5U) | RCC_RSR_WWDGRSTF_Pos)) /*!< Window watchdog reset flag */
...
#define RCC_RESET_FLAG_ALL                                                                                             \
    (RCC_RESET_FLAG_PIN | RCC_RESET_FLAG_PWR | RCC_RESET_FLAG_SW | RCC_RESET_FLAG_IWDG | RCC_RESET_FLAG_WWDG |         \
     RCC_RESET_FLAG_LPWR)
/**
 * @}
 */
...
#define RCC_ALL                                                                                                        \
    (RCC_HSI | RCC_HSE | RCC_CSI | RCC_LSI | RCC_LSE | RCC_HSI48 | RCC_SYSCLK | RCC_PRESC | RCC_PLL1 | RCC_PLL2 |      \
 ...
 */
#define __HAL_RCC_HSI_DIVIDER_CONFIG(__HSIDIV__) MODIFY_REG(RCC->CR, RCC_CR_HSIDIV, (uint32_t)(__HSIDIV__))
...
#define __HAL_RCC_RTC_CLKPRESCALER(__RTCCLKSource__)                                                                   \
    (((__RTCCLKSource__) & RCC_BDCR_RTCSEL) == RCC_BDCR_RTCSEL)                                                        \
        ? MODIFY_REG(RCC->CFGR1, RCC_CFGR1_RTCPRE, (((__RTCCLKSource__) & 0xFFFFCFFU) >> 4))                           \
 ...
 * @retval None
 */
#define __HAL_RCC_PLL1_VCIRANGE(__PLL1VCIRange__) MODIFY_REG(RCC->PLL1CFGR, RCC_PLL1CFGR_PLL1RGE, (__PLL1VCIRange__))
...
#define __HAL_RCC_GET_FLAG(__FLAG__)                                                                                   \
    (((((((__FLAG__) >> 5U) == 1U)                                                                                     \
            ? RCC->CR                                                                                                  \
            : ((((__FLAG__) >> 5U) == 2U) ? RCC->BDCR : ((((__FLAG__) >> 5U) == 3U) ? RCC->RSR : RCC->CIFR))) &        \
...
#define RCC_OSCILLATORTYPE_ALL                                                                                         \
    (RCC_OSCILLATORTYPE_HSE | RCC_OSCILLATORTYPE_HSI | RCC_OSCILLATORTYPE_HSI48 | RCC_OSCILLATORTYPE_CSI |             \
...
#define IS_RCC_PLL1_SOURCE(SOURCE)                                                                                     \
    (((SOURCE) == RCC_PLL1_SOURCE_CSI) || ((SOURCE) == RCC_PLL1_SOURCE_HSI) || ((SOURCE) == RCC_PLL1_SOURCE_HSE))
...
#define IS_RCC_PLL1_VCIRGE_VALUE(VALUE)                                                                                \
    (((VALUE) == RCC_PLL1_VCIRANGE_0) || ((VALUE) == RCC_PLL1_VCIRANGE_1) || ((VALUE) == RCC_PLL1_VCIRANGE_2) ||       \
...
#define IS_RCC_SYSCLKSOURCE(__SOURCE__)                                                                                \
    (((__SOURCE__) == RCC_SYSCLKSOURCE_CSI) || ((__SOURCE__) == RCC_SYSCLKSOURCE_HSI) ||                               \
...
#define IS_RCC_MCO1SOURCE(SOURCE)                                                                                      \
    (((SOURCE) == RCC_MCO1SOURCE_HSI) || ((SOURCE) == RCC_MCO1SOURCE_LSE) || ((SOURCE) == RCC_MCO1SOURCE_HSE) ||       \
     ((SOURCE) == RCC_MCO1SOURCE_PLL1Q) || ((SOURCE) == RCC_MCO1SOURCE_HSI48))

#define IS_RCC_MCO2SOURCE(SOURCE)                                                                                      \
    (((SOURCE) == RCC_MCO2SOURCE_SYSCLK) || ((SOURCE) == RCC_MCO2SOURCE_PLL2P) || ((SOURCE) == RCC_MCO2SOURCE_HSE) ||  \
     ((SOURCE) == RCC_MCO2SOURCE_PLL1P) || ((SOURCE) == RCC_MCO2SOURCE_CSI) || ((SOURCE) == RCC_MCO2SOURCE_LSI))

#define IS_RCC_MCODIV(DIV)                                                                                             \
    (((DIV) == RCC_MCODIV_1) || ((DIV) == RCC_MCODIV_2) || ((DIV) == RCC_MCODIV_3) || ((DIV) == RCC_MCODIV_4) ||       \
     ((DIV) == RCC_MCODIV_5) || ((DIV) == RCC_MCODIV_6) || ((DIV) == RCC_MCODIV_7) || ((DIV) == RCC_MCODIV_8) ||       \
     ((DIV) == RCC_MCODIV_9) || ((DIV) == RCC_MCODIV_10) || ((DIV) == RCC_MCODIV_11) || ((DIV) == RCC_MCODIV_12) ||    \
...
#define IS_RCC_STOP_WAKEUPCLOCK(__SOURCE__)                                                                            \
    (((__SOURCE__) == RCC_STOP_WAKEUPCLOCK_CSI) || ((__SOURCE__) == RCC_STOP_WAKEUPCLOCK_HSI))

#define IS_RCC_STOP_KERWAKEUPCLOCK(SOURCE)                                                                             \
    (((SOURCE) == RCC_STOP_KERWAKEUPCLOCK_CSI) || ((SOURCE) == RCC_STOP_KERWAKEUPCLOCK_HSI))
...
#define IS_RCC_SINGLE_ITEM_ATTRIBUTES(ITEM)                                                                            \
    (((ITEM) == RCC_HSI) || ((ITEM) == RCC_HSE) || ((ITEM) == RCC_CSI) || ((ITEM) == RCC_LSI) ||                       \
     ((ITEM) == RCC_LSE) || ((ITEM) == RCC_SYSCLK) || ((ITEM) == RCC_PRESC) || ((ITEM) == RCC_PLL1) ||                 \
     ((ITEM) == RCC_PLL2) || ((ITEM) == RCC_PLL3) || ((ITEM) == RCC_HSI48) || ((ITEM) == RCC_RMVF) ||                  \
     ((ITEM) == RCC_CKPERSEL))
#endif /* RCC_SECCFGR_HSISEC */
