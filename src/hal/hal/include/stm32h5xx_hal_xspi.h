 ...
 */
typedef struct {
    uint32_t RWRecoveryTimeCycle; /*!< It indicates the number of cycles for the device
...
#define HAL_XSPI_WRAP_32_BYTES                                                                                         \
    ((uint32_t)(XSPI_DCR2_WRAPSIZE_0 | XSPI_DCR2_WRAPSIZE_1)) /*!< external memory supports wrap size                  \
                                                                 of 32 bytes  */
...
#define HAL_XSPI_WRAP_128_BYTES                                                                                        \
    ((uint32_t)(XSPI_DCR2_WRAPSIZE_0 | XSPI_DCR2_WRAPSIZE_2)) /*!< external memory supports wrap size                  \
                                                                 of 128 bytes */
/**
 * @}
 */
 ...
 * @retval None
 */
#define HAL_XSPI_GET_FLAG(__HANDLE__, __FLAG__) ((READ_BIT((__HANDLE__)->Instance->SR, (__FLAG__)) != 0U) ? SET : RESET)
...
#define IS_XSPI_FIFO_THRESHOLD_BYTE(THRESHOLD)                                                                         \
    (((THRESHOLD) >= 1U) && ((THRESHOLD) <= ((XSPI_CR_FTHRES >> XSPI_CR_FTHRES_Pos) + 1U)))
...
#define IS_XSPI_FREE_RUN_CLK(CLK) (((CLK) == HAL_XSPI_FREERUNCLK_DISABLE) || ((CLK) == HAL_XSPI_FREERUNCLK_ENABLE))
...
#define IS_XSPI_WRAP_SIZE(SIZE)                                                                                        \
    (((SIZE) == HAL_XSPI_WRAP_NOT_SUPPORTED) || ((SIZE) == HAL_XSPI_WRAP_16_BYTES) ||                                  \
     ((SIZE) == HAL_XSPI_WRAP_32_BYTES) || ((SIZE) == HAL_XSPI_WRAP_64_BYTES) || ((SIZE) == HAL_XSPI_WRAP_128_BYTES))
...
#define IS_XSPI_CS_BOUND(SIZE)                                                                                         \
    (((SIZE) == HAL_XSPI_BONDARYOF_NONE) || ((SIZE) == HAL_XSPI_BONDARYOF_16B) ||                                      \
     ...
     ((SIZE) == HAL_XSPI_BONDARYOF_2KB) || ((SIZE) == HAL_XSPI_BONDARYOF_4KB) || ((SIZE) == HAL_XSPI_BONDARYOF_8KB) || \
     ((SIZE) == HAL_XSPI_BONDARYOF_16KB) || ((SIZE) == HAL_XSPI_BONDARYOF_32KB) ||                                     \
     ((SIZE) == HAL_XSPI_BONDARYOF_64KB) || ((SIZE) == HAL_XSPI_BONDARYOF_128KB) ||                                    \
     ((SIZE) == HAL_XSPI_BONDARYOF_256KB) || ((SIZE) == HAL_XSPI_BONDARYOF_512KB) ||                                   \
     ((SIZE) == HAL_XSPI_BONDARYOF_1MB) || ((SIZE) == HAL_XSPI_BONDARYOF_2MB) || ((SIZE) == HAL_XSPI_BONDARYOF_4MB) || \
     ...
     ((SIZE) == HAL_XSPI_BONDARYOF_2GB) || ((SIZE) == HAL_XSPI_BONDARYOF_4GB) || ((SIZE) == HAL_XSPI_BONDARYOF_8GB) || \
...
#define IS_XSPI_DATA_DTR_MODE(MODE) (((MODE) == HAL_XSPI_DATA_DTR_DISABLE) || ((MODE) == HAL_XSPI_DATA_DTR_ENABLE))
