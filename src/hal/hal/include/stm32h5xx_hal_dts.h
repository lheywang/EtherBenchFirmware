...
#define DTS_SMP_TIME_3_CYCLE                                                                                           \
    (DTS_CFGR1_TS1_SMP_TIME_0 | DTS_CFGR1_TS1_SMP_TIME_1) /*!< 3 clock cycle for the sampling time  */
#define DTS_SMP_TIME_4_CYCLE (DTS_CFGR1_TS1_SMP_TIME_2)   /*!< 4 clock cycle for the sampling time  */
#define DTS_SMP_TIME_5_CYCLE                                                                                           \
    (DTS_CFGR1_TS1_SMP_TIME_0 | DTS_CFGR1_TS1_SMP_TIME_2) /*!< 5 clock cycle for the sampling time  */
#define DTS_SMP_TIME_6_CYCLE                                                                                           \
    (DTS_CFGR1_TS1_SMP_TIME_1 | DTS_CFGR1_TS1_SMP_TIME_2) /*!< 6 clock cycle for the sampling time  */
...
#define DTS_SMP_TIME_9_CYCLE                                                                                           \
    (DTS_CFGR1_TS1_SMP_TIME_0 | DTS_CFGR1_TS1_SMP_TIME_3) /*!< 9 clock cycle for the sampling time  */
#define DTS_SMP_TIME_10_CYCLE                                                                                          \
    (DTS_CFGR1_TS1_SMP_TIME_1 | DTS_CFGR1_TS1_SMP_TIME_3) /*!< 10 clock cycle for the sampling time */
#define DTS_SMP_TIME_11_CYCLE                                                                                          \
    (DTS_CFGR1_TS1_SMP_TIME_0 | DTS_CFGR1_TS1_SMP_TIME_1 |                                                             \
     DTS_CFGR1_TS1_SMP_TIME_3) /*!< 11 clock cycle for the sampling time */
#define DTS_SMP_TIME_12_CYCLE                                                                                          \
    (DTS_CFGR1_TS1_SMP_TIME_2 | DTS_CFGR1_TS1_SMP_TIME_3) /*!< 12 clock cycle for the sampling time */
 ...
 * @retval None
 */
#define __HAL_DTS_CLEAR_FLAG(__HANDLE__, __FLAG__) ((__HANDLE__)->Instance->ICIFR = (__FLAG__))
 ...
 * @retval None
 */
#define __HAL_DTS_ENABLE_IT(__HANDLE__, __INTERRUPT__) SET_BIT((__HANDLE__)->Instance->ITENR, __INTERRUPT__)
 ...
 * @retval None
 */
#define __HAL_DTS_DISABLE_IT(__HANDLE__, __INTERRUPT__) CLEAR_BIT((__HANDLE__)->Instance->ITENR, __INTERRUPT__)
...
#if (USE_HAL_DTS_REGISTER_CALLBACKS == 1U)
HAL_StatusTypeDef HAL_DTS_RegisterCallback(DTS_HandleTypeDef *hdts, HAL_DTS_CallbackIDTypeDef CallbackID,
 ...
 * @{
 */
#define IS_DTS_QUICKMEAS(__SEL__) (((__SEL__) == DTS_QUICKMEAS_DISABLE) || ((__SEL__) == DTS_QUICKMEAS_ENABLE))

#define IS_DTS_REFCLK(__SEL__) (((__SEL__) == DTS_REFCLKSEL_LSE) || ((__SEL__) == DTS_REFCLKSEL_PCLK))
#if defined(LPTIM3)
#define IS_DTS_TRIGGERINPUT(__INPUT__)                                                                                 \
    (((__INPUT__) == DTS_TRIGGER_HW_NONE) || ((__INPUT__) == DTS_TRIGGER_LPTIMER1) ||                                  \
     ((__INPUT__) == DTS_TRIGGER_LPTIMER2) || ((__INPUT__) == DTS_TRIGGER_LPTIMER3) ||                                 \
...
#define IS_DTS_SAMPLINGTIME(__CYCLE__)                                                                                 \
    (((__CYCLE__) == DTS_SMP_TIME_1_CYCLE) || ((__CYCLE__) == DTS_SMP_TIME_2_CYCLE) ||                                 \
     ((__CYCLE__) == DTS_SMP_TIME_3_CYCLE) || ((__CYCLE__) == DTS_SMP_TIME_4_CYCLE) ||                                 \
     ((__CYCLE__) == DTS_SMP_TIME_5_CYCLE) || ((__CYCLE__) == DTS_SMP_TIME_6_CYCLE) ||                                 \
     ((__CYCLE__) == DTS_SMP_TIME_7_CYCLE) || ((__CYCLE__) == DTS_SMP_TIME_8_CYCLE) ||                                 \
     ((__CYCLE__) == DTS_SMP_TIME_9_CYCLE) || ((__CYCLE__) == DTS_SMP_TIME_10_CYCLE) ||                                \
     ((__CYCLE__) == DTS_SMP_TIME_11_CYCLE) || ((__CYCLE__) == DTS_SMP_TIME_12_CYCLE) ||                               \
     ((__CYCLE__) == DTS_SMP_TIME_13_CYCLE) || ((__CYCLE__) == DTS_SMP_TIME_14_CYCLE) ||                               \
