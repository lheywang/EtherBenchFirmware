...
typedef struct {
    ...
    uint32_t TimeStampOnTamperDetection; /*!< Specifies the timeStamp on tamper
...
typedef struct {
    ...
    uint32_t MonotonicCounterSecure; /*!< Specifies If the monotonic counter is secure
...
typedef struct {
    ...
    uint32_t MonotonicCounterPrivilege; /*!< Specifies If the monotonic counter is
...
#define RTC_TAMPER_ALL                                                                                                 \
    (RTC_TAMPER_1 | RTC_TAMPER_2 | RTC_TAMPER_3 | RTC_TAMPER_4 | RTC_TAMPER_5 | RTC_TAMPER_6 | RTC_TAMPER_7 |          \
     RTC_TAMPER_8)
#endif /* RTC_TAMP_NB */
/**
 * @}
...
#define RTC_INT_TAMPER_ALL                                                                                             \
    (RTC_INT_TAMPER_1 | RTC_INT_TAMPER_2 | RTC_INT_TAMPER_3 | RTC_INT_TAMPER_4 | RTC_INT_TAMPER_5 | RTC_INT_TAMPER_6 | \
     RTC_INT_TAMPER_7 | RTC_INT_TAMPER_8 | RTC_INT_TAMPER_9 | RTC_INT_TAMPER_11 | RTC_INT_TAMPER_12 |                  \
...
#define RTC_TAMPERSAMPLINGFREQ_RTCCLK_DIV4096                                                                          \
    (TAMP_FLTCR_TAMPFREQ_0 | TAMP_FLTCR_TAMPFREQ_1) /*!< Each of the tamper inputs are sampled with a                  \
...
#define RTC_TAMPERSAMPLINGFREQ_RTCCLK_DIV1024                                                                          \
    (TAMP_FLTCR_TAMPFREQ_0 | TAMP_FLTCR_TAMPFREQ_2) /*!< Each of the tamper inputs are sampled with a                  \
                                                       frequency =  RTCCLK / 1024  */
#define RTC_TAMPERSAMPLINGFREQ_RTCCLK_DIV512                                                                           \
    (TAMP_FLTCR_TAMPFREQ_1 | TAMP_FLTCR_TAMPFREQ_2) /*!< Each of the tamper inputs are sampled with a                  \
                                                       frequency =  RTCCLK / 512   */
#define RTC_TAMPERSAMPLINGFREQ_RTCCLK_DIV256                                                                           \
    (TAMP_FLTCR_TAMPFREQ_0 | TAMP_FLTCR_TAMPFREQ_1 | TAMP_FLTCR_TAMPFREQ_2) /*!< Each of the tamper inputs are sampled \
...
#define RTC_TAMPERPRECHARGEDURATION_8RTCCLK                                                                            \
    (TAMP_FLTCR_TAMPPRCH_0 | TAMP_FLTCR_TAMPPRCH_1) /*!< Tamper pins are pre-charged before sampling                   \
...
#define RTC_IT_TAMP_ALL                                                                                                \
    (RTC_IT_TAMP_1 | RTC_IT_TAMP_2 | RTC_IT_TAMP_3 | RTC_IT_TAMP_4 | RTC_IT_TAMP_5 | RTC_IT_TAMP_6 | RTC_IT_TAMP_7 |   \
     RTC_IT_TAMP_8)
#endif /* RTC_TAMP_NB */
/**
 * @}
...
#define RTC_IT_INT_TAMP_ALL                                                                                            \
    (RTC_IT_INT_TAMP_1 | RTC_IT_INT_TAMP_2 | RTC_IT_INT_TAMP_3 | RTC_IT_INT_TAMP_4 | RTC_IT_INT_TAMP_5 |               \
     RTC_IT_INT_TAMP_6 | RTC_IT_INT_TAMP_7 | RTC_IT_INT_TAMP_8 | RTC_IT_INT_TAMP_9 | RTC_IT_INT_TAMP_11 |              \
     RTC_IT_INT_TAMP_12 | RTC_IT_INT_TAMP_13 | RTC_IT_INT_TAMP_15)
/**
 * @}
 */
...
#define RTC_FLAG_TAMP_ALL                                                                                              \
    (RTC_FLAG_TAMP_1 | RTC_FLAG_TAMP_2 | RTC_FLAG_TAMP_3 | RTC_FLAG_TAMP_4 | RTC_FLAG_TAMP_5 | RTC_FLAG_TAMP_6 |       \
...
#define RTC_FLAG_INT_TAMP_ALL                                                                                          \
    (RTC_FLAG_INT_TAMP_1 | RTC_FLAG_INT_TAMP_2 | RTC_FLAG_INT_TAMP_3 | RTC_FLAG_INT_TAMP_4 | RTC_FLAG_INT_TAMP_5 |     \
     RTC_FLAG_INT_TAMP_6 | RTC_FLAG_INT_TAMP_7 | RTC_FLAG_INT_TAMP_8 | RTC_FLAG_INT_TAMP_9 | RTC_FLAG_INT_TAMP_11 |    \
     RTC_FLAG_INT_TAMP_12 | RTC_FLAG_INT_TAMP_13 | RTC_FLAG_INT_TAMP_15)
/**
 * @}
 */
...
#define RTC_ALARMSUBSECONDBINMASK_SS31                                                                                 \
    (31UL << RTC_ALRMASSR_MASKSS_Pos) /*!< SS[31] is don't care in Alarm comparison.                                   \
...
#define RTC_NONSECURE_FEATURE_ALL                                                                                      \
    (RTC_SECCFGR_INITSEC | RTC_SECCFGR_CALSEC | RTC_SECCFGR_TSSEC | RTC_SECCFGR_WUTSEC | RTC_SECCFGR_ALRASEC |         \
     RTC_SECCFGR_ALRBSEC)
/**
 * @}
 */
...
#define RTC_PRIVILEGE_FEATURE_ALL                                                                                      \
    (RTC_PRIVCFGR_INITPRIV | RTC_PRIVCFGR_CALPRIV | RTC_PRIVCFGR_TSPRIV | RTC_PRIVCFGR_WUTPRIV |                       \
...
#define __HAL_RTC_GET_FLAG(__HANDLE__, __FLAG__)                                                                       \
    (((__FLAG__) == RTC_FLAG_RECALPF) ? (READ_BIT(RTC->ICSR, RTC_ICSR_RECALPF) == RTC_ICSR_RECALPF)                    \
     : ((__FLAG__) == RTC_FLAG_INITF) ? (READ_BIT(RTC->ICSR, RTC_ICSR_INITF) == RTC_ICSR_INITF)                        \
     : ((__FLAG__) == RTC_FLAG_RSF)   ? (READ_BIT(RTC->ICSR, RTC_ICSR_RSF) == RTC_ICSR_RSF)                            \
     : ((__FLAG__) == RTC_FLAG_INITS) ? (READ_BIT(RTC->ICSR, RTC_ICSR_INITS) == RTC_ICSR_INITS)                        \
     : ((__FLAG__) == RTC_FLAG_SHPF)  ? (READ_BIT(RTC->ICSR, RTC_ICSR_SHPF) == RTC_ICSR_SHPF)                          \
     : ((__FLAG__) == RTC_FLAG_WUTWF) ? (READ_BIT(RTC->ICSR, RTC_ICSR_WUTWF) == RTC_ICSR_WUTWF)                        \
     : ((__FLAG__) == RTC_FLAG_SSRUF) ? (READ_BIT(RTC->SR, RTC_SR_SSRUF) == RTC_SR_SSRUF)                              \
     : ((__FLAG__) == RTC_FLAG_ITSF)  ? (READ_BIT(RTC->SR, RTC_SR_ITSF) == RTC_SR_ITSF)                                \
...
#define IS_RTC_TAMPER_TAMPERDETECTIONOUTPUT(MODE)                                                                      \
    (((MODE) == RTC_TAMPERDETECTIONOUTPUT_ENABLE) || ((MODE) == RTC_TAMPERDETECTIONOUTPUT_DISABLE))
#endif /* RTC_CR_TAMPOE */
...
#define IS_RTC_TAMPER(__TAMPER__) ((((__TAMPER__) & RTC_TAMPER_ALL) != 0U) && (((__TAMPER__) & ~RTC_TAMPER_ALL) == 0U))

#define IS_RTC_INTERNAL_TAMPER(__INT_TAMPER__)                                                                         \
    ((((__INT_TAMPER__) & RTC_INT_TAMPER_ALL) != 0U) && (((__INT_TAMPER__) & ~RTC_INT_TAMPER_ALL) == 0U))
...
#define IS_RTC_ATAMPER_FILTER(__FILTER__)                                                                              \
    (((__FILTER__) == RTC_ATAMP_FILTER_ENABLE) || ((__FILTER__) == RTC_ATAMP_FILTER_DISABLE))

#define IS_RTC_ATAMPER_OUTPUT_CHANGE_PERIOD(__PERIOD__) ((__PERIOD__) <= 7U)

#define IS_RTC_ATAMPER_ASYNCPRES_RTCCLK(__PRESCALER__)                                                                 \
    (((__PRESCALER__) == RTC_ATAMP_ASYNCPRES_RTCCLK) || ((__PRESCALER__) == RTC_ATAMP_ASYNCPRES_RTCCLK_2) ||           \
     ((__PRESCALER__) == RTC_ATAMP_ASYNCPRES_RTCCLK_4) || ((__PRESCALER__) == RTC_ATAMP_ASYNCPRES_RTCCLK_8) ||         \
     ((__PRESCALER__) == RTC_ATAMP_ASYNCPRES_RTCCLK_16) || ((__PRESCALER__) == RTC_ATAMP_ASYNCPRES_RTCCLK_32) ||       \
     ((__PRESCALER__) == RTC_ATAMP_ASYNCPRES_RTCCLK_64) || ((__PRESCALER__) == RTC_ATAMP_ASYNCPRES_RTCCLK_128) ||      \
...
#define IS_RTC_SECURE_FULL(__STATE__) (((__STATE__) == RTC_SECURE_FULL_YES) || ((__STATE__) == RTC_SECURE_FULL_NO))

#define IS_RTC_NONSECURE_FEATURES(__FEATURES__) (((__FEATURES__) & ~RTC_NONSECURE_FEATURE_ALL) == 0U)

#define IS_TAMP_SECURE_FULL(__STATE__) (((__STATE__) == TAMP_SECURE_FULL_YES) || ((__STATE__) == TAMP_SECURE_FULL_NO))

#define IS_TAMP_MONOTONIC_CNT_SECURE(__STATE__)                                                                        \
    (((__STATE__) == TAMP_MONOTONIC_CNT_SECURE_YES) || ((__STATE__) == TAMP_MONOTONIC_CNT_SECURE_NO))
...
#define IS_TAMP_MONOTONIC_CNT_PRIVILEGE(__STATE__)                                                                     \
    (((__STATE__) == TAMP_MONOTONIC_CNT_PRIVILEGE_YES) || ((__STATE__) == TAMP_MONOTONIC_CNT_PRIVILEGE_NO))
