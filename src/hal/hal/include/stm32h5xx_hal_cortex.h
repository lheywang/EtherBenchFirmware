...
#define IS_MPU_REGION_NUMBER(NUMBER)                                                                                   \
    (((NUMBER) == MPU_REGION_NUMBER0) || ((NUMBER) == MPU_REGION_NUMBER1) || ((NUMBER) == MPU_REGION_NUMBER2) ||       \
     ...
     ((NUMBER) == MPU_REGION_NUMBER6) || ((NUMBER) == MPU_REGION_NUMBER7) || ((NUMBER) == MPU_REGION_NUMBER8) ||       \
     ((NUMBER) == MPU_REGION_NUMBER9) || ((NUMBER) == MPU_REGION_NUMBER10) || ((NUMBER) == MPU_REGION_NUMBER11))
