...
#define IS_LL_RCC_USART_CLKSOURCE(__VALUE__)                                                                           \
    (((__VALUE__) == LL_RCC_USART1_CLKSOURCE) || ((__VALUE__) == LL_RCC_USART2_CLKSOURCE) ||                           \
     ...
     ((__VALUE__) == LL_RCC_USART10_CLKSOURCE) || ((__VALUE__) == LL_RCC_USART11_CLKSOURCE))
#elif defined(USART6)
#define IS_LL_RCC_USART_CLKSOURCE(__VALUE__)                                                                           \
    (((__VALUE__) == LL_RCC_USART1_CLKSOURCE) || ((__VALUE__) == LL_RCC_USART2_CLKSOURCE) ||                           \
     ((__VALUE__) == LL_RCC_USART3_CLKSOURCE) || ((__VALUE__) == LL_RCC_USART6_CLKSOURCE))
...
#define IS_LL_RCC_UART_CLKSOURCE(__VALUE__)                                                                            \
    (((__VALUE__) == LL_RCC_UART4_CLKSOURCE) || ((__VALUE__) == LL_RCC_UART5_CLKSOURCE) ||                             \
     ...
     ((__VALUE__) == LL_RCC_UART9_CLKSOURCE) || ((__VALUE__) == LL_RCC_UART12_CLKSOURCE))
#elif defined(UART5)
#define IS_LL_RCC_UART_CLKSOURCE(__VALUE__)                                                                            \
    (((__VALUE__) == LL_RCC_UART4_CLKSOURCE) || ((__VALUE__) == LL_RCC_UART5_CLKSOURCE))
#endif /* UART7 */
...
#define IS_LL_RCC_SPI_CLKSOURCE(__VALUE__)                                                                             \
    (((__VALUE__) == LL_RCC_SPI1_CLKSOURCE) || ((__VALUE__) == LL_RCC_SPI2_CLKSOURCE) ||                               \
     ((__VALUE__) == LL_RCC_SPI3_CLKSOURCE) || ((__VALUE__) == LL_RCC_SPI4_CLKSOURCE) ||                               \
...
#define IS_LL_RCC_LPTIM_CLKSOURCE(__VALUE__)                                                                           \
    (((__VALUE__) == LL_RCC_LPTIM1_CLKSOURCE) || ((__VALUE__) == LL_RCC_LPTIM2_CLKSOURCE) ||                           \
     ((__VALUE__) == LL_RCC_LPTIM3_CLKSOURCE) || ((__VALUE__) == LL_RCC_LPTIM4_CLKSOURCE) ||                           \
     ((__VALUE__) == LL_RCC_LPTIM5_CLKSOURCE) || ((__VALUE__) == LL_RCC_LPTIM6_CLKSOURCE))
#else
#define IS_LL_RCC_LPTIM_CLKSOURCE(__VALUE__)                                                                           \
    (((__VALUE__) == LL_RCC_LPTIM1_CLKSOURCE) || ((__VALUE__) == LL_RCC_LPTIM2_CLKSOURCE))
#endif /* LPTIM3 */
...
ErrorStatus LL_RCC_DeInit(void) {
    ...
    SET_BIT(RCC->CICR, RCC_CICR_LSIRDYC | RCC_CICR_LSERDYC | RCC_CICR_HSIRDYC | RCC_CICR_HSERDYC | RCC_CICR_CSIRDYC |
                           RCC_CICR_HSI48RDYC | RCC_CICR_PLL1RDYC | RCC_CICR_PLL2RDYC | RCC_CICR_PLL3RDYC |
                           RCC_CICR_HSECSSC);
#else
    /* Disable all interrupts */
    CLEAR_BIT(RCC->CIER, RCC_CIER_LSIRDYIE | RCC_CIER_LSERDYIE | RCC_CIER_HSIRDYIE | RCC_CIER_HSERDYIE |
    ...
    /* Clear all interrupt flags */
    SET_BIT(RCC->CICR, RCC_CICR_LSIRDYC | RCC_CICR_LSERDYC | RCC_CICR_HSIRDYC | RCC_CICR_HSERDYC | RCC_CICR_CSIRDYC |
                           RCC_CICR_HSI48RDYC | RCC_CICR_PLL1RDYC | RCC_CICR_PLL2RDYC | RCC_CICR_HSECSSC);
#endif /* PLL3 */
    ...
    if (LL_RCC_PLL1_IsReady() != 0U) {
        ...
        if ((pllinputfreq != LL_RCC_PERIPH_FREQUENCY_NO) && (pllm != 0U)) {
            if (LL_RCC_PLL1P_IsEnabled() != 0U) {
                pPLL_Clocks->PLL_P_Frequency =
                    LL_RCC_CalcPLLClockFreq(pllinputfreq, pllm, plln, fracn, LL_RCC_PLL1_GetP());
            }

            if (LL_RCC_PLL1Q_IsEnabled() != 0U) {
                pPLL_Clocks->PLL_Q_Frequency =
                    LL_RCC_CalcPLLClockFreq(pllinputfreq, pllm, plln, fracn, LL_RCC_PLL1_GetQ());
            }

            if (LL_RCC_PLL1R_IsEnabled() != 0U) {
                pPLL_Clocks->PLL_R_Frequency =
                    LL_RCC_CalcPLLClockFreq(pllinputfreq, pllm, plln, fracn, LL_RCC_PLL1_GetR());
            }
        }
    }
}
    ...
    if (LL_RCC_PLL2_IsReady() != 0U) {
        ...
        if ((pllinputfreq != LL_RCC_PERIPH_FREQUENCY_NO) && (pllm != 0U)) {
            if (LL_RCC_PLL2P_IsEnabled() != 0U) {
                pPLL_Clocks->PLL_P_Frequency =
                    LL_RCC_CalcPLLClockFreq(pllinputfreq, pllm, plln, fracn, LL_RCC_PLL2_GetP());
            }

            if (LL_RCC_PLL2Q_IsEnabled() != 0U) {
                pPLL_Clocks->PLL_Q_Frequency =
                    LL_RCC_CalcPLLClockFreq(pllinputfreq, pllm, plln, fracn, LL_RCC_PLL2_GetQ());
            }

            if (LL_RCC_PLL2R_IsEnabled() != 0U) {
                pPLL_Clocks->PLL_R_Frequency =
                    LL_RCC_CalcPLLClockFreq(pllinputfreq, pllm, plln, fracn, LL_RCC_PLL2_GetR());
            }
        }
    }
}
    ...
    if (LL_RCC_PLL3_IsReady() != 0U) {
        ...
        if ((pllinputfreq != LL_RCC_PERIPH_FREQUENCY_NO) && (pllm != 0U)) {
            if (LL_RCC_PLL3P_IsEnabled() != 0U) {
                pPLL_Clocks->PLL_P_Frequency =
                    LL_RCC_CalcPLLClockFreq(pllinputfreq, pllm, plln, fracn, LL_RCC_PLL3_GetP());
            }

            if (LL_RCC_PLL3Q_IsEnabled() != 0U) {
                pPLL_Clocks->PLL_Q_Frequency =
                    LL_RCC_CalcPLLClockFreq(pllinputfreq, pllm, plln, fracn, LL_RCC_PLL3_GetQ());
            }

            if (LL_RCC_PLL3R_IsEnabled() != 0U) {
                pPLL_Clocks->PLL_R_Frequency =
                    LL_RCC_CalcPLLClockFreq(pllinputfreq, pllm, plln, fracn, LL_RCC_PLL3_GetR());
            }
        }
    }
}
...
uint32_t RCC_PLL1_GetFreqSystem(void) {
    ...
    */
    ...
    return __LL_RCC_CALC_PLL1CLK_P_FREQ(pllinputfreq, LL_RCC_PLL1_GetM(), LL_RCC_PLL1_GetN(), LL_RCC_PLL1_GetP());
}
