...
#define IS_SDIO_RAW_FLAG(ReadAfterWrite)                                                                               \
    (((ReadAfterWrite) == HAL_SDIO_WRITE_ONLY) || ((ReadAfterWrite) == HAL_SDIO_READ_AFTER_WRITE))
...
#define IS_SDIO_SUPPORTED_BLOCK_SIZE(SDIO_BLOCKSIZE)                                                                   \
    (((SDIO_BLOCKSIZE) == HAL_SDIO_DATA_BLOCK_SIZE_1BYTE) || ((SDIO_BLOCKSIZE) == HAL_SDIO_DATA_BLOCK_SIZE_2BYTE) ||   \
     ((SDIO_BLOCKSIZE) == HAL_SDIO_DATA_BLOCK_SIZE_4BYTE) || ((SDIO_BLOCKSIZE) == HAL_SDIO_DATA_BLOCK_SIZE_8BYTE) ||   \
     ((SDIO_BLOCKSIZE) == HAL_SDIO_DATA_BLOCK_SIZE_16BYTE) || ((SDIO_BLOCKSIZE) == HAL_SDIO_DATA_BLOCK_SIZE_32BYTE) || \
...
HAL_StatusTypeDef HAL_SDIO_SetSpeedMode(SDIO_HandleTypeDef *hsdio, uint32_t DataRate) {
    ...
    case HAL_SDIOS_DATA_RATE_SDR50:
        ...
        errorstate = SDIO_WriteDirect(
            hsdio,
            ((SDIO_FUNCTION_0 << 2U) | (SDIO_FUNCTION_0 << 1U) | (SDIO_FUNCTION_0 << 14U) | SDMMC_SDIO_CCCR16_SD_BYTE3),
    ...
    case HAL_SDIOS_DATA_RATE_DDR50:
        ...
        errorstate = SDIO_WriteDirect(
            hsdio,
            ((SDIO_FUNCTION_0 << 2) | (SDIO_FUNCTION_0 << 1) | (SDIO_FUNCTION_0 << 14) | SDMMC_SDIO_CCCR16_SD_BYTE3),
            HAL_SDIO_WRITE_ONLY, SDIO_FUNCTION_0, &data);
