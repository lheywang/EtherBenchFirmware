...
HAL_StatusTypeDef HAL_COMP_Init(COMP_HandleTypeDef *hcomp) {
    ...
    if (hcomp == NULL) {
        ...
        /* Set COMP parameters */
        tmp_csr = (hcomp->Init.InputMinus | hcomp->Init.InputPlus | hcomp->Init.BlankingSrce | hcomp->Init.Hysteresis |
        ...
        MODIFY_REG(hcomp->Instance->CFGR1,
                   COMP_CFGR1_PWRMODE | COMP_CFGR1_INMSEL | COMP_CFGR1_INPSEL1 | COMP_CFGR1_INPSEL2 |
                       COMP_CFGR1_POLARITY | COMP_CFGR1_HYST | COMP_CFGR1_BLANKING | COMP_CFGR1_BRGEN |
                       COMP_CFGR1_SCALEN,
                   tmp_csr);
        ...
        if ((READ_BIT(hcomp->Instance->CFGR1, COMP_CFGR1_SCALEN) != 0UL) && (comp_voltage_scaler_initialized != 0UL)) {
