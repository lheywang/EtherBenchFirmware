...
#define OPAMP_CSR_INIT_MASK_PGA                                                                                        \
    (OPAMP_CSR_OPAHSM | OPAMP_CSR_VMSEL | OPAMP_CSR_PGGAIN | OPAMP_CSR_PGGAIN | OPAMP_CSR_VPSEL | OPAMP_CSR_USERTRIM)

#define OPAMP_CSR_INIT_MASK_FOLLOWER (OPAMP_CSR_OPAHSM | OPAMP_CSR_VMSEL | OPAMP_CSR_VPSEL | OPAMP_CSR_USERTRIM)

#define OPAMP_CSR_INIT_MASK_STANDALONE                                                                                 \
    (OPAMP_CSR_OPAHSM | OPAMP_CSR_VMSEL | OPAMP_CSR_VPSEL | OPAMP_CSR_VMSEL | OPAMP_CSR_USERTRIM)
/**
 * @}
 */
    ...
    if (hopamp == NULL) {
        ...
        if (hopamp->Init.Mode == OPAMP_PGA_MODE) {
            MODIFY_REG(hopamp->Instance->CSR, OPAMP_CSR_INIT_MASK_PGA,
                       hopamp->Init.PowerMode | hopamp->Init.Mode | hopamp->Init.PgaGain | hopamp->Init.PgaConnect |
        ...
        if (hopamp->Init.UserTrimming == OPAMP_TRIMMING_USER) {
            ...
            if (hopamp->Init.PowerMode != OPAMP_POWERMODE_HIGHSPEED) {
                ...
                /* normal mode.                                                     */
                updateotrlpotr =
                    (((hopamp->Init.TrimmingValueP) << (OPAMP_INPUT_NONINVERTING)) | (hopamp->Init.TrimmingValueN));
