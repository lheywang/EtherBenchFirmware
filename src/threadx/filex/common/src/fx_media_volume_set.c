...
UINT _fx_media_volume_set(FX_MEDIA *media_ptr, CHAR *volume_name) {
    ...
    if (media_ptr->fx_media_FAT_type == FX_exFAT) {
        ...
        /* If trace is enabled, insert this event into the trace buffer.  */
        FX_TRACE_IN_LINE_INSERT(FX_TRACE_INTERNAL_IO_DRIVER_BOOT_READ, media_ptr, media_ptr->fx_media_memory_buffer, 0,
        ...
        /* If trace is enabled, insert this event into the trace buffer.  */
        FX_TRACE_IN_LINE_INSERT(FX_TRACE_INTERNAL_IO_DRIVER_BOOT_WRITE, media_ptr, media_ptr->fx_media_memory_buffer, 0,
                                0, FX_TRACE_INTERNAL_EVENTS, 0, 0)
        ...
        work_ptr = media_ptr->fx_media_memory_buffer + (UINT)dir_entry.fx_dir_entry_byte_offset;
