...
/*                                                                        */
/**************************************************************************/
UINT _fx_utility_exFAT_system_area_checksum_verify(FX_MEDIA *media_ptr, UCHAR *sector_buffer, ULONG boot_sector_offset,
    ...
    *calculated_checksum = 0;
    ...
    for (temp = 0; temp < media_ptr->fx_media_bytes_per_sector; temp++) {
        ...
        if ((FX_EF_VOLUME_FLAGS == temp) || (FX_EF_VOLUME_FLAGS + 1 == temp) || (FX_EF_PERCENT_IN_USE == temp)) {
        ...
        *calculated_checksum =
            ((*calculated_checksum >> 1) | (*calculated_checksum << 31)) + (ULONG)sector_buffer[temp];
    }
