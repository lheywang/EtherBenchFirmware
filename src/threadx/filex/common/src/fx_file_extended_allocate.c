...
UINT _fx_file_extended_allocate(FX_FILE *file_ptr, ULONG64 size) {
    ...
    FX_TRACE_IN_LINE_INSERT(FX_TRACE_FILE_ALLOCATE, file_ptr, size, file_ptr->fx_file_current_available_size, 0,
    ...
    if (found) {
        ...
        FX_TRACE_EVENT_UPDATE(trace_event, trace_timestamp, FX_TRACE_FILE_ALLOCATE, 0, 0, 0,
