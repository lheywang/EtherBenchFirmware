...
UINT _fxe_media_open(FX_MEDIA *media_ptr, CHAR *media_name, VOID (*media_driver)(FX_MEDIA *), VOID *driver_info_ptr,
    ...
    if ((media_ptr == FX_NULL) || (media_driver == FX_NULL) || (memory_ptr == FX_NULL) ||
    ...
    status = _fx_media_open(media_ptr, media_name, media_driver, driver_info_ptr, memory_ptr, memory_size);
