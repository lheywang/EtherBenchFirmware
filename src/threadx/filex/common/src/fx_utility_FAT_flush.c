...
UINT _fx_utility_FAT_flush(FX_MEDIA *media_ptr) {
    ...
    for (index = 0; index < FX_MAX_FAT_CACHE; index++) {
...
#endif /* FX_ENABLE_EXFAT */
        {
            ...
            FAT_sector =
                (byte_offset / media_ptr->fx_media_bytes_per_sector) + (ULONG)media_ptr->fx_media_reserved_sectors;
            ...
            for (;;) {
                ...
                for (i = index; i < FX_MAX_FAT_CACHE; i++) {
                    ...
                    byte_offset = byte_offset - ((FAT_sector - (ULONG)media_ptr->fx_media_reserved_sectors) *
...
#endif /* FX_ENABLE_EXFAT */
        {
            ...
            /* Read the FAT sector.  */
            status = _fx_utility_logical_sector_read(media_ptr, (ULONG64)FAT_sector, media_ptr->fx_media_memory_buffer,
            ...
            status = _fx_utility_logical_sector_write(media_ptr, (ULONG64)FAT_sector, media_ptr->fx_media_memory_buffer,
                                                      ((ULONG)1), FX_FAT_SECTOR);
