...
/* Defined, this value represents the endpoint buffer owner.
   0 - The default, endpoint buffer is managed by core stack. Each endpoint takes UX_SLAVE_REQUEST_DATA_MAX_LENGTH
   bytes. 1 - Endpoint buffer managed by classes. In this case not all endpoints consume
...
#define UX_TRACE_IN_LINE_INSERT(i, a, b, c, d, f, g, h)                                                                \
    _ux_trace_event_insert((ULONG)i, (ULONG)a, (ULONG)b, (ULONG)c, (ULONG)d, (ULONG)f, g, h);
#define UX_TRACE_EVENT_UPDATE(e, t, i, a, b, c, d)                                                                     \
    _ux_trace_event_update((TX_TRACE_BUFFER_ENTRY *)e, (ULONG)t, (ULONG)i, (ULONG)a, (ULONG)b, (ULONG)c, (ULONG)d);
...
VOID _ux_trace_event_insert(ULONG event_id, ULONG info_field_1, ULONG info_field_2, ULONG info_field_3,
                            ULONG info_field_4, ULONG filter, TX_TRACE_BUFFER_ENTRY **current_event,
                            ULONG *current_timestamp);
VOID _ux_trace_event_update(TX_TRACE_BUFFER_ENTRY *event, ULONG timestamp, ULONG event_id, ULONG info_field_1,
...
#define UX_TRACE_HOST_STACK_CLASS_INSTANCE_CREATE                                                                      \
    (UX_TRACE_HOST_STACK_EVENTS_BASE + 1) /* I1 = class           , I2 = class instance */
#define UX_TRACE_HOST_STACK_CLASS_INSTANCE_DESTROY                                                                     \
    (UX_TRACE_HOST_STACK_EVENTS_BASE + 2) /* I1 = class           , I2 = class instance */
...
#define UX_TRACE_HOST_STACK_DEVICE_ADDRESS_SET                                                                         \
    (UX_TRACE_HOST_STACK_EVENTS_BASE + 8) /* I1 = device          , I2 = device address */
#define UX_TRACE_HOST_STACK_DEVICE_CONFIGURATION_GET                                                                   \
    (UX_TRACE_HOST_STACK_EVENTS_BASE + 9) /* I1 = device          , I2 = configuration */
...
#define UX_TRACE_HOST_STACK_DEVICE_REMOVE                                                                              \
    (UX_TRACE_HOST_STACK_EVENTS_BASE +                                                                                 \
     13) /* I1 = hcd             , I2 = parent          , I3 = port index        , I4 = device               */
...
#define UX_TRACE_HOST_STACK_ENDPOINT_INSTANCE_CREATE                                                                   \
    (UX_TRACE_HOST_STACK_EVENTS_BASE + 15) /* I1 = device          , I2 = endpoint */
#define UX_TRACE_HOST_STACK_ENDPOINT_INSTANCE_DELETE                                                                   \
    (UX_TRACE_HOST_STACK_EVENTS_BASE + 16) /* I1 = device          , I2 = endpoint */
#define UX_TRACE_HOST_STACK_ENDPOINT_RESET                                                                             \
    (UX_TRACE_HOST_STACK_EVENTS_BASE + 17) /* I1 = device          , I2 = endpoint */
...
#define UX_TRACE_HOST_STACK_HCD_REGISTER                                                                               \
    (UX_TRACE_HOST_STACK_EVENTS_BASE + 19) /* I1 = hcd name        , I2 = parameter 1     , I3 = parameter 2 */
#define UX_TRACE_HOST_STACK_INITIALIZE                                                                                 \
    (UX_TRACE_HOST_STACK_EVENTS_BASE +                                                                                 \
     20) /*                                                                                                  */
#define UX_TRACE_HOST_STACK_INTERFACE_ENDPOINT_GET                                                                     \
    (UX_TRACE_HOST_STACK_EVENTS_BASE + 21) /* I1 = interface       , I2 = endpoint index */
...
#define UX_TRACE_HOST_STACK_NEW_CONFIGURATION_CREATE                                                                   \
    (UX_TRACE_HOST_STACK_EVENTS_BASE + 26) /* I1 = device          , I2 = configuration */
#define UX_TRACE_HOST_STACK_NEW_DEVICE_CREATE                                                                          \
    (UX_TRACE_HOST_STACK_EVENTS_BASE +                                                                                 \
     27) /* I1 = hcd             , I2 = device owner    , I3 = port index        , I4 = device               */
#define UX_TRACE_HOST_STACK_NEW_ENDPOINT_CREATE                                                                        \
    (UX_TRACE_HOST_STACK_EVENTS_BASE + 28) /* I1 = interface       , I2 = endpoint */
...
#define UX_TRACE_HOST_STACK_RH_DEVICE_EXTRACTION                                                                       \
    (UX_TRACE_HOST_STACK_EVENTS_BASE + 30) /* I1 = hcd             , I2 = port index */
#define UX_TRACE_HOST_STACK_RH_DEVICE_INSERTION                                                                        \
    (UX_TRACE_HOST_STACK_EVENTS_BASE + 31) /* I1 = hcd             , I2 = port index */
#define UX_TRACE_HOST_STACK_TRANSFER_REQUEST                                                                           \
    (UX_TRACE_HOST_STACK_EVENTS_BASE + 32) /* I1 = device          , I2 = endpoint        , I3 = transfer request */
#define UX_TRACE_HOST_STACK_TRANSFER_REQUEST_ABORT                                                                     \
    (UX_TRACE_HOST_STACK_EVENTS_BASE + 33) /* I1 = device          , I2 = endpoint        , I3 = transfer request */
#define UX_TRACE_HOST_STACK_UNINITIALIZE                                                                               \
    (UX_TRACE_HOST_STACK_EVENTS_BASE +                                                                                 \
     34) /*                                                                                                  */
#define UX_TRACE_HOST_STACK_HCD_UNREGISTER                                                                             \
    (UX_TRACE_HOST_STACK_EVENTS_BASE + 35) /* I1 = hcd name        , I2 = parameter 1     , I3 = parameter 2 */
#define UX_TRACE_HOST_STACK_CLASS_REGISTER                                                                             \
    (UX_TRACE_HOST_STACK_EVENTS_BASE + 36) /* I1 = class name      , I2 = entry function */
...
#define UX_TRACE_HOST_STACK_DEVICE_STRING_GET                                                                          \
    (UX_TRACE_HOST_STACK_EVENTS_BASE +                                                                                 \
     38) /* I1 = device          , I2 = buffer          , I3 = length            , I4 = (langID<<16) | index */
...
#define UX_TRACE_HOST_CLASS_ASIX_READ                                                                                  \
    (UX_TRACE_HOST_CLASS_EVENTS_BASE + 4) /* I1 = class instance  , I2 = data pointer    , I3 = requested length */
#define UX_TRACE_HOST_CLASS_ASIX_WRITE                                                                                 \
    (UX_TRACE_HOST_CLASS_EVENTS_BASE + 5) /* I1 = class instance  , I2 = data pointer    , I3 = requested length */
...
#define UX_TRACE_HOST_CLASS_AUDIO_CONTROL_VALUE_SET                                                                    \
    (UX_TRACE_HOST_CLASS_EVENTS_BASE + 12) /* I1 = class instance  , I2 = audio control */
...
#define UX_TRACE_HOST_CLASS_AUDIO_READ                                                                                 \
    (UX_TRACE_HOST_CLASS_EVENTS_BASE + 14) /* I1 = class instance  , I2 = data pointer    , I3 = requested length */
...
#define UX_TRACE_HOST_CLASS_AUDIO_STREAMING_SAMPLING_SET                                                               \
    (UX_TRACE_HOST_CLASS_EVENTS_BASE + 16) /* I1 = class instance  , I2 = audio sampling */
#define UX_TRACE_HOST_CLASS_AUDIO_WRITE                                                                                \
    (UX_TRACE_HOST_CLASS_EVENTS_BASE + 17) /* I1 = class instance  , I2 = data pointer    , I3 = requested length */
...
#define UX_TRACE_HOST_CLASS_CDC_ACM_IOCTL_SET_LINE_CODING                                                              \
    (UX_TRACE_HOST_CLASS_EVENTS_BASE + 22) /* I1 = class instance  , I2 = parameter */
#define UX_TRACE_HOST_CLASS_CDC_ACM_IOCTL_GET_LINE_CODING                                                              \
    (UX_TRACE_HOST_CLASS_EVENTS_BASE + 23) /* I1 = class instance  , I2 = parameter */
#define UX_TRACE_HOST_CLASS_CDC_ACM_IOCTL_SET_LINE_STATE                                                               \
    (UX_TRACE_HOST_CLASS_EVENTS_BASE + 24) /* I1 = class instance  , I2 = parameter */
#define UX_TRACE_HOST_CLASS_CDC_ACM_IOCTL_SEND_BREAK                                                                   \
    (UX_TRACE_HOST_CLASS_EVENTS_BASE + 25) /* I1 = class instance  , I2 = parameter */
#define UX_TRACE_HOST_CLASS_CDC_ACM_IOCTL_ABORT_IN_PIPE                                                                \
    (UX_TRACE_HOST_CLASS_EVENTS_BASE + 26) /* I1 = class instance  , I2 = endpoint */
...
#define UX_TRACE_HOST_CLASS_CDC_ACM_IOCTL_NOTIFICATION_CALLBACK                                                        \
    (UX_TRACE_HOST_CLASS_EVENTS_BASE + 28) /* I1 = class instance  , I2 = parameter */
#define UX_TRACE_HOST_CLASS_CDC_ACM_IOCTL_GET_DEVICE_STATUS                                                            \
    (UX_TRACE_HOST_CLASS_EVENTS_BASE + 29) /* I1 = class instance  , I2 = device status */
#define UX_TRACE_HOST_CLASS_CDC_ACM_READ                                                                               \
    (UX_TRACE_HOST_CLASS_EVENTS_BASE + 30) /* I1 = class instance  , I2 = data pointer    , I3 = requested length */
...
#define UX_TRACE_HOST_CLASS_CDC_ACM_WRITE                                                                              \
    (UX_TRACE_HOST_CLASS_EVENTS_BASE + 33) /* I1 = class instance  , I2 = data pointer    , I3 = requested length */
...
#define UX_TRACE_HOST_CLASS_CDC_ECM_READ                                                                               \
    (UX_TRACE_HOST_CLASS_EVENTS_BASE + 37) /* I1 = class instance  , I2 = data pointer    , I3 = requested length */
#define UX_TRACE_HOST_CLASS_CDC_ECM_WRITE                                                                              \
    (UX_TRACE_HOST_CLASS_EVENTS_BASE + 38) /* I1 = class instance  , I2 = data pointer    , I3 = requested length */
...
#define UX_TRACE_HOST_CLASS_HID_KEYBOARD_ACTIVATE                                                                      \
    (UX_TRACE_HOST_CLASS_EVENTS_BASE + 45) /* I1 = class instance  , I2 = hid client instance */
#define UX_TRACE_HOST_CLASS_HID_KEYBOARD_DEACTIVATE                                                                    \
    (UX_TRACE_HOST_CLASS_EVENTS_BASE + 46) /* I1 = class instance  , I2 = hid client instance */
#define UX_TRACE_HOST_CLASS_HID_MOUSE_ACTIVATE                                                                         \
    (UX_TRACE_HOST_CLASS_EVENTS_BASE + 47) /* I1 = class instance  , I2 = hid client instance */
#define UX_TRACE_HOST_CLASS_HID_MOUSE_DEACTIVATE                                                                       \
    (UX_TRACE_HOST_CLASS_EVENTS_BASE + 48) /* I1 = class instance  , I2 = hid client instance */
#define UX_TRACE_HOST_CLASS_HID_REMOTE_CONTROL_ACTIVATE                                                                \
    (UX_TRACE_HOST_CLASS_EVENTS_BASE + 49) /* I1 = class instance  , I2 = hid client instance */
#define UX_TRACE_HOST_CLASS_HID_REMOTE_CONTROL_DEACTIVATE                                                              \
    (UX_TRACE_HOST_CLASS_EVENTS_BASE + 50) /* I1 = class instance  , I2 = hid client instance */
#define UX_TRACE_HOST_CLASS_HID_REPORT_GET                                                                             \
    (UX_TRACE_HOST_CLASS_EVENTS_BASE + 51) /* I1 = class instance  , I2 = client report */
#define UX_TRACE_HOST_CLASS_HID_REPORT_SET                                                                             \
    (UX_TRACE_HOST_CLASS_EVENTS_BASE + 52) /* I1 = class instance  , I2 = client report */
#define UX_TRACE_HOST_CLASS_HID_REMOTE_CONTROL_CALLBACK                                                                \
    (UX_TRACE_HOST_CLASS_EVENTS_BASE + 53) /* I1 = client instance , I2 = remote control instance */
...
#define UX_TRACE_HOST_CLASS_HUB_PORT_CHANGE_CONNECTION_PROCESS                                                         \
    (UX_TRACE_HOST_CLASS_EVENTS_BASE + 63) /* I1 = class instance  , I2 = port            , I3 = port status */
#define UX_TRACE_HOST_CLASS_HUB_PORT_CHANGE_ENABLE_PROCESS                                                             \
    (UX_TRACE_HOST_CLASS_EVENTS_BASE + 64) /* I1 = class instance  , I2 = port            , I3 = port status */
#define UX_TRACE_HOST_CLASS_HUB_PORT_CHANGE_OVER_CURRENT_PROCESS                                                       \
    (UX_TRACE_HOST_CLASS_EVENTS_BASE + 65) /* I1 = class instance  , I2 = port            , I3 = port status */
#define UX_TRACE_HOST_CLASS_HUB_PORT_CHANGE_RESET_PROCESS                                                              \
    (UX_TRACE_HOST_CLASS_EVENTS_BASE + 66) /* I1 = class instance  , I2 = port            , I3 = port status */
#define UX_TRACE_HOST_CLASS_HUB_PORT_CHANGE_SUSPEND_PROCESS                                                            \
    (UX_TRACE_HOST_CLASS_EVENTS_BASE + 67) /* I1 = class instance  , I2 = port            , I3 = port status */
...
#define UX_TRACE_HOST_CLASS_PIMA_DEVICE_INFO_GET                                                                       \
    (UX_TRACE_HOST_CLASS_EVENTS_BASE + 72) /* I1 = class instance  , I2 = pima device */
...
#define UX_TRACE_HOST_CLASS_PIMA_NOTIFICATION                                                                          \
    (UX_TRACE_HOST_CLASS_EVENTS_BASE +                                                                                 \
     74) /* I1 = class instance  , I2 = event code      , I3 = transaction ID    , I4 = parameter1           */
...
#define UX_TRACE_HOST_CLASS_PIMA_OBJECT_CLOSE                                                                          \
    (UX_TRACE_HOST_CLASS_EVENTS_BASE + 76) /* I1 = class instance  , I2 = object */
#define UX_TRACE_HOST_CLASS_PIMA_OBJECT_COPY                                                                           \
    (UX_TRACE_HOST_CLASS_EVENTS_BASE + 77) /* I1 = class instance  , I2 = object handle */
#define UX_TRACE_HOST_CLASS_PIMA_OBJECT_DELETE                                                                         \
    (UX_TRACE_HOST_CLASS_EVENTS_BASE + 78) /* I1 = class instance  , I2 = object handle */
#define UX_TRACE_HOST_CLASS_PIMA_OBJECT_GET                                                                            \
    (UX_TRACE_HOST_CLASS_EVENTS_BASE + 79) /* I1 = class instance  , I2 = object handle   , I3 = object */
#define UX_TRACE_HOST_CLASS_PIMA_OBJECT_INFO_GET                                                                       \
    (UX_TRACE_HOST_CLASS_EVENTS_BASE + 80) /* I1 = class instance  , I2 = object handle   , I3 = object */
#define UX_TRACE_HOST_CLASS_PIMA_OBJECT_INFO_SEND                                                                      \
    (UX_TRACE_HOST_CLASS_EVENTS_BASE + 81) /* I1 = class instance  , I2 = object */
#define UX_TRACE_HOST_CLASS_PIMA_OBJECT_MOVE                                                                           \
    (UX_TRACE_HOST_CLASS_EVENTS_BASE + 82) /* I1 = class instance  , I2 = object handle */
#define UX_TRACE_HOST_CLASS_PIMA_OBJECT_SEND                                                                           \
    (UX_TRACE_HOST_CLASS_EVENTS_BASE +                                                                                 \
     83) /* I1 = class instance  , I2 = object          , I3 = object_buffer     , I4 = object length        */
#define UX_TRACE_HOST_CLASS_PIMA_OBJECT_TRANSFER_ABORT                                                                 \
    (UX_TRACE_HOST_CLASS_EVENTS_BASE + 84) /* I1 = class instance  , I2 = object handle   , I3 = object */
#define UX_TRACE_HOST_CLASS_PIMA_READ                                                                                  \
    (UX_TRACE_HOST_CLASS_EVENTS_BASE + 85) /* I1 = class instance  , I2 = data pointer    , I3 = data length */
...
#define UX_TRACE_HOST_CLASS_PIMA_SESSION_CLOSE                                                                         \
    (UX_TRACE_HOST_CLASS_EVENTS_BASE + 87) /* I1 = class instance  , I2 = pima session */
#define UX_TRACE_HOST_CLASS_PIMA_SESSION_OPEN                                                                          \
    (UX_TRACE_HOST_CLASS_EVENTS_BASE + 88) /* I1 = class instance  , I2 = pima session */
#define UX_TRACE_HOST_CLASS_PIMA_STORAGE_IDS_GET                                                                       \
    (UX_TRACE_HOST_CLASS_EVENTS_BASE + 89) /* I1 = class instance  , I2 = storage ID array, I3 = storage ID length */
#define UX_TRACE_HOST_CLASS_PIMA_STORAGE_INFO_GET                                                                      \
    (UX_TRACE_HOST_CLASS_EVENTS_BASE + 90) /* I1 = class instance  , I2 = storage ID      , I3 = storage */
#define UX_TRACE_HOST_CLASS_PIMA_THUMB_GET                                                                             \
    (UX_TRACE_HOST_CLASS_EVENTS_BASE + 91) /* I1 = class instance  , I2 = object handle */
#define UX_TRACE_HOST_CLASS_PIMA_WRITE                                                                                 \
    (UX_TRACE_HOST_CLASS_EVENTS_BASE + 92) /* I1 = class instance  , I2 = data pointer    , I3 = data length */
...
#define UX_TRACE_HOST_CLASS_PRINTER_READ                                                                               \
    (UX_TRACE_HOST_CLASS_EVENTS_BASE + 103) /* I1 = class instance  , I2 = data pointer    , I3 = requested length */
#define UX_TRACE_HOST_CLASS_PRINTER_WRITE                                                                              \
    (UX_TRACE_HOST_CLASS_EVENTS_BASE + 104) /* I1 = class instance  , I2 = data pointer    , I3 = requested length */
...
#define UX_TRACE_HOST_CLASS_PRINTER_STATUS_GET                                                                         \
    (UX_TRACE_HOST_CLASS_EVENTS_BASE + 106) /* I1 = class instance  , I2 = printer status */
#define UX_TRACE_HOST_CLASS_PRINTER_DEVICE_ID_GET                                                                      \
    (UX_TRACE_HOST_CLASS_EVENTS_BASE +                                                                                 \
     107) /* I1 = class instance  , I2 = printer         , I3 = data pointer      , I4 = buffer length        */
...
#define UX_TRACE_HOST_CLASS_PROLIFIC_IOCTL_SET_LINE_CODING                                                             \
    (UX_TRACE_HOST_CLASS_EVENTS_BASE + 112) /* I1 = class instance  , I2 = parameter */
#define UX_TRACE_HOST_CLASS_PROLIFIC_IOCTL_GET_LINE_CODING                                                             \
    (UX_TRACE_HOST_CLASS_EVENTS_BASE + 113) /* I1 = class instance  , I2 = parameter */
#define UX_TRACE_HOST_CLASS_PROLIFIC_IOCTL_SET_LINE_STATE                                                              \
    (UX_TRACE_HOST_CLASS_EVENTS_BASE + 114) /* I1 = class instance  , I2 = parameter */
#define UX_TRACE_HOST_CLASS_PROLIFIC_IOCTL_PURGE                                                                       \
    (UX_TRACE_HOST_CLASS_EVENTS_BASE + 115) /* I1 = class instance  , I2 = parameter */
...
#define UX_TRACE_HOST_CLASS_PROLIFIC_IOCTL_ABORT_IN_PIPE                                                               \
    (UX_TRACE_HOST_CLASS_EVENTS_BASE + 117) /* I1 = class instance  , I2 = endpoint */
...
#define UX_TRACE_HOST_CLASS_PROLIFIC_IOCTL_REPORT_DEVICE_STATUS_CHANGE                                                 \
    (UX_TRACE_HOST_CLASS_EVENTS_BASE + 119) /* I1 = class instance  , I2 = parameter */
#define UX_TRACE_HOST_CLASS_PROLIFIC_IOCTL_GET_DEVICE_STATUS                                                           \
    (UX_TRACE_HOST_CLASS_EVENTS_BASE + 120) /* I1 = class instance  , I2 = device status */
#define UX_TRACE_HOST_CLASS_PROLIFIC_READ                                                                              \
    (UX_TRACE_HOST_CLASS_EVENTS_BASE + 121) /* I1 = class instance  , I2 = data pointer    , I3 = requested length */
...
#define UX_TRACE_HOST_CLASS_PROLIFIC_WRITE                                                                             \
    (UX_TRACE_HOST_CLASS_EVENTS_BASE + 124) /* I1 = class instance  , I2 = data pointer    , I3 = requested length */
...
#define UX_TRACE_HOST_CLASS_STORAGE_MEDIA_MOUNT                                                                        \
    (UX_TRACE_HOST_CLASS_EVENTS_BASE + 134) /* I1 = class instance  , I2 = sector */
#define UX_TRACE_HOST_CLASS_STORAGE_MEDIA_OPEN                                                                         \
    (UX_TRACE_HOST_CLASS_EVENTS_BASE + 135) /* I1 = class instance  , I2 = media */
...
#define UX_TRACE_HOST_CLASS_STORAGE_MEDIA_WRITE                                                                        \
    (UX_TRACE_HOST_CLASS_EVENTS_BASE +                                                                                 \
     137) /* I1 = class instance  , I2 = sector start    , I3 = sector count      , I4 = data pointer         */
...
#define UX_TRACE_HOST_CLASS_STORAGE_START_STOP                                                                         \
    (UX_TRACE_HOST_CLASS_EVENTS_BASE + 139) /* I1 = class instance  , I2 = start stop signal */
...
#define UX_TRACE_HOST_CLASS_DPUMP_READ                                                                                 \
    (UX_TRACE_HOST_CLASS_EVENTS_BASE + 152) /* I1 = class instance  , I2 = data pointer    , I3 = requested length */
#define UX_TRACE_HOST_CLASS_DPUMP_WRITE                                                                                \
    (UX_TRACE_HOST_CLASS_EVENTS_BASE + 153) /* I1 = class instance  , I2 = data pointer    , I3 = requested length */
...
#define UX_TRACE_HOST_CLASS_SWAR_IOCTL_ABORT_IN_PIPE                                                                   \
    (UX_TRACE_HOST_CLASS_EVENTS_BASE + 162) /* I1 = class instance  , I2 = endpoint */
#define UX_TRACE_HOST_CLASS_SWAR_IOCTL_ABORT_OUT_PIPE                                                                  \
    (UX_TRACE_HOST_CLASS_EVENTS_BASE + 163) /* I1 = class instance  , I2 = endpointr */
#define UX_TRACE_HOST_CLASS_SWAR_READ                                                                                  \
    (UX_TRACE_HOST_CLASS_EVENTS_BASE + 164) /* I1 = class instance  , I2 = data pointer    , I3 = requested length */
...
#define UX_TRACE_HOST_CLASS_SWAR_WRITE                                                                                 \
    (UX_TRACE_HOST_CLASS_EVENTS_BASE + 167) /* I1 = class instance  , I2 = data pointer    , I3 = requested length */
...
#define UX_TRACE_HOST_CLASS_GSER_IOCTL_SET_LINE_CODING                                                                 \
    (UX_TRACE_HOST_CLASS_EVENTS_BASE + 172) /* I1 = class instance  , I2 = parameter */
#define UX_TRACE_HOST_CLASS_GSER_IOCTL_GET_LINE_CODING                                                                 \
    (UX_TRACE_HOST_CLASS_EVENTS_BASE + 173) /* I1 = class instance  , I2 = parameter */
#define UX_TRACE_HOST_CLASS_GSER_IOCTL_SET_LINE_STATE                                                                  \
    (UX_TRACE_HOST_CLASS_EVENTS_BASE + 174) /* I1 = class instance  , I2 = parameter */
#define UX_TRACE_HOST_CLASS_GSER_IOCTL_PURGE                                                                           \
    (UX_TRACE_HOST_CLASS_EVENTS_BASE + 175) /* I1 = class instance  , I2 = parameter */
...
#define UX_TRACE_HOST_CLASS_GSER_IOCTL_ABORT_IN_PIPE                                                                   \
    (UX_TRACE_HOST_CLASS_EVENTS_BASE + 177) /* I1 = class instance  , I2 = endpoint */
...
#define UX_TRACE_HOST_CLASS_GSER_IOCTL_REPORT_DEVICE_STATUS_CHANGE                                                     \
    (UX_TRACE_HOST_CLASS_EVENTS_BASE + 179) /* I1 = class instance  , I2 = parameter */
#define UX_TRACE_HOST_CLASS_GSER_IOCTL_GET_DEVICE_STATUS                                                               \
    (UX_TRACE_HOST_CLASS_EVENTS_BASE + 180) /* I1 = class instance  , I2 = device status */
#define UX_TRACE_HOST_CLASS_GSER_IOCTL_NOTIFICATION_CALLBACK                                                           \
    (UX_TRACE_HOST_CLASS_EVENTS_BASE + 181) /* I1 = class instance  , I2 = data pointer    , I3 = requested length */
#define UX_TRACE_HOST_CLASS_GSER_READ                                                                                  \
    (UX_TRACE_HOST_CLASS_EVENTS_BASE + 182) /* I1 = class instance  , I2 = data pointer    , I3 = requested length */
...
#define UX_TRACE_HOST_CLASS_GSER_WRITE                                                                                 \
    (UX_TRACE_HOST_CLASS_EVENTS_BASE + 185) /* I1 = class instance  , I2 = data pointer    , I3 = requested length */
...
#define UX_TRACE_DEVICE_STACK_ALTERNATE_SETTING_SET                                                                    \
    (UX_TRACE_DEVICE_STACK_EVENTS_BASE + 2) /* I1 = interface value , I2 = alternate setting value */
#define UX_TRACE_DEVICE_STACK_CLASS_REGISTER                                                                           \
    (UX_TRACE_DEVICE_STACK_EVENTS_BASE + 3) /* I1 = class name      , I2 = interface number, I3 = parameter */
#define UX_TRACE_DEVICE_STACK_CLEAR_FEATURE                                                                            \
    (UX_TRACE_DEVICE_STACK_EVENTS_BASE + 4) /* I1 = request type    , I2 = request value   , I3 = request index */
...
#define UX_TRACE_DEVICE_STACK_DESCRIPTOR_SEND                                                                          \
    (UX_TRACE_DEVICE_STACK_EVENTS_BASE + 8) /* I1 = descriptor type , I2 = request index */
...
#define UX_TRACE_DEVICE_STACK_GET_STATUS                                                                               \
    (UX_TRACE_DEVICE_STACK_EVENTS_BASE + 11) /* I1 = request type    , I2 = request value   , I3 = request index */
...
#define UX_TRACE_DEVICE_STACK_SET_FEATURE                                                                              \
    (UX_TRACE_DEVICE_STACK_EVENTS_BASE + 17) /* I1 = request value   , I2 = request index */
#define UX_TRACE_DEVICE_STACK_TRANSFER_ABORT                                                                           \
    (UX_TRACE_DEVICE_STACK_EVENTS_BASE + 18) /* I1 = transfer request, I2 = completion code */
#define UX_TRACE_DEVICE_STACK_TRANSFER_ALL_REQUEST_ABORT                                                               \
    (UX_TRACE_DEVICE_STACK_EVENTS_BASE + 19) /* I1 = endpoint        , I2 = completion code */
...
#define UX_TRACE_DEVICE_CLASS_DPUMP_READ                                                                               \
    (UX_TRACE_DEVICE_CLASS_EVENTS_BASE + 3) /* I1 = class instance  , I2 = buffer          , I3 = requested_length */
#define UX_TRACE_DEVICE_CLASS_DPUMP_WRITE                                                                              \
    (UX_TRACE_DEVICE_CLASS_EVENTS_BASE + 4) /* I1 = class instance  , I2 = buffer          , I3 = requested_length */
#define UX_TRACE_DEVICE_CLASS_DPUMP_CHANGE                                                                             \
    (UX_TRACE_DEVICE_CLASS_EVENTS_BASE + 5) /* I1 = class instance  , I2 = buffer          , I3 = requested_length */
...
#define UX_TRACE_DEVICE_CLASS_CDC_ACM_READ                                                                             \
    (UX_TRACE_DEVICE_CLASS_EVENTS_BASE + 12) /* I1 = class instance  , I2 = buffer          , I3 = requested_length */
#define UX_TRACE_DEVICE_CLASS_CDC_ACM_WRITE                                                                            \
    (UX_TRACE_DEVICE_CLASS_EVENTS_BASE + 13) /* I1 = class instance  , I2 = buffer          , I3 = requested_length */
...
#define UX_TRACE_DEVICE_CLASS_HID_EVENT_GET                                                                            \
    (UX_TRACE_DEVICE_CLASS_EVENTS_BASE + 22) /* I1 = class instance  , I2 = hid event */
#define UX_TRACE_DEVICE_CLASS_HID_EVENT_SET                                                                            \
    (UX_TRACE_DEVICE_CLASS_EVENTS_BASE + 23) /* I1 = class instance  , I2 = hid event */
#define UX_TRACE_DEVICE_CLASS_HID_REPORT_GET                                                                           \
    (UX_TRACE_DEVICE_CLASS_EVENTS_BASE + 24) /* I1 = class instance  , I2 = descriptor type , I3 = request index */
#define UX_TRACE_DEVICE_CLASS_HID_REPORT_SET                                                                           \
    (UX_TRACE_DEVICE_CLASS_EVENTS_BASE + 25) /* I1 = class instance  , I2 = descriptor type , I3 = request index */
#define UX_TRACE_DEVICE_CLASS_HID_DESCRIPTOR_SEND                                                                      \
    (UX_TRACE_DEVICE_CLASS_EVENTS_BASE + 26) /* I1 = class instance  , I2 = descriptor type , I3 = request index */
#define UX_TRACE_DEVICE_CLASS_HID_READ                                                                                 \
    (UX_TRACE_DEVICE_CLASS_EVENTS_BASE + 27) /* I1 = class instance  , I2 = buffer          , I3 = requested_length */
#define UX_TRACE_DEVICE_CLASS_HID_RECEIVER_EVENT_GET                                                                   \
    (UX_TRACE_DEVICE_CLASS_EVENTS_BASE + 28) /* I1 = class instance  , I2 = receiver event  , I3 = wait_option */
#define UX_TRACE_DEVICE_CLASS_HID_RECEIVER_EVENT_FREE                                                                  \
    (UX_TRACE_DEVICE_CLASS_EVENTS_BASE + 29) /* I1 = class instance  , I2 = receiver event */
...
#define UX_TRACE_DEVICE_CLASS_PIMA_EVENT_GET                                                                           \
    (UX_TRACE_DEVICE_CLASS_EVENTS_BASE + 33) /* I1 = class instance  , I2 = pima event */
#define UX_TRACE_DEVICE_CLASS_PIMA_EVENT_SET                                                                           \
    (UX_TRACE_DEVICE_CLASS_EVENTS_BASE + 34) /* I1 = class instance  , I2 = pima event */
#define UX_TRACE_DEVICE_CLASS_PIMA_OBJECT_ADD                                                                          \
    (UX_TRACE_DEVICE_CLASS_EVENTS_BASE + 35) /* I1 = class instance  , I2 = object handle */
#define UX_TRACE_DEVICE_CLASS_PIMA_OBJECT_DATA_GET                                                                     \
    (UX_TRACE_DEVICE_CLASS_EVENTS_BASE + 36) /* I1 = class instance  , I2 = object handle */
#define UX_TRACE_DEVICE_CLASS_PIMA_OBJECT_DATA_SEND                                                                    \
    (UX_TRACE_DEVICE_CLASS_EVENTS_BASE + 37) /* I1 = class instance  , I2 = object handle */
#define UX_TRACE_DEVICE_CLASS_PIMA_OBJECT_DELETE                                                                       \
    (UX_TRACE_DEVICE_CLASS_EVENTS_BASE + 38) /* I1 = class instance  , I2 = object handle */
#define UX_TRACE_DEVICE_CLASS_PIMA_OBJECT_HANDLES_SEND                                                                 \
    (UX_TRACE_DEVICE_CLASS_EVENTS_BASE +                                                                               \
     39) /* I1 = class instance  , I2 = storage id      , I3 = object format code, I4 = object association   */
#define UX_TRACE_DEVICE_CLASS_PIMA_OBJECT_INFO_GET                                                                     \
    (UX_TRACE_DEVICE_CLASS_EVENTS_BASE + 40) /* I1 = class instance  , I2 = object handle */
...
#define UX_TRACE_DEVICE_CLASS_PIMA_OBJECTS_NUMBER_SEND                                                                 \
    (UX_TRACE_DEVICE_CLASS_EVENTS_BASE +                                                                               \
     42) /* I1 = class instance  , I2 = storage id      , I3 = object format code, I4 = object association   */
#define UX_TRACE_DEVICE_CLASS_PIMA_PARTIAL_OBJECT_DATA_GET                                                             \
    (UX_TRACE_DEVICE_CLASS_EVENTS_BASE +                                                                               \
     43) /* I1 = class instance  , I2 = object handle   , I3 = offset requested  , I4 = length requested     */
#define UX_TRACE_DEVICE_CLASS_PIMA_RESPONSE_SEND                                                                       \
    (UX_TRACE_DEVICE_CLASS_EVENTS_BASE +                                                                               \
     44) /* I1 = class instance  , I2 = response code   , I3 = number parameter  , I4 = pima parameter 1     */
...
#define UX_TRACE_DEVICE_CLASS_RNDIS_MSG_QUERY                                                                          \
    (UX_TRACE_DEVICE_CLASS_EVENTS_BASE + 64) /* I1 = class instance  , I2 = rndis OID */
...
#define UX_TRACE_DEVICE_CLASS_RNDIS_MSG_SET                                                                            \
    (UX_TRACE_DEVICE_CLASS_EVENTS_BASE + 67) /* I1 = class instance  , I2 = rndis OID */
...
#define UX_TRACE_DEVICE_CLASS_STORAGE_READ                                                                             \
    (UX_TRACE_DEVICE_CLASS_EVENTS_BASE +                                                                               \
     77) /* I1 = class instance  , I2 = lun             , I3 = sector              , I4 = number sectors     */
...
#define UX_TRACE_DEVICE_CLASS_STORAGE_REQUEST_SENSE                                                                    \
    (UX_TRACE_DEVICE_CLASS_EVENTS_BASE +                                                                               \
     81) /* I1 = class instance  , I2 = lun             , I3 = sense key           , I4 = code               */
...
#define UX_TRACE_DEVICE_CLASS_STORAGE_WRITE                                                                            \
    (UX_TRACE_DEVICE_CLASS_EVENTS_BASE +                                                                               \
     85) /* I1 = class instance  , I2 = lun             , I3 = sector              , I4 = number sectors     */
...
#define UX_TRACE_DEVICE_CLASS_STORAGE_SYNCHRONIZE_CACHE                                                                \
    (UX_TRACE_DEVICE_CLASS_EVENTS_BASE +                                                                               \
     87) /* I1 = class instance  , I2 = lun             , I3 = sector              , I4 = number sectors     */
...
#define UX_TRACE_DEVICE_CLASS_CDC_ECM_READ                                                                             \
    (UX_TRACE_DEVICE_CLASS_EVENTS_BASE + 93) /* I1 = class instance  , I2 = buffer          , I3 = requested_length */
#define UX_TRACE_DEVICE_CLASS_CDC_ECM_WRITE                                                                            \
    (UX_TRACE_DEVICE_CLASS_EVENTS_BASE + 94) /* I1 = class instance  , I2 = buffer          , I3 = requested_length */
#define UX_TRACE_DEVICE_CLASS_CDC_ECM_PACKET_TRANSMIT                                                                  \
    (UX_TRACE_DEVICE_CLASS_EVENTS_BASE + 95) /* I1 = class instance  , I2 = buffer          , I3 = requested_length */
#define UX_TRACE_DEVICE_CLASS_CDC_ECM_PACKET_RECEIVE                                                                   \
    (UX_TRACE_DEVICE_CLASS_EVENTS_BASE + 96) /* I1 = class instance  , I2 = buffer          , I3 = requested_length */
...
#define UX_TRACE_DEVICE_CLASS_CCID_REQ_ABORT                                                                           \
    (UX_TRACE_DEVICE_CLASS_EVENTS_BASE + 112) /* I1 = class instance  , I2 = slot */
#define UX_TRACE_DEVICE_CLASS_CCID_PC_TO_RDR_ICC_POWER_ON                                                              \
    (UX_TRACE_DEVICE_CLASS_EVENTS_BASE + 113) /* I1 = class instance  , I2 = slot */
#define UX_TRACE_DEVICE_CLASS_CCID_PC_TO_RDR_ICC_POWER_OFF                                                             \
    (UX_TRACE_DEVICE_CLASS_EVENTS_BASE + 114) /* I1 = class instance  , I2 = slot */
#define UX_TRACE_DEVICE_CLASS_CCID_PC_TO_RDR_GET_SLOT_STATUS                                                           \
    (UX_TRACE_DEVICE_CLASS_EVENTS_BASE + 115) /* I1 = class instance  , I2 = slot */
#define UX_TRACE_DEVICE_CLASS_CCID_PC_TO_RDR_XFR_BLOCK                                                                 \
    (UX_TRACE_DEVICE_CLASS_EVENTS_BASE + 116) /* I1 = class instance  , I2 = slot */
#define UX_TRACE_DEVICE_CLASS_CCID_PC_TO_RDR_GET_PARAMETERS                                                            \
    (UX_TRACE_DEVICE_CLASS_EVENTS_BASE + 117) /* I1 = class instance  , I2 = slot */
#define UX_TRACE_DEVICE_CLASS_CCID_PC_TO_RDR_RESET_PARAMETERS                                                          \
    (UX_TRACE_DEVICE_CLASS_EVENTS_BASE + 118) /* I1 = class instance  , I2 = slot */
#define UX_TRACE_DEVICE_CLASS_CCID_PC_TO_RDR_SET_PARAMETERS                                                            \
    (UX_TRACE_DEVICE_CLASS_EVENTS_BASE + 119) /* I1 = class instance  , I2 = slot */
#define UX_TRACE_DEVICE_CLASS_CCID_PC_TO_RDR_ESCAPE                                                                    \
    (UX_TRACE_DEVICE_CLASS_EVENTS_BASE + 120) /* I1 = class instance  , I2 = slot */
#define UX_TRACE_DEVICE_CLASS_CCID_PC_TO_RDR_ICC_CLOCK                                                                 \
    (UX_TRACE_DEVICE_CLASS_EVENTS_BASE + 121) /* I1 = class instance  , I2 = slot */
#define UX_TRACE_DEVICE_CLASS_CCID_PC_TO_RDR_T0_APDU                                                                   \
    (UX_TRACE_DEVICE_CLASS_EVENTS_BASE + 122) /* I1 = class instance  , I2 = slot */
#define UX_TRACE_DEVICE_CLASS_CCID_PC_TO_RDR_SECURE                                                                    \
    (UX_TRACE_DEVICE_CLASS_EVENTS_BASE + 123) /* I1 = class instance  , I2 = slot */
#define UX_TRACE_DEVICE_CLASS_CCID_PC_TO_RDR_MECHANICAL                                                                \
    (UX_TRACE_DEVICE_CLASS_EVENTS_BASE + 124) /* I1 = class instance  , I2 = slot */
#define UX_TRACE_DEVICE_CLASS_CCID_PC_TO_RDR_ABORT                                                                     \
    (UX_TRACE_DEVICE_CLASS_EVENTS_BASE + 125) /* I1 = class instance  , I2 = slot */
#define UX_TRACE_DEVICE_CLASS_CCID_PC_TO_RDR_SET_RATE_CLOCK                                                            \
    (UX_TRACE_DEVICE_CLASS_EVENTS_BASE + 126) /* I1 = class instance  , I2 = slot */
#define UX_TRACE_DEVICE_CLASS_CCID_RDR_TO_PC_RESPONSE                                                                  \
    (UX_TRACE_DEVICE_CLASS_EVENTS_BASE + 127) /* I1 = class instance  , I2 = slot */
#define UX_TRACE_DEVICE_CLASS_CCID_ICC_INSERT                                                                          \
    (UX_TRACE_DEVICE_CLASS_EVENTS_BASE + 128) /* I1 = class instance  , I2 = slot */
#define UX_TRACE_DEVICE_CLASS_CCID_ICC_REMOVE                                                                          \
    (UX_TRACE_DEVICE_CLASS_EVENTS_BASE + 129) /* I1 = class instance  , I2 = slot */
#define UX_TRACE_DEVICE_CLASS_CCID_AUTO_SEQ_START                                                                      \
    (UX_TRACE_DEVICE_CLASS_EVENTS_BASE + 130) /* I1 = class instance  , I2 = slot */
#define UX_TRACE_DEVICE_CLASS_CCID_AUTO_SEQ_STOP                                                                       \
    (UX_TRACE_DEVICE_CLASS_EVENTS_BASE + 131) /* I1 = class instance  , I2 = slot */
#define UX_TRACE_DEVICE_CLASS_CCID_TIME_EXTENSION                                                                      \
    (UX_TRACE_DEVICE_CLASS_EVENTS_BASE + 132) /* I1 = class instance  , I2 = slot            , I3 = time */
#define UX_TRACE_DEVICE_CLASS_CCID_HARDWARE_ERROR                                                                      \
    (UX_TRACE_DEVICE_CLASS_EVENTS_BASE + 133) /* I1 = class instance  , I2 = slot */
...
UINT ux_host_stack_device_string_get(UX_DEVICE *device, UCHAR *descriptor_buffer, ULONG length, ULONG language_id,
                                     ULONG string_index);
UINT ux_host_stack_endpoint_transfer_abort(UX_ENDPOINT *endpoint);
UINT ux_host_stack_hcd_register(UCHAR *hcd_name, UINT (*hcd_initialize_function)(struct UX_HCD_STRUCT *),
...
UINT ux_device_stack_initialize(UCHAR *device_framework_high_speed, ULONG device_framework_length_high_speed,
                                ...
                                UCHAR *string_framework, ULONG string_framework_length, UCHAR *language_id_framework,
