...
UINT _ux_device_stack_alternate_setting_set(ULONG interface_value, ULONG alternate_setting_value) {
    ...
    UX_TRACE_IN_LINE_INSERT(UX_TRACE_DEVICE_STACK_ALTERNATE_SETTING_SET, interface_value, alternate_setting_value, 0, 0,
    ...
    while (device_framework_length != 0) {
        ...
        if (descriptor_type == UX_CONFIGURATION_DESCRIPTOR_ITEM) {
            ...
            _ux_utility_descriptor_parse(device_framework, _ux_system_configuration_descriptor_structure,
                        ...
                        if (interface_descriptor.bInterfaceNumber == interface_value &&
                            ...
                            while (device_framework_length != 0) {
                                ...
                                case UX_ENDPOINT_DESCRIPTOR_ITEM:
                                    ...
                                    max_transfer_length =
                                        endpoint->ux_slave_endpoint_descriptor.wMaxPacketSize & UX_MAX_PACKET_SIZE_MASK;
                                ...
                                case UX_INTERFACE_DESCRIPTOR_ITEM:
                                    ...
                                    /* We have found a new configuration or interface descriptor, this is the end of the
                                       current interface. The search for the endpoints must be terminated as if it was
                                       the end of the entire descriptor.  */
                            ...
                            /* The interface descriptor in the current class must be changed to the new alternate
                             * setting.  */
                            _ux_utility_memory_copy(
                                &interface_ptr->ux_slave_interface_descriptor, &interface_descriptor,
                                sizeof(UX_INTERFACE_DESCRIPTOR)); /* Use case of memcpy is verified. */

                            /* Get the class for the interface.  */
                            class_ptr = _ux_system_slave->ux_system_slave_interface_class_array
                            ...
                            /* We have found a potential candidate. Call this registered class entry function to change
