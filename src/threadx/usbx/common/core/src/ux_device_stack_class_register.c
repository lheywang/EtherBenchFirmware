...
UINT _ux_device_stack_class_register(UCHAR *class_name,
    ...
    UX_TRACE_IN_LINE_INSERT(UX_TRACE_DEVICE_STACK_CLASS_REGISTER, class_name, interface_number, parameter, 0,
...
UINT _uxe_device_stack_class_register(UCHAR *class_name,
    ...
    return (_ux_device_stack_class_register(class_name, class_entry_function, configuration_number, interface_number,
                                            parameter));
}
