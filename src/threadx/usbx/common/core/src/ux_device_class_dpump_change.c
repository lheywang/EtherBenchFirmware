...
UINT _ux_device_class_dpump_change(UX_SLAVE_CLASS_COMMAND *command) {
    ...
    if (interface_ptr->ux_slave_interface_descriptor.bAlternateSetting != 0) {
        ...
        if (dpump->ux_slave_class_dpump_bulkout_endpoint == UX_NULL ||
            dpump->ux_slave_class_dpump_bulkin_endpoint == UX_NULL)
        ...
        _ux_utility_memory_set(dpump->ux_slave_class_dpump_bulkout_endpoint->ux_slave_endpoint_transfer_request
                               ...
                               0, UX_SLAVE_REQUEST_DATA_MAX_LENGTH); /* Use case of memset is verified. */
        ...
        _ux_device_stack_transfer_all_request_abort(dpump->ux_slave_class_dpump_bulkin_endpoint,
                                                    UX_TRANSFER_APPLICATION_RESET);
        _ux_device_stack_transfer_all_request_abort(dpump->ux_slave_class_dpump_bulkout_endpoint,
                                                    UX_TRANSFER_APPLICATION_RESET);
    }
