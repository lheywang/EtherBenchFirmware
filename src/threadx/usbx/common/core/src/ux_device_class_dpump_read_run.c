...
/*                                                                        */
/**************************************************************************/
UINT _ux_device_class_dpump_read_run(UX_SLAVE_CLASS_DPUMP *dpump, UCHAR *buffer, ULONG requested_length,
                                     ULONG *actual_length) {
    ...
    UX_TRACE_IN_LINE_INSERT(UX_TRACE_DEVICE_CLASS_DPUMP_READ, dpump, buffer, requested_length, 0,
    ...
    case UX_DEVICE_CLASS_DPUMP_READ_START:
        ...
        requested_length =
            dpump->ux_device_class_dpump_read_requested_length - dpump->ux_device_class_dpump_read_actual_length;
    ...
    case UX_DEVICE_CLASS_DPUMP_READ_WAIT:
        ...
        status = _ux_device_stack_transfer_run(transfer_request, dpump->ux_device_class_dpump_read_transfer_length,
        ...
        if (status < UX_STATE_NEXT) {
            ...
            dpump->ux_device_class_dpump_read_state = UX_STATE_RESET;
            dpump->ux_device_class_dpump_read_status = transfer_request->ux_slave_transfer_request_completion_code;
            return (UX_STATE_EXIT);
        }
        ...
        if (status == UX_STATE_NEXT) {
            ...
            _ux_utility_memory_copy(
                dpump->ux_device_class_dpump_read_buffer, transfer_request->ux_slave_transfer_request_data_pointer,
                dpump->ux_device_class_dpump_read_transfer_length); /* Use case of memcpy is verified. */

            /* Next buffer address.  */
            dpump->ux_device_class_dpump_read_buffer += transfer_request->ux_slave_transfer_request_actual_length;
