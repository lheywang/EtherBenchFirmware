...
/*                                                                        */
/**************************************************************************/
UINT _ux_host_stack_new_endpoint_create(UX_INTERFACE *interface_ptr, UCHAR *interface_endpoint) {
    ...
    UX_TRACE_IN_LINE_INSERT(UX_TRACE_HOST_STACK_NEW_ENDPOINT_CREATE, interface_ptr, endpoint, 0, 0,
    ...
    _ux_utility_descriptor_parse(interface_endpoint, _ux_system_endpoint_descriptor_structure,
    ...
    /* Interrupt/isochronous endpoint, max 1024 and 3 transactions can be accepted.  */
        ...
        if ((endpoint_type == UX_ISOCHRONOUS_ENDPOINT) ||
            (interface_ptr->ux_interface_configuration->ux_configuration_device->ux_device_speed ==
