            ...
            while (current_interface != UX_NULL) {
                ...
                if (current_interface != UX_NULL) {
                    ...
                    if (current_interface->ux_interface_descriptor.bInterfaceNumber != current_interface_number) {
                        ...
                        /* If trace is enabled, insert this event into the trace buffer.  */
                        UX_TRACE_IN_LINE_INSERT(UX_TRACE_ERROR, UX_INTERFACE_HANDLE_UNKNOWN, ux_interface, 0, 0,
                                                UX_TRACE_ERRORS, 0, 0)
...
UINT _uxe_host_stack_configuration_interface_get(UX_CONFIGURATION *configuration, UINT interface_index,
    ...
    return (_ux_host_stack_configuration_interface_get(configuration, interface_index, alternate_setting_index,
                                                       ux_interface));
}
