...
typedef struct UX_SLAVE_CLASS_STORAGE_LUN_STRUCT {
    ...
    UINT (*ux_slave_class_storage_media_read)(VOID *storage, ULONG lun, UCHAR *data_pointer, ULONG number_blocks,
                                              ULONG lba, ULONG *media_status);
    UINT (*ux_slave_class_storage_media_write)(VOID *storage, ULONG lun, UCHAR *data_pointer, ULONG number_blocks,
                                               ULONG lba, ULONG *media_status);
    UINT (*ux_slave_class_storage_media_flush)(VOID *storage, ULONG lun, ULONG number_blocks, ULONG lba,
                                               ULONG *media_status);
...
#define UX_DEVICE_CLASS_STORAGE_BULKIN_BUFFER(storage)                                                                 \
    (UX_DEVICE_CLASS_STORAGE_BULKOUT_BUFFER(storage) + UX_DEVICE_CLASS_STORAGE_BULK_BUFFER_SIZE)
...
UINT _ux_device_class_storage_get_status_notification(UX_SLAVE_CLASS_STORAGE *storage, ULONG lun,
                                                      UX_SLAVE_ENDPOINT *endpoint_in, UX_SLAVE_ENDPOINT *endpoint_out,
                                                      UCHAR *cbwcb);
UINT _ux_device_class_storage_report_key(UX_SLAVE_CLASS_STORAGE *storage, ULONG lun, UX_SLAVE_ENDPOINT *endpoint_in,
                                         UX_SLAVE_ENDPOINT *endpoint_out, UCHAR *cbwcb);
