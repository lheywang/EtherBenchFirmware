...
/*                                                                        */
/**************************************************************************/
UINT _ux_device_class_pima_response_send(UX_SLAVE_CLASS_PIMA *pima, ULONG response_code, ULONG number_parameters,
                                         ULONG pima_parameter_1, ULONG pima_parameter_2, ULONG pima_parameter_3) {
    ...
    UX_TRACE_IN_LINE_INSERT(UX_TRACE_DEVICE_CLASS_PIMA_RESPONSE_SEND, pima, response_code, number_parameters,
                            pima_parameter_1, UX_TRACE_DEVICE_CLASS_EVENTS, 0, 0)
    ...
    _ux_utility_short_put(response + UX_DEVICE_CLASS_PIMA_RESPONSE_HEADER_TYPE, UX_DEVICE_CLASS_PIMA_CT_RESPONSE_BLOCK);

    /* Fill in the response code.  */
    _ux_utility_short_put(response + UX_DEVICE_CLASS_PIMA_RESPONSE_HEADER_CODE, (USHORT)response_code);
    ...
    case 2:
        ...
        /* fall through */
    case 1:
        _ux_utility_long_put(response + UX_DEVICE_CLASS_PIMA_RESPONSE_HEADER_PARAMETERS, pima_parameter_1);
