...
UINT _ux_device_class_storage_read_capacity(UX_SLAVE_CLASS_STORAGE *storage, ULONG lun, UX_SLAVE_ENDPOINT *endpoint_in,
    ...
    if (status != UX_SUCCESS) {
        ...
        _ux_utility_memory_set(read_capacity_buffer, 0,
        ...
        _ux_utility_long_put_big_endian(
            &read_capacity_buffer[UX_SLAVE_CLASS_STORAGE_READ_CAPACITY_RESPONSE_BLOCK_SIZE],
        ...
        _ux_device_stack_transfer_request(transfer_request, UX_SLAVE_CLASS_STORAGE_READ_CAPACITY_RESPONSE_LENGTH,
