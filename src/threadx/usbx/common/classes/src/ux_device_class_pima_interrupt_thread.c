...
VOID _ux_device_class_pima_interrupt_thread(ULONG pima_class) {
    ...
    pima->ux_device_class_pima_event_array = _ux_utility_memory_allocate_mulc_safe(
        UX_NO_ALIGN, UX_REGULAR_MEMORY, sizeof(UX_SLAVE_CLASS_PIMA_EVENT), UX_DEVICE_CLASS_PIMA_MAX_EVENTS_QUEUE);
    ...
    pima->ux_device_class_pima_event_array_end =
        pima->ux_device_class_pima_event_array + UX_DEVICE_CLASS_PIMA_MAX_EVENTS_QUEUE;
    ...
    while (1) {
        ...
        while (device->ux_slave_device_state == UX_DEVICE_CONFIGURED) {
            ...
            if (status == UX_SUCCESS) {
                ...
                _ux_utility_long_put(buffer + UX_DEVICE_CLASS_PIMA_AEI_DATA_LENGTH,
                                     UX_DEVICE_CLASS_PIMA_AEI_MAX_LENGTH);
                ...
                _ux_utility_short_put(buffer + UX_DEVICE_CLASS_PIMA_AEI_EVENT_CODE,
                                      (USHORT)pima_event.ux_device_class_pima_event_code);

                /* Put the transaction ID.  */
                _ux_utility_long_put(buffer + UX_DEVICE_CLASS_PIMA_AEI_TRANSACTION_ID,
                                     pima_event.ux_device_class_pima_event_transaction_id);

                /* Put the value of parameter 1.   */
                _ux_utility_long_put(buffer + UX_DEVICE_CLASS_PIMA_AEI_PARAMETER_1,
                                     pima_event.ux_device_class_pima_event_parameter_1);

                /* Put the value of parameter 2.   */
                _ux_utility_long_put(buffer + UX_DEVICE_CLASS_PIMA_AEI_PARAMETER_2,
                                     pima_event.ux_device_class_pima_event_parameter_3);
                ...
                status = _ux_device_stack_transfer_request(transfer_request_in, UX_DEVICE_CLASS_PIMA_AEI_MAX_LENGTH,
                                                           UX_DEVICE_CLASS_PIMA_AEI_MAX_LENGTH);
