...
UINT _ux_device_class_hid_descriptor_send(UX_SLAVE_CLASS_HID *hid, ULONG descriptor_type, ULONG request_index,
    ...
    UX_TRACE_IN_LINE_INSERT(UX_TRACE_DEVICE_CLASS_HID_DESCRIPTOR_SEND, hid, descriptor_type, request_index, 0,
    ...
    case UX_DEVICE_CLASS_HID_DESCRIPTOR_HID:
        ...
        while (device_framework < device_framework_end) {
            ...
            if ((descriptor_type == UX_DEVICE_CLASS_HID_DESCRIPTOR_HID) && (interface_number == (UCHAR)request_index)) {
