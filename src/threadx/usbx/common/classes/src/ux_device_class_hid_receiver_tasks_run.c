...
UINT _ux_device_class_hid_receiver_tasks_run(UX_SLAVE_CLASS_HID *hid) {
    ...
    case UX_DEVICE_CLASS_HID_RECEIVER_START:
        ...
        /* Set request length.  */
        hid->ux_device_class_hid_read_requested_length = receiver->ux_device_class_hid_receiver_event_buffer_size;
    ...
    case UX_DEVICE_CLASS_HID_RECEIVER_WAIT:
        ...
        status = _ux_device_stack_transfer_run(transfer, hid->ux_device_class_hid_read_requested_length,
        ...
        if (status < UX_STATE_NEXT) {
            ...
            hid->ux_device_class_hid_read_status = transfer->ux_slave_transfer_request_completion_code;
