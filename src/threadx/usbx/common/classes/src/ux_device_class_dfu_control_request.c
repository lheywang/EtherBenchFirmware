...
static inline VOID _ux_device_class_dfu_status_get(UX_SLAVE_CLASS_DFU *, UX_SLAVE_TRANSFER *, UCHAR, UCHAR, UCHAR,
                                                   UCHAR);
#endif
...
UINT _ux_device_class_dfu_control_request(UX_SLAVE_CLASS_COMMAND *command) {
    ...
    case UX_SYSTEM_DFU_STATE_APP_IDLE:
        ...
        case UX_SLAVE_CLASS_DFU_COMMAND_GET_STATUS:
            ...
            *(transfer_request->ux_slave_transfer_request_data_pointer + UX_SLAVE_CLASS_DFU_GET_STATUS_POLL_TIMEOUT) =
                UX_DW0(UX_DEVICE_CLASS_DFU_STATUS_POLLTIMEOUT);
            *(transfer_request->ux_slave_transfer_request_data_pointer + UX_SLAVE_CLASS_DFU_GET_STATUS_POLL_TIMEOUT +
              1) = UX_DW1(UX_DEVICE_CLASS_DFU_STATUS_POLLTIMEOUT);
            *(transfer_request->ux_slave_transfer_request_data_pointer + UX_SLAVE_CLASS_DFU_GET_STATUS_POLL_TIMEOUT +
              2) = UX_DW2(UX_DEVICE_CLASS_DFU_STATUS_POLLTIMEOUT);

            /* Next state.  */
            *(transfer_request->ux_slave_transfer_request_data_pointer + UX_SLAVE_CLASS_DFU_GET_STATUS_STATE) =
                (UCHAR)_ux_system_slave->ux_system_slave_device_dfu_state_machine;
            ...
            *(transfer_request->ux_slave_transfer_request_data_pointer + UX_SLAVE_CLASS_DFU_GET_STATUS_STRING) = 0;
            ...
            _ux_device_stack_transfer_request(transfer_request, UX_SLAVE_CLASS_DFU_GET_STATUS_LENGTH,
                                              UX_SLAVE_CLASS_DFU_GET_STATUS_LENGTH);
        ...
        case UX_SLAVE_CLASS_DFU_COMMAND_GET_STATE:
            ...
            *transfer_request->ux_slave_transfer_request_data_pointer =
            ...
            /* We have a request to obtain the status of the DFU instance. */
            _ux_device_stack_transfer_request(transfer_request, UX_SLAVE_CLASS_DFU_GET_STATE_LENGTH,
                                              UX_SLAVE_CLASS_DFU_GET_STATE_LENGTH);
    ...
    case UX_SYSTEM_DFU_STATE_DFU_IDLE:
        ...
        case UX_SLAVE_CLASS_DFU_COMMAND_DOWNLOAD:
            ...
            /* We received a DOWNLOAD command. Check the length field of the request. It cannot be 0.  */
                ...
                if (_ux_system_slave->ux_system_slave_device_dfu_capabilities &
        ...
        case UX_SLAVE_CLASS_DFU_COMMAND_GET_STATUS:
            ...
            *(transfer_request->ux_slave_transfer_request_data_pointer + UX_SLAVE_CLASS_DFU_GET_STATUS_POLL_TIMEOUT +
            ...
            /* Next state.  */
            *(transfer_request->ux_slave_transfer_request_data_pointer + UX_SLAVE_CLASS_DFU_GET_STATUS_STATE) =
                (UCHAR)UX_SYSTEM_DFU_STATE_DFU_IDLE;
        ...
        case UX_SLAVE_CLASS_DFU_COMMAND_UPLOAD:
            ...
            if (!(_ux_system_slave->ux_system_slave_device_dfu_capabilities &
                ...
                (request_length == 0) || (request_length > UX_SLAVE_REQUEST_CONTROL_MAX_LENGTH)) {
                _ux_device_stack_endpoint_stall(&device->ux_slave_device_control_endpoint);
    ...
    case UX_SYSTEM_DFU_STATE_DFU_DNLOAD_SYNC:
        ...
        case UX_SLAVE_CLASS_DFU_COMMAND_GET_STATUS:
            ...
            _ux_device_class_dfu_status_get(
                ...
                UX_SLAVE_CLASS_DFU_STATUS_STATE_DFU_DNBUSY, UX_SLAVE_CLASS_DFU_STATUS_STATE_DFU_ERROR);
#else
...
#if UX_DEVICE_CLASS_DFU_STATUS_MODE == 1
static inline VOID _ux_device_class_dfu_status_get(UX_SLAVE_CLASS_DFU *dfu, UX_SLAVE_TRANSFER *transfer,
                                                   UCHAR move_state, UCHAR state_ok, UCHAR state_busy,
                                                   UCHAR state_error) {
    ULONG media_status = ((UX_SLAVE_CLASS_DFU_MEDIA_STATUS_OK) | (UX_SLAVE_CLASS_DFU_STATUS_OK << 4) |
