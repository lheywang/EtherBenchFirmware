...
UINT _ux_device_class_pima_object_delete(UX_SLAVE_CLASS_PIMA *pima, ULONG object_handle, ULONG object_format) {
    ...
    UX_TRACE_IN_LINE_INSERT(UX_TRACE_DEVICE_CLASS_PIMA_OBJECT_DELETE, pima, object_handle, 0, 0,
    ...
    /* Response status.  */
    status = _ux_device_class_pima_response_send(pima, (status == UX_SUCCESS) ? UX_DEVICE_CLASS_PIMA_RC_OK : status, 0,
                                                 0, 0, 0);
