...
VOID _ux_device_class_ccid_runner_thread_entry(ULONG ccid_runner) {
    ...
    while (1) {
        ...
        /* Wait signal.  */
        status = _ux_utility_event_flags_get(&ccid->ux_device_class_ccid_events, event_mask, UX_OR_CLEAR, &flags,
                                             UX_WAIT_FOREVER);
        ...
        cmd = (UX_DEVICE_CLASS_CCID_MESSAGE_HEADER *)runner->ux_device_class_ccid_runner_command;
        rsp = (UX_DEVICE_CLASS_CCID_RDR_TO_PC_SLOT_STATUS_HEADER *)runner->ux_device_class_ccid_runner_response;
        ...
        /* Process command, application can fill status.  */
            ...
            case UX_DEVICE_CLASS_CCID_RDR_TO_PC_SLOT_STATUS:
                ...
                /* Length fixed to 10.  */
                messages.ux_device_class_ccid_messages_rdr_to_pc_length = UX_DEVICE_CLASS_CCID_MESSAGE_HEADER_LENGTH;
                break;
            ...
            /* Save bmICCStatus.  */
            slot->ux_device_class_ccid_slot_icc_status = rsp->bStatus & UX_DEVICE_CLASS_CCID_SLOT_STATUS_ICC_MASK;
        ...
        /* Send response.  */
        _ux_device_class_ccid_response(ccid, (UCHAR *)rsp, messages.ux_device_class_ccid_messages_rdr_to_pc_length);
