...
UINT _ux_device_class_pima_object_info_send(UX_SLAVE_CLASS_PIMA *pima, ULONG storage_id, ULONG parent_object_handle) {
    ...
    UX_TRACE_IN_LINE_INSERT(UX_TRACE_DEVICE_CLASS_PIMA_OBJECT_INFO_SEND, pima, 0, 0, 0, UX_TRACE_DEVICE_CLASS_EVENTS, 0,
                            0)
    ...
    _ux_utility_descriptor_parse(object_info_pointer, _ux_system_class_pima_object_structure,
                                 UX_DEVICE_CLASS_PIMA_OBJECT_ENTRIES, (UCHAR *)object);
    ...
    if (status == UX_SUCCESS) {
        ...
        _ux_utility_memory_copy(object->ux_device_class_pima_object_filename, object_info_pointer,
                                unicode_string_length); /* Use case of memcpy is verified. */
    ...
    if (status == UX_SUCCESS) {
        ...
        _ux_utility_memory_copy(object->ux_device_class_pima_object_capture_date, object_info_pointer,
                                unicode_string_length); /* Use case of memcpy is verified. */
    ...
    if (status == UX_SUCCESS) {
        ...
        _ux_utility_memory_copy(object->ux_device_class_pima_object_modification_date, object_info_pointer,
                                unicode_string_length); /* Use case of memcpy is verified. */
    ...
    if (status == UX_SUCCESS) {
        ...
        _ux_utility_memory_copy(object->ux_device_class_pima_object_keywords, object_info_pointer,
                                unicode_string_length); /* Use case of memcpy is verified. */
        ...
        status =
            pima->ux_device_class_pima_object_info_send(pima, object, storage_id, parent_object_handle, &object_handle);
