...
/*                                                                        */
/**************************************************************************/
UINT _ux_device_class_pima_object_prop_value_set(UX_SLAVE_CLASS_PIMA *pima, ULONG object_handle,
    ...
    UX_TRACE_IN_LINE_INSERT(UX_TRACE_DEVICE_CLASS_PIMA_SET_OBJECT_PROP_VALUE, pima, object_handle, object_property_code,
    ...
    if (object_property_value_length > UX_DEVICE_CLASS_PIMA_DATA_HEADER_SIZE) {
        ...
        status = pima->ux_device_class_pima_object_prop_value_set(pima, object_handle, object_property_code,
