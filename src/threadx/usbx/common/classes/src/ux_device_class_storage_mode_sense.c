...
UCHAR usbx_device_class_storage_mode_sense_page_cdrom[USBX_DEVICE_CLASS_STORAGE_MODE_SENSE_PAGE_CDROM_LENGTH] = {
    ...
    0x2A, 0x42, 0x3F, 0x37, 0xF1, 0x77, 0x29, 0x23, 0x10, 0x89, 0x01, 0x00, 0x02, 0x00, 0x05, 0x84, 0x00, 0x10,
    0x10, 0x89, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
...
#define USBX_DEVICE_CLASS_STORAGE_MODE_SENSE_PAGE_ALL_RESPONSE_LENGTH                                                  \
    (UX_SLAVE_CLASS_STORAGE_MODE_SENSE_PARAMETER_HEADER_LENGTH_10 +                                                    \
     USBX_DEVICE_CLASS_STORAGE_MODE_SENSE_PAGE_CDROM_LENGTH + USBX_DEVICE_CLASS_STORAGE_MODE_SENSE_PAGE_CACHE_LENGTH + \
...
UINT _ux_device_class_storage_mode_sense(UX_SLAVE_CLASS_STORAGE *storage, ULONG lun, UX_SLAVE_ENDPOINT *endpoint_in,
    ...
    UX_TRACE_IN_LINE_INSERT(UX_TRACE_DEVICE_CLASS_STORAGE_MODE_SENSE, storage, lun, 0, 0, UX_TRACE_DEVICE_CLASS_EVENTS,
                            0, 0)
    ...
    if (mode_sense_command == UX_SLAVE_CLASS_STORAGE_SCSI_MODE_SENSE_SHORT) {
        ...
        mode_sense_reply_length =
            _ux_utility_short_get_big_endian(cbwcb + UX_SLAVE_CLASS_STORAGE_MODE_SENSE_ALLOCATION_LENGTH_10);
    ...
    _ux_utility_memory_set(transfer_request->ux_slave_transfer_request_data_pointer, 0,
    ...
    if (page_code == UX_SLAVE_CLASS_STORAGE_MMC2_PAGE_CODE_CDROM || page_code == UX_SLAVE_CLASS_STORAGE_PAGE_CODE_ALL) {
        ...
        /* Copy page data.  */
        _ux_utility_memory_copy(page_pointer, usbx_device_class_storage_mode_sense_page_cdrom,
    ...
    if (storage->ux_slave_class_storage_lun[lun].ux_slave_class_storage_media_flush != UX_NULL &&
        (page_code == UX_SLAVE_CLASS_STORAGE_PAGE_CODE_CACHE || page_code == UX_SLAVE_CLASS_STORAGE_PAGE_CODE_ALL)) {
