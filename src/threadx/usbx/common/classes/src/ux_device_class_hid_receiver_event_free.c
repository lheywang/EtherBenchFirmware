...
UINT _ux_device_class_hid_receiver_event_free(UX_SLAVE_CLASS_HID *hid) {
    ...
    UX_TRACE_IN_LINE_INSERT(UX_TRACE_DEVICE_CLASS_HID_RECEIVER_EVENT_FREE, hid, pos, 0, 0, UX_TRACE_DEVICE_CLASS_EVENTS,
                            0, 0)
    ...
    _ux_device_event_flags_set(&hid->ux_device_class_hid_event_flags_group, UX_DEVICE_CLASS_HID_RECEIVER_RESTART,
                               UX_OR);
