...
/*                                                                        */
/**************************************************************************/
UINT _nxde_telnet_client_connect(
    ...
    status = _nxd_telnet_client_connect(
        client_ptr, server_ip_address, server_port, wait_option);
...
/*                                                                        */
/**************************************************************************/
UINT _nxd_telnet_client_connect(
    NX_TELNET_CLIENT *client_ptr,
    NXD_ADDRESS *server_ip_address,
    UINT server_port,
    ULONG wait_option)

{
    ...
    status = nx_tcp_client_socket_bind(
        &(client_ptr->nx_telnet_client_socket), NX_ANY_PORT, wait_option);
    ...
    /* Connect the socket to the TELNET server using the 'duo' (support IPv4 and IPv6
       addresses types) tcp connect service.  */
    status = nxd_tcp_client_socket_connect(
        &(client_ptr->nx_telnet_client_socket),
        server_ip_address,
        server_port,
        wait_option);
...
/*                                                                        */
/**************************************************************************/
UINT _nxe_telnet_client_connect(
    NX_TELNET_CLIENT *client_ptr, ULONG server_ip, UINT server_port, ULONG wait_option) {
...
/*                                                                        */
/**************************************************************************/
UINT _nx_telnet_client_connect(
    NX_TELNET_CLIENT *client_ptr,
    ...
    return (_nxd_telnet_client_connect(
        client_ptr, &server_ipduo_address, server_port, wait_option));
#else
    NX_PARAMETER_NOT_USED(client_ptr);
...
/*                                                                        */
/**************************************************************************/
UINT _nxe_telnet_client_create(
    NX_TELNET_CLIENT *client_ptr, CHAR *client_name, NX_IP *ip_ptr, ULONG window_size) {
...
/*                                                                        */
/**************************************************************************/
UINT _nxe_telnet_client_packet_receive(
    NX_TELNET_CLIENT *client_ptr, NX_PACKET **packet_ptr, ULONG wait_option) {
...
/*                                                                        */
/**************************************************************************/
UINT _nx_telnet_client_packet_receive(
    NX_TELNET_CLIENT *client_ptr, NX_PACKET **packet_ptr, ULONG wait_option) {
    ...
    status = nx_tcp_socket_receive(
        &(client_ptr->nx_telnet_client_socket), packet_ptr, wait_option);
...
/*                                                                        */
/**************************************************************************/
UINT _nxe_telnet_client_packet_send(
    NX_TELNET_CLIENT *client_ptr, NX_PACKET *packet_ptr, ULONG wait_option) {
...
/*                                                                        */
/**************************************************************************/
UINT _nx_telnet_client_packet_send(
    NX_TELNET_CLIENT *client_ptr, NX_PACKET *packet_ptr, ULONG wait_option) {
