...
UINT _nx_dhcpv6_add_client_duid(NX_DHCPV6 *dhcpv6_ptr, UCHAR *buffer_ptr, UINT *index) {
    ...
    available_payload = dhcpv6_ptr->nx_dhcpv6_pool_ptr->nx_packet_pool_payload_size -
                        (ULONG)sizeof(NX_IPV6_HEADER) - (ULONG)sizeof(NX_UDP_HEADER) -
                        *index;

    /* Check if the largest possible client DUID will fit in the packet buffer. */
    if ((available_payload - 4) <
        ((ULONG)(dhcpv6_ptr->nx_dhcpv6_client_duid.nx_option_length))) {
    ...
    memcpy(
        (buffer_ptr + (*index)),
        &message_word,
        sizeof(UINT)); /* Use case of memcpy is verified. */
    ...
    if (dhcpv6_ptr->nx_dhcpv6_client_duid.nx_duid_type == NX_DHCPV6_DUID_TYPE_LINK_TIME) {
        ...
        memcpy(
            (buffer_ptr + (*index)),
            &message_word,
            sizeof(ULONG)); /* Use case of memcpy is verified. */
        (*index) += (ULONG)sizeof(ULONG);
    }

    /* Build the link layer address.  */
    if (dhcpv6_ptr->nx_dhcpv6_client_duid.nx_hardware_type ==
        ...
        /* Build the MSW.  */
        mac[i++] =
            (UCHAR)(dhcpv6_ptr->nx_dhcpv6_client_duid.nx_link_layer_address_msw >> 8);
        mac[i++] = (UCHAR)(dhcpv6_ptr->nx_dhcpv6_client_duid.nx_link_layer_address_msw);
    } else if (
        dhcpv6_ptr->nx_dhcpv6_client_duid.nx_hardware_type ==
        NX_DHCPV6_CLIENT_HARDWARE_TYPE_EUI_64) {

        /* The length of link layer address is 64 bits.  */

        /* Build the MSW.  */
        mac[i++] =
            (UCHAR)(dhcpv6_ptr->nx_dhcpv6_client_duid.nx_link_layer_address_msw >> 24);
        mac[i++] =
            (UCHAR)(dhcpv6_ptr->nx_dhcpv6_client_duid.nx_link_layer_address_msw >> 16);
        mac[i++] =
            (UCHAR)(dhcpv6_ptr->nx_dhcpv6_client_duid.nx_link_layer_address_msw >> 8);
        mac[i++] = (UCHAR)(dhcpv6_ptr->nx_dhcpv6_client_duid.nx_link_layer_address_msw);
    }
...
UINT _nx_dhcpv6_add_elapsed_time(NX_DHCPV6 *dhcpv6_ptr, UCHAR *buffer_ptr, UINT *index) {
    ...
    available_payload =
        (dhcpv6_ptr->nx_dhcpv6_pool_ptr->nx_packet_pool_payload_size -
    ...
    memcpy(
        (buffer_ptr + (*index)),
        &(dhcpv6_ptr->nx_dhcpv6_elapsed_time),
        sizeof(NX_DHCPV6_ELAPSED_TIME)); /* Use case of memcpy is verified. */
...
/*                                                                        */
/**************************************************************************/
UINT _nx_dhcpv6_add_ia_address(
    NX_DHCPV6 *dhcpv6_ptr, UCHAR *buffer_ptr, UINT *index, UINT ia_index) {
    ...
    if (available_payload <
        (((ULONG)dhcpv6_ptr->nx_dhcpv6_ia[ia_index].nx_option_length) + 4)) {
    ...
    if ((dhcpv6_ptr->nx_dhcpv6_ia[ia_index].nx_global_address.nxd_ip_address.v6[0] ==
         0) &&
        (dhcpv6_ptr->nx_dhcpv6_ia[ia_index].nx_global_address.nxd_ip_address.v6[1] ==
         0) &&
        (dhcpv6_ptr->nx_dhcpv6_ia[ia_index].nx_global_address.nxd_ip_address.v6[2] ==
         0) &&
        (dhcpv6_ptr->nx_dhcpv6_ia[ia_index].nx_global_address.nxd_ip_address.v6[3] ==
         0)) {
    ...
    NX_CHANGE_ULONG_ENDIAN(
        dhcpv6_ptr->nx_dhcpv6_ia[ia_index].nx_global_address.nxd_ip_address.v6[0]);
    NX_CHANGE_ULONG_ENDIAN(
        dhcpv6_ptr->nx_dhcpv6_ia[ia_index].nx_global_address.nxd_ip_address.v6[1]);
    NX_CHANGE_ULONG_ENDIAN(
        dhcpv6_ptr->nx_dhcpv6_ia[ia_index].nx_global_address.nxd_ip_address.v6[2]);
    ...
    if ((dhcpv6_ptr->nx_dhcpv6_message_hdr.nx_message_type ==
         NX_DHCPV6_MESSAGE_TYPE_SOLICIT) ||
        (dhcpv6_ptr->nx_dhcpv6_message_hdr.nx_message_type ==
        ...
        /* When sending a confirm request, DHCPv6 Client should set its
           T1,T2,preferred-lifetime and valid-lifetime to zero, as the server will ignore
           these fields, RFC3315,page41.  */
        ...
        memcpy(
            (buffer_ptr + (*index)),
            &(dhcpv6_ptr->nx_dhcpv6_ia[ia_index].nx_preferred_lifetime),
            sizeof(ULONG)); /* Use case of memcpy is verified. */
        (*index) += (ULONG)sizeof(ULONG);
        memcpy(
            (buffer_ptr + (*index)),
            &(dhcpv6_ptr->nx_dhcpv6_ia[ia_index].nx_valid_lifetime),
            sizeof(ULONG)); /* Use case of memcpy is verified. */
        (*index) += (ULONG)sizeof(ULONG);
...
UINT _nx_dhcpv6_add_iana(NX_DHCPV6 *dhcpv6_ptr, UCHAR *buffer_ptr, UINT *index) {
    ...
    /* Skip the option code and option lenght of IA_NA, write these option after padding
     * the all IA option. */
    (*index) += (ULONG)sizeof(ULONG);
    ...
    memcpy(
        (buffer_ptr + (*index)),
        &(dhcpv6_ptr->nx_dhcpv6_iana.nx_IA_NA_id),
        sizeof(ULONG)); /* Use case of memcpy is verified. */
    (*index) += (ULONG)sizeof(ULONG);
    NX_CHANGE_ULONG_ENDIAN(dhcpv6_ptr->nx_dhcpv6_iana.nx_IA_NA_id);
    ...
    if ((dhcpv6_ptr->nx_dhcpv6_message_hdr.nx_message_type ==
        ...
        memcpy(
            (buffer_ptr + (*index)),
            &(dhcpv6_ptr->nx_dhcpv6_iana.nx_T1),
            sizeof(ULONG)); /* Use case of memcpy is verified. */
        (*index) += (ULONG)sizeof(ULONG);
        memcpy(
            (buffer_ptr + (*index)),
            &(dhcpv6_ptr->nx_dhcpv6_iana.nx_T2),
            sizeof(ULONG)); /* Use case of memcpy is verified. */
        (*index) += (ULONG)sizeof(ULONG);
    ...
    for (ia_index = 0; ia_index < NX_DHCPV6_MAX_IA_ADDRESS; ia_index++) {
        ...
        if (dhcpv6_ptr->nx_dhcpv6_ia[ia_index].nx_address_status) {
            ...
            if (status == NX_SUCCESS) {
                ...
                ia_length =
                    (UINT)(ia_length +
                           dhcpv6_ptr->nx_dhcpv6_ia[ia_index].nx_option_length + 4);
            }
        }
    }
...
/*                                                                        */
/**************************************************************************/
UINT _nx_dhcpv6_add_option_request(
    NX_DHCPV6 *dhcpv6_ptr, UCHAR *buffer_ptr, UINT *index) {
    ...
    if (available_payload <
        (((ULONG)(dhcpv6_ptr->nx_dhcpv6_option_request.nx_option_length)) + 4)) {
    ...
    memcpy(
        (buffer_ptr + (*index)),
        &(dhcpv6_ptr->nx_dhcpv6_option_request.nx_op_code),
        sizeof(USHORT)); /* Use case of memcpy is verified. */
    *index += (ULONG)sizeof(USHORT);

    /* Swap bytes back. */
    NX_CHANGE_USHORT_ENDIAN(dhcpv6_ptr->nx_dhcpv6_option_request.nx_op_code);

    /* Record the option length pointer and skip it, update the option length after fill
     * the option data.  */
    ...
    *index += (ULONG)sizeof(USHORT);
    ...
    if (option_list & NX_DHCPV6_DNS_SERVER_OPTION) {
        ...
        memcpy(
            (buffer_ptr + (*index)),
            &message_word,
            sizeof(SHORT)); /* Use case of memcpy is verified. */
    ...
    /* Is the fully qualified domain name option requested?
       A client MUST only include the Client FQDN option in SOLICIT, REQUEST, RENEW, or
       REBIND message. A client that sends the Client FQDN option MUST also include the
       option in the Option Requst option if it expects the server to include the Client
       FQDN option in any responses. RFC4704, Section5, Page7.  */
    if (((dhcpv6_ptr->nx_dhcpv6_message_hdr.nx_message_type ==
          NX_DHCPV6_MESSAGE_TYPE_SOLICIT) ||
         (dhcpv6_ptr->nx_dhcpv6_message_hdr.nx_message_type ==
...
UINT _nx_dhcpv6_add_server_duid(NX_DHCPV6 *dhcpv6_ptr, UCHAR *buffer_ptr, UINT *index) {
    ...
    if (available_payload <
        (((ULONG)(dhcpv6_ptr->nx_dhcpv6_server_duid.nx_option_length)) + 4)) {
    ...
    *index += (ULONG)sizeof(UINT);
    ...
    /* Build the link layer address.  */
    if (dhcpv6_ptr->nx_dhcpv6_server_duid.nx_hardware_type ==
        NX_DHCPV6_CLIENT_HARDWARE_TYPE_ETHERNET) {
        ...
        /* Build the MSW.  */
        mac[i++] =
            (UCHAR)(dhcpv6_ptr->nx_dhcpv6_server_duid.nx_link_layer_address_msw >> 8);
        mac[i++] = (UCHAR)(dhcpv6_ptr->nx_dhcpv6_server_duid.nx_link_layer_address_msw);
    } else if (
        dhcpv6_ptr->nx_dhcpv6_server_duid.nx_hardware_type ==
        NX_DHCPV6_CLIENT_HARDWARE_TYPE_EUI_64) {
        ...
        /* Build the MSW.  */
        mac[i++] =
            (UCHAR)(dhcpv6_ptr->nx_dhcpv6_server_duid.nx_link_layer_address_msw >> 24);
        mac[i++] =
            (UCHAR)(dhcpv6_ptr->nx_dhcpv6_server_duid.nx_link_layer_address_msw >> 16);
        mac[i++] =
            (UCHAR)(dhcpv6_ptr->nx_dhcpv6_server_duid.nx_link_layer_address_msw >> 8);
        mac[i++] = (UCHAR)(dhcpv6_ptr->nx_dhcpv6_server_duid.nx_link_layer_address_msw);
    }
...
UINT _nx_dhcpv6_add_client_FQDN(NX_DHCPV6 *dhcpv6_ptr, UCHAR *buffer_ptr, UINT *index) {
    ...
    *index += 1;
    ...
    domain_name_length = _nx_dhcpv6_name_string_encode(
        buffer_ptr + (*index), (UCHAR *)dhcpv6_ptr->nx_dhcpv6_client_FQDN.nx_domain_name);
...
/*                                                                        */
/**************************************************************************/
UINT _nxe_dhcpv6_client_create(
    ...
    VOID (*dhcpv6_state_change_notify)(
        struct NX_DHCPV6_STRUCT *dhcpv6_ptr, UINT old_state, UINT new_state),
    ...
    status = _nx_dhcpv6_client_create(
        dhcpv6_ptr,
        ip_ptr,
        name_ptr,
        packet_pool_ptr,
...

{
    ...
    COPY_NXD_ADDRESS(
        &All_DHCPv6_Relay_Servers_Address,
        &(dhcpv6_ptr->nx_dhcpv6_client_destination_address));
    ...
    /* If multihome support is available, default the client DHCP network to the primary
     * interface. */
    ...
    status = tx_event_flags_create(
        &(dhcpv6_ptr->nx_dhcpv6_events), "DHCPv6 Client Timer Events Queue");
    ...
    status = tx_mutex_create(
        &(dhcpv6_ptr->nx_dhcpv6_client_mutex),
        "DHCPV6 Client Process State",
        TX_NO_INHERIT);
    ...
    /* Create the DHCPV6 timer for keeping track of the IP lease's time remaining before
     * expiration.  */
    status = tx_timer_create(
        &(dhcpv6_ptr->nx_dhcpv6_IP_lifetime_timer),
        "NetX DHCPV6 Client IP Lease timer",
        _nx_dhcpv6_IP_lifetime_timeout_entry,
        (ULONG)(ALIGN_TYPE)dhcpv6_ptr,
    ...
    status = tx_timer_create(
        &(dhcpv6_ptr->nx_dhcpv6_session_timer),
        "NetX DHCPV6 Client Session Duration timer",
        _nx_dhcpv6_session_timeout_entry,
        (ULONG)(ALIGN_TYPE)dhcpv6_ptr,
    ...
    status = tx_thread_create(
        &(dhcpv6_ptr->nx_dhcpv6_thread),
        "NetX DHCPV6 Client",
        _nx_dhcpv6_thread_entry,
        (ULONG)(ALIGN_TYPE)dhcpv6_ptr,
        stack_ptr,
        stack_size,
        NX_DHCPV6_THREAD_PRIORITY,
        NX_DHCPV6_THREAD_PRIORITY,
        1,
        TX_DONT_START);
    ...
    status = nx_udp_socket_create(
        dhcpv6_ptr->nx_dhcpv6_ip_ptr,
        &(dhcpv6_ptr->nx_dhcpv6_socket),
        "NetX DHCPV6 Client",
    ...
    /* Set up the elapsed time for the anticipated message exchange with the DHCPv6
     * Server. */
    ...
    status = nxd_ipv6_address_change_notify(
        dhcpv6_ptr->nx_dhcpv6_ip_ptr, _nx_dhcpv6_ipv6_address_DAD_notify);
...
/*                                                                        */
/**************************************************************************/
UINT _nxe_dhcpv6_create_client_duid(
    NX_DHCPV6 *dhcpv6_ptr, UINT duid_type, UINT hardware_type, ULONG time) {
...
/*                                                                        */
/**************************************************************************/
UINT _nx_dhcpv6_create_client_duid(
    NX_DHCPV6 *dhcpv6_ptr, UINT duid_type, UINT hardware_type, ULONG time) {
    ...
    interface_ptr =
        &(dhcpv6_ptr->nx_dhcpv6_ip_ptr
              ->nx_ip_interface[dhcpv6_ptr->nx_dhcpv6_client_interface_index]);
    ...
    if ((duid_type == NX_DHCPV6_DUID_TYPE_LINK_TIME) ||
        ...
        if (duid_type == NX_DHCPV6_DUID_TYPE_LINK_TIME) {
            ...
            if (!time) {
                /* No, create a time field using the defined time constant plus a
                 * randomizing factor.*/
                dhcpv6_ptr->nx_dhcpv6_client_duid.nx_duid_time =
                    (SECONDS_SINCE_JAN_1_2000_MOD_32 + (ULONG)(NX_RAND())) & 0xFFFFFFFF;
            } else {
        ...
        dhcpv6_ptr->nx_dhcpv6_client_duid.nx_link_layer_address_msw =
            interface_ptr->nx_interface_physical_address_msw;
        dhcpv6_ptr->nx_dhcpv6_client_duid.nx_link_layer_address_lsw =
...
/*                                                                        */
/**************************************************************************/
UINT _nxe_dhcpv6_add_client_ia(
    NX_DHCPV6 *dhcpv6_ptr,
    ...
    /* Call the actual service. */
    status = _nx_dhcpv6_add_client_ia(
        dhcpv6_ptr, ipv6_address, preferred_lifetime, valid_lifetime);
...
UINT _nx_dhcpv6_add_client_ia(
    ...
    for (ia_index = 0; ia_index < NX_DHCPV6_MAX_IA_ADDRESS; ia_index++) {
        if ((dhcpv6_ptr->nx_dhcpv6_ia[ia_index].nx_global_address.nxd_ip_address.v6[0] ==
             ipv6_address->nxd_ip_address.v6[0]) &&
            (dhcpv6_ptr->nx_dhcpv6_ia[ia_index].nx_global_address.nxd_ip_address.v6[1] ==
             ipv6_address->nxd_ip_address.v6[1]) &&
            (dhcpv6_ptr->nx_dhcpv6_ia[ia_index].nx_global_address.nxd_ip_address.v6[2] ==
             ipv6_address->nxd_ip_address.v6[2]) &&
            (dhcpv6_ptr->nx_dhcpv6_ia[ia_index].nx_global_address.nxd_ip_address.v6[3] ==
    ...
    if (ia_index < NX_DHCPV6_MAX_IA_ADDRESS) {
        ...
        dhcpv6_ptr->nx_dhcpv6_ia[ia_index].nx_global_address.nxd_ip_version =
            NX_IP_VERSION_V6;
        COPY_IPV6_ADDRESS(
            &(ipv6_address->nxd_ip_address.v6[0]),
            &(dhcpv6_ptr->nx_dhcpv6_ia[ia_index].nx_global_address.nxd_ip_address.v6[0]));
        ...
        dhcpv6_ptr->nx_dhcpv6_ia[ia_index].nx_address_status =
            NX_DHCPV6_IA_ADDRESS_STATE_INITIAL;
...
/*                                                                        */
/**************************************************************************/
UINT _nxe_dhcpv6_create_client_iana(
    NX_DHCPV6 *dhcpv6_ptr, UINT IA_ident, ULONG T1, ULONG T2) {
...
/*                                                                        */
/**************************************************************************/
UINT _nx_dhcpv6_create_client_iana(
    NX_DHCPV6 *dhcpv6_ptr, UINT IA_ident, ULONG T1, ULONG T2) {
...
UINT _nx_dhcpv6_register_IP_address(NX_DHCPV6 *dhcpv6_ptr) {
    ...
    for (ia_index = 0; ia_index < NX_DHCPV6_MAX_IA_ADDRESS; ia_index++) {
        ...
        if (dhcpv6_ptr->nx_dhcpv6_ia[ia_index].nx_address_status ==
            ...
            status = nxd_ipv6_address_set(
                dhcpv6_ptr->nx_dhcpv6_ip_ptr,
                dhcpv6_ptr->nx_dhcpv6_client_interface_index,
                &dhcpv6_ptr->nx_dhcpv6_ia[ia_index].nx_global_address,
                64,
                &address_index);
            ...
            if (status == NX_SUCCESS) {
                ...
                /* Set the IPv6 address status as DAD tentative, the status will be
                 * updated in _nx_dhcpv6_ipv6_address_DAD_notify.  */
                dhcpv6_ptr->nx_dhcpv6_ia[ia_index].nx_address_status =
                    NX_DHCPV6_IA_ADDRESS_STATE_DAD_TENTATIVE;
#else

                /* Set the IPv6 address status as valid.  */
                dhcpv6_ptr->nx_dhcpv6_ia[ia_index].nx_address_status =
                    NX_DHCPV6_IA_ADDRESS_STATE_VALID;
#endif
    ...
    nxd_ipv6_default_router_add(
        dhcpv6_ptr->nx_dhcpv6_ip_ptr,
        &(dhcpv6_ptr->nx_dhcpv6_server_address),
        NX_WAIT_FOREVER,
        dhcpv6_ptr->nx_dhcpv6_client_interface_index);
...
UINT _nx_dhcpv6_get_IP_address(NX_DHCPV6 *dhcpv6_ptr, NXD_ADDRESS *ip_address) {
    ...
    if (dhcpv6_ptr->nx_dhcpv6_ia[0].nx_address_status ==
        NX_DHCPV6_IA_ADDRESS_STATE_VALID) {
        /* Yes; return the assigned IP address from the DHCPv6 Client record. */
        COPY_IPV6_ADDRESS(
            &(dhcpv6_ptr->nx_dhcpv6_ia[0].nx_global_address.nxd_ip_address.v6[0]),
...
/*                                                                        */
/**************************************************************************/
UINT _nxe_dhcpv6_get_lease_time_data(
    NX_DHCPV6 *dhcpv6_ptr,
    ULONG *T1,
    ULONG *T2,
    ULONG *preferred_lifetime,
    ...
    /* Call the actual service. */
    status = _nx_dhcpv6_get_lease_time_data(
        dhcpv6_ptr, T1, T2, preferred_lifetime, valid_lifetime);
...
/*                                                                        */
/**************************************************************************/
UINT _nx_dhcpv6_get_lease_time_data(
    NX_DHCPV6 *dhcpv6_ptr,
    ULONG *T1,
    ULONG *T2,
    ULONG *preferred_lifetime,
...
/*                                                                        */
/**************************************************************************/
UINT _nxe_dhcpv6_get_DNS_server_address(
    NX_DHCPV6 *dhcpv6_ptr, UINT index, NXD_ADDRESS *server_address) {
...
UINT _nx_dhcpv6_get_DNS_server_address(
    NX_DHCPV6 *dhcpv6_ptr, UINT index, NXD_ADDRESS *server_address) {
    ...
    COPY_NXD_ADDRESS(
        &(dhcpv6_ptr->nx_dhcpv6_DNS_name_server_address[index]), server_address);
...
/*                                                                        */
/**************************************************************************/
UINT _nxe_dhcpv6_get_time_server_address(
    NX_DHCPV6 *dhcpv6_ptr, UINT index, NXD_ADDRESS *server_address) {
...
/*                                                                        */
/**************************************************************************/
UINT _nx_dhcpv6_get_time_server_address(
    NX_DHCPV6 *dhcpv6_ptr, UINT index, NXD_ADDRESS *server_address) {
...
/*                                                                        */
/**************************************************************************/
UINT _nxe_dhcpv6_get_other_option_data(
    NX_DHCPV6 *dhcpv6_ptr, UINT option_code, UCHAR *buffer, UINT buffer_length) {
    ...
    /* Call the actual service. */
    status =
        _nx_dhcpv6_get_other_option_data(dhcpv6_ptr, option_code, buffer, buffer_length);
...
/*                                                                        */
/**************************************************************************/
UINT _nx_dhcpv6_get_other_option_data(
    NX_DHCPV6 *dhcpv6_ptr, UINT option_code, UCHAR *buffer, UINT buffer_length) {
    ...
    case NX_DHCPV6_NEW_POSIX_TIMEZONE_OPTION:
        ...
        memcpy(
            buffer,
            dhcpv6_ptr->nx_dhcpv6_time_zone,
            NX_DHCPV6_TIME_ZONE_BUFFER_SIZE); /* Use case of memcpy is verified. */
    ...
    case NX_DHCPV6_DOMAIN_NAME_OPTION:
        ...
        memcpy(
            buffer,
            dhcpv6_ptr->nx_dhcpv6_domain_name,
            NX_DHCPV6_DOMAIN_NAME_BUFFER_SIZE); /* Use case of memcpy is verified. */
        break;
...
/*                                                                        */
/**************************************************************************/
UINT _nxe_dhcpv6_get_valid_ip_address_lease_time(
    NX_DHCPV6 *dhcpv6_ptr,
    UINT address_index,
    ...
    /* Call the actual service. */
    status = _nx_dhcpv6_get_valid_ip_address_lease_time(
        dhcpv6_ptr, address_index, ip_address, preferred_lifetime, valid_lifetime);
...
/*                                                                        */
/**************************************************************************/
UINT _nx_dhcpv6_get_valid_ip_address_lease_time(
    NX_DHCPV6 *dhcpv6_ptr,
    UINT address_index,
    NXD_ADDRESS *ip_address,
    ULONG *preferred_lifetime,
...
VOID _nx_dhcpv6_IP_lifetime_timeout_entry(ULONG dhcpv6_ptr_value) {
    ...
    if ((dhcpv6_ptr->nx_dhcpv6_iana.nx_T1 != NX_DHCPV6_INFINITE_LEASE) &&
        ...
        dhcpv6_ptr->nx_dhcpv6_IP_lifetime_time_accrued +=
            NX_DHCPV6_IP_LIFETIME_TIMER_INTERVAL;
    }
...
VOID _nx_dhcpv6_process(NX_DHCPV6 *dhcpv6_ptr) {
    ...
    case NX_DHCPV6_STATE_SENDING_SOLICIT: {
        ...
        /* Make sure the server DUID is cleared. Client should be accepting any server
         * reply. */
        ...
        /* Check for processing error or error code sent by server. As per RFC 3315
           section 17.1.3, the Client ignores status errors (e.g. No Addresses Available)
           from the server, and continues sending Solicit messages. */
        if ((status != NX_SUCCESS) || (dhcpv6_ptr->nx_status_code != NX_DHCPV6_SUCCESS)) {
            ...
            if (_nx_dhcpv6_update_retransmit_info(dhcpv6_ptr)) {
                ...
                /* Request attempt failed. The state change callback if set will be
                 * called. */
            }
        } else {

            if (dhcpv6_ptr->nx_dhcpv6_request_solicit_mode == NX_DHCPV6_SOLICIT_NORMAL) {
                /* Server has responded to and accepted the SOLICIT request with an
                   ADVERTISE message. Move to the next state to continue the DHCPv6
                   protocol. */
                ...
                dhcpv6_ptr->nx_dhcpv6_transmission_timeout =
                    NX_DHCPV6_INIT_REQ_TRANSMISSION_TIMEOUT;
                ...
                dhcpv6_ptr->nx_dhcpv6_init_retransmission_timeout =
                    NX_DHCPV6_INIT_REQ_TRANSMISSION_TIMEOUT;
                dhcpv6_ptr->nx_dhcpv6_max_retransmission_count =
                    NX_DHCPV6_MAX_REQ_RETRANSMISSION_COUNT;
                dhcpv6_ptr->nx_dhcpv6_max_retransmission_timeout =
                    NX_DHCPV6_MAX_REQ_RETRANSMISSION_TIMEOUT;
                dhcpv6_ptr->nx_dhcpv6_max_retransmission_duration =
                    NX_DHCPV6_MAX_REQ_RETRANSMISSION_DURATION;
                ...
                /* Server sending the REPLY message responded to and accepted the SOLICIT
                   request with Rapid Commit option, Move to the next state to continue
                   the DHCPv6 protocol. */
    ...
    /* The DHCP Client is in the REQUEST state; send the Request message till the server
       responds or the number of retries exceeds the max. */
    case NX_DHCPV6_STATE_SENDING_REQUEST: {
        ...
        if ((status != NX_SUCCESS) || (dhcpv6_ptr->nx_status_code != NX_DHCPV6_SUCCESS)) {
            ...
            if ((status == NX_SUCCESS) &&
                ...
                _nx_dhcpv6_remove_assigned_address(
                    dhcpv6_ptr, NX_DHCPV6_REMOVE_ALL_IA_ADDRESS);

                /* When the client receives a NotOnLink status from the server in response
                   to a Request, the client can restart the DHCP server discovery process.
                   RFC3315, Section18.1.8, Page48.  */
                ...
                if (_nx_dhcpv6_update_retransmit_info(dhcpv6_ptr)) {
                    ...
                    /* The retry limit on Request messages is exceeded. Set the Client
                    back to the INIT state and stop sending request messages for now. */
                    dhcpv6_ptr->nx_dhcpv6_state = NX_DHCPV6_STATE_INIT;
            ...
            /* The Server responded to and accepted the REQUEST message. The Client is now
               bound to assigned IPv6 address. The Client must still register this IPv6
               address with NetX Duo to verify it is unique on the network.  */
            ...
            /* Receive the correct response, so deactivate the session timer of elapsed
             * time. */
            tx_timer_deactivate(&(dhcpv6_ptr->nx_dhcpv6_session_timer));
    ...
    case NX_DHCPV6_STATE_SENDING_RENEW: {
        ...
        /* Check for socket receive error or Server error code. */
        if ((status != NX_SUCCESS) || (dhcpv6_ptr->nx_status_code != NX_DHCPV6_SUCCESS) ||
            ((dhcpv6_ptr->nx_dhcpv6_reply_option_flags &
              NX_DHCPV6_INCLUDE_IA_ADDRESS_OPTION) == 0)) {

            /* Process the NoBinding status.  */
            if ((status == NX_SUCCESS) &&
                (dhcpv6_ptr->nx_status_code == NX_DHCPV6_NO_BINDING)) {

                /* When the client receives a Reply message in response to a Renew or
                   Rebind message, send a Request message if the IA contains a Status Code
                   option with the NoBinding status. RFC 3315, Sectoon 18.1.8, Page 48. */
                dhcpv6_ptr->nx_dhcpv6_state = NX_DHCPV6_STATE_SENDING_REQUEST;
                ...
                if (_nx_dhcpv6_update_retransmit_info(dhcpv6_ptr)) {
                    ...
                    /* The retry limit on Renew messages is exceeded. Set the Client back
                    to the INIT state and stop sending Renew messages for now. */
                    dhcpv6_ptr->nx_dhcpv6_state = NX_DHCPV6_STATE_INIT;

                    /* Renew attempt failed. The state change callback if set will be
                     * called. */
                }
            }
        } else {

            /* The Server responded to and accepted our RENEW request. Update the Client
               to a bound state and reset the lease timers.  */
    ...
    case NX_DHCPV6_STATE_SENDING_REBIND: {
        ...
        if ((status != NX_SUCCESS) || (dhcpv6_ptr->nx_status_code != NX_DHCPV6_SUCCESS) ||
            ...
            if ((status == NX_SUCCESS) &&
                ...
                /* When the client receives a Reply message in response to a Renew or
                   Rebind message, send a Request message if the IA contains a Status Code
                   option with the NoBinding status. RFC 3315, Section 18.1.8, Page 48. */
                dhcpv6_ptr->nx_dhcpv6_state = NX_DHCPV6_STATE_SENDING_REQUEST;
                ...
                if (_nx_dhcpv6_update_retransmit_info(dhcpv6_ptr)) {
                    ...
                    /* The retry limit on Rebind messages is exceeded. Set the Client back
                    to the INIT state and stop sending Rebind messages for now. */
                    dhcpv6_ptr->nx_dhcpv6_state = NX_DHCPV6_STATE_INIT;

                    /* Rebind attempt failed. The client state change callback if set will
                     * be called. */
                }
            }
        } else {
    ...
    case NX_DHCPV6_STATE_SENDING_CONFIRM: {
        ...
        if ((status != NX_SUCCESS) || (dhcpv6_ptr->nx_status_code != NX_DHCPV6_SUCCESS)) {
            ...
            if ((status == NX_SUCCESS) &&
                ...
                /* When the client receives a NotOnLink status from the server in response
                   to a Confirm messag, the client performs DHCP server solicitation.
                   RFC3315, Section18.1.8, Page48.  */
                _nx_dhcpv6_request_solicit(dhcpv6_ptr);
            }
            ...
            /* Retransmit the Confirm message.  */
                ...
                if (_nx_dhcpv6_update_retransmit_info(dhcpv6_ptr)) {
                    ...
                    /* The retry limit on Confirm messages is exceeded. Set the Client
                    back to the INIT state and stop sending rebind messages for now. */
                    dhcpv6_ptr->nx_dhcpv6_state = NX_DHCPV6_STATE_INIT;

                    /* Confirm request failed. The state change callback if set will be
                     * called. */
                }
            }
        } else {

            /* Successful confirmation. Set the assigned address status to valid
             * (confirmed). */
    ...
    case NX_DHCPV6_STATE_SENDING_RELEASE: {
        ...
        /* Check for socket receive error.  For the release message, consider the release
           request completed if the server responds, regardless of Server error code. RFC
           3315 Section 18.1.8 */
        if (status != NX_SUCCESS) {
            ...
            if (_nx_dhcpv6_update_retransmit_info(dhcpv6_ptr)) {
                ...
                /* No response to release message from server. The state change callback
                 * if set will be called. */
            }
        } else {
    ...
    case NX_DHCPV6_STATE_SENDING_DECLINE: {
        ...
        /* Check for socket receive error.  For the decline message, consider the release
           request completed if the server responds, regardless of Server error code.
           RFC3315,Section 18.1.7 */
        if (status != NX_SUCCESS) {
            ...
            if (_nx_dhcpv6_update_retransmit_info(dhcpv6_ptr)) {
                ...
                /* No response to decline message from server. The state change callback
                 * if set will be called. */
            }
        } else {
            ...
            /* Clear global ip address and lifetime parameters from the Client record. */
            status = _nx_dhcpv6_remove_assigned_address(
                dhcpv6_ptr, NX_DHCPV6_REMOVE_ALL_IA_ADDRESS);
    ...
    if ((dhcpv6_ptr->nx_dhcpv6_state_change_callback) &&
        (original_state != (dhcpv6_ptr->nx_dhcpv6_state))) {

        /* Yes, call the the state change callback with the original and new state.  */
        (dhcpv6_ptr->nx_dhcpv6_state_change_callback)(
            dhcpv6_ptr, original_state, dhcpv6_ptr->nx_dhcpv6_state);
    }
...
/*                                                                        */
/**************************************************************************/
UINT _nx_dhcpv6_process_client_duid(
    NX_DHCPV6 *dhcpv6_ptr, UCHAR *option_data, UINT option_length) {
    ...
    if ((dhcpv6_ptr->nx_dhcpv6_client_duid.nx_duid_type) ==
...
/*                                                                        */
/**************************************************************************/
UINT _nx_dhcpv6_process_domain_name(
    NX_DHCPV6 *dhcpv6_ptr, UCHAR *packet_start, UCHAR *option_data, UINT option_length) {
    ...
    while (temp_length < option_length) {
        ...
        /* Calculate the domain name length in the Domaim Search List option,include the
         * null flag '\0'.  */
        for (i = 0; (i + temp_length < option_length) && (domain_name_ptr[i] != '\0');
             i++)
            ;
        ...
        /* Record the real domain name and return the length, one less for NULL
         * termination. */
        domain_name_length = _nx_dhcpv6_name_string_unencode(
            packet_start,
            (UINT)(domain_name_ptr - packet_start),
            buffer_prepend_ptr,
            (UINT)((buffer_size - 1) & 0xFFFFFFFF));
...
/*                                                                        */
/**************************************************************************/
UINT _nx_dhcpv6_process_DNS_server(
    NX_DHCPV6 *dhcpv6_ptr, UCHAR *option_data, UINT option_length) {
    ...
    while ((index + 16) <= option_length) {
        ...
        if (j < NX_DHCPV6_NUM_DNS_SERVERS) {
            ...
            /* Set the IP version. */
            dhcpv6_ptr->nx_dhcpv6_DNS_name_server_address[j].nxd_ip_version =
                NX_IP_VERSION_V6;
            ...
            for (w = 0; w <= 3; w++) {
                ...
                memcpy(
                    &(dhcpv6_ptr->nx_dhcpv6_DNS_name_server_address[j]
                          .nxd_ip_address.v6[w]), /* Use case of memcpy is verified. */
                    (option_data + index),
                    sizeof(ULONG));

                /* Adjust for endianness. */
                NX_CHANGE_ULONG_ENDIAN(dhcpv6_ptr->nx_dhcpv6_DNS_name_server_address[j]
                                           .nxd_ip_address.v6[w]);
...
/*                                                                        */
/**************************************************************************/
UINT _nx_dhcpv6_process_ia(
    NX_DHCPV6 *dhcpv6_ptr, UCHAR *option_data, UINT option_length, UINT ia_index) {
    ...
    /* Check option length for Ipv6 address (16 bytes), preferred-lifetime (4 bytes) and
    ...
    for (w = 0; w <= 3; w++) {
        ...
        memcpy(
            &(dhcpv6_ptr->nx_dhcpv6_ia[ia_index]
                  .nx_global_address.nxd_ip_address
                  .v6[w]), /* Use case of memcpy is verified. */
            (option_data + index),
            sizeof(ULONG));

        /* Adjust for endianness. */
        NX_CHANGE_ULONG_ENDIAN(
            dhcpv6_ptr->nx_dhcpv6_ia[ia_index].nx_global_address.nxd_ip_address.v6[w]);
    ...
    if (dhcpv6_ptr->nx_dhcpv6_ia[ia_index].nx_address_status ==
        NX_DHCPV6_IA_ADDRESS_STATE_INVALID) {
        dhcpv6_ptr->nx_dhcpv6_ia[ia_index].nx_address_status =
            NX_DHCPV6_IA_ADDRESS_STATE_INITIAL;
    }

    /* Update the map status, 0xFFFFFFFF indicate the IPv6 address of IA option has been
     * processed.  */
    ...
    status = _nx_dhcpv6_utility_get_block_option_length(
        option_data + index, &ia_option_code, &ia_option_length);
    ...
    if (ia_option_code == NX_DHCPV6_OP_STATUS_CODE) {
        ...
        /* Process the status. */
        status = _nx_dhcpv6_process_status(
            dhcpv6_ptr, (option_data + index), ia_option_length);
        ...
        if ((status == NX_SUCCESS) && (dhcpv6_ptr->nx_status_code != NX_DHCPV6_SUCCESS)) {
            ...
            if (dhcpv6_ptr->nx_dhcpv6_server_error_handler) {
                ...
                /* Call the error handler with status code, option (IAaddr) and which
                 * message type it refers to. */
                dhcpv6_ptr->nx_dhcpv6_server_error_handler(
                    dhcpv6_ptr,
                    NX_DHCPV6_ERROR_STATUS_CODE_IN_IA_ADDRESS,
                    dhcpv6_ptr->nx_status_code,
...
UINT _nx_dhcpv6_process_iana(
    ...
    while (index + 4 <= option_length) {
        ...
        status = _nx_dhcpv6_utility_get_block_option_length(
            (option_data + index), &iana_option_code, &iana_option_length);
        ...
        /* This is a double check to verify we haven't gone off the end of the packet
         * buffer. */
        ...
        if (iana_option_code == NX_DHCPV6_OP_IA_ADDRESS) {
            ...
            for (ia_index = 0; ia_index < NX_DHCPV6_MAX_IA_ADDRESS; ia_index++) {
                ...
                if (dhcpv6_ptr->nx_dhcpv6_ia[ia_index].nx_address_map == ia_count) {
                    ...
                    status = _nx_dhcpv6_process_ia(
                        dhcpv6_ptr, (option_data + index), iana_option_length, ia_index);
        ...
        if (iana_option_code == NX_DHCPV6_OP_STATUS_CODE) {
            ...
            /* Process the status. */
            status = _nx_dhcpv6_process_status(
                dhcpv6_ptr, (option_data + index), iana_option_length);
            ...
            if ((status == NX_SUCCESS) &&
                ...
                if (dhcpv6_ptr->nx_dhcpv6_server_error_handler) {
                    ...
                    /* Call the error handler with status code, option (IA_NA) and which
                     * message type it refers to. */
                    dhcpv6_ptr->nx_dhcpv6_server_error_handler(
                        dhcpv6_ptr,
                        NX_DHCPV6_ERROR_STATUS_CODE_IN_IA_NA,
                        dhcpv6_ptr->nx_status_code,
                        dhcpv6_ptr->nx_dhcpv6_received_message_type);
                }
            }
...
/*                                                                        */
/**************************************************************************/
UINT _nx_dhcpv6_process_preference(
    NX_DHCPV6 *dhcpv6_ptr, UCHAR *option_data, UINT option_length) {
...
/*                                                                        */
/**************************************************************************/
UINT _nx_dhcpv6_process_server_duid(
    NX_DHCPV6 *dhcpv6_ptr, UCHAR *option_data, UINT option_length) {
    ...
    /* If the client state in SENDING SOLICIT/CONFRIM/REBIND/INFORM_REQUEST, record the
     * server DUID.  */
...
/*                                                                        */
/**************************************************************************/
UINT _nx_dhcpv6_process_status(
    NX_DHCPV6 *dhcpv6_ptr, UCHAR *option_data, UINT option_length) {
    ...
    memcpy(
        dhcpv6_ptr->nx_status_message,
        (option_data + index),
        message_length); /* Use case of memcpy is verified. */
...
/*                                                                        */
/**************************************************************************/
UINT _nx_dhcpv6_process_time_zone(
    NX_DHCPV6 *dhcpv6_ptr, UCHAR *option_data, UINT option_length) {
...
/*                                                                        */
/**************************************************************************/
UINT _nx_dhcpv6_process_time_server(
    NX_DHCPV6 *dhcpv6_ptr, UCHAR *option_data, UINT option_length) {
    ...
    while (index + 16 <= option_length) {
        ...
        /* Check that the DHCPv6 Client configured to store this time server address e.g.
           it may only store one address, but the server could be sending two or more. */
        if (j < NX_DHCPV6_NUM_TIME_SERVERS) {

            /* Set the IP version. */
            dhcpv6_ptr->nx_dhcpv6_time_server_address[j].nxd_ip_version =
                NX_IP_VERSION_V6;
            ...
            for (w = 0; w <= 3; w++) {
                ...
                memcpy(
                    &(dhcpv6_ptr->nx_dhcpv6_time_server_address[j]
                          .nxd_ip_address.v6[w]), /* Use case of memcpy is verified. */
                    (option_data + index),
                    sizeof(ULONG));
                ...
                /* Adjust for endianness. */
                NX_CHANGE_ULONG_ENDIAN(
                    dhcpv6_ptr->nx_dhcpv6_time_server_address[j].nxd_ip_address.v6[w]);
    ...
    if (ia_index != NX_DHCPV6_REMOVE_ALL_IA_ADDRESS) {
        ...
        if ((dhcpv6_ptr->nx_dhcpv6_ia[ia_index].nx_address_status) &&
            ...
            nxd_ipv6_address_delete(
                dhcpv6_ptr->nx_dhcpv6_ip_ptr,
                dhcpv6_ptr->nx_dhcpv6_client_address_index[ia_index]);
    ...
    /* Clear the all addresses.  */
        ...
        for (index = 0; index < NX_DHCPV6_MAX_IA_ADDRESS; index++) {
            ...
            if ((dhcpv6_ptr->nx_dhcpv6_ia[index].nx_address_status) &&
                ...
                nxd_ipv6_address_delete(
                    dhcpv6_ptr->nx_dhcpv6_ip_ptr,
                    dhcpv6_ptr->nx_dhcpv6_client_address_index[index]);
        ...
        memset(
            &dhcpv6_ptr->nx_dhcpv6_ia[0],
            0,
            NX_DHCPV6_MAX_IA_ADDRESS * sizeof(NX_DHCPV6_IA_ADDRESS));

        /* Removed the default router.  */
        if (dhcpv6_ptr->nx_dhcpv6_state >= NX_DHCPV6_STATE_SENDING_RENEW) {
            nxd_ipv6_default_router_delete(
                dhcpv6_ptr->nx_dhcpv6_ip_ptr, &(dhcpv6_ptr->nx_dhcpv6_server_address));
...
UINT _nx_dhcpv6_request_confirm(NX_DHCPV6 *dhcpv6_ptr) {
    ...
    dhcpv6_ptr->nx_dhcpv6_transmission_timeout =
        NX_DHCPV6_INIT_CONFIRM_TRANSMISSION_TIMEOUT;
    dhcpv6_ptr->nx_dhcpv6_retransmission_count = 0;
    ...
    dhcpv6_ptr->nx_dhcpv6_init_retransmission_timeout =
        NX_DHCPV6_INIT_CONFIRM_TRANSMISSION_TIMEOUT;
    dhcpv6_ptr->nx_dhcpv6_max_retransmission_count =
        NX_DHCPV6_MAX_CONFIRM_RETRANSMISSION_COUNT;
    dhcpv6_ptr->nx_dhcpv6_max_retransmission_timeout =
        NX_DHCPV6_MAX_CONFIRM_RETRANSMISSION_TIMEOUT;
    dhcpv6_ptr->nx_dhcpv6_max_retransmission_duration =
        NX_DHCPV6_MAX_CONFIRM_RETRANSMISSION_DURATION;
...
UINT _nx_dhcpv6_request_decline(NX_DHCPV6 *dhcpv6_ptr) {
    ...
    dhcpv6_ptr->nx_dhcpv6_transmission_timeout =
        NX_DHCPV6_INIT_DECLINE_TRANSMISSION_TIMEOUT;
    dhcpv6_ptr->nx_dhcpv6_retransmission_count = 0;
    ...
    dhcpv6_ptr->nx_dhcpv6_init_retransmission_timeout =
        NX_DHCPV6_INIT_DECLINE_TRANSMISSION_TIMEOUT;
    dhcpv6_ptr->nx_dhcpv6_max_retransmission_count =
        NX_DHCPV6_MAX_DECLINE_RETRANSMISSION_COUNT;
    dhcpv6_ptr->nx_dhcpv6_max_retransmission_timeout =
        NX_DHCPV6_MAX_DECLINE_RETRANSMISSION_TIMEOUT;
    dhcpv6_ptr->nx_dhcpv6_max_retransmission_duration =
        NX_DHCPV6_MAX_DECLINE_RETRANSMISSION_DURATION;

    /* Activate the session timer to update the elapsed time.  */
    tx_timer_activate(&dhcpv6_ptr->nx_dhcpv6_session_timer);

    /* Now remove the address from the IP address table,the client MUST NOT use any of the
       addresses it is declining as the source address in the Release message or in any
       subsequently transmitted message, RFC3315,section18.1.7.. */

    /* Set the DHCPv6 Client IPv6 addresses.  */
    for (ia_index = 0; ia_index < NX_DHCPV6_MAX_IA_ADDRESS; ia_index++) {

        /* Now remove the address from the IP address table,the client MUST NOT use any of
        the addresses it is declining as the source address in the Release message or in
        any subsequently transmitted message, RFC3315,section18.1.7.. */

        /* Verify we have a valid address index. */
        if (dhcpv6_ptr->nx_dhcpv6_client_address_index[ia_index] >=
        ...
        if (dhcpv6_ptr->nx_dhcpv6_ia[ia_index].nx_address_status ==
            NX_DHCPV6_IA_ADDRESS_STATE_DAD_FAILURE) {
...
UINT _nx_dhcpv6_request_inform_request(NX_DHCPV6 *dhcpv6_ptr) {
    ...
    /* Set the initial and max retransmission timeout and max number of retries.  */
    dhcpv6_ptr->nx_dhcpv6_transmission_timeout =
        NX_DHCPV6_INIT_INFORM_TRANSMISSION_TIMEOUT;
    dhcpv6_ptr->nx_dhcpv6_retransmission_count = 0;
    ...
    dhcpv6_ptr->nx_dhcpv6_init_retransmission_timeout =
        NX_DHCPV6_INIT_INFORM_TRANSMISSION_TIMEOUT;
    dhcpv6_ptr->nx_dhcpv6_max_retransmission_count =
        NX_DHCPV6_MAX_INFORM_RETRANSMISSION_COUNT;
    dhcpv6_ptr->nx_dhcpv6_max_retransmission_timeout =
        NX_DHCPV6_MAX_INFORM_RETRANSMISSION_TIMEOUT;
    dhcpv6_ptr->nx_dhcpv6_max_retransmission_duration =
        NX_DHCPV6_MAX_INFORM_RETRANSMISSION_DURATION;
...
UINT _nx_dhcpv6_request_option_DNS_server(NX_DHCPV6 *dhcpv6_ptr, UINT enable) {
    ...
    if (enable == NX_TRUE) {
        ...
        dhcpv6_ptr->nx_dhcpv6_option_request.nx_op_request |=
            (USHORT)NX_DHCPV6_DNS_SERVER_OPTION;
    } else {
...
UINT _nx_dhcpv6_request_option_domain_name(NX_DHCPV6 *dhcpv6_ptr, UINT enable) {
    ...
    if (enable == NX_TRUE) {
        /* Yes, register this option request with the DHCPv6 Client. */
        dhcpv6_ptr->nx_dhcpv6_option_request.nx_op_request |=
            (USHORT)NX_DHCPV6_DOMAIN_NAME_OPTION;
    } else {
...
UINT _nx_dhcpv6_request_option_time_server(NX_DHCPV6 *dhcpv6_ptr, UINT enable) {
    ...
    if (enable == NX_TRUE) {
        /* Yes, register this option request with the DHCPv6 Client. */
        dhcpv6_ptr->nx_dhcpv6_option_request.nx_op_request |=
            (USHORT)NX_DHCPV6_SNTP_SERVER_OPTION;
    } else {
...
UINT _nx_dhcpv6_request_option_timezone(NX_DHCPV6 *dhcpv6_ptr, UINT enable) {
    ...
    if (enable == NX_TRUE) {
        /* Yes, register this option request with the DHCPv6 Client. */
        dhcpv6_ptr->nx_dhcpv6_option_request.nx_op_request |=
            NX_DHCPV6_NEW_POSIX_TIMEZONE_OPTION;
    } else {

        /* Clear this option request with the DHCPv6 Client. */
        dhcpv6_ptr->nx_dhcpv6_option_request.nx_op_request &=
            (USHORT)(~NX_DHCPV6_NEW_POSIX_TIMEZONE_OPTION);
    }
...
UINT _nx_dhcpv6_request_option_FQDN(NX_DHCPV6 *dhcpv6_ptr, CHAR *domain_name, UINT op) {
    ...
    /* Check domain name lengrh. The total length of a domain name is restricted to 255
     * octets or less. RFC1035.  */
    if (_nx_utility_string_length_check(
            domain_name, &name_length, NX_DHCPV6_MAX_NAME_SIZE)) {
        return (NX_DHCPV6_PARAM_ERROR);
    }

    /* Set the Client FQDN option length. 1 + length of domain name(domain name length +
     * label + terminator) .  */
    ...
    */
    ...
    if (op == NX_DHCPV6_CLIENT_DESIRES_UPDATE_AAAA_RR) {
        ...
        /* DHCPv6 Client chooses to update the FQDN-to-IPv6 address mapping for FQDN and
           address(es) used by the Cslient. Set the "S", "O" and "N" bits as 0.  */
        dhcpv6_ptr->nx_dhcpv6_client_FQDN.nx_flags = 0x00;
    } else if (op == NX_DHCPV6_CLIENT_DESIRES_SERVER_DO_DNS_UPDATE) {

        /* DHCPv6 Client chooses to update the FQDN-to-IPv6 address mapping for FQDN and
           address(es) used by the Client to the Server. Set the "S" bit as 1, Set "O" and
           "N" bits as 0.  */
        dhcpv6_ptr->nx_dhcpv6_client_FQDN.nx_flags = 0x01;
    } else {

        /* DHCPv6 Client choose to request that the Server perform no DNS updates on its
           behalf. Set the "N" bit as 1, Set "O" and "S" bits as 0.  */
...
UINT _nx_dhcpv6_request_rebind(NX_DHCPV6 *dhcpv6_ptr) {
    ...
    /* Set the initial and max retransmission timeouts and max number of retries. */
    dhcpv6_ptr->nx_dhcpv6_transmission_timeout =
        NX_DHCPV6_INIT_REBIND_TRANSMISSION_TIMEOUT;
    dhcpv6_ptr->nx_dhcpv6_retransmission_count = 0;
    ...
    dhcpv6_ptr->nx_dhcpv6_init_retransmission_timeout =
        NX_DHCPV6_INIT_REBIND_TRANSMISSION_TIMEOUT;
    dhcpv6_ptr->nx_dhcpv6_max_retransmission_count =
        NX_DHCPV6_MAX_REBIND_RETRANSMISSION_COUNT;
    dhcpv6_ptr->nx_dhcpv6_max_retransmission_timeout =
        NX_DHCPV6_MAX_REBIND_RETRANSMISSION_TIMEOUT;
    ...
    /* Set the max duration time.The message exchange is terminated when the valid
       lifetimes of all the addresses assigned to the IA expire, RFC3315, Section18.1.4,
       Page43.  */
...
UINT _nx_dhcpv6_request_release(NX_DHCPV6 *dhcpv6_ptr) {
    ...
    if ((dhcpv6_ptr->nx_dhcpv6_state != NX_DHCPV6_STATE_BOUND_TO_ADDRESS) &&
        ...
        /* It is not. The host application should use the nx_dhcpv6_stop if the DHCP
           Client has simply failed to obtain an IP address from the server instead. */
    ...
    /* Set the initial and max retransmission timeouts and max number of retries.  */
    dhcpv6_ptr->nx_dhcpv6_transmission_timeout =
        NX_DHCPV6_INIT_RELEASE_TRANSMISSION_TIMEOUT;
    dhcpv6_ptr->nx_dhcpv6_retransmission_count = 0;
    ...
    dhcpv6_ptr->nx_dhcpv6_init_retransmission_timeout =
        NX_DHCPV6_INIT_RELEASE_TRANSMISSION_TIMEOUT;
    dhcpv6_ptr->nx_dhcpv6_max_retransmission_count =
        NX_DHCPV6_MAX_RELEASE_RETRANSMISSION_COUNT;
    dhcpv6_ptr->nx_dhcpv6_max_retransmission_timeout =
        NX_DHCPV6_MAX_RELEASE_RETRANSMISSION_TIMEOUT;
    dhcpv6_ptr->nx_dhcpv6_max_retransmission_duration =
        NX_DHCPV6_MAX_RELEASE_RETRANSMISSION_DURATION;
...
UINT _nx_dhcpv6_request_renew(NX_DHCPV6 *dhcpv6_ptr) {
    ...
    dhcpv6_ptr->nx_dhcpv6_retransmission_count = 0;
    dhcpv6_ptr->nx_dhcpv6_transmission_timeout =
        NX_DHCPV6_INIT_RENEW_TRANSMISSION_TIMEOUT;
    ...
    dhcpv6_ptr->nx_dhcpv6_init_retransmission_timeout =
        NX_DHCPV6_INIT_RENEW_TRANSMISSION_TIMEOUT;
    dhcpv6_ptr->nx_dhcpv6_max_retransmission_count =
        NX_DHCPV6_MAX_RENEW_RETRANSMISSION_COUNT;
    dhcpv6_ptr->nx_dhcpv6_max_retransmission_timeout =
        NX_DHCPV6_MAX_RENEW_RETRANSMISSION_TIMEOUT;
...
UINT _nx_dhcpv6_request_solicit(NX_DHCPV6 *dhcpv6_ptr) {
    ...
    /* Set the mode of sending the solicit message.  Do not override a rapid option if
     * set. */
    ...
    dhcpv6_ptr->nx_dhcpv6_max_retransmission_duration =
        NX_DHCPV6_MAX_SOL_RETRANSMISSION_DURATION;
...
UINT _nx_dhcpv6_resume(NX_DHCPV6 *dhcpv6_ptr) {
    ...
    status = nx_udp_socket_bind(
        &(dhcpv6_ptr->nx_dhcpv6_socket), NX_DHCPV6_CLIENT_UDP_PORT, TX_WAIT_FOREVER);
    ...
    if ((dhcpv6_ptr->nx_dhcpv6_state != NX_DHCPV6_STATE_BOUND_TO_ADDRESS) &&
        ...
        if ((dhcpv6_ptr->nx_dhcpv6_state == NX_DHCPV6_STATE_BOUND_TO_ADDRESS) &&
            ...
            /* Update the status as NX_DHCPV6_STATE_SENDING_RENEW to send rebinding
             * message in _nx_dhcpv6_thread_entry function.  */
            dhcpv6_ptr->nx_dhcpv6_state = NX_DHCPV6_STATE_SENDING_RENEW;
        }
    }
...
UINT _nx_dhcpv6_send_request(NX_DHCPV6 *dhcpv6_ptr) {
    ...
    if ((dhcpv6_ptr->nx_dhcpv6_message_hdr.nx_message_type ==
         NX_DHCPV6_MESSAGE_TYPE_ADVERTISE) ||
        (dhcpv6_ptr->nx_dhcpv6_message_hdr.nx_message_type ==
         NX_DHCPV6_MESSAGE_TYPE_REPLY) ||
        (dhcpv6_ptr->nx_dhcpv6_message_hdr.nx_message_type ==
         NX_DHCPV6_MESSAGE_TYPE_RECONFIGURE) ||
        (dhcpv6_ptr->nx_dhcpv6_message_hdr.nx_message_type >
         NX_DHCPV6_MESSAGE_TYPE_INFORM_REQUEST) ||
    ...
    /* Use the message id value to judge whether the next packet is retransmit packet or
       not. If the id value is 0, indicate the new dhcpv6 request, then generate a random
       number, else,leave the transaction  ID unchanged. A client MUST leave the
       transaction ID unchanged in retransmissions of a
       message,RFC3315,section 15.1,page 28.  */
    if (dhcpv6_ptr->nx_dhcpv6_message_hdr.nx_message_xid == 0) {

        /* Generate "random" transaction ID using physical address and a random factor for
        each request to the Server.  The Server must include a matching transaction ID in
        its reply. */
        ...
        dhcpv6_ptr->nx_dhcpv6_message_hdr.nx_message_xid =
            (dhcpv6_ptr->nx_dhcpv6_message_hdr.nx_message_xid & (ULONG)(0x0ffffff));
    }
    ...
    message_word |=
        (((ULONG)(0x0ffffff)) & (dhcpv6_ptr->nx_dhcpv6_message_hdr.nx_message_xid));
    ...
    /* Determine if any additional options need to be added relative to the DHCPV6 message
     * type.  */
    ...
    case NX_DHCPV6_MESSAGE_TYPE_SOLICIT: {
        ...
        /* Did the Client ask for a DHCPv6 Client FQDN option ?
           A client MUST only include the Client FQDN option in SOLICIT, REQUEST, RENEW,
           or REBIND messsage.  */
        ...
        if (dhcpv6_ptr->nx_dhcpv6_request_solicit_mode == NX_DHCPV6_SOLICIT_RAPID) {
            ...
            /* Compute the available payload for DHCP data in the packet buffer. */
            available_payload =
                (ULONG)(dhcpv6_ptr->nx_dhcpv6_pool_ptr->nx_packet_pool_payload_size -
    ...
    case NX_DHCPV6_MESSAGE_TYPE_REQUEST: {
        ...
        /* Append an IA-NA with the IA address option received from server added to the
         * IA-NA option. */
        status = _nx_dhcpv6_add_iana(dhcpv6_ptr, buffer, &index);
    ...
    case NX_DHCPV6_MESSAGE_TYPE_RENEW: {
        ...
        /* A client MAY include an Option Request option in a Solicit, Request, Renew,
           Rebind, Confirm or Information-request message to inform the server about
           options the client wants the server to send to the client. RFC3315,
           Section22.7, Page78.*/
        if (dhcpv6_ptr->nx_dhcpv6_option_request.nx_op_request) {
            /* Add the server DUID just extracted from the Server Advertise message. */
            status = _nx_dhcpv6_add_option_request(dhcpv6_ptr, buffer, &index);
    ...
    /* Select Client Source address:
       1. When a client sends a DHCP message to the All_DHCP_Relay_Agents_and_Servers
       address, the client must use a link-local address assigned to the interface for
       which it is requesting configuration as the source address.
    ...
    if (CHECK_IPV6_ADDRESSES_SAME(
            dhcpv6_ptr->nx_dhcpv6_client_destination_address.nxd_ip_address.v6,
            All_DHCPv6_Relay_Servers_Address.nxd_ip_address.v6)) {
        ...
        while (ipv6_address) {
            ...
            /* Check for link-local address. */
                ...
                IPv6_Address_Type(ipv6_address->nxd_ipv6_address) &
    ...
    /* Send the packet out! */
    status = _nxd_udp_socket_source_send(
        &(dhcpv6_ptr->nx_dhcpv6_socket),
        packet_ptr,
        &dhcpv6_ptr->nx_dhcpv6_client_destination_address,
        NX_DHCPV6_SERVER_UDP_PORT,
...
VOID _nx_dhcpv6_session_timeout_entry(ULONG dhcpv6_ptr_value) {
    ...
    /* Check the elapsed time, the time is expressed in hundredths of 1 second, 65500 is
    ...
    if (dhcpv6_ptr->nx_dhcpv6_elapsed_time.nx_session_time < 65500) {
        ...
        dhcpv6_ptr->nx_dhcpv6_elapsed_time.nx_session_time =
            (USHORT)(dhcpv6_ptr->nx_dhcpv6_elapsed_time.nx_session_time +
                     NX_DHCPV6_SESSION_TIMER_INTERVAL * 100);
    } else {

        /* Set the value 0xFFFF to represent any elapsed time values greater than the
         * largest time value . */
...
/*                                                                        */
/**************************************************************************/
UINT _nxe_dhcpv6_client_set_destination_address(
    NX_DHCPV6 *dhcpv6_ptr, NXD_ADDRESS *destination_address) {
...
/*                                                                        */
/**************************************************************************/
UINT _nx_dhcpv6_client_set_destination_address(
    NX_DHCPV6 *dhcpv6_ptr, NXD_ADDRESS *destination_address) {
    ...
    /* Set the destination address.  */
    COPY_NXD_ADDRESS(
        destination_address, &(dhcpv6_ptr->nx_dhcpv6_client_destination_address));
...
UINT _nx_dhcpv6_stop(NX_DHCPV6 *dhcpv6_ptr) {
    ...
    tx_thread_preemption_change(
        tx_thread_identify(), current_preemption, &current_preemption);
...
VOID _nx_dhcpv6_thread_entry(ULONG info) {
    ...
    do {
        ...
        /* Check the expiration on valid and preferred lifetimes only if the Client is in
         * the Bound state. */
        if (dhcpv6_ptr->nx_dhcpv6_state == NX_DHCPV6_STATE_BOUND_TO_ADDRESS) {

            /* At time T1 for an IA, the client initiates a Renew message exchange to
             * extend the lifetimes. RFC3315,page 42.*/
            if (dhcpv6_ptr->nx_dhcpv6_IP_lifetime_time_accrued >=
                dhcpv6_ptr->nx_dhcpv6_iana.nx_T1) {
        ...
        /* Check the expiration on valid and preferred lifetimes only if the Client is in
         * the sending renew state. */
        if (dhcpv6_ptr->nx_dhcpv6_state == NX_DHCPV6_STATE_SENDING_RENEW) {

            /* At time T2 for an IA, The Client initiates a Rebind message exchanges.
             * RFC3315, page 43. */
            if (dhcpv6_ptr->nx_dhcpv6_IP_lifetime_time_accrued >=
                dhcpv6_ptr->nx_dhcpv6_iana.nx_T2) {
        ...
        if ((dhcpv6_ptr->nx_dhcpv6_state == NX_DHCPV6_STATE_BOUND_TO_ADDRESS) ||
            ...
            for (ia_index = 0; ia_index < NX_DHCPV6_MAX_IA_ADDRESS; ia_index++) {
                ...
                if ((dhcpv6_ptr->nx_dhcpv6_ia[ia_index].nx_address_status) &&
                    ...
                    /* Indicate the DHCP Client process is idle while the handler
                     * executes. */
                    dhcpv6_ptr->nx_dhcpv6_sleep_flag = NX_TRUE;
                    ...
                    if (dhcpv6_ptr->nx_dhcpv6_state_change_callback &&
                        (original_state != dhcpv6_ptr->nx_dhcpv6_state)) {
                        /* Yes, call the state change callback with the original and new
                         * state. */
                        (dhcpv6_ptr->nx_dhcpv6_state_change_callback)(
                            dhcpv6_ptr, original_state, dhcpv6_ptr->nx_dhcpv6_state);
                    }
        ...
        status = tx_event_flags_get(
            &(_nx_dhcpv6_DAD_ptr->nx_dhcpv6_events),
            NX_IP_ALL_EVENTS,
            TX_OR_CLEAR,
            &dhcpv6_events,
            TX_NO_WAIT);
...
/*                                                                        */
/**************************************************************************/
UINT _nx_dhcpv6_utility_get_block_option_length(
    UCHAR *buffer_ptr, ULONG *option, ULONG *length) {
...
UINT _nx_dhcpv6_waiting_on_reply(NX_DHCPV6 *dhcpv6_ptr) {
    ...
    /* Wait in short intervals to receive a valid packet while continuously checking for
       packets not intended for this DHCP Client to be removed from the receive queue. */
    do {

        /* Release the DHCP mutex while the Client will be blocked on a receive socket
         * call.  */
        tx_mutex_put(&(dhcpv6_ptr->nx_dhcpv6_client_mutex));
        ...
        status = nx_udp_socket_receive(
            &(dhcpv6_ptr->nx_dhcpv6_socket), &packet_ptr, receive_wait);
        ...
        if (status == NX_SUCCESS) {
            ...
            /* Get the DHCP mutex.  */
            while ((tx_mutex_get(&(dhcpv6_ptr->nx_dhcpv6_client_mutex), NX_NO_WAIT) !=
                    TX_SUCCESS) &&
                   (time_remaining > 0)) {
            ...
            if (status == NX_SUCCESS) {
                ...
                if ((dhcpv6_ptr->nx_dhcpv6_state == NX_DHCPV6_STATE_SENDING_SOLICIT) &&
                    ...
                    if (dhcpv6_ptr->nx_dhcpv6_request_solicit_mode ==
                        NX_DHCPV6_SOLICIT_RAPID) {

                        /* Client terminates the waiting process as soon as a reply
                           message with a Rapid Commit option is received. RFC3315,
                           Section17.1.2, Page34. */
                        break;
                    }
...
UINT _nx_dhcpv6_packet_process(NX_DHCPV6 *dhcpv6_ptr, NX_PACKET *packet_ptr) {
    ...
    if ((ULONG)(new_packet_ptr->nx_packet_data_end -
                new_packet_ptr->nx_packet_prepend_ptr) < packet_ptr->nx_packet_length) {
    ...
    status = nx_packet_data_extract_offset(
        packet_ptr,
        0,
        (VOID *)new_packet_ptr->nx_packet_prepend_ptr,
    ...
    /* Update the new packet with the bytes copied.  For chained packets, this will
       reflect the total 'datagram' length. */
    new_packet_ptr->nx_packet_length = bytes_copied;
    new_packet_ptr->nx_packet_append_ptr =
        new_packet_ptr->nx_packet_prepend_ptr + bytes_copied;
...
UINT _nx_dhcpv6_scan_packet_options(NX_DHCPV6 *dhcpv6_ptr, NX_PACKET *packet_ptr) {
    ...
    while (index + 4 <= packet_ptr->nx_packet_length) {
        ...
        status = _nx_dhcpv6_utility_get_block_option_length(
            dhcpv6_option_ptr, &option_code, &option_length);
        ...
        case NX_DHCPV6_OP_CLIENT_ID: {
            ...
            dhcpv6_ptr->nx_dhcpv6_reply_option_flags |=
                NX_DHCPV6_INCLUDE_CLIENT_ID_OPTION;
            break;
        }
        ...
        case NX_DHCPV6_OP_SERVER_ID: {
            ...
            dhcpv6_ptr->nx_dhcpv6_reply_option_flags |=
                NX_DHCPV6_INCLUDE_SERVER_ID_OPTION;
            break;
        }
        case NX_DHCPV6_OP_IA_NA: {
            ...
            /* Skip the IA_NA header data (4 bytes for IANA option code and option length,
             * 12 bytes for IANA option field).  */
            dhcpv6_iana_option_ptr = dhcpv6_option_ptr + 4 + 12;
            iana_index = 0;

            /* Process the IA and status options embedded in the IANA option.  */
            /* 12 bytes is IA_NA header, 4 bytes for iana sub option code and option
             * length.  */
            while (iana_index + 4 <= (option_length - 12)) {

                /* Get the next option code and length. */
                status = _nx_dhcpv6_utility_get_block_option_length(
                    dhcpv6_iana_option_ptr, &iana_option_code, &iana_option_length);

                /* Check if the option data is in the packet.  */
                if ((dhcpv6_iana_option_ptr + 4 + iana_option_length) >
                ...
                if (iana_option_code == NX_DHCPV6_OP_IA_ADDRESS) {
                    ...
                    dhcpv6_ptr->nx_dhcpv6_reply_option_flags |=
                        NX_DHCPV6_INCLUDE_IA_ADDRESS_OPTION;
                    ...
                    for (w = 0; w <= 3; w++) {
                        ...
                        memcpy(
                            &ipv6_address[w],
                            (dhcpv6_iana_option_ptr + ia_option_index),
                            sizeof(ULONG)); /* Use case of memcpy is verified. */
                    ...
                    for (w = 0; w < NX_DHCPV6_MAX_IA_ADDRESS; w++) {
                        ...
                        if (!(memcmp(
                                &(dhcpv6_ptr->nx_dhcpv6_ia[w]
                                      .nx_global_address.nxd_ip_address.v6[0]),
                                &ipv6_address[0],
                                16))) {

                            /* Yes, it is, record the index to store the IA option, 0
                               means is IA address inexistence. Then update the IA option
                               according to the IA count in nx_dhcpv6_update_ia function.
                             */
                    ...
                    /* 24 bytes is IA address option, 4 bytes for next option code and
                     * option length.  */
                    if (iana_option_length >= (24 + 4)) {
                        ...
                        status = _nx_dhcpv6_utility_get_block_option_length(
                            dhcpv6_ia_option_ptr, &ia_option_code, &ia_option_length);

                        /* Check if the option data is in the packet.  */
                        if ((dhcpv6_ia_option_ptr + 4 + ia_option_length) >
                            packet_ptr->nx_packet_append_ptr) {
                            return (NX_DHCPV6_INCOMPLETE_OPTION_BLOCK);
                        }
                        ...
                        if (ia_option_code == NX_DHCPV6_OP_STATUS_CODE) {
                            ...
                            if (status_code == 0) {
                                ...
                                dhcpv6_ptr->nx_dhcpv6_reply_option_flags |=
                                    NX_DHCPV6_INCLUDE_STATUS_SUCCESS_OPTION;
                            } else if (status_code == 1) {

                                /* Yes, The message includes the UnspecFail status option.
                                 */
                                dhcpv6_ptr->nx_dhcpv6_reply_option_flags |=
                                    NX_DHCPV6_INCLUDE_STATUS_UNSPEC_FAIL_OPTION;
                            } else if (status_code == 2) {

                                /* Yes, The message includes the NoAddrsAvail status
                                 * option.  */
                                dhcpv6_ptr->nx_dhcpv6_reply_option_flags |=
                                    NX_DHCPV6_INCLUDE_STATUS_NO_ADDR_AVAIL_OPTION;
                            } else if (status_code == 3) {

                                /* Yes, The message includes the NoBinding status option.
                                 */
                                dhcpv6_ptr->nx_dhcpv6_reply_option_flags |=
                                    NX_DHCPV6_INCLUDE_STATUS_NO_BIND_OPTION;
                            } else if (status_code == 4) {

                                /* Yes, The message includes the NotOnLink status option.
                                 */
                                dhcpv6_ptr->nx_dhcpv6_reply_option_flags |=
                                    NX_DHCPV6_INCLUDE_STATUS_NOT_ONLINK_OPTION;
                            } else if (status_code == 5) {

                                /* Yes, The message includes the UseMulticast status
                                 * option.  */
                                dhcpv6_ptr->nx_dhcpv6_reply_option_flags |=
                                    NX_DHCPV6_INCLUDE_STATUS_USE_MULTICAST_OPTION;
                            } else {
        ...
        case NX_DHCPV6_OP_PREFERENCE: {
            ...
            dhcpv6_ptr->nx_dhcpv6_reply_option_flags |=
                NX_DHCPV6_INCLUDE_PREFERENCE_OPTION;

            /* Record the preference option value of current advetise message.  */
            dhcpv6_ptr->nx_dhcpv6_reply_option_current_pref_value =
                (USHORT)(*(dhcpv6_option_ptr + 4));
        ...
        case NX_DHCPV6_OP_RAPID_COMMIT: {
            ...
            dhcpv6_ptr->nx_dhcpv6_reply_option_flags |=
                NX_DHCPV6_INCLUDE_RAPID_COMMIT_OPTION;
            break;
        }
        ...
        case NX_DHCPV6_OP_DNS_SERVER: {
            ...
            dhcpv6_ptr->nx_dhcpv6_reply_option_flags |=
                NX_DHCPV6_INCLUDE_DNS_SERVER_OPTION;
            break;
        }
        ...
        case NX_DHCPV6_OP_SNTP_SERVER: {
            ...
            dhcpv6_ptr->nx_dhcpv6_reply_option_flags |=
                NX_DHCPV6_INCLUDE_SNTP_SERVER_OPTION;
            break;
        }
        ...
        case NX_DHCPV6_OP_CLIENT_FQDN: {
            ...
            dhcpv6_ptr->nx_dhcpv6_reply_option_flags |=
                NX_DHCPV6_INCLUDE_CLIENT_FQDN_OPTION;
            break;
        }
        ...
        case NX_DHCPV6_OP_NEW_POSIX_TIMEZONE: {
            ...
            dhcpv6_ptr->nx_dhcpv6_reply_option_flags |=
                NX_DHCPV6_INCLUDE_NEW_POSIX_TIIMEZONE_OPTION;
            break;
        }
...
/*                                                                        */
/**************************************************************************/
UINT _nx_dhcpv6_preprocess_packet_information(
    NX_DHCPV6 *dhcpv6_ptr, NX_PACKET *packet_ptr) {
    ...
    _nx_dhcpv6_utility_get_data(
        packet_ptr->nx_packet_prepend_ptr, 1, &received_message_type);
    ...
    _nx_dhcpv6_utility_get_data(
        (packet_ptr->nx_packet_prepend_ptr + 1), 3, &returned_xid);
    ...
    case NX_DHCPV6_STATE_SENDING_SOLICIT: {
        ...
        if (!(dhcpv6_ptr->nx_dhcpv6_reply_option_flags &
              NX_DHCPV6_INCLUDE_CLIENT_ID_OPTION) ||
            !(dhcpv6_ptr->nx_dhcpv6_reply_option_flags &
              NX_DHCPV6_INCLUDE_SERVER_ID_OPTION)) {
        ...
        /* DHcpv6 Client must ignore any advertise message that includes a status code
        ...
        if (dhcpv6_ptr->nx_dhcpv6_request_solicit_mode == NX_DHCPV6_SOLICIT_RAPID) {
            ...
            if ((dhcpv6_ptr->nx_dhcpv6_preference.nx_pref_value != 0) &&
                (dhcpv6_ptr->nx_dhcpv6_reply_option_current_pref_value <=
                 dhcpv6_ptr->nx_dhcpv6_preference.nx_pref_value)) {

                /* The current preference value is equal to or less than the recorded
                   preference valude, DHCPv6 Client need not process the message, return.
                 */
...
UINT _nx_dhcpv6_extract_packet_information(NX_DHCPV6 *dhcpv6_ptr, NX_PACKET *packet_ptr) {
    ...
    /* The DHCPv6 header has been processed in preprocess function, so process the
     * options.  */
    ...
    while (index + 4 <= packet_ptr->nx_packet_length) {
        ...
        /* Get the option code and length of data of the current option block. */
        status = _nx_dhcpv6_utility_get_block_option_length(
            buffer_ptr, &option_code, &option_length);
        ...
        case NX_DHCPV6_OP_CLIENT_ID: {
            ...
            status =
                _nx_dhcpv6_process_client_duid(dhcpv6_ptr, buffer_ptr, option_length);
        ...
        case NX_DHCPV6_OP_SERVER_ID: {
            ...
            status =
                _nx_dhcpv6_process_server_duid(dhcpv6_ptr, buffer_ptr, option_length);
        ...
        /* This should not happen. The IA address option must be embedded in the IANA
         * option. */
        case NX_DHCPV6_OP_IA_ADDRESS: {

            /* Don't process an IA address option outside of an address association
             * (IANA). */
        ...
        /* The RFC for DHCPv6 indicates any option can have a status option applied to it.
           So a status option outside of an IANA option (where it is usually found) has to
           be handled. */
        case NX_DHCPV6_OP_STATUS_CODE: {
            ...
            if ((status == NX_SUCCESS) &&
                ...
                if (dhcpv6_ptr->nx_dhcpv6_server_error_handler) {
                    ...
                    /* Send the status and which option the status is reported for to the
                     * handler. */
                    (dhcpv6_ptr->nx_dhcpv6_server_error_handler)(
                        dhcpv6_ptr,
                        NX_DHCPV6_ERROR_STATUS_CODE_IN_OPTION_FIELD,
                        dhcpv6_ptr->nx_status_code,
                        dhcpv6_ptr->nx_dhcpv6_received_message_type);
                }
            }
        ...
        case NX_DHCPV6_OP_PREFERENCE: {
            ...
            /* The remainder are RFC mandated option codes for specific options. Not all
               of these have been finalized by IANA as of this release. */
        ...
        case NX_DHCPV6_OP_DOMAIN_NAME: {
            status = _nx_dhcpv6_process_domain_name(
                dhcpv6_ptr, packet_ptr->nx_packet_prepend_ptr, buffer_ptr, option_length);
            break;
        }
        ...
        case NX_DHCPV6_OP_SNTP_SERVER: {
            ...
            status =
                _nx_dhcpv6_process_time_server(dhcpv6_ptr, buffer_ptr, option_length);
            break;
        }
...
VOID _nx_dhcpv6_flush_queue_packets(NX_DHCPV6 *dhcpv6_ptr) {
    ...
    while (status == NX_SUCCESS) {
        ...
        status = nx_udp_socket_receive(
            &(dhcpv6_ptr->nx_dhcpv6_socket), &packet_ptr, NX_NO_WAIT);
...
UINT _nx_dhcpv6_update_retransmit_info(NX_DHCPV6 *dhcpv6_ptr) {
    ...
    if ((dhcpv6_ptr->nx_dhcpv6_max_retransmission_count != 0) ||
        (dhcpv6_ptr->nx_dhcpv6_max_retransmission_duration != 0)) {
        ...
        if ((dhcpv6_ptr->nx_dhcpv6_max_retransmission_duration != 0) &&
            (dhcpv6_ptr->nx_dhcpv6_elapsed_time.nx_session_time >=
             (dhcpv6_ptr->nx_dhcpv6_max_retransmission_duration * 100))) {
    ...
    dhcpv6_ptr->nx_dhcpv6_transmission_timeout =
        2 * dhcpv6_ptr->nx_dhcpv6_transmission_timeout;

    /* Is the retransmission timeout greater than the max allowable timeout, if there is
     * one? */
...
/*                                                                        */
/**************************************************************************/
UINT _nxe_dhcpv6_user_option_add_callback_set(
    NX_DHCPV6 *dhcpv6_ptr,
    UINT (*dhcpv6_user_option_add)(
        NX_DHCPV6 *dhcpv6_ptr,
...
/*                                                                        */
/**************************************************************************/
UINT _nx_dhcpv6_user_option_add_callback_set(
    NX_DHCPV6 *dhcpv6_ptr,
    UINT (*dhcpv6_user_option_add)(
        NX_DHCPV6 *dhcpv6_ptr,
        UINT interface_index,
...
/*                                                                        */
/**************************************************************************/
VOID _nx_dhcpv6_ipv6_address_DAD_notify(
    NX_IP *ip_ptr,
    UINT status,
    UINT interface_index,
    ...
    if (status == NX_IPV6_ADDRESS_DAD_FAILURE) {
        ...
        for (ia_index = 0; ia_index < NX_DHCPV6_MAX_IA_ADDRESS; ia_index++) {
            ...
            if ((_nx_dhcpv6_DAD_ptr->nx_dhcpv6_client_address_index[ia_index] ==
                 ipv6_addr_index) &&
                (!memcmp(
                    &(_nx_dhcpv6_DAD_ptr->nx_dhcpv6_ia[ia_index]
                          .nx_global_address.nxd_ip_address.v6[0]),
                    ipv6_address,
                    16))) {

                /* Set the IPv6 address status DAD failure.  */
                _nx_dhcpv6_DAD_ptr->nx_dhcpv6_ia[ia_index].nx_address_status =
                    NX_DHCPV6_IA_ADDRESS_STATE_DAD_FAILURE;

                /* Wakeup DHCPv6 thread for processing DAD failure event.  */
                tx_event_flags_set(
                    &_nx_dhcpv6_DAD_ptr->nx_dhcpv6_events,
                    NX_DHCPV6_DAD_FAILURE_EVENT,
                    TX_OR);
...
/*                                                                        */
/**************************************************************************/
UINT _nxe_dhcpv6_client_get_record(
...
/*                                                                        */
/**************************************************************************/
UINT _nx_dhcpv6_client_get_record(
    NX_DHCPV6 *dhcpv6_ptr, NX_DHCPV6_CLIENT_RECORD *client_record_ptr) {
    ...
    /* The DHCPv6 Client is not Bound to an IP address. Cannot create a record for
       restoring Client state if not bound to an IP lease. */
    if (dhcpv6_ptr->nx_dhcpv6_state != NX_DHCPV6_STATE_BOUND_TO_ADDRESS) {
    ...
    client_record_ptr->nx_dhcpv6_client_interface_index =
        dhcpv6_ptr->nx_dhcpv6_client_interface_index;
    memcpy(
        client_record_ptr->nx_dhcpv6_client_address_index,
        dhcpv6_ptr->nx_dhcpv6_client_address_index,
        sizeof(UINT) * NX_DHCPV6_MAX_IA_ADDRESS); /* Use case of memcpy is verified. */

    /* Set the time since client set its IP address.  */
    client_record_ptr->nx_dhcpv6_IP_lifetime_time_accrued =
        dhcpv6_ptr->nx_dhcpv6_IP_lifetime_time_accrued;

    /* Set the Client DUID.  */
    memcpy(
        &client_record_ptr->nx_dhcpv6_client_duid,
        &dhcpv6_ptr->nx_dhcpv6_client_duid,
        sizeof(NX_DHCPV6_DUID)); /* Use case of memcpy is verified. */

    /* Set the Server DUID.  */
    memcpy(
        &client_record_ptr->nx_dhcpv6_server_duid,
        &dhcpv6_ptr->nx_dhcpv6_server_duid,
        sizeof(NX_DHCPV6_DUID)); /* Use case of memcpy is verified. */

    /* Set the IANA.  */
    memcpy(
        &client_record_ptr->nx_dhcpv6_iana,
        &dhcpv6_ptr->nx_dhcpv6_iana,
        sizeof(NX_DHCPV6_IA_NA)); /* Use case of memcpy is verified. */

    /* Set the IA Address.  */
    memcpy(
        &client_record_ptr->nx_dhcpv6_ia,
        &dhcpv6_ptr->nx_dhcpv6_ia,
        sizeof(NX_DHCPV6_IA_ADDRESS) *
            NX_DHCPV6_MAX_IA_ADDRESS); /* Use case of memcpy is verified. */

    /* Set the Option request.  */
    memcpy(
        &client_record_ptr->nx_dhcpv6_option_request,
        &dhcpv6_ptr->nx_dhcpv6_option_request,
        sizeof(NX_DHCPV6_OPTIONREQUEST)); /* Use case of memcpy is verified. */

    /* Set the Client FQDN.  */
    memcpy(
        &client_record_ptr->nx_dhcpv6_client_FQDN,
        &dhcpv6_ptr->nx_dhcpv6_client_FQDN,
        sizeof(NX_DHCPV6_CLIENT_FQDN)); /* Use case of memcpy is verified. */

    /* Set the dns name server address.  */
    memcpy(
        &client_record_ptr->nx_dhcpv6_DNS_name_server_address,
        &dhcpv6_ptr->nx_dhcpv6_DNS_name_server_address,
        sizeof(NXD_ADDRESS) *
            NX_DHCPV6_NUM_DNS_SERVERS); /* Use case of memcpy is verified. */

    /* Set the time server address.  */
    memcpy(
        &client_record_ptr->nx_dhcpv6_time_server_address,
        &dhcpv6_ptr->nx_dhcpv6_time_server_address,
        sizeof(NXD_ADDRESS) *
            NX_DHCPV6_NUM_TIME_SERVERS); /* Use case of memcpy is verified. */

    /* Set the domain name.  */
    memcpy(
        client_record_ptr->nx_dhcpv6_domain_name,
        dhcpv6_ptr->nx_dhcpv6_domain_name,
        NX_DHCPV6_DOMAIN_NAME_BUFFER_SIZE); /* Use case of memcpy is verified. */

    /* Set the time zone.  */
    memcpy(
        client_record_ptr->nx_dhcpv6_time_zone,
        dhcpv6_ptr->nx_dhcpv6_time_zone,
        NX_DHCPV6_TIME_ZONE_BUFFER_SIZE); /* Use case of memcpy is verified. */
...
/*                                                                        */
/**************************************************************************/
UINT _nxe_dhcpv6_client_restore_record(
    NX_DHCPV6 *dhcpv6_ptr,
    ...
    /* Call actual DHCPv6 client get record service.  */
    status =
        _nx_dhcpv6_client_restore_record(dhcpv6_ptr, client_record_ptr, time_elapsed);
...
/*                                                                        */
/**************************************************************************/
UINT _nx_dhcpv6_client_restore_record(
    NX_DHCPV6 *dhcpv6_ptr,
    NX_DHCPV6_CLIENT_RECORD *client_record_ptr,
    ULONG time_elapsed) {
    ...
    /* Set the time since client set its IP address.  */
    dhcpv6_ptr->nx_dhcpv6_IP_lifetime_time_accrued =
        (client_record_ptr->nx_dhcpv6_IP_lifetime_time_accrued + time_elapsed);
