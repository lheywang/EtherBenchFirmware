...
typedef struct NX_HTTP_CLIENT_STRUCT {
    ...
    NX_PACKET_POOL
    *nx_http_client_packet_pool_ptr;           /* Pointer to HTTP Client packet pool   */
...
#define nx_http_client_create(p, n, i, pp, w)                                            \
    _nxe_http_client_create(p, n, i, pp, w, sizeof(NX_HTTP_CLIENT))
