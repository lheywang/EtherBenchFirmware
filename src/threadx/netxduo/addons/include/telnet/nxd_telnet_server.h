...
#define NX_TELNET_ACTIVITY_TIMEOUT                                                       \
    600 /* Seconds allowed with no activity                     */
#endif

#ifndef NX_TELNET_TIMEOUT_PERIOD
#define NX_TELNET_TIMEOUT_PERIOD                                                         \
    60 /* Number of seconds to check                           */
#endif

/* Define TELNET commands that are optionally included in the TELNET data.  The
   application is responsible for recognizing and responding to the commands in accordance
   with the specification.  The TELNET option command requires three bytes, as follows:
...
#define NX_TELNET_SERVER_CONNECT                                                         \
    0x01 /* TELNET connection is present                         */
#define NX_TELNET_SERVER_DISCONNECT                                                      \
    0x02 /* TELNET disconnection is present                      */
#define NX_TELNET_SERVER_DATA                                                            \
    0x04 /* TELNET receive data is present                       */
#define NX_TELNET_SERVER_ACTIVITY_TIMEOUT                                                \
    0x08 /* TELNET activity timeout check                        */
#define NX_TELNET_STOP_EVENT                                                             \
    0x10 /* TELNET stop service                                  */
#define NX_TELNET_ANY_EVENT                                                              \
    0xFF /* Any TELNET event                                     */
...
#define NX_TELNET_NOT_CONNECTED                                                          \
    0xF3 /* TELNET not connected error                           */
#define NX_TELNET_NOT_DISCONNECTED                                                       \
    0xF4 /* TELNET not disconnected error                        */
#define NX_TELNET_INVALID_PARAMETER                                                      \
    0xF5 /* Invalid non pointer input to Telnet function         */
#define NX_TELNET_NO_PACKET_POOL                                                         \
    0xF6 /* Telnet server packet pool not set                    */

/* Define the TELNET Server TCP port numbers.  */

#ifndef NX_TELNET_SERVER_PORT
#define NX_TELNET_SERVER_PORT                                                            \
    23 /* Default Port for TELNET server                       */
#endif
...
#ifndef NX_TELNET_SERVER_OPTION_DISABLE
    USHORT nx_telnet_client_agree_server_will_echo_success; /* True if server will echo
                                                               negotiation success      */
    USHORT nx_telnet_client_agree_server_will_SGA_success;  /* True if server will SGA
                                                               negotiation success      */
#endif /* NX_TELNET_SERVER_OPTION_DISABLE */
