...
/* NX_DHCPV6_HW_TYPE_IEEE_802 is defined as 1 to indicate Ethernet hardware type in old
   releases, for backward compatibility.

   Note: NX_DHCPV6_HW_TYPE_IEEE_802 will be deprecated by
   NX_DHCPV6_CLIENT_HARDWARE_TYPE_ETHERNET in future releases, should use above symbols to
...
#define NX_DHCPV6_OP_PREFERENCE                                                          \
    7 /* Server's means of affecting Client choice of servers. */
...
#define NX_DHCPV6_OP_SERVER_UNICAST                                                      \
    12 /* Server ok's allowing the client to address it in Unicast */
...
#define NX_DHCPV6_ERROR_STATUS_CODE_IN_OPTION_FIELD                                      \
    0 /* An Error Status Code option appears in options field of DHCP message.  */
#define NX_DHCPV6_ERROR_STATUS_CODE_IN_IA_NA                                             \
    1 /* An Error Status Code option appears in options field of IA_NA option.  */
#define NX_DHCPV6_ERROR_STATUS_CODE_IN_IA_ADDRESS                                        \
    2 /* An Error Status Code option appears in options field of IA_ADDRESS option .  */

/* Define the options included in the reply message.  */

#define NX_DHCPV6_INCLUDE_CLIENT_ID_OPTION                                               \
    0x00000001 /* The reply message includes a Client Identifier option. */
#define NX_DHCPV6_INCLUDE_SERVER_ID_OPTION                                               \
    0x00000002 /* The reply message includes a Server Identifier option. */
#define NX_DHCPV6_INCLUDE_IA_NA_OPTION                                                   \
    0x00000004 /* The reply message includes a IA_NA option. */
#define NX_DHCPV6_INCLUDE_IA_ADDRESS_OPTION                                              \
    0x00000008 /* The reply message includes a IA address option. */
#define NX_DHCPV6_INCLUDE_OPTION_REQUEST_OPTION                                          \
    0x00000010 /* The reply message includes a option request option. */
#define NX_DHCPV6_INCLUDE_PREFERENCE_OPTION                                              \
    0x00000020 /* The reply message includes a preference option. */
#define NX_DHCPV6_INCLUDE_ELAPSED_TIME_OPTION                                            \
    0x00000040 /* The reply message includes a elapsed time option. */
#define NX_DHCPV6_INCLUDE_RELAY_MESSAGE_OPTION                                           \
    0x00000080 /* The reply message includes a relay message option. */
#define NX_DHCPV6_INCLUDE_AUTHENTICATION_OPTION                                          \
    0x00000100 /* The reply message includes a authentication option. */
#define NX_DHCPV6_INCLUDE_SERVER_UNICAST_OPTION                                          \
    0x00000200 /* The reply message includes a server unicast option. */
#define NX_DHCPV6_INCLUDE_STATUS_SUCCESS_OPTION                                          \
    0x00000400 /* The reply message includes a status code option with success. */
#define NX_DHCPV6_INCLUDE_STATUS_UNSPEC_FAIL_OPTION                                      \
    0x00000800 /* The reply message includes a status code option with failure. */
#define NX_DHCPV6_INCLUDE_STATUS_NO_ADDR_AVAIL_OPTION                                    \
    0x00001000 /* The reply message includes a status code option with no addresses      \
                  available. */
#define NX_DHCPV6_INCLUDE_STATUS_NO_BIND_OPTION                                          \
    0x00002000 /* The reply message includes a status code option with unavailable. */
#define NX_DHCPV6_INCLUDE_STATUS_NOT_ONLINK_OPTION                                       \
    0x00004000 /* The reply message includes a status code option with not onlink. */
#define NX_DHCPV6_INCLUDE_STATUS_USE_MULTICAST_OPTION                                    \
    0x00008000 /* The reply message includes a status code option with use multicast. */
#define NX_DHCPV6_INCLUDE_RAPID_COMMIT_OPTION                                            \
    0x00010000 /* The reply message includes a rapid commit option. */
#define NX_DHCPV6_INCLUDE_USER_CLASS_OPTION                                              \
    0x00020000 /* The reply message includes a user class option. */
#define NX_DHCPV6_INCLUDE_VENDOR_CLASS_OPTION                                            \
    0x00040000 /* The reply message includes a vendor class option. */
#define NX_DHCPV6_INCLUDE_VENDOR_SPEC_INFO_OPTION                                        \
    0x00080000 /* The reply message includes a vendor specifc information option. */
#define NX_DHCPV6_INCLUDE_INTERFACE_ID_OPTION                                            \
    0x00100000 /* The reply message includes a interface Id option. */
#define NX_DHCPV6_INCLUDE_RECONF_MESSAGE_OPTION                                          \
    0x00200000 /* The reply message includes a reconfigure message option. */
#define NX_DHCPV6_INCLUDE_RECONF_ACCEPT_OPTION                                           \
    0x00400000 /* The reply message includes a reconfigure accept option. */
#define NX_DHCPV6_INCLUDE_DNS_SERVER_OPTION                                              \
    0x00800000 /* The reply message includes a dns server option. */
#define NX_DHCPV6_INCLUDE_DOMAIN_NAME_OPTION                                             \
    0x01000000 /* The reply message includes a domain name option. */
#define NX_DHCPV6_INCLUDE_SNTP_SERVER_OPTION                                             \
    0x02000000 /* The reply message includes a network time protocol servers option. */
#define NX_DHCPV6_INCLUDE_NEW_POSIX_TIIMEZONE_OPTION                                     \
    0x04000000 /* The reply message includes a new timezone POSIX string index option.   \
                */
#define NX_DHCPV6_INCLUDE_CLIENT_FQDN_OPTION                                             \
    0x08000000 /* The reply message includes a client FQDN option. */

/* Define internal DHCPv6 option flags. */

#define NX_DHCPV6_DNS_SERVER_OPTION                                                      \
    0x00000001UL /* Option code for requesting DNS server IP address  */
#define NX_DHCPV6_DOMAIN_NAME_OPTION                                                     \
    0x00000002UL /* Option code for requesting domain name. */
#define NX_DHCPV6_SNTP_SERVER_OPTION                                                     \
    0x00000004UL /* Option code for requesting time server IP address. */
#define NX_DHCPV6_NEW_POSIX_TIMEZONE_OPTION                                              \
    0x00000008UL /* Option code for requesting Time zone. */
...
#define NX_DHCPV6_UNSPECIFIED_FAILURE                                                    \
    1 /* Unspecified reason e.g. not found in RFC 3315 */
#define NX_DHCPV6_NO_ADDRESS_AVAILABLE                                                   \
    2 /* Server unable to assign IP address because none are available. */
...
#define NX_DHCPV6_USE_MULTICAST                                                          \
    5 /* Server indicates Client must use multicast ALL_SERVERS address to get IP        \
         address */
...
#define NX_DHCPV6_STATE_SENDING_SOLICIT                                                  \
    2 /* Client sends Sollicit to identify a DHCP server */
#define NX_DHCPV6_STATE_SENDING_REQUEST                                                  \
    3 /* Address requested, Client initiating a request after receiving server           \
         advertisement */
#define NX_DHCPV6_STATE_SENDING_RENEW                                                    \
    4 /* Address established, Client is initiating a renew request */
#define NX_DHCPV6_STATE_SENDING_REBIND                                                   \
    5 /* Address established, Client is initiating a rebind request */
#define NX_DHCPV6_STATE_SENDING_DECLINE                                                  \
    6 /* Address was established but Client can't use it e.g. duplicate address check    \
         failed. */
#define NX_DHCPV6_STATE_SENDING_CONFIRM                                                  \
    7 /* Client IP Address is established but Client requires confirmation its still ok  \
       */
#define NX_DHCPV6_STATE_SENDING_INFORM_REQUEST                                           \
    8 /* Client IP Address is established but Client requests information other than IP  \
         address */
#define NX_DHCPV6_STATE_SENDING_RELEASE                                                  \
    9 /* Requesting an IP address release of a recently assigned IP address. */
#define NX_DHCPV6_STATE_BOUND_TO_ADDRESS                                                 \
    15 /* Client is bound to an assigned address; DHCP Client task is basically idle. */
...
#define NX_DHCPV6_IA_ADDRESS_STATE_INITIAL                                               \
    1 /* The IA inlcude one IPv6 address,but the DHCPv6 interactive is not complete. */
#define NX_DHCPV6_IA_ADDRESS_STATE_DAD_TENTATIVE                                         \
    2 /* After DHCPv6 interactive, NetX pefrome the DAD to check this IPv6 address.  */
#define NX_DHCPV6_IA_ADDRESS_STATE_DAD_FAILURE                                           \
    3 /* DAD process failure,the DHCPv6 Client should send DECLINE message.*/
#define NX_DHCPV6_IA_ADDRESS_STATE_VALID                                                 \
    4 /* The global IP address is valid and set it to the IP instance. */
...
#define NX_DHCPV6_DAD_FAILURE_EVENT                                                      \
    0x00000001UL /* The DHCPv6 Client perform DAD failure.  */
#define NX_DHCPV6_DAD_SUCCESSFUL_EVENT                                                   \
    0x00000002UL /* The DHCPv6 Client perform DAD failure.  */

/* The behavior of a DHCPv6 client that implements the Client FQDN option. RFC4704,
 * Section5, Page7.  */

#define NX_DHCPV6_CLIENT_DESIRES_UPDATE_AAAA_RR                                          \
    0 /* DHCPv6 Client choose to updating the FQDN-to-IPv6 address mapping for FQDN and  \
         address(es) used by the client.  */
#define NX_DHCPV6_CLIENT_DESIRES_SERVER_DO_DNS_UPDATE                                    \
    1 /* DHCPv6 Client choose to updating the FQDN-to-IPv6 address mapping for FQDN and  \
         address(es) used by the client to the server.  */
#define NX_DHCPV6_CLIENT_DESIRES_NO_SERVER_DNS_UPDATE                                    \
    2 /* DHCPv6 Client choose to request that the server perform no DNS updatest on its  \
         behalf.  */
...
#define NX_DHCPV6_ALREADY_STARTED                                                        \
    0xE91 /* DHCPv6 already started when API called to start it. */
...
#define NX_DHCPV6_INVALID_CLIENT_DUID                                                    \
    0xE95 /* Client DUID received from Server with invalid data or mismatches Client     \
             server DUID on record. */
#define NX_DHCPV6_INVALID_SERVER_DUID                                                    \
    0xE96 /* Server DUID received by Client has bad syntax or missing data*/
#define NX_DHCPV6_MESSAGE_MISSING_DUID                                                   \
    0xE97 /* Client receives a message type missing server or client DUID. */
#define NX_DHCPV6_UNSUPPORTED_DUID_TYPE                                                  \
    0xE98 /* Client configuration involves a DUID type not supported by this API. */
#define NX_DHCPV6_UNSUPPORTED_DUID_HW_TYPE                                               \
    0xE99 /* Client configuration involves a network hardware type not supported by this \
             API. */
#define NX_DHCPV6_NO_DUID_OPTION                                                         \
    0xE9A /* The reply message does not include server or client identifier option. */
#define NX_DHCPV6_NO_RAPID_COMMIT_OPTION                                                 \
    0xE9B /* The reply message does not iclude rapid commit option. */
#define NX_DHCPV6_EQUAL_OR_LESS_PREF_VALUE                                               \
    0xE9C /* The current preference value is equal to or less than the recorded          \
             preference valude. */

#define NX_DHCPV6_INVALID_IANA_TIME                                                      \
    0xEA0 /* Server IA-NA option T1 vs T2 address lease time is invalid. */
#define NX_DHCPV6_MISSING_IANA_OPTION                                                    \
    0xEA1 /* Client received IA address option not belonging to an IA block */
#define NX_DHCPV6_BAD_IANA_ID                                                            \
    0xEA2 /* Server IA-NA option does not contain the Client's original IA-NA ID. */
#define NX_DHCPV6_INVALID_IANA_DATA                                                      \
    0xEA3 /* Server IA-NA option block has bad syntax or missing data */
#define NX_DHCPV6_INVALID_IA_ADDRESS                                                     \
    0xEA4 /* Client inquiring about an unknown IA address */
#define NX_DHCPV6_INVALID_IA_DATA                                                        \
    0xEA5 /* Server IA address option block has bad syntax or missing data */
#define NX_DHCPV6_INVALID_IA_TIME                                                        \
    0xEA6 /* Server IA option preferred vs valid lease time is invalid. */
#define NX_DHCPV6_INVALID_PREF_DATA                                                      \
    0xEA7 /* Client received Preference block with missing data or bad syntax */
#define NX_DHCPV6_INCOMPLETE_OPTION_BLOCK                                                \
    0xEA8 /* Empty option block data; either zero length or zero option parsed. */
#define NX_DHCPV6_MISSING_REQUIRED_OPTIONS                                               \
    0xEA9 /* Cannot start the DHCPv6 Client because required options are missing e.g.    \
             IANA, DUID etc */
#define NX_DHCPV6_INVALID_OPTION_DATA                                                    \
    0xEAA /* Client received option data with missing data or bad syntax */
#define NX_DHCPV6_UNKNOWN_OPTION                                                         \
    0xEAB /* Client received an unknown or unsupported option from server */
#define NX_DHCPV6_INVALID_SERVER_PACKET                                                  \
    0xEAC /* Server reply invalid e.g. bad port, invalid DHCP header or invalid reply    \
             message.  */
#define NX_DHCPV6_IA_ADDRESS_NOT_VALID                                                   \
    0xEAD /* Client not assigned an IP address from the DHCPv6 Server */
#define NX_DHCPV6_REACHED_MAX_IA_ADDRESS                                                 \
    0xEAE /* IA address exceeds the maximum IAs specified by NX_DHCPV6_MAX_IA_ADDRESS.   \
           */
#define NX_DHCPV6_IA_ADDRESS_ALREADY_EXIST                                               \
    0xEAF /* The IA address already added to the Client.  */

#define NX_DHCPV6_UNKNOWN_PROCESS_STATE                                                  \
    0xEB0 /* Internal DHCPv6 state machine in an unknown state */
#define NX_DHCPV6_ILLEGAL_MESSAGE_TYPE                                                   \
    0xEB1 /* Client receives a message type intended for a DHCPv6 server e.g. REQUEST or \
             CONFIRM */
#define NX_DHCPV6_UNKNOWN_MSG_TYPE                                                       \
    0xEB2 /* NetX DHCPv6 receives an unknown message type  */
#define NX_DHCPV6_BAD_TRANSACTION_ID                                                     \
    0xEB3 /* Client received message with bad transaction ID */
#define NX_DHCPV6_BAD_IPADDRESS_ERROR                                                    \
    0xEB4 /* Unable to parse a valid IPv6 address from specified data buffer  */
#define NX_DHCPV6_PROCESSING_ERROR                                                       \
    0xEB5 /* Server packet size received out of synch with NetX packet length - no       \
             assignment of blame */
#define NX_DHCPV6_INSUFFICIENT_PACKET_PAYLOAD                                            \
    0xEB6 /* Client DHCPv6 message will not fit in Client packet pool packet buffer. */
#define NX_DHCPV6_INVALID_DATA_SIZE                                                      \
    0xEB7 /* Attempting to parse too large a data object to/from DHCPv6 request. */
#define NX_DHCPV6_ADDRESS_MISMATCH                                                       \
    0xEB8 /* Client IPv6 address index into the IP table is incorrect (addresses do not  \
             match). */

#define NX_DHCPV6_REACHED_MAX_RETRANSMISSION_COUNT                                       \
    0xEC0 /* No response from server after maximum number of retries. */
#define NX_DHCPV6_REACHED_MAX_RETRANSMISSION_TIMEOUT                                     \
    0xEC1 /* No response from server after maximum retry timeout. */
...
typedef struct NX_DHCPV6_IA_ADDRESS_STRUCT {
    ...
    USHORT nx_option_length; /* Length of the IA address option data = 24 not including
                                length and op code field*/
    NXD_ADDRESS nx_global_address; /* Assigned Host IPv6 address */
    ULONG nx_preferred_lifetime; /* Server's preference for IPv6 address T1 life time for
                                    itself */
    ULONG nx_valid_lifetime;     /* Server's assigned valid time for T2 for any server  */
    UINT nx_address_status;      /* Indicates if the global address is registered and
                                    validated. */
    UINT nx_address_map; /* Map the IPv6 address with client, indicates if the IPv6
                            address already exists or not.  */
...
typedef struct NX_DHCPV6_IA_NA_STRUCT {
    ...
    ULONG nx_IA_NA_id; /* IANA identifier; must be unique among all client IANA's. Must be
                          the same on restart per IANA */
    ULONG nx_T1; /* Time client can extend time before address lifetime expires from the
                    server it got it from; applies to all addresses in IA_NA. */
    ULONG nx_T2; /* Same as T1 except this is when the client will request REBIND from
                    another server. */

} NX_DHCPV6_IA_NA;

/* Define DHCPv6 Unique Identifier (DUID); both Client and Server must send messages with
 * their own DUID. */
...
typedef struct NX_DHCPV6_DUID_STRUCT {
    ...
    USHORT
    nx_option_length;    /* Option length = 14 not including length and op code field; */
    USHORT nx_duid_type; /* 3 main types: hw; hw + time; vendor assigned ID (not supported
                            here); requires DUID be stored in non volatile storage */
    USHORT nx_hardware_type; /* Only if LL/LLT type. Hardware type specified by IANA/RFC
                                826 e.g. IEEE 802; network byte order */
    ULONG nx_duid_time; /* Only if LLT type. Time based on when DUID generated; network
                           byte order. */
    ULONG nx_link_layer_address_msw; /* Only if LL/LLT type. Pointer to Unique link layer
                                        address - most significant word (2/4 bytes)*/
    ULONG nx_link_layer_address_lsw; /* Only if LL/LLT type. Pointer to Unique link layer
                                        address - least significant word (4 bytes) */

} NX_DHCPV6_DUID;

/* Define the elapsed time option structure.  This contains the length of the Client
 * Server session. */

typedef struct NX_DHCPV6_ELAPSED_TIME_STRUCT {

    USHORT nx_op_code;   /* Elapsed time option code = 8 not including length and op code
                            field. */
    USHORT nx_op_length; /* Length of time data = 2. */
    USHORT
    nx_session_time; /* Time of DHCP session e.g. first msg elapsed time is zero. */

} NX_DHCPV6_ELAPSED_TIME;

/* Define the Message Option structure. Each message from the Client must have a unique
 * message ID. */
...
/* Define the option request structure. This is how the Client requests information other
   than global IP address. It can ask for domain name, DNS server, time zone, time server
   and other options. */
...
typedef struct NX_DHCPV6_CLIENT_FQDN_STRUCT {
    ...
    UCHAR nx_flags; /* Flag bits used between client and server to negotiate who performs
                       which updates.  */
...
/* Define the Client DHCPv6 structure containind the DHCPv6 Client record (DHCPv6 status,
 * server DUID etc).  */
...
typedef struct NX_DHCPV6_STRUCT {
    ...
    TX_MUTEX nx_dhcpv6_client_mutex;      /* Mutex for exclusive access to the DHCP Client
                                             instance */
    ...
    NX_PACKET_POOL
    *nx_dhcpv6_pool_ptr; /* Pointer to packet pool for sending DHCPV6 messages */
    ...
    UINT nx_dhcpv6_sleep_flag; /* If true, the DHCPv6 client is in a position where it can
                                  be stopped */
    NX_DHCPV6_MESSAGE_HDR nx_dhcpv6_message_hdr; /* Message Header for all client messages
                                                    to DHCPv6 Servers */
    NX_DHCPV6_DUID nx_dhcpv6_client_duid; /* Client DUID; ID by which Client and Server
                                             identify each other's DUID */
    NX_DHCPV6_DUID nx_dhcpv6_server_duid; /* Server DUID; ID by which Client and Server
                                             identify each other's DUID */
    NX_DHCPV6_ELAPSED_TIME
    nx_dhcpv6_elapsed_time; /* Time duration of the current DHCP msg exchange between
                               Client and Server. */
    NX_DHCPV6_IA_NA nx_dhcpv6_iana; /* Identity Association for non temp address - must be
                                       stored in non volatile memory */
    NX_DHCPV6_IA_ADDRESS
    nx_dhcpv6_ia[NX_DHCPV6_MAX_IA_ADDRESS];    /* Client internet address option */
    NX_DHCPV6_PREFERENCE nx_dhcpv6_preference; /* Server's preference affecting the
                                                  Client's DHCPv6 server selection. */
    NX_DHCPV6_OPTIONREQUEST
    nx_dhcpv6_option_request; /* Set of request options in Solicit, Renew, Confirm or
                                 Rebind message types. */
    NX_DHCPV6_CLIENT_FQDN
    nx_dhcpv6_client_FQDN; /* Set of Client options in Solicit, Request, Renew, or
                              Rebind message types. */
    ULONG nx_dhcpv6_IP_lifetime_time_accrued; /* Time since Client set received or renewed
                                                 its IP address with the DHCPv6 server. */
    UCHAR nx_status_message[NX_DHCPV6_MAX_MESSAGE_SIZE]; /* Server's message in its Option
                                                            status to client.  */
    NXD_ADDRESS nx_dhcpv6_server_address;                /* DHCPv6 server address.  */
    NXD_ADDRESS
    nx_dhcpv6_DNS_name_server_address[NX_DHCPV6_NUM_DNS_SERVERS]; /* DNS name server
                                                                     IP address */
    NXD_ADDRESS
    nx_dhcpv6_time_server_address[NX_DHCPV6_NUM_TIME_SERVERS]; /* time server IP
                                                                  address */
    NXD_ADDRESS
    nx_dhcpv6_client_destination_address; /* The destination address where DHCP
                                             message should be sent, by default
                                             All_DHCP_Relay_Agents_and_Servers(FF02::1:2).
                                           */
    UCHAR nx_dhcpv6_domain_name[NX_DHCPV6_DOMAIN_NAME_BUFFER_SIZE]; /* Buffer for holding
                                                                       domain name. */
    UCHAR nx_dhcpv6_time_zone[NX_DHCPV6_TIME_ZONE_BUFFER_SIZE]; /* Buffer for holding time
                                                                   zone. */
    ULONG nx_dhcpv6_solicitations_sent;     /* The number of Solicit messages sent */
    ULONG nx_dhcpv6_solicitation_responses; /* The number of solicitations server
                                               responded to */
    ...
    ULONG
    nx_dhcpv6_confirm_responses;   /* The number of confirmations server responded to */
    ...
    ULONG nx_dhcpv6_transmission_timeout; /* Timeout on Client messages before resending a
                                             request to the server. */
    ULONG nx_dhcpv6_retransmission_count; /* The number of request retransmissions to the
                                             server. */
    ...
    ULONG
    nx_dhcpv6_max_retransmission_duration; /* The maximum retransmissions duration. */
    UINT nx_dhcpv6_request_solicit_mode;   /* The mode of sending the solicit message with
                                              rapid commit option. */
    UINT nx_dhcpv6_reply_option_flags; /* The flags indicate options the reply messages
                                          included. */
    USHORT nx_dhcpv6_reply_option_current_pref_value; /* The preference value of current
                                                         advertise message. */
    ...
    VOID (*nx_dhcpv6_state_change_callback)(
        struct NX_DHCPV6_STRUCT *dhcpv6_ptr, UINT old_state, UINT new_state);

    /* Define the callback function for receiving a non successful status from the Server.
       The context of the status/error is defined by the message type is was received in
       and what option the status is referring to e.g. IA Address.  */
    VOID (*nx_dhcpv6_server_error_handler)(
    ...
    UINT (*nx_dhcpv6_user_option_add)(
        struct NX_DHCPV6_STRUCT *dhcpv6_ptr,
...
/* Define the DHCPv6 Client record structure for restore the DHCPv6 Client state from non
 * volatile memory/across reboots.  */
...
UINT nx_dhcpv6_user_option_add_callback_set(
    NX_DHCPV6 *dhcpv6_ptr,
    UINT (*dhcpv6_user_option_add)(
        ...
        UINT *user_option_length));
#ifdef NX_DHCPV6_CLIENT_RESTORE_STATE
UINT nx_dhcpv6_client_get_record(
    NX_DHCPV6 *dhcpv6_ptr, NX_DHCPV6_CLIENT_RECORD *client_record_ptr);
UINT nx_dhcpv6_client_restore_record(
    NX_DHCPV6 *dhcpv6_ptr,
