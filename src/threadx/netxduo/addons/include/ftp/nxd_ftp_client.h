...
#define NX_FTP_TRANSFER_MODE_STREAM                                                      \
    0 /* FTP stream transmission mode                        */
#define NX_FTP_TRANSFER_MODE_BLOCK                                                       \
    1 /* FTP block transmission mode                         */
#define NX_FTP_TRANSFER_MODE_COMPRESSED                                                  \
    2 /* FTP compressed transmission mode                    */
...
#define NX_FTP_CLIENT_INVALID_SIZE                                                       \
    0x1D2 /* Invalid FTP file size                               */
#define NX_FTP_CLIENT_FILE_SIZE_ALREADY_SET                                              \
    0x1D3 /* The file size is already set                        */
#define NX_FTP_CLIENT_NOT_BLOCK_MODE                                                     \
    0x1D4 /* Block mode is not enabled                           */
#define NX_FTP_CLIENT_END_OF_BLOCK                                                       \
...
#define NX_FTP_SERVER_DATA_PORT                                                          \
    20 /* Data Port for FTP server in active transfer mode    */
...
#define nx_ftp_client_directory_listing_continue                                         \
    _nxe_ftp_client_directory_listing_continue
...
UINT nx_ftp_client_file_rename(
    NX_FTP_CLIENT *ftp_ptr, CHAR *filename, CHAR *new_filename, ULONG wait_option);
...
UINT _nxe_ftp_client_file_rename(
    NX_FTP_CLIENT *ftp_client_ptr, CHAR *filename, CHAR *new_filename, ULONG wait_option);
...
UINT _nx_ftp_utility_convert_IPv6_to_ascii(
    NX_TCP_SOCKET *tcp_socket_ptr, CHAR *buffer, UINT buffer_length, UINT *size);
