    ...
    if (tcp_header_ptr->nx_tcp_header_word_3 & NX_TCP_ACK_BIT) {
        ...
        if (socket_ptr->nx_tcp_socket_receive_queue_tail) {
            ...
            if (search_ptr->nx_packet_ip_version == NX_IP_VERSION_V4) {
                 ...
                 * necessary  */
                search_header_ptr = (NX_TCP_HEADER *)(search_ptr->nx_packet_ip_header + sizeof(NX_IPV4_HEADER));
            } else
                ...
                /*lint -e{927} -e{826} suppress cast of pointer to pointer, since it is
                 * necessary  */
                search_header_ptr = (NX_TCP_HEADER *)(search_ptr->nx_packet_ip_header + sizeof(NX_IPV6_HEADER));
            } else
            ...
            tcp_payload_length = (search_ptr->nx_packet_length -
                                  (header_length + (ULONG)((ALIGN_TYPE)search_header_ptr -
        ...
        if (tcp_header_ptr->nx_tcp_acknowledgment_number == ending_tx_sequence) {
            ...
            while (search_ptr) {
                ...
                if (search_ptr->nx_packet_queue_next != ((NX_PACKET *)NX_DRIVER_TX_DONE)) {
                    ...
                    /* Setup a pointer to header of this packet in the sent list.  */
                    search_header_ptr =
                        (NX_TCP_HEADER *)(search_ptr->nx_packet_ip_header + search_ptr->nx_packet_ip_header_length);
                } else {
        ...
        while (packet_release_count--) {
            ...
            if (previous_ptr->nx_packet_queue_next == ((NX_PACKET *)NX_DRIVER_TX_DONE)) {
                ...
                /* Open up the transmit window. */
                search_header_ptr =
                    (NX_TCP_HEADER *)(previous_ptr->nx_packet_ip_header + previous_ptr->nx_packet_ip_header_length);
