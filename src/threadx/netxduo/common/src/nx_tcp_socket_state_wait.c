...
UINT _nx_tcp_socket_state_wait(NX_TCP_SOCKET *socket_ptr, UINT desired_state, ULONG wait_option) {
    ...
    NX_TRACE_IN_LINE_INSERT(NX_TRACE_TCP_SOCKET_STATE_WAIT, socket_ptr->nx_tcp_socket_ip_ptr, socket_ptr, desired_state,
...
#ifdef NX_ENABLE_HTTP_PROXY
            if ((desired_state != NX_TCP_ESTABLISHED) || (!socket_ptr->nx_tcp_socket_ip_ptr->nx_ip_http_proxy_enable) ||
