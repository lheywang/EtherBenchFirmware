...
UINT _nx_tcp_server_socket_accept(NX_TCP_SOCKET *socket_ptr, ULONG wait_option) {
    ...
    NX_TRACE_IN_LINE_INSERT(NX_TRACE_TCP_SERVER_SOCKET_ACCEPT, ip_ptr, socket_ptr, wait_option,
    ...
    if (socket_ptr->nx_tcp_socket_state == NX_TCP_LISTEN_STATE) {
        ...
        NX_TRACE_IN_LINE_INSERT(NX_TRACE_INTERNAL_TCP_STATE_CHANGE, ip_ptr, socket_ptr, socket_ptr->nx_tcp_socket_state,
                                NX_TCP_SYN_RECEIVED, NX_TRACE_INTERNAL_EVENTS, 0, 0);
    ...
    if ((wait_option) && (_tx_thread_current_ptr != &(ip_ptr->nx_ip_thread))) {
        ...
        if (_tx_thread_current_ptr->tx_thread_suspend_status) {
            ...
            NX_TRACE_IN_LINE_INSERT(NX_TRACE_INTERNAL_TCP_STATE_CHANGE, ip_ptr, socket_ptr,
                                    socket_ptr->nx_tcp_socket_state, NX_TCP_LISTEN_STATE, NX_TRACE_INTERNAL_EVENTS, 0,
                                    0);
