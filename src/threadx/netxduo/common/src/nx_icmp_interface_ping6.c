...
UINT _nx_icmp_interface_ping6(NX_IP *ip_ptr, NXD_ADDRESS *ip_address, CHAR *data_ptr, ULONG data_size,
    ...
    NX_TRACE_IN_LINE_INSERT(NX_TRACE_ICMP_PING6, ip_ptr, ip_address_lsw, data_ptr, data_size, NX_TRACE_ICMP_EVENTS, 0,
                            0);
#endif /* TX_ENABLE_EVENT_TRACE */
 ...
 * NX_TRACE_INTERNAL_EVENTS, 0, 0) */
        ...
        */
    {
        ...
        checksum = _nx_ip_checksum_compute(request_ptr, NX_PROTOCOL_ICMPV6, (UINT)request_ptr->nx_packet_length,
    ...
    _nx_ipv6_packet_send(ip_ptr, request_ptr, NX_PROTOCOL_ICMPV6, request_ptr->nx_packet_length,
                         ip_ptr->nx_ipv6_hop_limit, ipv6_address->nxd_ipv6_address, ip_address->nxd_ip_address.v6);
