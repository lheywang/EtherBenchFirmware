...
static UINT _nx_udp_socket_driver_unbind(NX_UDP_SOCKET *socket_ptr) {
    ...
    for (i = 0; i < NX_MAX_IP_INTERFACES; i++) {
        ...
        interface_ptr->nx_interface_tcpip_offload_handler(ip_ptr, interface_ptr, socket_ptr,
                                                          NX_TCPIP_OFFLOAD_UDP_SOCKET_UNBIND, NX_NULL, NX_NULL, NX_NULL,
                                                          socket_ptr->nx_udp_socket_port, NX_NULL, NX_NO_WAIT);
    }
...
UINT _nx_udp_socket_unbind(NX_UDP_SOCKET *socket_ptr) {
    ...
    NX_TRACE_IN_LINE_INSERT(NX_TRACE_UDP_SOCKET_UNBIND, ip_ptr, socket_ptr, socket_ptr->nx_udp_socket_port, 0,
    ...
    if (socket_ptr->nx_udp_socket_bound_next == socket_ptr) {
        ...
        (socket_ptr->nx_udp_socket_bound_next)->nx_udp_socket_bound_previous = socket_ptr->nx_udp_socket_bound_previous;
        (socket_ptr->nx_udp_socket_bound_previous)->nx_udp_socket_bound_next = socket_ptr->nx_udp_socket_bound_next;
    ...
    if (thread_ptr) {
        ...
        new_socket_ptr->nx_udp_socket_bind_suspension_list = socket_ptr->nx_udp_socket_bind_suspension_list;
        socket_ptr->nx_udp_socket_bind_suspension_list = NX_NULL;
        ...
        if (ip_ptr->nx_ip_udp_port_table[index]) {
            ...
            /* There are already sockets on this list... just add this one
               to the end.  */
            new_socket_ptr->nx_udp_socket_bound_next = ip_ptr->nx_ip_udp_port_table[index];
