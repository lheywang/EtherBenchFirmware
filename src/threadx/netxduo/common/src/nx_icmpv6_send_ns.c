...
VOID _nx_icmpv6_send_ns(NX_IP *ip_ptr, ULONG *neighbor_IP_address, INT send_slla, NXD_IPV6_ADDRESS *outgoing_address,
    ...
    if (send_slla) /* Need to send SLLA option */
    {
        ...
        mac_addr[1] =
            (USHORT)((outgoing_address->nxd_ipv6_address_attached->nx_interface_physical_address_lsw & 0xFFFF0000) >>
                     16); /* lgtm[cpp/overflow-buffer] */
        mac_addr[2] = (USHORT)(outgoing_address->nxd_ipv6_address_attached->nx_interface_physical_address_lsw &
    ...
    if (outgoing_address->nxd_ipv6_address_attached->nx_interface_capability_flag &
        ...
        */
    {
        ...
        checksum = _nx_ip_checksum_compute(pkt_ptr, NX_PROTOCOL_ICMPV6, (UINT)pkt_ptr->nx_packet_length, src_address,
                                           dest_address);
    ...
    /* Add IPv6 header. */
    if (_nx_ipv6_header_add(ip_ptr, &pkt_ptr, NX_PROTOCOL_ICMPV6, pkt_ptr->nx_packet_length, 255, src_address,
