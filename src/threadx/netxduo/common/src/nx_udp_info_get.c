...
UINT _nx_udp_info_get(NX_IP *ip_ptr, ULONG *udp_packets_sent, ULONG *udp_bytes_sent, ULONG *udp_packets_received,
    ...
    NX_TRACE_IN_LINE_INSERT(NX_TRACE_UDP_INFO_GET, ip_ptr, ip_ptr->nx_ip_udp_bytes_sent,
                            ip_ptr->nx_ip_udp_bytes_received, ip_ptr->nx_ip_udp_invalid_packets, NX_TRACE_UDP_EVENTS, 0,
                            0);
