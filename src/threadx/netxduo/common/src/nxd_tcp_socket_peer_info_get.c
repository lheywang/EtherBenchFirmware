...
UINT _nxd_tcp_socket_peer_info_get(NX_TCP_SOCKET *socket_ptr, NXD_ADDRESS *peer_ip_address, ULONG *peer_port) {
    ...
    if (socket_ptr->nx_tcp_socket_connect_ip.nxd_ip_version == NX_IP_VERSION_V6) {
        ...
        COPY_IPV6_ADDRESS(socket_ptr->nx_tcp_socket_connect_ip.nxd_ip_address.v6, peer_ip_address->nxd_ip_address.v6);
    }
    ...
    *peer_port = socket_ptr->nx_tcp_socket_connect_port;
    ...
    NX_TRACE_IN_LINE_INSERT(NXD_TRACE_TCP_SOCKET_PEER_INFO_GET, socket_ptr, ip_address_lsw, *peer_port, 0,
