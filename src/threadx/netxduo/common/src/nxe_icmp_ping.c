...
/*                                                                        */
/**************************************************************************/
UINT _nxe_icmp_ping(NX_IP *ip_ptr, ULONG ip_address, CHAR *data_ptr, ULONG data_size, NX_PACKET **response_ptr,
                    ULONG wait_option) {
    ...
    status = _nx_icmp_ping(ip_ptr, ip_address, data_ptr, data_size, response_ptr, wait_option);
