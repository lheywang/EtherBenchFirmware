...
UINT _nx_igmp_info_get(NX_IP *ip_ptr, ULONG *igmp_reports_sent, ULONG *igmp_queries_received,
    ...
    NX_TRACE_IN_LINE_INSERT(NX_TRACE_IGMP_INFO_GET, ip_ptr, ip_ptr->nx_ip_igmp_reports_sent,
                            ip_ptr->nx_ip_igmp_queries_received, ip_ptr->nx_ip_igmp_groups_joined, NX_TRACE_IGMP_EVENTS,
                            0, 0);
