...
UINT _nx_tcp_server_socket_unaccept(NX_TCP_SOCKET *socket_ptr) {
    ...
    NX_TRACE_IN_LINE_INSERT(NX_TRACE_TCP_SERVER_SOCKET_UNACCEPT, ip_ptr, socket_ptr, socket_ptr->nx_tcp_socket_state, 0,
    ...
    if ((socket_ptr->nx_tcp_socket_state >= NX_TCP_CLOSE_WAIT) ||
        ...
        NX_TRACE_IN_LINE_INSERT(NX_TRACE_INTERNAL_TCP_STATE_CHANGE, ip_ptr, socket_ptr, socket_ptr->nx_tcp_socket_state,
                                NX_TCP_LISTEN_STATE, NX_TRACE_INTERNAL_EVENTS, 0, 0);
