...
UINT _nx_tcp_socket_info_get(NX_TCP_SOCKET *socket_ptr, ULONG *tcp_packets_sent, ULONG *tcp_bytes_sent,
    ...
    NX_TRACE_IN_LINE_INSERT(NX_TRACE_TCP_SOCKET_INFO_GET, ip_ptr, socket_ptr, socket_ptr->nx_tcp_socket_packets_sent,
                            socket_ptr->nx_tcp_socket_bytes_received, NX_TRACE_TCP_EVENTS, 0, 0);
