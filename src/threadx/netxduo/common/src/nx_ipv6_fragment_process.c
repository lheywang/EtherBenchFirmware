    ...
    *last_header_location = NX_PROTOCOL_NEXT_HEADER_FRAGMENT;
    ...
    while (packet_length) {
        ...
        /* Figure out the number of bytes (fragmentable part + unfragmentable part)
           of this frame. */
        remaining_bytes =
            fragment_size + unfragmentable_size + (UINT)sizeof(NX_IPV6_HEADER_FRAGMENT_OPTION) + NX_PHYSICAL_HEADER;
        ...
        word_1 = (ULONG)(((fragment_size + unfragmentable_size - sizeof(NX_IPV6_HEADER)) +
        ...
        (source_packet->nx_packet_address.nx_packet_ipv6_address_ptr->nxd_ipv6_address_attached
