...
VOID _nx_icmpv4_process_echo_request(NX_IP *ip_ptr, NX_PACKET *packet_ptr) {
    ...
    NX_TRACE_IN_LINE_INSERT(NX_TRACE_INTERNAL_ICMP_RECEIVE, ip_ptr, ipv4_header->nx_ip_header_source_ip, packet_ptr, 0,
    ...
    _nx_ip_packet_send(ip_ptr, packet_ptr, ipv4_header->nx_ip_header_source_ip, NX_IP_NORMAL, NX_IP_TIME_TO_LIVE,
                       NX_IP_ICMP, NX_FRAGMENT_OKAY, next_hop_address);
}
