                ...
                if (ip_version == search_ptr->nx_packet_ip_version) {
                    ...
                    if (ip_version == NX_IP_VERSION_V6) {
                        ...
                        if ((current_id == search_v6_fragment_option->nx_ipv6_header_fragment_option_packet_id) &&
                            (CHECK_IPV6_ADDRESSES_SAME(search_pkt_ip_header->nx_ip_header_source_ip,
                                                       current_pkt_ip_header->nx_ip_header_source_ip)) &&
                            (CHECK_IPV6_ADDRESSES_SAME(search_pkt_ip_header->nx_ip_header_destination_ip,
        ...
        if (found_ptr) {
            ...
            do {
                ...
                if (ip_version == NX_IP_VERSION_V6) {
                    ...
                    /* Determine if the incoming IP fragment goes before this packet.  */
                    if (current_offset <=
                        (ULONG)(search_v6_fragment_option->nx_ipv6_header_fragment_option_offset_flag & 0xFFF8)) {
            ...
            do {
                ...
                if (ip_version == NX_IP_VERSION_V4) {
                    ...
                    current_offset = current_offset + ((search_header->nx_ip_header_word_0 & NX_LOWER_16_MASK) -
                ...
                if (ip_version == NX_IP_VERSION_V6) {
                    ...
                    /* Calculate the next expected offset.  */
                    current_offset =
                        current_offset + (search_ptr->nx_packet_length - (ULONG)sizeof(NX_IPV6_HEADER_FRAGMENT_OPTION));
                }
#endif /* FEATURE_NX_IPV6 */
            ...
            if (
                ...
                ((ip_version == NX_IP_VERSION_V6) &&
                 (search_v6_fragment_option->nx_ipv6_header_fragment_option_offset_flag & 1))
#endif /* FEATURE_NX_IPV6 */
            ) {
            ...
            while (search_ptr) {
                ...
                if (ip_version == NX_IP_VERSION_V4) {
                    ...
                    fragment_head->nx_packet_length =
                        fragment_head->nx_packet_length + search_ptr->nx_packet_length - (ULONG)sizeof(NX_IPV4_HEADER);

                    /* Position past the IP header in the subsequent packets.  */
                    search_ptr->nx_packet_prepend_ptr = search_ptr->nx_packet_prepend_ptr + sizeof(NX_IPV4_HEADER);
                }
#endif /* NX_DISABLE_IPV4 */
#ifdef FEATURE_NX_IPV6
                if (ip_version == NX_IP_VERSION_V6) {
