...
UINT _nxe_arp_info_get(NX_IP *ip_ptr, ULONG *arp_requests_sent, ULONG *arp_requests_received, ULONG *arp_responses_sent,
    ...
    status =
        _nx_arp_info_get(ip_ptr, arp_requests_sent, arp_requests_received, arp_responses_sent, arp_responses_received,
                         arp_dynamic_entries, arp_static_entries, arp_aged_entries, arp_invalid_messages);
