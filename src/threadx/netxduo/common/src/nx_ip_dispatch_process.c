    ...
    while (!drop_packet) {
        ...
        case NX_PROTOCOL_NEXT_HEADER_AUTHENTICATION:
            ...
            if (ip_ptr->nx_ip_ipsec_authentication_header_receive == NX_NULL) {
                ...
                ret =
                    ip_ptr->nx_ip_ipsec_authentication_header_receive(ip_ptr, packet_ptr, &next_protocol, &packet_ptr);
        ...
        case NX_PROTOCOL_NEXT_HEADER_ENCAP_SECURITY:
            ...
            if (ip_ptr->nx_ip_ipsec_encapsulating_security_payload_receive == NX_NULL) {
                ...
                ret = ip_ptr->nx_ip_ipsec_encapsulating_security_payload_receive(ip_ptr, packet_ptr, &next_protocol,
                                                                                 &packet_ptr);
        ...
        default:
            ...
            if (packet_ptr->nx_packet_ipsec_sa_ptr == NX_NULL) {
                ...
                if (packet_ptr->nx_packet_ip_version == NX_IP_VERSION_V6) {
                    ...
                    COPY_IPV6_ADDRESS(ipv6_header->nx_ip_header_source_ip, src_addr.nxd_ip_address.v6);

                    COPY_IPV6_ADDRESS(ipv6_header->nx_ip_header_destination_ip, dest_addr.nxd_ip_address.v6);
                } else
#endif /* FEATURE_NX_IPV6 */
                {
#ifndef NX_DISABLE_IPV4
                ...
                if (_nx_ipsec_sa_ingress_lookup(ip_ptr, &src_addr, &dest_addr, 0, (UCHAR)protocol, NX_NULL,
            ...
            /* For IPsec tunnel mode, next protocol is checked here. */
                ...
                if (_nx_ipsec_sa_ingress_selector_check(
                        ...
                        ((NX_IPSEC_SA *)(packet_ptr->nx_packet_ipsec_sa_ptr))->nx_ipsec_selector_ptr) ==
          ...
          defined(NX_ENABLE_IP_RAW_PACKET_FILTER) */
            ...
            if (protocol == NX_PROTOCOL_TCP) {
...
#ifdef FEATURE_NX_IPV6
            else if ((packet_ptr->nx_packet_ip_version == NX_IP_VERSION_V6) && (protocol == NX_PROTOCOL_ICMPV6)) {
...
#ifndef NX_DISABLE_IPV4
            else if ((packet_ptr->nx_packet_ip_version == NX_IP_VERSION_V4) && (protocol == NX_PROTOCOL_ICMP)) {
                ...
                drop_packet = 1;
            } else if ((packet_ptr->nx_packet_ip_version == NX_IP_VERSION_V4) && (protocol == NX_PROTOCOL_IGMP)) {
