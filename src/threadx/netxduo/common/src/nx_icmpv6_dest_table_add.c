...
UINT _nx_icmpv6_dest_table_add(NX_IP *ip_ptr, ULONG *destination_address, NX_IPV6_DESTINATION_ENTRY **dest_entry_ptr,
    ...
    *dest_entry_ptr = NX_NULL;
    ...
    COPY_IPV6_ADDRESS(destination_address,
                      ip_ptr->nx_ipv6_destination_table[i].nx_ipv6_destination_entry_destination_address);
    ...
    status = _nx_nd_cache_find_entry(ip_ptr, next_hop,
    ...
    if (mtu_timeout > 0) {
        ...
        if (ip_ptr->nx_ipv6_destination_table[i].nx_ipv6_destination_entry_path_mtu ==
            ...
            ip_ptr->nx_ipv6_destination_table[i].nx_ipv6_destination_entry_MTU_timer_tick =
