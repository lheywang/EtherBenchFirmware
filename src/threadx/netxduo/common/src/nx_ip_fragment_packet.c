...
VOID _nx_ip_fragment_packet(struct NX_IP_DRIVER_STRUCT *driver_req_ptr) {
    ...
    fragment_size = source_packet->nx_packet_address.nx_packet_interface_ptr->nx_interface_ip_mtu_size -
    ...
    while (remaining_bytes) {
        ...
        status = _nx_packet_allocate(ip_ptr->nx_ip_default_packet_pool, &fragment_packet, NX_IPv4_PACKET, TX_NO_WAIT);
        ...
        fragment_packet->nx_packet_address.nx_packet_interface_ptr =
            driver_req_ptr->nx_ip_driver_packet->nx_packet_address.nx_packet_interface_ptr;
        ...
        while (copy_remaining_size) {
            ...
            status = _nx_packet_data_append(fragment_packet, source_ptr, copy_size, ip_ptr->nx_ip_default_packet_pool,
                                            NX_NO_WAIT);
        ...
        fragment_header_ptr->nx_ip_header_word_0 =
            (source_header_ptr->nx_ip_header_word_0 & ~NX_LOWER_16_MASK) | fragment_packet->nx_packet_length;
...
#ifdef NX_ENABLE_INTERFACE_CAPABILITY
        if (fragment_packet->nx_packet_address.nx_packet_interface_ptr->nx_interface_capability_flag &
          ...
          defined(NX_ENABLE_INTERFACE_CAPABILITY) */
        {
            ...
            fragment_header_ptr->nx_ip_header_word_2 =
                fragment_header_ptr->nx_ip_header_word_2 | (NX_LOWER_16_MASK & (~checksum));
        }
#ifdef NX_ENABLE_INTERFACE_CAPABILITY
        else {
        ...
        NX_TRACE_IN_LINE_INSERT(NX_TRACE_INTERNAL_IO_DRIVER_PACKET_SEND, ip_ptr, fragment_packet,
                                fragment_packet->nx_packet_length, 0, NX_TRACE_INTERNAL_EVENTS, 0, 0);
