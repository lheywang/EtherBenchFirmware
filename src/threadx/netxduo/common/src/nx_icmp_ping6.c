...
UINT _nx_icmp_ping6(NX_IP *ip_ptr, NXD_ADDRESS *ip_address, CHAR *data_ptr, ULONG data_size, NX_PACKET **response_ptr,
    ...
    *response_ptr = NX_NULL;
    ...
    status = _nxd_ipv6_interface_find(ip_ptr, ip_address->nxd_ip_address.v6, &outgoing_address, NX_NULL);
    ...
    status =
        _nx_icmp_interface_ping6(ip_ptr, ip_address, data_ptr, data_size, outgoing_address, response_ptr, wait_option);
