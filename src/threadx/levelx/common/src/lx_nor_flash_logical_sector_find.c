...
UINT _lx_nor_flash_logical_sector_find(LX_NOR_FLASH *nor_flash, ULONG logical_sector, ULONG superceded_check,
    ...
    *physical_sector_address = (ULONG *)0;
    ...
    if (logical_sector < nor_flash->lx_nor_flash_extended_cache_mapping_bitmap_max_logical_sector) {
        ...
        if ((nor_flash->lx_nor_flash_extended_cache_mapping_bitmap[logical_sector >> 5] &
    ...
    if (nor_flash->lx_nor_flash_sector_mapping_cache_enabled) {
        ...
        if ((sector_mapping_cache_entry_ptr->lx_nor_sector_mapping_cache_logical_sector) ==
            ...
            *physical_sector_map_entry =
                sector_mapping_cache_entry_ptr->lx_nor_sector_mapping_cache_physical_sector_map_entry;
            *physical_sector_address =
            ...
            /* Yes, return the cached values associated with the sector.  */
            *physical_sector_map_entry =
                (sector_mapping_cache_entry_ptr + 1)->lx_nor_sector_mapping_cache_physical_sector_map_entry;
            *physical_sector_address =
            ...
            *physical_sector_map_entry =
                (sector_mapping_cache_entry_ptr + 2)->lx_nor_sector_mapping_cache_physical_sector_map_entry;
            *physical_sector_address =
                (sector_mapping_cache_entry_ptr + 2)->lx_nor_sector_mapping_cache_physical_sector_address;
            ...
            *(sector_mapping_cache_entry_ptr + 1) = temp_sector_mapping_cache_entry;
            ...
            /* Yes, return the cached value.  */
            *physical_sector_map_entry =
                (sector_mapping_cache_entry_ptr + 3)->lx_nor_sector_mapping_cache_physical_sector_map_entry;
            *physical_sector_address =
                (sector_mapping_cache_entry_ptr + 3)->lx_nor_sector_mapping_cache_physical_sector_address;
    ...
    while (total_blocks--) {
...
#else
        status = _lx_nor_flash_driver_read(nor_flash, block_word_ptr + LX_NOR_FLASH_MIN_LOGICAL_SECTOR_OFFSET,
...
#else
            status = _lx_nor_flash_driver_read(nor_flash, block_word_ptr + LX_NOR_FLASH_MAX_LOGICAL_SECTOR_OFFSET,
        ...
        while (total_sectors--) {
            ...
            /* Is this entry valid?  */
            if ((list_word & (LX_NOR_PHYSICAL_SECTOR_VALID | LX_NOR_PHYSICAL_SECTOR_MAPPING_NOT_VALID)) ==
                ...
                if ((list_word & LX_NOR_LOGICAL_SECTOR_MASK) == logical_sector) {
                    ...
                    if (superceded_check == LX_FALSE) {
                        ...
                        *physical_sector_address = block_word_ptr +
                        ...
                        if (nor_flash->lx_nor_flash_sector_mapping_cache_enabled) {
                            ...
                            *(sector_mapping_cache_entry_ptr + 1) = *(sector_mapping_cache_entry_ptr);
                            ...
                            sector_mapping_cache_entry_ptr->lx_nor_sector_mapping_cache_logical_sector =
                                (logical_sector | LX_NOR_SECTOR_MAPPING_CACHE_ENTRY_VALID);
                            sector_mapping_cache_entry_ptr->lx_nor_sector_mapping_cache_physical_sector_map_entry =
                                *physical_sector_map_entry;
                            sector_mapping_cache_entry_ptr->lx_nor_sector_mapping_cache_physical_sector_address =
        ...
        if ((valid_sector_found == LX_FALSE) && (max_logical_sector != LX_ALL_ONES)) {
            ...
            status = _lx_nor_flash_driver_write(nor_flash, block_word_ptr + LX_NOR_FLASH_MAX_LOGICAL_SECTOR_OFFSET,
                                                &max_logical_sector, 1);
