...
UINT _lx_nand_flash_metadata_build(LX_NAND_FLASH *nand_flash) {
    ...
    page_count = (nand_flash->lx_nand_flash_erase_count_table_size + (nand_flash->lx_nand_flash_bytes_per_page - 1)) /
    ...
    for (i = 0; i < page_count; i++) {
        ...
        status = _lx_nand_flash_metadata_write(
            nand_flash,
            (UCHAR *)(nand_flash->lx_nand_flash_erase_count_table + i * nand_flash->lx_nand_flash_bytes_per_page),
    ...
    page_count = (nand_flash->lx_nand_flash_block_mapping_table_size + (nand_flash->lx_nand_flash_bytes_per_page - 1)) /
                 nand_flash->lx_nand_flash_bytes_per_page;
    ...
    page_count = (nand_flash->lx_nand_flash_block_status_table_size + (nand_flash->lx_nand_flash_bytes_per_page - 1)) /
                 nand_flash->lx_nand_flash_bytes_per_page;
