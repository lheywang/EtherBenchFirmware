...
UINT _lx_nand_flash_open(LX_NAND_FLASH *nand_flash, CHAR *name, UINT (*nand_driver_initialize)(LX_NAND_FLASH *),
    ...
    LX_MEMSET(nand_flash, 0,
              (ULONG)((UCHAR *)&(nand_flash->lx_nand_flash_open_previous) - (UCHAR *)nand_flash) +
    ...
    nand_flash->lx_nand_flash_words_per_block =
        (nand_flash->lx_nand_flash_words_per_page * nand_flash->lx_nand_flash_pages_per_block);

    /* Calculate the total pages.  */
    nand_flash->lx_nand_flash_total_pages =
        nand_flash->lx_nand_flash_total_blocks * nand_flash->lx_nand_flash_pages_per_block;
    ...
    for (block = 0; block < nand_flash->lx_nand_flash_total_blocks; block++) {
        ...
        status =
            (nand_flash->lx_nand_flash_driver_pages_read)(nand_flash, block, 0, page_buffer_ptr, spare_buffer_ptr, 1);
#else
    ...
    do {
        ...
        for (page = 0; page < nand_flash->lx_nand_flash_pages_per_block; page++) {
...
#ifdef LX_NAND_ENABLE_CONTROL_BLOCK_FOR_DRIVER_INTERFACE
            status = (nand_flash->lx_nand_flash_driver_pages_read)(nand_flash, block, page, page_buffer_ptr,
                                                                   spare_buffer_ptr, 1);
#else
            ...
            page_index = LX_UTILITY_LONG_GET(&spare_buffer_ptr[nand_flash->lx_nand_flash_spare_data1_offset]) &
                         LX_NAND_PAGE_TYPE_PAGE_NUMBER_MASK;
            ...
            case LX_NAND_PAGE_TYPE_ERASE_COUNT_TABLE:
                ...
                LX_MEMCPY(nand_flash->lx_nand_flash_erase_count_table +
                              page_index * nand_flash->lx_nand_flash_bytes_per_page, /* Use case of memcpy is
                                                                                        verified. */
            ...
            case LX_NAND_PAGE_TYPE_BLOCK_MAPPING_TABLE:
                ...
                LX_MEMCPY(nand_flash->lx_nand_flash_block_mapping_table +
                              page_index * nand_flash->lx_nand_flash_bytes_per_page /
                                  sizeof(*nand_flash->lx_nand_flash_block_mapping_table), /* Use case
                                                                                             of memcpy
                                                                                             is
                                                                                             verified.
                                                                                           */
            ...
            case LX_NAND_PAGE_TYPE_BLOCK_STATUS_TABLE:
                ...
                LX_MEMCPY(nand_flash->lx_nand_flash_block_status_table +
                              page_index * nand_flash->lx_nand_flash_bytes_per_page /
                                  sizeof(*nand_flash->lx_nand_flash_block_status_table), /* Use case of
                                                                                            memcpy is
                                                                                            verified.
                                                                                          */
                          page_buffer_ptr, nand_flash->lx_nand_flash_bytes_per_page);
            ...
            case LX_NAND_PAGE_TYPE_BLOCK_LINK:
                ...
                nand_flash->lx_nand_flash_metadata_block_number_next =
                    LX_UTILITY_LONG_GET(&page_buffer_ptr[LX_NAND_BLOCK_LINK_MAIN_METADATA_OFFSET]);
                nand_flash->lx_nand_flash_backup_metadata_block_number_next =
                    LX_UTILITY_LONG_GET(&page_buffer_ptr[LX_NAND_BLOCK_LINK_BACKUP_METADATA_OFFSET]);

                /* Save block numbers in metadata block lists.  */
                nand_flash->lx_nand_flash_metadata_block[nand_flash->lx_nand_flash_metadata_block_count] =
                    (USHORT)LX_UTILITY_LONG_GET(&page_buffer_ptr[LX_NAND_BLOCK_LINK_MAIN_METADATA_OFFSET]);
                nand_flash->lx_nand_flash_backup_metadata_block[nand_flash->lx_nand_flash_metadata_block_count] =
                    (USHORT)LX_UTILITY_LONG_GET(&page_buffer_ptr[LX_NAND_BLOCK_LINK_BACKUP_METADATA_OFFSET]);
