        ...
        if (mapped_sectors <= (nor_flash->lx_nor_flash_free_physical_sectors - free_sectors)) {
            ...
            for (i = 0; i < nor_flash->lx_nor_flash_physical_sectors_per_block; i++) {
                ...
                if (list_word & LX_NOR_PHYSICAL_SECTOR_VALID) {
                    ...
                    _lx_nor_flash_physical_sector_allocate(nor_flash, logical_sector, &new_mapping_address,
                                                           &new_sector_address);
                    ...
                    if (new_mapping_address) {
                        ...
                        status = _lx_nor_flash_driver_write(
                            ...
                            (block_word_ptr + nor_flash->lx_nor_flash_block_physical_sector_offset) +
                         ...
                         * physical sector.  */
                        status = _lx_nor_flash_driver_write(nor_flash, new_sector_address,
                                                            nor_flash->lx_nor_flash_sector_buffer, LX_NOR_SECTOR_SIZE);
